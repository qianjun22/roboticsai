"""Robot whole-body motion controller — coordinates base, torso, and arms for mobile manipulation with operational space control and QP constraint satisfaction
...
try:
    ...
    _has_fastapi = False
PORT = 10924
SERVICE = "robot_whole_body_motion_controller"
DESCRIPTION = "Robot whole-body motion controller — coordinates base, torso, and arms for mobile manipulation with operational space control and QP constraint satisfaction"
if _has_fastapi:

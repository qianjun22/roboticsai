"""Robot workspace boundary monitor — real-time reachability monitoring with singularity proximity detection, configurable safety zones, and velocity ramp-down near limits
...
DESCRIPTION = "Robot workspace boundary monitor — real-time reachability monitoring with singularity proximity detection, configurable safety zones, and velocity ramp-down near limits"
if _has_fastapi:

...
PORT = 12312
SERVICE = "robot_livestock_health_monitor_trainer"
DESCRIPTION = "Training service for livestock health monitoring robot automated scanning and disease detection"

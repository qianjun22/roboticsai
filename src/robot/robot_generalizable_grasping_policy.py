...
PORT = 11500
SERVICE = "robot_generalizable_grasping_policy"
DESCRIPTION = "Zero-shot generalizable grasping across unseen objects using geometric and semantic feature matching"

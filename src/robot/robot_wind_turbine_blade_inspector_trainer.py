...
PORT = 12392
SERVICE = "robot_wind_turbine_blade_inspector_trainer"
DESCRIPTION = "Training service for wind turbine blade inspection robot crack detection and erosion measurement"

"""Multi-finger grasp planner using dexterous hand kinematics and contact optimization for complex object manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11180
SERVICE = "robot_multi_finger_grasp_planner"
DESCRIPTION = "Multi-finger grasp planner using dexterous hand kinematics and contact optimization for complex object manipulation"
if _has_fastapi:

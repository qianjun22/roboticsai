"""Robot grasp sequence planner — optimizes multi-step grasp sequences for complex object manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 10908
SERVICE = "robot_grasp_sequence_planner"
DESCRIPTION = "Robot grasp sequence planner — optimizes multi-step grasp sequences for complex object manipulation"
if _has_fastapi:

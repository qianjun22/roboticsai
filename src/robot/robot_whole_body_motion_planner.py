"""Whole-body motion planner coordinating base, torso, and arm for loco-manipulation tasks in mobile robot systems
...
try:
    ...
    _has_fastapi = False
PORT = 11172
SERVICE = "robot_whole_body_motion_planner"
DESCRIPTION = "Whole-body motion planner coordinating base, torso, and arm for loco-manipulation tasks in mobile robot systems"
if _has_fastapi:

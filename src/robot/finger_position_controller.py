"""Finger position controller for precise gripper jaw placement and force modulation
...
try:
    ...
    _has_fastapi = False
PORT = 11076
SERVICE = "robot_finger_position_controller"
DESCRIPTION = "Finger position controller for precise gripper jaw placement and force modulation"
if _has_fastapi:

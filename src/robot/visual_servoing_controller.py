"""Image-based visual servoing controller for precise end-effector positioning using camera feedback
...
try:
    ...
    _has_fastapi = False
PORT = 11108
SERVICE = "robot_visual_servoing_controller"
DESCRIPTION = "Image-based visual servoing controller for precise end-effector positioning using camera feedback"
if _has_fastapi:

...
PORT = 12384
SERVICE = "robot_satellite_dish_alignment_trainer"
DESCRIPTION = "Training service for satellite dish alignment robot precision pointing and signal optimization"

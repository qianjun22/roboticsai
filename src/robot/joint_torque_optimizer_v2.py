"""Joint torque optimization v2 for precise force-controlled manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11036
SERVICE = "robot_joint_torque_optimizer_v2"
DESCRIPTION = "Joint torque optimization v2 for precise force-controlled manipulation"
if _has_fastapi:

"""Dynamic balance controller for whole-body stability during fast manipulation motions
...
try:
    ...
    _has_fastapi = False
PORT = 11060
SERVICE = "robot_dynamic_balance_controller"
DESCRIPTION = "Dynamic balance controller for whole-body stability during fast manipulation motions"
if _has_fastapi:

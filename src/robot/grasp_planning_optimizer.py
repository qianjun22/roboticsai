"""Grasp planning optimizer combining geometry-based and learned quality metrics for optimal approach
...
try:
    ...
    _has_fastapi = False
PORT = 11116
SERVICE = "robot_grasp_planning_optimizer"
DESCRIPTION = "Grasp planning optimizer combining geometry-based and learned quality metrics for optimal approach"
if _has_fastapi:

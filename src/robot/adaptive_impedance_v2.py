"""Adaptive impedance v2 with online stiffness estimation and task-phase-aware compliance
...
try:
    ...
    _has_fastapi = False
PORT = 11100
SERVICE = "robot_adaptive_impedance_v2"
DESCRIPTION = "Adaptive impedance v2 with online stiffness estimation and task-phase-aware compliance"
if _has_fastapi:

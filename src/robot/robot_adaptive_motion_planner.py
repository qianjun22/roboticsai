"""Robot adaptive motion planner — real-time trajectory replanning on obstacle detection and perturbations using OMPL RRT* with warm start and 22ms replanning latency
...
try:
    ...
    _has_fastapi = False
PORT = 10932
SERVICE = "robot_adaptive_motion_planner"
DESCRIPTION = "Robot adaptive motion planner — real-time trajectory replanning on obstacle detection and perturbations using OMPL RRT* with warm start and 22ms replanning latency"
if _has_fastapi:

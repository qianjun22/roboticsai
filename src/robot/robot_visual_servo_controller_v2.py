"""Visual servoing controller v2 with image-based and position-based modes for precision robot manipulation using camera feedback
...
try:
    ...
    _has_fastapi = False
PORT = 11156
SERVICE = "robot_visual_servo_controller_v2"
DESCRIPTION = "Visual servoing controller v2 with image-based and position-based modes for precision robot manipulation using camera feedback"
if _has_fastapi:

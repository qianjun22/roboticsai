"""Robot joint torque limiter — 1kHz per-joint torque monitoring with dynamic posture-aware limit adjustment and thermal derating protection
...
try:
    ...
    _has_fastapi = False
PORT = 10964
SERVICE = "robot_joint_torque_limiter"
DESCRIPTION = "Robot joint torque limiter — 1kHz per-joint torque monitoring with dynamic posture-aware limit adjustment and thermal derating protection"
if _has_fastapi:

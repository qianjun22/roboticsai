...
PORT = 12416
SERVICE = "robot_brewery_fermentation_monitor_trainer"
DESCRIPTION = "Training service for brewery fermentation monitoring robot sensor calibration and quality sampling"

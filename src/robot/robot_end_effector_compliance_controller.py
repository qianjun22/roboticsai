"""Robot end effector compliance controller — Cartesian impedance with task-specific stiffness profiles (200-2000 N/m) and passivity-guaranteed null space compliance
...
try:
    ...
    _has_fastapi = False
PORT = 10980
SERVICE = "robot_end_effector_compliance_controller"
DESCRIPTION = "Robot end effector compliance controller — Cartesian impedance with task-specific stiffness profiles (200-2000 N/m) and passivity-guaranteed null space compliance"
if _has_fastapi:

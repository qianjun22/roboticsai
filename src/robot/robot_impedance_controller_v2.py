"""Robot impedance controller v2 — variable impedance learning with task-adaptive compliance and whole-arm 7×7 impedance matrix for contact-rich manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 10940
SERVICE = "robot_impedance_controller_v2"
DESCRIPTION = "Robot impedance controller v2 — variable impedance learning with task-adaptive compliance and whole-arm 7×7 impedance matrix for contact-rich manipulation"
if _has_fastapi:

...
PORT = 12304
SERVICE = "robot_semiconductor_wafer_handler_trainer"
DESCRIPTION = "Training service for semiconductor wafer handling robot precision placement and contamination prevention"

...
PORT = 12424
SERVICE = "robot_marble_stone_cutting_trainer"
DESCRIPTION = "Training service for marble and stone cutting robot precision saw path planning and surface finishing"

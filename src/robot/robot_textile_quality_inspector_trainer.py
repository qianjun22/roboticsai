...
PORT = 12296
SERVICE = "robot_textile_quality_inspector_trainer"
DESCRIPTION = "Training service for textile quality inspection robot defect detection and grading automation"

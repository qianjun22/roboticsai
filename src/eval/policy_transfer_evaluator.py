"""Policy Transfer Evaluator — measures zero-shot and few-shot policy transfer across tasks and embodiments.
...
PORT = 10696
SERVICE = "policy_transfer_evaluator"
DESCRIPTION = "Measures zero-shot and few-shot policy transfer across tasks and embodiments"

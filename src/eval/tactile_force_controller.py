"""Tactile Force Controller — closed-loop force control using tactile sensor feedback.
...
PORT = 10684
SERVICE = "tactile_force_controller"
DESCRIPTION = "Closed-loop force control using tactile sensor feedback for delicate manipulation"

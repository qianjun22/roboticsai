"""Robot Scene Parser — semantic scene parsing with object affordance and task relevance scoring.
...
PORT = 10692
SERVICE = "robot_scene_parser"
DESCRIPTION = "Semantic scene parsing with object affordance and task relevance scoring"

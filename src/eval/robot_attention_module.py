"""Robot Attention Module — visual attention maps for robot manipulation interpretability.
...
PORT = 10648
SERVICE = "robot_attention_module"
DESCRIPTION = "Visual attention maps for robot manipulation interpretability"

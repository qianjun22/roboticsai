"""Pose Estimation V3 — 6-DoF object pose estimation with RGB-D input and sub-mm accuracy.
...
PORT = 10640
SERVICE = "pose_estimation_v3"
DESCRIPTION = "6-DoF object pose estimation with RGB-D input and sub-mm accuracy"

"""Grasp Quality Estimator — real-time grasp quality scoring via force closure analysis.
...
DESCRIPTION = "Real-time grasp quality scoring via force closure analysis"

"""Robot Perception Pipeline — end-to-end perception pipeline for robot scene understanding.
...
PORT = 10632
SERVICE = "robot_perception_pipeline"
DESCRIPTION = "End-to-end perception pipeline for robot scene understanding"

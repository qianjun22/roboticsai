"""Bimanual Coordination Evaluator — FastAPI port 8996"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Bimanual Coordination Evaluator</title>
...
<body><h1>Bimanual Coordination Evaluator</h1>
<div class="card"><h2>Coordination Scores</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="Bimanual Coordination Evaluator")

"""Real-time grasp stability analyzer using wrench space metrics, slip prediction with 18ms lead time, and regrasp planning
...
try:
    ...
    _has_fastapi = False
PORT = 10900
SERVICE = "robot_grasp_stability_analyzer"
DESCRIPTION = "Real-time grasp stability analyzer using wrench space metrics, slip prediction with 18ms lead time, and regrasp planning"
if _has_fastapi:

"""Model-based contact force estimator using motor current and joint encoders without dedicated FT sensor
...
DESCRIPTION = "Model-based contact force estimator using motor current and joint encoders without dedicated FT sensor"
if _has_fastapi:

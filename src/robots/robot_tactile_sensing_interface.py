"""Multi-modal tactile sensor interface aggregating GelSight, BioTac, and pressure array data for manipulation feedback
...
try:
    ...
    _has_fastapi = False
PORT = 10876
SERVICE = "robot_tactile_sensing_interface"
DESCRIPTION = "Multi-modal tactile sensor interface aggregating GelSight, BioTac, and pressure array data for manipulation feedback"
if _has_fastapi:

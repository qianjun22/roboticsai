"""Real-time slip detection system for robot grasping using tactile and force feedback
...
try:
    ...
    _has_fastapi = False
PORT = 10828
SERVICE = "robot_slip_detection_system"
DESCRIPTION = "Real-time slip detection system for robot grasping using tactile and force feedback"
if _has_fastapi:

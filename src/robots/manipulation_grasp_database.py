"""Manipulation grasp database storing successful grasp configurations indexed by object geometry
...
try:
    ...
    _has_fastapi = False
PORT = 10840
SERVICE = "manipulation_grasp_database"
DESCRIPTION = "Manipulation grasp database storing successful grasp configurations indexed by object geometry"
if _has_fastapi:

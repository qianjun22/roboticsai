...
PORT = 12019
SERVICE = "enterprise-resource-optimization-platform"
DESCRIPTION = "Enterprise resource optimization platform for maximizing robot fleet utilization and throughput"

...
PORT = 52531
SERVICE = "robotics-services-pipeline-forecaster"
DESCRIPTION = "Robotics GTM services pipeline forecaster service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-services-pipeline-forecaster</title><style>
...
<div class="header"><h1>robotics-services-pipeline-forecaster</h1><div class="subtitle">Robotics GTM services pipeline forecaster service · port 52531</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52531</div>

...
PORT = 50583
SERVICE = "robotics-media-coverage-tracker"
DESCRIPTION = "Robotics GTM media coverage tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-media-coverage-tracker</title><style>
...
<div class="header"><h1>robotics-media-coverage-tracker</h1><div class="subtitle">Robotics GTM media coverage tracker service · port 50583</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50583</div>

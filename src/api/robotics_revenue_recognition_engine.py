...
PORT = 12989
SERVICE = "robotics_revenue_recognition_engine"
DESCRIPTION = "Revenue recognition engine for robotics SaaS — automates ASC 606 compliance, usage-based billing, and contract modification handling"

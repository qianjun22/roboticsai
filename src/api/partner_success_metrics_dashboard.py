...
PORT = 12213
SERVICE = "partner-success-metrics-dashboard"
DESCRIPTION = "Partner success metrics dashboard tracking joint pipeline contribution, customer satisfaction scores, and ecosystem health indicators for OCI Robot Cloud partnerships"

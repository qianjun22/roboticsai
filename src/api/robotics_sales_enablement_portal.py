...
PORT = 51343
SERVICE = "robotics-sales-enablement-portal"
DESCRIPTION = "Robotics GTM sales enablement portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sales-enablement-portal</title><style>
...
<div class="header"><h1>robotics-sales-enablement-portal</h1><div class="subtitle">Robotics GTM sales enablement portal service · port 51343</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51343</div>

...
PORT = 40101
SERVICE = "robotics_knowledge_base_api"
DESCRIPTION = "GTM service: knowledge base api"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_knowledge_base_api</title><style>
...
<div class="header"><h1>robotics_knowledge_base_api</h1><div class="subtitle">GTM service: knowledge base api port 40101</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40101</div>

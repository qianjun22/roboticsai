...
PORT = 13333
SERVICE = "robotics_gtm_efficiency_v2"
DESCRIPTION = "GTM efficiency v2 for measuring cost-per-lead, sales productivity, and pipeline-to-close ratios across robotics channels"

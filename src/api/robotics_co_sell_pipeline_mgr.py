...
PORT = 50111
SERVICE = "robotics-co-sell-pipeline-mgr"
DESCRIPTION = "Robotics GTM co sell pipeline mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-co-sell-pipeline-mgr</title><style>
...
<div class="header"><h1>robotics-co-sell-pipeline-mgr</h1><div class="subtitle">Robotics GTM co sell pipeline mgr service · port 50111</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50111</div>

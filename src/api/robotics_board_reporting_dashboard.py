...
PORT = 13069
SERVICE = "robotics_board_reporting_dashboard"
DESCRIPTION = "Board reporting dashboard for robotics startup — aggregates KPIs, pipeline metrics, and milestone status for quarterly board presentations"

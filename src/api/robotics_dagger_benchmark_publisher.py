...
PORT = 50945
SERVICE = "robotics-dagger-benchmark-publisher"
DESCRIPTION = "Robotics GTM dagger benchmark publisher service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-benchmark-publisher</title><style>
...
<div class="header"><h1>robotics-dagger-benchmark-publisher</h1><div class="subtitle">Robotics GTM dagger benchmark publisher service · port 50945</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50945</div>

...
PORT = 12611
SERVICE = "sales-forecast-accuracy-analyzer"
DESCRIPTION = "Analyzes sales forecast accuracy for enterprise robotics pipeline — flags outliers and improves CRM hygiene"

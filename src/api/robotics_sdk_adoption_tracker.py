...
PORT = 12949
SERVICE = "robotics_sdk_adoption_tracker"
DESCRIPTION = "SDK adoption tracker for robotics platform — monitors developer onboarding, API call patterns, and SDK version distribution across customers"

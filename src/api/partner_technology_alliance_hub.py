...
PORT = 12433
SERVICE = "partner_technology_alliance_hub"
DESCRIPTION = "Partner technology alliance hub managing joint solution development, API integrations, and co-innovation programs"

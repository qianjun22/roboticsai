...
PORT = 12943
SERVICE = "robotics_deployment_success_metrics"
DESCRIPTION = "Deployment success metrics tracker for robotics platform — measures time-to-value, integration health, and customer onboarding completion"

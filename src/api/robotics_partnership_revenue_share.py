...
PORT = 13061
SERVICE = "robotics_partnership_revenue_share"
DESCRIPTION = "Partnership revenue share manager for robotics ecosystem — calculates referral fees, co-sell splits, and OEM royalty distributions"

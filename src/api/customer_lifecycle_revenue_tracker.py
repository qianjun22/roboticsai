...
PORT = 11823
SERVICE = "customer_lifecycle_revenue_tracker"
DESCRIPTION = "Customer lifecycle revenue tracker for cohort analysis, expansion revenue tracking, and churn revenue impact"

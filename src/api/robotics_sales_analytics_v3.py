...
PORT = 13523
SERVICE = "robotics_sales_analytics_v3"
DESCRIPTION = "Sales analytics service v3 — real-time pipeline metrics, win/loss analysis, and predictive revenue modeling for robotics sales teams"

...
PORT = 11891
SERVICE = "enterprise_innovation_pipeline_tracker"
DESCRIPTION = "Enterprise innovation pipeline tracker for R&D project portfolio management, technology readiness assessment, and innovation ROI measurement"

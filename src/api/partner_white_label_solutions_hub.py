...
PORT = 12193
SERVICE = "partner-white-label-solutions-hub"
DESCRIPTION = "White-label solutions hub enabling partners to brand and resell OCI Robot Cloud capabilities as their own managed robotics AI platform offerings"

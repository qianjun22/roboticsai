...
DESCRIPTION = "GTM platform for win back engine automation"
...
<div class="header"><h1>robotics-win-back-engine</h1><div class="sub">GTM platform for win back engine automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15125 | <b>Status:</b> <span style="color:#4ade80">Live</span>

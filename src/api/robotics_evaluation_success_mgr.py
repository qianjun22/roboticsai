...
PORT = 51699
SERVICE = "robotics-evaluation-success-mgr"
DESCRIPTION = "Robotics GTM evaluation success mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-evaluation-success-mgr</title><style>
...
<div class="header"><h1>robotics-evaluation-success-mgr</h1><div class="subtitle">Robotics GTM evaluation success mgr service · port 51699</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51699</div>

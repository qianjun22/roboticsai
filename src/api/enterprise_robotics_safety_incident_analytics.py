...
PORT = 12595
SERVICE = "enterprise-robotics-safety-incident-analytics"
DESCRIPTION = "Analytics platform for tracking, classifying, and resolving safety incidents in enterprise robot deployments"

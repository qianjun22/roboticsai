...
PORT = 12205
SERVICE = "enterprise-contract-intelligence-platform"
DESCRIPTION = "Contract intelligence platform automating robotics service agreement analysis, renewal alerts, SLA compliance monitoring, and contract optimization recommendations"

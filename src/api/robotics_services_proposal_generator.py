...
PORT = 53243
SERVICE = "robotics-services-proposal-generator"
DESCRIPTION = "Robotics GTM services proposal generator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-services-proposal-generator</title><style>
...
<div class="header"><h1>robotics-services-proposal-generator</h1><div class="subtitle">Robotics GTM services proposal generator service · port 53243</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53243</div>

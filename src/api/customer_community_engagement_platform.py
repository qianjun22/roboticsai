...
PORT = 11971
SERVICE = "customer_community_engagement_platform"
DESCRIPTION = "Customer community engagement platform for user group management, peer learning facilitation, and community-driven product feedback aggregation"

...
PORT = 50283
SERVICE = "robotics-poc-management-platform"
DESCRIPTION = "Robotics GTM poc management platform service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-poc-management-platform</title><style>
...
<div class="header"><h1>robotics-poc-management-platform</h1><div class="subtitle">Robotics GTM poc management platform service · port 50283</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50283</div>

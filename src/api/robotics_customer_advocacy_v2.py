...
PORT = 13519
SERVICE = "robotics_customer_advocacy_v2"
DESCRIPTION = "Customer advocacy program v2 — manages robotics customer success stories, reference programs, and NPS-driven expansion"

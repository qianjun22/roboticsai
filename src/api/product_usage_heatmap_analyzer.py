...
PORT = 11597
SERVICE = "product-usage-heatmap-analyzer"
DESCRIPTION = "Analyzes product feature usage heatmaps to identify high-value features, friction points, and optimization opportunities"

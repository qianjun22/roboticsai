...
PORT = 50455
SERVICE = "robotics-post-implementation-monitor"
DESCRIPTION = "Robotics GTM post implementation monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-post-implementation-monitor</title><style>
...
<div class="header"><h1>robotics-post-implementation-monitor</h1><div class="subtitle">Robotics GTM post implementation monitor service · port 50455</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50455</div>

...
PORT = 11773
SERVICE = "sales-rep-performance-coach"
DESCRIPTION = "Sales rep performance coaching platform for activity analysis, skill gap identification, and improvement planning"

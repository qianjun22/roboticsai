...
PORT = 12209
SERVICE = "enterprise-predictive-quality-control-hub"
DESCRIPTION = "Predictive quality control hub using robot sensor data and vision models to detect manufacturing defects before they reach downstream processes"

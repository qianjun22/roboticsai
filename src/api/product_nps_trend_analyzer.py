...
PORT = 11641
SERVICE = "product-nps-trend-analyzer"
DESCRIPTION = "Analyzes NPS trends over time by segment, release, and customer cohort with driver analysis and action recommendations"

...
PORT = 15289
SERVICE = "robotics-roi-calculator"
DESCRIPTION = "GTM platform for roi calculator automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-roi-calculator</title><style>
...
<div class="header"><h1>robotics-roi-calculator</h1><div class="sub">GTM platform for roi calculator automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15289 | <b>Status:</b> <span style="color:#4ade80">Live</span>

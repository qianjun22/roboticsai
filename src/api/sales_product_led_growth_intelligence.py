...
PORT = 12229
SERVICE = "sales-product-led-growth-intelligence"
DESCRIPTION = "Product-led growth intelligence platform tracking developer adoption signals, free-tier usage patterns, and conversion triggers for OCI Robot Cloud SDK users"

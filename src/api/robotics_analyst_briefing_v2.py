...
PORT = 13369
SERVICE = "robotics_analyst_briefing_v2"
DESCRIPTION = "Analyst briefing v2 for preparing OCI Robot Cloud position papers, demo scripts, and competitive differentiation for Gartner and Forrester"

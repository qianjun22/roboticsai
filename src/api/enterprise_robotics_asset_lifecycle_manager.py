...
PORT = 12493
SERVICE = "enterprise_robotics_asset_lifecycle_manager"
DESCRIPTION = "Enterprise robotics asset lifecycle manager tracking deployment age, maintenance cycles, upgrade planning, and end-of-life disposition"

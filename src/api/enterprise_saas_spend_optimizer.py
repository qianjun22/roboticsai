...
PORT = 11935
SERVICE = "enterprise_saas_spend_optimizer"
DESCRIPTION = "Enterprise SaaS spend optimizer for license utilization analysis, duplicate tool detection, and software contract renegotiation recommendations"

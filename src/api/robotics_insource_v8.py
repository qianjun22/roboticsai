...
PORT = 40855
SERVICE = "robotics-insource-v8"
DESCRIPTION = "Insourcing decision engine for robotics GTM identifying competency gaps worth building internally for strategic advantage"

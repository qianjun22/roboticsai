...
PORT = 51639
SERVICE = "robotics-plg-revenue-optimizer"
DESCRIPTION = "Robotics GTM plg revenue optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-plg-revenue-optimizer</title><style>
...
<div class="header"><h1>robotics-plg-revenue-optimizer</h1><div class="subtitle">Robotics GTM plg revenue optimizer service · port 51639</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51639</div>

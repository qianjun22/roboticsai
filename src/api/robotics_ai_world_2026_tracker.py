...
PORT = 12973
SERVICE = "robotics_ai_world_2026_tracker"
DESCRIPTION = "AI World 2026 event tracker for robotics platform — manages demo scheduling, lead capture, and conference ROI measurement"

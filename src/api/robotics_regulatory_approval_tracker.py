...
PORT = 13135
SERVICE = "robotics_regulatory_approval_tracker"
DESCRIPTION = "Regulatory approval tracker for managing FDA, CE, and safety certifications for robotics deployments"

...
PORT = 12939
SERVICE = "robotics_api_gateway_analytics"
DESCRIPTION = "API gateway analytics for robotics platform — tracks request rates, latency distributions, and endpoint usage patterns"

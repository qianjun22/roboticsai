...
PORT = 12505
SERVICE = "enterprise_robotics_total_cost_analyzer"
DESCRIPTION = "Enterprise robotics total cost analyzer modeling hardware, software, integration, training, maintenance, and downtime costs over fleet lifetime"

...
PORT = 50751
SERVICE = "robotics-deal-velocity-optimizer"
DESCRIPTION = "Robotics GTM deal velocity optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-deal-velocity-optimizer</title><style>
...
<div class="header"><h1>robotics-deal-velocity-optimizer</h1><div class="subtitle">Robotics GTM deal velocity optimizer service · port 50751</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50751</div>

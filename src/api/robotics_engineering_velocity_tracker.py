...
PORT = 13083
SERVICE = "robotics_engineering_velocity_tracker"
DESCRIPTION = "Engineering velocity tracker for robotics platform — monitors sprint throughput, cycle time, and deployment frequency for continuous improvement"

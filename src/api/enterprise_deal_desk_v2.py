"""Enterprise Deal Desk V2 — automated deal approval workflows with discount guardrails.
...
PORT = 10641
SERVICE = "enterprise_deal_desk_v2"
DESCRIPTION = "Automated deal approval workflows with discount guardrails"

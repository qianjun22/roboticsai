...
PORT = 12115
SERVICE = "enterprise-business-continuity-platform"
DESCRIPTION = "Enterprise business continuity platform for robot fleet failover and disaster recovery planning"

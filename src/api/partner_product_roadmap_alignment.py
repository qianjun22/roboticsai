...
PORT = 12039
SERVICE = "partner-product-roadmap-alignment"
DESCRIPTION = "Partner product roadmap alignment tool for coordinating feature requests and co-development priorities"

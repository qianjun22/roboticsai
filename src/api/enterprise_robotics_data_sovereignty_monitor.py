...
PORT = 12709
SERVICE = "enterprise-robotics-data-sovereignty-monitor"
DESCRIPTION = "Monitors data sovereignty compliance for enterprise robotics — ensures robot telemetry stays within required geographic boundaries"

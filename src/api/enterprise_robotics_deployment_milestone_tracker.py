...
PORT = 12629
SERVICE = "enterprise-robotics-deployment-milestone-tracker"
DESCRIPTION = "Tracks deployment milestones for enterprise robotics rollouts — from POC to full production at scale"

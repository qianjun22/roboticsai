...
PORT = 13021
SERVICE = "robotics_presales_automation"
DESCRIPTION = "Presales automation for robotics platform — generates technical proposals, ROI models, and integration assessments from CRM opportunity data"

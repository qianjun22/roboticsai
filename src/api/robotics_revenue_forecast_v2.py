...
PORT = 13533
SERVICE = "robotics_revenue_forecast_v2"
DESCRIPTION = "Revenue forecasting service v2 — ML-driven quarterly and annual revenue projections for robotics cloud platform with scenario modeling"

...
PORT = 51027
SERVICE = "robotics-architecture-review-board"
DESCRIPTION = "Robotics GTM architecture review board service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-architecture-review-board</title><style>
...
<div class="header"><h1>robotics-architecture-review-board</h1><div class="subtitle">Robotics GTM architecture review board service · port 51027</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51027</div>

...
PORT = 11957
SERVICE = "sales_territory_expansion_modeler"
DESCRIPTION = "Sales territory expansion modeler for greenfield market analysis, coverage gap identification, and new territory ROI forecasting"

...
PORT = 50665
SERVICE = "robotics-dagger-plg-optimizer"
DESCRIPTION = "Robotics GTM dagger plg optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-plg-optimizer</title><style>
...
<div class="header"><h1>robotics-dagger-plg-optimizer</h1><div class="subtitle">Robotics GTM dagger plg optimizer service · port 50665</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50665</div>

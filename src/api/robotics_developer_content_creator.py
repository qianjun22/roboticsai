...
PORT = 50911
SERVICE = "robotics-developer-content-creator"
DESCRIPTION = "Robotics GTM developer content creator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-content-creator</title><style>
...
<div class="header"><h1>robotics-developer-content-creator</h1><div class="subtitle">Robotics GTM developer content creator service · port 50911</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50911</div>

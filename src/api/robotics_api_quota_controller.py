...
PORT = 38457
SERVICE = "robotics_api_quota_controller"
DESCRIPTION = "API quota controller for robotics developer rate limiting"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_api_quota_controller</title><style>
...
<div class="header"><h1>robotics_api_quota_controller</h1><div class="subtitle">API quota controller for robotics developer rate limiting · port 38457</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38457</div>

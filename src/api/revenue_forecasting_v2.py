"""Revenue forecasting v2 — ML ensemble bottom-up/top-down with ±8% accuracy at 60 days, 3-scenario board format and deal-level delta tracking
...
try:
    ...
    _has_fastapi = False
PORT = 10981
SERVICE = "revenue_forecasting_v2"
DESCRIPTION = "Revenue forecasting v2 — ML ensemble bottom-up/top-down with ±8% accuracy at 60 days, 3-scenario board format and deal-level delta tracking"
if _has_fastapi:

...
PORT = 13019
SERVICE = "robotics_sales_territory_manager"
DESCRIPTION = "Sales territory manager for robotics platform — optimizes rep coverage by geography, industry vertical, and account potential"

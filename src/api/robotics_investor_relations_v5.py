...
PORT = 30505
SERVICE = "robotics_investor_relations_v5"
DESCRIPTION = "Investor relations GTM API microservice for robotics funding, valuation, and shareholder communications"

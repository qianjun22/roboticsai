...
PORT = 50201
SERVICE = "robotics-dagger-alliance-mgr"
DESCRIPTION = "Robotics GTM dagger alliance mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-alliance-mgr</title><style>
...
<div class="header"><h1>robotics-dagger-alliance-mgr</h1><div class="subtitle">Robotics GTM dagger alliance mgr service · port 50201</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50201</div>

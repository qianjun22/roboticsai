...
PORT = 13247
SERVICE = "robotics_sales_enablement_v3"
DESCRIPTION = "Sales enablement v3 with AI-assisted content recommendations and buyer journey personalization for robotics"

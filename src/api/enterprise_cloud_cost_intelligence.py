...
PORT = 11825
SERVICE = "enterprise_cloud_cost_intelligence"
DESCRIPTION = "Enterprise cloud cost intelligence platform for multi-cloud spend optimization, anomaly detection, and rightsizing recommendations"

...
PORT = 12841
SERVICE = "robotics_platform_adoption_funnel"
DESCRIPTION = "Tracks robotics platform adoption funnel — awareness to activation to expansion metrics, cohort analysis, and conversion optimization"

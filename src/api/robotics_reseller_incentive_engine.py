...
PORT = 50791
SERVICE = "robotics-reseller-incentive-engine"
DESCRIPTION = "Robotics GTM reseller incentive engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reseller-incentive-engine</title><style>
...
<div class="header"><h1>robotics-reseller-incentive-engine</h1><div class="subtitle">Robotics GTM reseller incentive engine service · port 50791</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50791</div>

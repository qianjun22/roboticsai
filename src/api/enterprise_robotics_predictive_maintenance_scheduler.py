...
PORT = 12553
SERVICE = "enterprise_robotics_predictive_maintenance_scheduler"
DESCRIPTION = "Enterprise robotics predictive maintenance scheduler using sensor telemetry, wear models, and production calendars to minimize unplanned downtime"

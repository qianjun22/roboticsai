...
PORT = 12073
SERVICE = "enterprise-automation-center-of-excellence"
DESCRIPTION = "Enterprise automation center of excellence for standardizing robotics deployment best practices"

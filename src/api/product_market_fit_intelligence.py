...
PORT = 11769
SERVICE = "product-market-fit-intelligence"
DESCRIPTION = "Product-market fit intelligence platform for ICP scoring, usage signal analysis, and segment saturation mapping"

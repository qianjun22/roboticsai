...
PORT = 13867
SERVICE = "robotics_strategic_planning_v4"
DESCRIPTION = "Robotics strategic planning platform v4 — long-range business planning, OKR tracking, and strategic initiative management"

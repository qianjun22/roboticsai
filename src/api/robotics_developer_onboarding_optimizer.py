...
PORT = 50903
SERVICE = "robotics-developer-onboarding-optimizer"
DESCRIPTION = "Robotics GTM developer onboarding optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-onboarding-optimizer</title><style>
...
<div class="header"><h1>robotics-developer-onboarding-optimizer</h1><div class="subtitle">Robotics GTM developer onboarding optimizer service · port 50903</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50903</div>

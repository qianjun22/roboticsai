...
PORT = 13617
SERVICE = "robotics_enterprise_motion_v2"
DESCRIPTION = "Robotics enterprise motion management platform v2 — coordinates multi-robot fleets across warehouse and factory floors, optimizing path planning, task assignment, and collision avoidance for large-scale enterprise deployments"

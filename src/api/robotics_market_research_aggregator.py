...
PORT = 13045
SERVICE = "robotics_market_research_aggregator"
DESCRIPTION = "Market research aggregator for robotics industry — consolidates analyst reports, survey data, and signals into competitive intelligence summaries"

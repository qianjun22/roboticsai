...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-rfp-response-generator</title><style>
...
<div class="header"><h1>robotics-rfp-response-generator</h1><div class="subtitle">Robotics GTM rfp response generator service · port 50287</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50287</div>

...
PORT = 13579
SERVICE = "robotics_revenue_operations_v3"
DESCRIPTION = "Robotics revenue operations platform v3 — end-to-end RevOps orchestration integrating marketing, sales, and customer success data for unified pipeline visibility and revenue growth optimization"

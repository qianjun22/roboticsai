...
PORT = 11775
SERVICE = "product-pricing-intelligence-hub"
DESCRIPTION = "Product pricing intelligence hub for competitive benchmarking, elasticity modeling, and discount impact analysis"

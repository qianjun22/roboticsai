...
PORT = 13181
SERVICE = "robotics_investor_update_v3"
DESCRIPTION = "Investor update v3 for communicating OCI Robot Cloud progress, metrics, and strategic milestones to stakeholders"

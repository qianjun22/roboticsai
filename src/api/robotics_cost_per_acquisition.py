...
PORT = 13121
SERVICE = "robotics_cost_per_acquisition"
DESCRIPTION = "Cost per acquisition tracker for measuring and optimizing robotics customer acquisition efficiency across channels"

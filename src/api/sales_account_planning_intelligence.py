...
PORT = 11899
SERVICE = "sales_account_planning_intelligence"
DESCRIPTION = "Sales account planning intelligence platform for whitespace analysis, strategic account mapping, and executive relationship tracking"

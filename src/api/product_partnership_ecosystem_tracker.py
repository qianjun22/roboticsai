...
PORT = 11753
SERVICE = "product-partnership-ecosystem-tracker"
DESCRIPTION = "Product partnership ecosystem tracker for integration health, marketplace listing performance, and ISV revenue"

...
PORT = 12821
SERVICE = "robotics_cloud_migration_calculator"
DESCRIPTION = "Calculates cloud migration costs and ROI for robotics workloads — on-prem to OCI comparison, payback period, and risk assessment"

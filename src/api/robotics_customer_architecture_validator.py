...
PORT = 51035
SERVICE = "robotics-customer-architecture-validator"
DESCRIPTION = "Robotics GTM customer architecture validator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-architecture-validator</title><style>
...
<div class="header"><h1>robotics-customer-architecture-validator</h1><div class="subtitle">Robotics GTM customer architecture validator service · port 51035</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51035</div>

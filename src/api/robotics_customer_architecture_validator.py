...
<div class="header"><h1>robotics-customer-architecture-validator</h1><div class="subtitle">Robotics GTM customer architecture validator service · port 53819</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53819</div>

...
PORT = 13857
SERVICE = "robotics_competitive_intel_v5"
DESCRIPTION = "Robotics competitive intelligence platform v5 — real-time competitor tracking, battlecard generation, and win-rate analysis"

...
PORT = 11593
SERVICE = "enterprise-deal-scoring-model"
DESCRIPTION = "ML-powered enterprise deal scoring using firmographics, engagement signals, and historical win/loss patterns"

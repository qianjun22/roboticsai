...
PORT = 12731
SERVICE = "sales-plg-signal-analyzer"
DESCRIPTION = "Analyzes product-led growth signals for enterprise robotics — API usage spikes, seat expansion, and self-serve upgrade triggers"

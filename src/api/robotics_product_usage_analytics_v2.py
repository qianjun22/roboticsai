...
PORT = 13305
SERVICE = "robotics_product_usage_analytics_v2"
DESCRIPTION = "Product usage analytics v2 for tracking inference call volume, fine-tune job frequency, and SDK method adoption across robotics accounts"

...
PORT = 46835
SERVICE = "robotics_seed_fund"
DESCRIPTION = "Seed fund robotics GTM pipeline tracker and investor relations"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_seed_fund</title><style>
...
<div class="header"><h1>robotics_seed_fund</h1><div class="subtitle">Seed fund robotics GTM pipeline tracker and investor relations · port 46835</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46835</div>

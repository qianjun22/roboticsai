...
PORT = 15291
SERVICE = "robotics-community-growth"
DESCRIPTION = "GTM platform for community growth optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-community-growth</title><style>
...
<div class="header"><h1>robotics-community-growth</h1><div class="sub">GTM platform for community growth optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15291 | <b>Status:</b> <span style="color:#4ade80">Live</span>

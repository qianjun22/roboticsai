...
PORT = 15387
SERVICE = "robotics-issue-escalator"
DESCRIPTION = "GTM platform for issue escalator optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-issue-escalator</title><style>
...
<div class="header"><h1>robotics-issue-escalator</h1><div class="sub">GTM platform for issue escalator optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15387 | <b>Status:</b> <span style="color:#4ade80">Live</span>

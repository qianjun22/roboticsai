...
PORT = 15707
SERVICE = "robotics_procurement_automation_v5"
DESCRIPTION = "Procurement automation v5: vendor evaluation, PO generation, and approval workflows for robot hardware"

...
PORT = 50699
SERVICE = "robotics-localization-mgr"
DESCRIPTION = "Robotics GTM localization mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-localization-mgr</title><style>
...
<div class="header"><h1>robotics-localization-mgr</h1><div class="subtitle">Robotics GTM localization mgr service · port 50699</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50699</div>

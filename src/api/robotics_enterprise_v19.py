...
PORT = 46845
SERVICE = "robotics_enterprise_v19"
DESCRIPTION = "Enterprise robotics sales and deployment manager"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_enterprise_v19</title><style>
...
<div class="header"><h1>robotics_enterprise_v19</h1><div class="subtitle">Enterprise robotics sales and deployment manager · port 46845</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46845</div>

...
PORT = 13709
SERVICE = "robotics_sales_pipeline_v5"
DESCRIPTION = "Robotics sales pipeline API v5 — opportunity stage management, deal velocity tracking, and pipeline coverage analytics"

...
PORT = 51051
SERVICE = "robotics-security-architecture-reviewer"
DESCRIPTION = "Robotics GTM security architecture reviewer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-security-architecture-reviewer</title><style>
...
<div class="header"><h1>robotics-security-architecture-reviewer</h1><div class="subtitle">Robotics GTM security architecture reviewer service · port 51051</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51051</div>

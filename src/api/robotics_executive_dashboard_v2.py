...
PORT = 13167
SERVICE = "robotics_executive_dashboard_v2"
DESCRIPTION = "Executive dashboard v2 for real-time OCI Robot Cloud business metrics, pipeline health, and strategic KPIs"

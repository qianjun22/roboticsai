...
PORT = 12667
SERVICE = "sales-opportunity-scoring-v2"
DESCRIPTION = "v2 ML scoring model for enterprise robotics sales opportunities — multi-factor propensity with churn risk overlay"

...
PORT = 12931
SERVICE = "robotics_simulation_fidelity_benchmark"
DESCRIPTION = "Benchmarks simulation fidelity vs real-world for robotics — visual realism scores, physics accuracy metrics, and sim-to-real transfer gap quantification"

...
PORT = 13187
SERVICE = "robotics_competitive_positioning_v3"
DESCRIPTION = "Competitive positioning v3 for maintaining differentiated messaging as NVIDIA ecosystem and cloud robotics landscape evolves"

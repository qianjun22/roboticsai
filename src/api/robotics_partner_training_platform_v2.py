...
PORT = 13477
SERVICE = "robotics_partner_training_platform_v2"
DESCRIPTION = "Partner training platform v2 for robotics channel partner certification and skill development"

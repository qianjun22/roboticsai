...
PORT = 12937
SERVICE = "robotics_self_service_analytics_portal"
DESCRIPTION = "Self-service analytics portal for robotics customers — policy performance dashboards, data export tools, custom report builder, and benchmark comparisons"

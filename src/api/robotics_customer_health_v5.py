...
PORT = 13851
SERVICE = "robotics_customer_health_v5"
DESCRIPTION = "Robotics customer health platform v5 — customer success scoring, churn prediction, and expansion opportunity detection"

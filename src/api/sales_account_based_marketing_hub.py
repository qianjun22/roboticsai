...
PORT = 11779
SERVICE = "sales-account-based-marketing-hub"
DESCRIPTION = "Sales ABM hub for target account identification, intent signal monitoring, and multi-touch campaign orchestration"

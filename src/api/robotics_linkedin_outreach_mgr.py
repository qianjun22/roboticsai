...
PORT = 51287
SERVICE = "robotics-linkedin-outreach-mgr"
DESCRIPTION = "Robotics GTM linkedin outreach mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-linkedin-outreach-mgr</title><style>
...
<div class="header"><h1>robotics-linkedin-outreach-mgr</h1><div class="subtitle">Robotics GTM linkedin outreach mgr service · port 51287</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51287</div>

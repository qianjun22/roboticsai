...
PORT = 53963
SERVICE = "robotics-go-live-readiness-checker"
DESCRIPTION = "Robotics GTM go live readiness checker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-go-live-readiness-checker</title><style>
...
<div class="header"><h1>robotics-go-live-readiness-checker</h1><div class="subtitle">Robotics GTM go live readiness checker service · port 53963</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53963</div>

...
PORT = 12907
SERVICE = "robotics_customer_reference_program_manager"
DESCRIPTION = "Manages customer reference program for robotics — reference request matching, reference fatigue tracking, case study pipeline, and testimonial library"

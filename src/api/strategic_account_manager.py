"""Strategic Account Manager — executive relationship management and expansion planning for key accounts.
...
PORT = 10653
SERVICE = "strategic_account_manager"
DESCRIPTION = "Executive relationship management and expansion planning for key accounts"

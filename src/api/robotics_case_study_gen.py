...
PORT = 15083
SERVICE = "robotics-case-study-gen"
DESCRIPTION = "GTM platform for case study gen optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-case-study-gen</title><style>
...
<div class="header"><h1>robotics-case-study-gen</h1><div class="sub">GTM platform for case study gen optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15083 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13161
SERVICE = "robotics_quarterly_business_review"
DESCRIPTION = "Quarterly business review dashboard for tracking OCI Robot Cloud KPIs and strategic milestone progress"

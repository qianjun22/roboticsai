...
PORT = 11789
SERVICE = "product-roadmap-alignment-tracker"
DESCRIPTION = "Product roadmap alignment tracker for customer request correlation, feature priority scoring, and release planning"

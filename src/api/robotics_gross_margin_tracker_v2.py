...
PORT = 13067
SERVICE = "robotics_gross_margin_tracker_v2"
DESCRIPTION = "Gross margin tracker v2 for robotics platform — monitors COGS by product line, tracks infrastructure cost per unit, and projects 80%+ GM target"

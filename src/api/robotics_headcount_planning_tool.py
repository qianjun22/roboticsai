...
PORT = 13055
SERVICE = "robotics_headcount_planning_tool"
DESCRIPTION = "Headcount planning tool for robotics startup — models engineering, sales, and operations hiring against revenue milestones and runway"

...
PORT = 13245
SERVICE = "robotics_revenue_quality_tracker"
DESCRIPTION = "Revenue quality tracker for measuring contract mix, discount depth, and renewal health across robotics pipeline"

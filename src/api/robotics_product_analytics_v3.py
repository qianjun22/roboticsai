...
PORT = 13119
SERVICE = "robotics_product_analytics_v3"
DESCRIPTION = "Product analytics v3 for tracking feature adoption, usage patterns, and engagement depth in robotics platform"

...
PORT = 40495
SERVICE = "robotics_usage_dashboard"
DESCRIPTION = "GTM service: usage dashboard"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_usage_dashboard</title><style>
...
<div class="header"><h1>robotics_usage_dashboard</h1><div class="subtitle">GTM service: usage dashboard port 40495</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40495</div>

...
PORT = 50981
SERVICE = "robotics-dagger-forecast-engine"
DESCRIPTION = "Robotics GTM dagger forecast engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-forecast-engine</title><style>
...
<div class="header"><h1>robotics-dagger-forecast-engine</h1><div class="subtitle">Robotics GTM dagger forecast engine service · port 50981</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50981</div>

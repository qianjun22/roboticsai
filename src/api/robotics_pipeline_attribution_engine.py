...
PORT = 51951
SERVICE = "robotics-pipeline-attribution-engine"
DESCRIPTION = "Robotics GTM pipeline attribution engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pipeline-attribution-engine</title><style>
...
<div class="header"><h1>robotics-pipeline-attribution-engine</h1><div class="subtitle">Robotics GTM pipeline attribution engine service · port 51951</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51951</div>

...
PORT = 12605
SERVICE = "enterprise-account-expansion-playbook"
DESCRIPTION = "Automated playbook engine for enterprise account expansion in robotics — triggers upsell and cross-sell workflows"

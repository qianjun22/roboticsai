...
PORT = 13715
SERVICE = "robotics_product_launch_v4"
DESCRIPTION = "Robotics product launch API v4 — launch readiness tracking, GTM execution, launch metrics, and cross-functional coordination"

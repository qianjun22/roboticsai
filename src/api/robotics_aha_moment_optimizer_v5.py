...
PORT = 16805
SERVICE = "robotics_aha_moment_optimizer_v5"
DESCRIPTION = "Robotics GTM aha moment optimizer v5 personalizing value discovery paths based on customer industry verticals"

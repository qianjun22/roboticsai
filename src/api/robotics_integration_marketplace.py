...
PORT = 12993
SERVICE = "robotics_integration_marketplace"
DESCRIPTION = "Integration marketplace for robotics platform — hosts certified connectors for ERP, MES, WMS, and sensor systems with one-click deployment"

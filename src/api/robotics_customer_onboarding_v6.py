...
PORT = 13873
SERVICE = "robotics_customer_onboarding_v6"
DESCRIPTION = "Robotics customer onboarding platform v6 — automated onboarding workflows, time-to-value acceleration, and adoption tracking"

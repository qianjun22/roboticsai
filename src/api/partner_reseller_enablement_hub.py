...
PORT = 12535
SERVICE = "partner_reseller_enablement_hub"
DESCRIPTION = "Partner reseller enablement hub with product training content, pricing tools, demo environments, and sales support resources"

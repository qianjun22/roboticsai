...
PORT = 11653
SERVICE = "enterprise-adoption-accelerator"
DESCRIPTION = "Accelerates enterprise product adoption through guided onboarding, executive sponsorship programs, and internal champion development"

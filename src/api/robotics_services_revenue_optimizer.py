...
PORT = 50427
SERVICE = "robotics-services-revenue-optimizer"
DESCRIPTION = "Robotics GTM services revenue optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-services-revenue-optimizer</title><style>
...
<div class="header"><h1>robotics-services-revenue-optimizer</h1><div class="subtitle">Robotics GTM services revenue optimizer service · port 50427</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50427</div>

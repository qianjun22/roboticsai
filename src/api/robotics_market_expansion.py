...
PORT = 15217
SERVICE = "robotics-market-expansion"
DESCRIPTION = "GTM platform for market expansion automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-market-expansion</title><style>
...
<div class="header"><h1>robotics-market-expansion</h1><div class="sub">GTM platform for market expansion automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15217 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12581
SERVICE = "sales_pricing_elasticity_analyzer"
DESCRIPTION = "Sales pricing elasticity analyzer modeling demand sensitivity to price changes for robotics hardware, software, and service bundles"

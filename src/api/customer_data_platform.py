"""Customer data platform — unified 360-degree customer profile aggregating CRM, usage, support, and marketing data with ML-powered segmentation and activation
...
DESCRIPTION = "Customer data platform — unified 360-degree customer profile aggregating CRM, usage, support, and marketing data with ML-powered segmentation and activation"
if _has_fastapi:

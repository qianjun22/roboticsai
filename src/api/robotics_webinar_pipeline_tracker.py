...
PORT = 50523
SERVICE = "robotics-webinar-pipeline-tracker"
DESCRIPTION = "Robotics GTM webinar pipeline tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-webinar-pipeline-tracker</title><style>
...
<div class="header"><h1>robotics-webinar-pipeline-tracker</h1><div class="subtitle">Robotics GTM webinar pipeline tracker service · port 50523</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50523</div>

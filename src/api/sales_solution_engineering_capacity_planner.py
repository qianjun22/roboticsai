...
PORT = 12517
SERVICE = "sales_solution_engineering_capacity_planner"
DESCRIPTION = "Sales solution engineering capacity planner balancing SE workload, proof-of-concept scheduling, and technical win investment"

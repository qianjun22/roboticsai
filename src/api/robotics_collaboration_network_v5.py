...
PORT = 16827
SERVICE = "robotics_collaboration_network_v5"
DESCRIPTION = "Robotics GTM collaboration network v5 with partner certification programs and joint innovation labs"

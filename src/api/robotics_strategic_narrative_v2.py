...
PORT = 13257
SERVICE = "robotics_strategic_narrative_v2"
DESCRIPTION = "Strategic narrative v2 for articulating OCI Robot Cloud vision to executives, investors, and NVIDIA partners"

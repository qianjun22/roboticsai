...
PORT = 13027
SERVICE = "robotics_deal_acceleration_engine"
DESCRIPTION = "Deal acceleration engine for robotics sales — identifies stalled opportunities, recommends next actions, and triggers executive engagement"

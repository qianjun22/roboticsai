...
PORT = 30609
SERVICE = "robotics_payment_ops_v5"
DESCRIPTION = "Payment operations GTM microservice for robotics subscription processing and financial transaction management"

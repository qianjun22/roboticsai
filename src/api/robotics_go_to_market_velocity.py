...
PORT = 12951
SERVICE = "robotics_go_to_market_velocity"
DESCRIPTION = "GTM velocity tracker for robotics sales — measures sales cycle duration, win rates by segment, and time-to-close across the funnel"

...
PORT = 11845
SERVICE = "product_adoption_analytics_platform"
DESCRIPTION = "Product adoption analytics platform for feature usage tracking, onboarding funnel optimization, and activation rate improvement"

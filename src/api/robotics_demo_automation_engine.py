...
PORT = 51015
SERVICE = "robotics-demo-automation-engine"
DESCRIPTION = "Robotics GTM demo automation engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-demo-automation-engine</title><style>
...
<div class="header"><h1>robotics-demo-automation-engine</h1><div class="subtitle">Robotics GTM demo automation engine service · port 51015</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51015</div>

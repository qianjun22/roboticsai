...
DESCRIPTION = "GTM platform for mql scorer automation"
...
<div class="header"><h1>robotics-mql-scorer</h1><div class="sub">GTM platform for mql scorer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15369 | <b>Status:</b> <span style="color:#4ade80">Live</span>

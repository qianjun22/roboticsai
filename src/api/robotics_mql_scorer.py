...
PORT = 15127
SERVICE = "robotics-mql-scorer"
DESCRIPTION = "GTM platform for mql scorer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-mql-scorer</title><style>
...
<div class="header"><h1>robotics-mql-scorer</h1><div class="sub">GTM platform for mql scorer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15127 | <b>Status:</b> <span style="color:#4ade80">Live</span>

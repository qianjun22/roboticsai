...
PORT = 11629
SERVICE = "gtm-velocity-dashboard"
DESCRIPTION = "Real-time GTM velocity dashboard tracking deal velocity, pipeline coverage, and quota attainment across all segments"

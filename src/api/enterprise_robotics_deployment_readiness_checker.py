...
PORT = 12563
SERVICE = "enterprise_robotics_deployment_readiness_checker"
DESCRIPTION = "Enterprise robotics deployment readiness checker validating site preparation, network infrastructure, safety zones, and operator certification"

...
PORT = 12783
SERVICE = "robotics_channel_partner_scorecard"
DESCRIPTION = "Scorecard system for robotics channel partners — pipeline generation, deal registration, technical capability, and customer satisfaction metrics"

...
PORT = 13175
SERVICE = "robotics_success_metrics_v3"
DESCRIPTION = "Success metrics v3 dashboard for tracking OCI Robot Cloud adoption velocity, NPS, and customer value realization"

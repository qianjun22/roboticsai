...
PORT = 14963
SERVICE = "robotics-partner-enablement"
DESCRIPTION = "GTM platform for partner enablement optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-enablement</title><style>
...
<div class="header"><h1>robotics-partner-enablement</h1><div class="sub">GTM platform for partner enablement optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14963 |&nbsp; <b>Status:</b> <span style="color:#4ade80">Live</span>

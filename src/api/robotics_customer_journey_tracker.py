...
PORT = 52475
SERVICE = "robotics-customer-journey-tracker"
DESCRIPTION = "Robotics GTM customer journey tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-journey-tracker</title><style>
...
<div class="header"><h1>robotics-customer-journey-tracker</h1><div class="subtitle">Robotics GTM customer journey tracker service · port 52475</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52475</div>

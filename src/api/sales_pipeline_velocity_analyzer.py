...
PORT = 12395
SERVICE = "sales_pipeline_velocity_analyzer"
DESCRIPTION = "Pipeline velocity analyzer for robotics platform deal cycle time optimization and stage conversion"

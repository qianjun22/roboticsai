...
PORT = 12743
SERVICE = "sales-analyst-coverage-improvement-tracker"
DESCRIPTION = "Tracks improvements in analyst coverage for enterprise robotics — Gartner, Forrester, and IDC mention velocity"

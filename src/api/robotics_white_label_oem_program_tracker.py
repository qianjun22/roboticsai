...
PORT = 12887
SERVICE = "robotics_white_label_oem_program_tracker"
DESCRIPTION = "Tracks white-label and OEM program partnerships for robotics — branding requirements, integration milestones, volume commitments, and co-sell agreements"

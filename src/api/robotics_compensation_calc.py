...
DESCRIPTION = "GTM platform for compensation calc automation"
...
<div class="header"><h1>robotics-compensation-calc</h1><div class="sub">GTM platform for compensation calc automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15261 | <b>Status:</b> <span style="color:#4ade80">Live</span>

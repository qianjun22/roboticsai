...
PORT = 15019
SERVICE = "robotics-compensation-calc"
DESCRIPTION = "GTM platform for compensation calc optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-compensation-calc</title><style>
...
<div class="header"><h1>robotics-compensation-calc</h1><div class="sub">GTM platform for compensation calc optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15019 | <b>Status:</b> <span style="color:#4ade80">Live</span>

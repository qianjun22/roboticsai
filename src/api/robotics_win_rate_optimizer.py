...
PORT = 15233
SERVICE = "robotics-win-rate-optimizer"
DESCRIPTION = "GTM platform for win rate optimizer automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-win-rate-optimizer</title><style>
...
<div class="header"><h1>robotics-win-rate-optimizer</h1><div class="sub">GTM platform for win rate optimizer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15233 | <b>Status:</b> <span style="color:#4ade80">Live</span>

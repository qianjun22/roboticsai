...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_support_ticket_router</title><style>
...
<div class="header"><h1>robotics_support_ticket_router</h1><div class="subtitle">GTM service: support ticket router port 39019</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39019</div>

...
PORT = 52519
SERVICE = "robotics-consultant-utilization-monitor"
DESCRIPTION = "Robotics GTM consultant utilization monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-consultant-utilization-monitor</title><style>
...
<div class="header"><h1>robotics-consultant-utilization-monitor</h1><div class="subtitle">Robotics GTM consultant utilization monitor service · port 52519</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52519</div>

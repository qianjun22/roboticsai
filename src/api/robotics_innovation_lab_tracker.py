...
PORT = 13043
SERVICE = "robotics_innovation_lab_tracker"
DESCRIPTION = "Innovation lab tracker for robotics R&D — manages research projects, prototype status, and technology readiness level progression"

...
PORT = 11843
SERVICE = "customer_advocacy_program_manager"
DESCRIPTION = "Customer advocacy program manager for reference program coordination, case study pipeline, and NPS-to-advocacy conversion"

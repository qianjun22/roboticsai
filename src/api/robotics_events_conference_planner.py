...
PORT = 12769
SERVICE = "robotics_events_conference_planner"
DESCRIPTION = "Plans robotics industry events and conference presence — booth logistics, speaking slots, demo scheduling, and lead capture setup"

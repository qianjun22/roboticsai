...
PORT = 50967
SERVICE = "robotics-in-product-upsell-engine"
DESCRIPTION = "Robotics GTM in product upsell engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-in-product-upsell-engine</title><style>
...
<div class="header"><h1>robotics-in-product-upsell-engine</h1><div class="subtitle">Robotics GTM in product upsell engine service · port 50967</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50967</div>

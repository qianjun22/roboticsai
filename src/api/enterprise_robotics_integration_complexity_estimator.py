...
PORT = 12643
SERVICE = "enterprise-robotics-integration-complexity"
DESCRIPTION = "Estimates integration complexity for enterprise robotics deployments — APIs, PLCs, MES, and ERP system dependencies"

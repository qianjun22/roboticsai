...
PORT = 39667
SERVICE = "robotics_customer_health_score"
DESCRIPTION = "GTM service: customer health score"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_customer_health_score</title><style>
...
<div class="header"><h1>robotics_customer_health_score</h1><div class="subtitle">GTM service: customer health score port 39667</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39667</div>

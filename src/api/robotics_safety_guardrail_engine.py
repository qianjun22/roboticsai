...
PORT = 38463
SERVICE = "robotics_safety_guardrail_engine"
DESCRIPTION = "Safety guardrail engine for preventing harmful robot actions"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_safety_guardrail_engine</title><style>
...
<div class="header"><h1>robotics_safety_guardrail_engine</h1><div class="subtitle">Safety guardrail engine for preventing harmful robot actions · port 38463</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38463</div>

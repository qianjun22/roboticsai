...
PORT = 50855
SERVICE = "robotics-proof-of-concept-tracker"
DESCRIPTION = "Robotics GTM proof of concept tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-proof-of-concept-tracker</title><style>
...
<div class="header"><h1>robotics-proof-of-concept-tracker</h1><div class="subtitle">Robotics GTM proof of concept tracker service · port 50855</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50855</div>

...
PORT = 15059
SERVICE = "robotics-discount-approver"
DESCRIPTION = "GTM platform for discount approver optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-discount-approver</title><style>
...
<div class="header"><h1>robotics-discount-approver</h1><div class="sub">GTM platform for discount approver optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15059 | <b>Status:</b> <span style="color:#4ade80">Live</span>

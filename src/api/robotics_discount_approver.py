...
DESCRIPTION = "GTM platform for discount approver automation"
...
<div class="header"><h1>robotics-discount-approver</h1><div class="sub">GTM platform for discount approver automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15301 | <b>Status:</b> <span style="color:#4ade80">Live</span>

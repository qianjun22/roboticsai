...
PORT = 11617
SERVICE = "pricing-sensitivity-analyzer"
DESCRIPTION = "Analyzes customer pricing sensitivity using Van Westendorp, conjoint analysis, and competitive price positioning"

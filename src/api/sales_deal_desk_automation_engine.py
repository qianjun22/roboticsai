...
PORT = 12575
SERVICE = "sales_deal_desk_automation_engine"
DESCRIPTION = "Sales deal desk automation engine streamlining custom pricing approvals, non-standard terms reviews, and executive sign-off workflows"

...
PORT = 12167
SERVICE = "enterprise-innovation-lab-manager"
DESCRIPTION = "Innovation lab management platform enabling enterprises to run controlled robotics experiments, track hypothesis outcomes, and scale proven use cases"

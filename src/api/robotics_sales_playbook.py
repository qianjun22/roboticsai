...
PORT = 15333
SERVICE = "robotics-sales-playbook"
DESCRIPTION = "GTM platform for sales playbook automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sales-playbook</title><style>
...
<div class="header"><h1>robotics-sales-playbook</h1><div class="sub">GTM platform for sales playbook automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15333 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
<div class="header"><h1>robotics-configuration-management-engine</h1><div class="subtitle">Robotics GTM configuration management engine service · port 52563</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52563</div>

...
PORT = 51171
SERVICE = "robotics-configuration-management-engine"
DESCRIPTION = "Robotics GTM configuration management engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-configuration-management-engine</title><style>
...
<div class="header"><h1>robotics-configuration-management-engine</h1><div class="subtitle">Robotics GTM configuration management engine service · port 51171</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51171</div>

...
PORT = 12723
SERVICE = "enterprise-robotics-security-audit-toolkit"
DESCRIPTION = "Security audit toolkit for enterprise robotics deployments — network isolation, credential rotation, and vulnerability scanning"

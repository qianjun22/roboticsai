...
PORT = 15251
SERVICE = "robotics-budget-allocator"
DESCRIPTION = "GTM platform for budget allocator optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-budget-allocator</title><style>
...
<div class="header"><h1>robotics-budget-allocator</h1><div class="sub">GTM platform for budget allocator optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15251 | <b>Status:</b> <span style="color:#4ade80">Live</span>

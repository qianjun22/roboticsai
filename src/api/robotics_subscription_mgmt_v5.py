...
PORT = 30611
SERVICE = "robotics_subscription_mgmt_v5"
DESCRIPTION = "Subscription management GTM microservice for robotics license entitlement and recurring revenue tracking"

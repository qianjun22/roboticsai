...
PORT = 11585
SERVICE = "customer-journey-analytics-v2"
DESCRIPTION = "Enhanced customer journey analytics tracking touchpoints from awareness through expansion with attribution modeling"

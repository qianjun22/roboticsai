...
PORT = 12199
SERVICE = "partner-developer-community-hub"
DESCRIPTION = "Developer community hub fostering engagement among robotics developers building on OCI Robot Cloud — forums, hackathons, open-source contributions, and recognition programs"

...
PORT = 13853
SERVICE = "robotics_sales_excellence_v6"
DESCRIPTION = "Robotics sales excellence platform v6 — sales methodology, coaching, and performance optimization for robotics teams"

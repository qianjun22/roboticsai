...
PORT = 53943
SERVICE = "robotics-consultant-skills-matcher"
DESCRIPTION = "Robotics GTM consultant skills matcher service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-consultant-skills-matcher</title><style>
...
<div class="header"><h1>robotics-consultant-skills-matcher</h1><div class="subtitle">Robotics GTM consultant skills matcher service · port 53943</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53943</div>

...
PORT = 11871
SERVICE = "partner_solution_marketplace"
DESCRIPTION = "Partner solution marketplace for joint solution cataloging, integration certification tracking, and co-sell bundle management"

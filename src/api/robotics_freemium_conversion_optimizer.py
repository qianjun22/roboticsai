...
PORT = 50927
SERVICE = "robotics-freemium-conversion-optimizer"
DESCRIPTION = "Robotics GTM freemium conversion optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-freemium-conversion-optimizer</title><style>
...
<div class="header"><h1>robotics-freemium-conversion-optimizer</h1><div class="subtitle">Robotics GTM freemium conversion optimizer service · port 50927</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50927</div>

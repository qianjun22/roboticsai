...
PORT = 13863
SERVICE = "robotics_sales_velocity_v5"
DESCRIPTION = "Robotics sales velocity platform v5 — deal speed optimization, cycle time reduction, and pipeline throughput analytics"

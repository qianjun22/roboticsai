...
PORT = 12477
SERVICE = "enterprise_robotics_compliance_audit_hub"
DESCRIPTION = "Enterprise robotics compliance audit hub for ISO 10218, CE marking, and safety standard certification tracking across robot fleets"

...
PORT = 12133
SERVICE = "sales-social-proof-engine"
DESCRIPTION = "Social proof aggregation engine collecting customer testimonials, case studies, and reference metrics to accelerate enterprise sales cycles"

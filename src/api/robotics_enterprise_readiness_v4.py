...
PORT = 13845
SERVICE = "robotics_enterprise_readiness_v4"
DESCRIPTION = "Robotics enterprise readiness platform v4 — enterprise-grade compliance, security, and scalability assessment"

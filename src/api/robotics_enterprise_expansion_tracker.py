...
PORT = 12967
SERVICE = "robotics_enterprise_expansion_tracker"
DESCRIPTION = "Enterprise expansion tracker for robotics customers — monitors upsell pipeline, additional site deployments, and fleet size growth per account"

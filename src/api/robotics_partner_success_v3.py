...
PORT = 13573
SERVICE = "robotics_partner_success_v3"
DESCRIPTION = "Robotics partner success platform v3 — partner health monitoring, joint customer success programs, escalation management, and shared KPI dashboards for strategic robotics partnerships"

...
PORT = 13559
SERVICE = "robotics_pipeline_acceleration_v2"
DESCRIPTION = "Robotics pipeline acceleration platform v2 — deal velocity optimization, bottleneck identification, stage conversion analytics, and AI-driven next-best-action for sales pipeline"

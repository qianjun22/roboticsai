...
PORT = 12387
SERVICE = "enterprise_robotics_capacity_planning_hub"
DESCRIPTION = "Enterprise robotics capacity planning hub for fleet sizing and deployment timeline optimization"

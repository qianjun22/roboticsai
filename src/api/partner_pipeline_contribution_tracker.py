...
PORT = 11827
SERVICE = "partner_pipeline_contribution_tracker"
DESCRIPTION = "Partner pipeline contribution tracker for deal attribution, co-sell metrics, and partner-sourced revenue analytics"

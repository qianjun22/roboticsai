"""Customer Lifetime Value V2 — advanced cohort-adjusted CLV with expansion and churn modeling.
...
DESCRIPTION = "Advanced cohort-adjusted CLV with expansion and churn modeling"

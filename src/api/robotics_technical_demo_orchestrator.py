...
PORT = 50975
SERVICE = "robotics-technical-demo-orchestrator"
DESCRIPTION = "Robotics GTM technical demo orchestrator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-demo-orchestrator</title><style>
...
<div class="header"><h1>robotics-technical-demo-orchestrator</h1><div class="subtitle">Robotics GTM technical demo orchestrator service · port 50975</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50975</div>

...
PORT = 50795
SERVICE = "robotics-si-partner-coordinator"
DESCRIPTION = "Robotics GTM si partner coordinator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-si-partner-coordinator</title><style>
...
<div class="header"><h1>robotics-si-partner-coordinator</h1><div class="subtitle">Robotics GTM si partner coordinator service · port 50795</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50795</div>

...
PORT = 54023
SERVICE = "robotics-marketing-automation-svc"
DESCRIPTION = "Robotics GTM marketing automation svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-marketing-automation-svc</title><style>
...
<div class="header"><h1>robotics-marketing-automation-svc</h1><div class="subtitle">Robotics GTM marketing automation svc service · port 54023</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54023</div>

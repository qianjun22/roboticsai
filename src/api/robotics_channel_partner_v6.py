...
PORT = 13861
SERVICE = "robotics_channel_partner_v6"
DESCRIPTION = "Robotics channel partner platform v6 — reseller management, deal registration, and channel incentive programs"

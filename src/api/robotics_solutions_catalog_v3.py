...
PORT = 13495
SERVICE = "robotics_solutions_catalog_v3"
DESCRIPTION = "Solutions catalog v3 for managing and publishing robotics reference architectures and solution bundles"

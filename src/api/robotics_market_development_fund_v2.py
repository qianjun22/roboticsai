...
PORT = 13327
SERVICE = "robotics_market_development_fund_v2"
DESCRIPTION = "Market development fund v2 for allocating co-marketing budget with NVIDIA and channel partners to maximize pipeline creation"

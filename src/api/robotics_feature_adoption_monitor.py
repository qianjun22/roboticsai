...
PORT = 50939
SERVICE = "robotics-feature-adoption-monitor"
DESCRIPTION = "Robotics GTM feature adoption monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-feature-adoption-monitor</title><style>
...
<div class="header"><h1>robotics-feature-adoption-monitor</h1><div class="subtitle">Robotics GTM feature adoption monitor service · port 50939</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50939</div>

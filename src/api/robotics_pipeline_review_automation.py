...
PORT = 53451
SERVICE = "robotics-pipeline-review-automation"
DESCRIPTION = "Robotics GTM pipeline review automation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pipeline-review-automation</title><style>
...
<div class="header"><h1>robotics-pipeline-review-automation</h1><div class="subtitle">Robotics GTM pipeline review automation service · port 53451</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53451</div>

...
PORT = 13035
SERVICE = "robotics_partner_enablement_portal"
DESCRIPTION = "Partner enablement portal for robotics ecosystem — delivers training modules, certification paths, and co-sell playbooks to channel partners"

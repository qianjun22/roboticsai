...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-competitive-intel-aggregator</title><style>
...
<div class="header"><h1>robotics-competitive-intel-aggregator</h1><div class="subtitle">Robotics GTM competitive intel aggregator service · port 50167</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50167</div>

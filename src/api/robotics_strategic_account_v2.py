...
PORT = 13189
SERVICE = "robotics_strategic_account_v2"
DESCRIPTION = "Strategic account v2 for managing whitespace mapping, executive engagement, and multi-year growth plans in key robotics accounts"

...
PORT = 12715
SERVICE = "enterprise-robotics-fleet-expansion-planner"
DESCRIPTION = "Plans fleet expansion roadmaps for enterprise robotics customers — capacity modeling, phased rollout, and budget forecasting"

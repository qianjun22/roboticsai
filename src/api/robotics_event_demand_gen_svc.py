...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-event-demand-gen-svc</title><style>
...
<div class="header"><h1>robotics-event-demand-gen-svc</h1><div class="subtitle">Robotics GTM event demand gen svc service · port 52607</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52607</div>

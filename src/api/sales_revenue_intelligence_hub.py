...
PORT = 12571
SERVICE = "sales_revenue_intelligence_hub"
DESCRIPTION = "Sales revenue intelligence hub aggregating CRM signals, product usage data, and market indicators for AI-driven deal prioritization"

...
PORT = 12861
SERVICE = "robotics_sdk_version_compatibility_matrix"
DESCRIPTION = "Maintains SDK version compatibility matrix — supported OS/hardware combinations, deprecation timelines, and migration guides for each release"

...
PORT = 11809
SERVICE = "enterprise-customer-intelligence-hub"
DESCRIPTION = "Enterprise customer intelligence hub for account health aggregation, risk scoring, and growth opportunity signals"

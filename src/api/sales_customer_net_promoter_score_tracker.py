...
PORT = 12273
SERVICE = "sales_customer_net_promoter_score_tracker"
DESCRIPTION = "Customer net promoter score tracking and analysis for robotics platform satisfaction metrics"

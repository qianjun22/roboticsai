...
PORT = 12651
SERVICE = "enterprise-robotics-change-management"
DESCRIPTION = "Change management toolkit for enterprise robotics deployments — workforce transition planning and adoption metrics"

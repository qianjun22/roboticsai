...
PORT = 53199
SERVICE = "robotics-customer-advocacy-builder"
DESCRIPTION = "Robotics GTM customer advocacy builder service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-advocacy-builder</title><style>
...
<div class="header"><h1>robotics-customer-advocacy-builder</h1><div class="subtitle">Robotics GTM customer advocacy builder service · port 53199</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53199</div>

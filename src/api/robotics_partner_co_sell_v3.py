...
PORT = 13689
SERVICE = "robotics_partner_co_sell_v3"
DESCRIPTION = "Robotics partner co-sell API v3 — joint opportunity tracking, co-sell motion orchestration, and partner deal registration"

...
PORT = 50435
SERVICE = "robotics-project-health-dashboard"
DESCRIPTION = "Robotics GTM project health dashboard service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-project-health-dashboard</title><style>
...
<div class="header"><h1>robotics-project-health-dashboard</h1><div class="subtitle">Robotics GTM project health dashboard service · port 50435</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50435</div>

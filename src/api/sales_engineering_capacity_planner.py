...
PORT = 12661
SERVICE = "sales-engineering-capacity-planner"
DESCRIPTION = "Plans sales engineering capacity for enterprise robotics POCs — resource allocation and skill gap analysis"

...
PORT = 50361
SERVICE = "robotics-dagger-demand-gen"
DESCRIPTION = "Robotics GTM dagger demand gen service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-demand-gen</title><style>
...
<div class="header"><h1>robotics-dagger-demand-gen</h1><div class="subtitle">Robotics GTM dagger demand gen service · port 50361</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50361</div>

...
PORT = 38455
SERVICE = "robotics_inference_cost_tracker"
DESCRIPTION = "Inference cost tracking for cloud robotics deployments"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_inference_cost_tracker</title><style>
...
<div class="header"><h1>robotics_inference_cost_tracker</h1><div class="subtitle">Inference cost tracking for cloud robotics deployments · port 38455</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38455</div>

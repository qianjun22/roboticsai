...
PORT = 16741
SERVICE = "robotics_collaboration_network_v4"
DESCRIPTION = "Robotics GTM collaboration network builder connecting robot operators, trainers and system integrators"

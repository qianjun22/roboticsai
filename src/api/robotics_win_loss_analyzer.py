...
PORT = 50659
SERVICE = "robotics-win-loss-analyzer"
DESCRIPTION = "Robotics GTM win loss analyzer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-win-loss-analyzer</title><style>
...
<div class="header"><h1>robotics-win-loss-analyzer</h1><div class="subtitle">Robotics GTM win loss analyzer service · port 50659</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50659</div>

...
PORT = 51811
SERVICE = "robotics-professional-services-tracker"
DESCRIPTION = "Robotics GTM professional services tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-professional-services-tracker</title><style>
...
<div class="header"><h1>robotics-professional-services-tracker</h1><div class="subtitle">Robotics GTM professional services tracker service · port 51811</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51811</div>

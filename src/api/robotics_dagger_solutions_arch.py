...
PORT = 50057
SERVICE = "robotics-dagger-solutions-arch"
DESCRIPTION = "Robotics GTM dagger solutions arch service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-solutions-arch</title><style>
...
<div class="header"><h1>robotics-dagger-solutions-arch</h1><div class="subtitle">Robotics GTM dagger solutions arch service · port 50057</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50057</div>

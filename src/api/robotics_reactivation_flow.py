...
PORT = 15129
SERVICE = "robotics-reactivation-flow"
DESCRIPTION = "GTM platform for reactivation flow automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reactivation-flow</title><style>
...
<div class="header"><h1>robotics-reactivation-flow</h1><div class="sub">GTM platform for reactivation flow automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15129 | <b>Status:</b> <span style="color:#4ade80">Live</span>

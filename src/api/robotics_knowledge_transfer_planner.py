...
PORT = 51843
SERVICE = "robotics-knowledge-transfer-planner"
DESCRIPTION = "Robotics GTM knowledge transfer planner service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-knowledge-transfer-planner</title><style>
...
<div class="header"><h1>robotics-knowledge-transfer-planner</h1><div class="subtitle">Robotics GTM knowledge transfer planner service · port 51843</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51843</div>

...
PORT = 12507
SERVICE = "sales_incentive_compensation_manager"
DESCRIPTION = "Sales incentive compensation manager automating commission calculations, accelerator triggers, and SPIFs for robotics sales teams"

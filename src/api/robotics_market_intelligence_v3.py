...
PORT = 13717
SERVICE = "robotics_market_intelligence_v3"
DESCRIPTION = "Robotics market intelligence API v3 — competitive landscape monitoring, analyst relations, market sizing, and industry trend synthesis"

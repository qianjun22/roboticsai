...
PORT = 11851
SERVICE = "partner_co_innovation_program"
DESCRIPTION = "Partner co-innovation program manager for joint R&D tracking, IP sharing agreements, and co-development milestone monitoring"

"""Enterprise Expansion Tracker — tracks upsell and cross-sell pipeline with signal-driven playbooks.
...
DESCRIPTION = "Tracks upsell and cross-sell pipeline with signal-driven expansion playbooks"

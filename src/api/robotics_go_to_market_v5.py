...
PORT = 13317
SERVICE = "robotics_go_to_market_v5"
DESCRIPTION = "Go-to-market v5 for scaling OCI Robot Cloud from design partner phase to general availability with structured sales motion"

...
PORT = 40379
SERVICE = "robotics_billing_engine"
DESCRIPTION = "GTM service: billing engine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_billing_engine</title><style>
...
<div class="header"><h1>robotics_billing_engine</h1><div class="subtitle">GTM service: billing engine port 40379</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40379</div>

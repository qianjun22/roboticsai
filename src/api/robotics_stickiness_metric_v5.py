...
PORT = 16811
SERVICE = "robotics_stickiness_metric_v5"
DESCRIPTION = "Robotics GTM stickiness metric v5 with cross-shift continuity scoring and operator return-rate benchmarking"

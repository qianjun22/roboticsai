...
PORT = 13629
SERVICE = "robotics_customer_success_v4"
DESCRIPTION = "Robotics customer success management platform v4 — tracks health scores, manages onboarding milestones, orchestrates proactive intervention workflows, and drives expansion motions across the robotics customer lifecycle"

...
PORT = 13653
SERVICE = "robotics_revenue_quality_v2"
DESCRIPTION = "Robotics revenue quality analytics platform v2 — measures deal health beyond raw ARR, scoring margin quality, customer stickiness, multi-product attachment, and strategic account value to guide resource allocation decisions"

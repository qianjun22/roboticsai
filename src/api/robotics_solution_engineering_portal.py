...
PORT = 12795
SERVICE = "robotics_solution_engineering_portal"
DESCRIPTION = "Portal for robotics solution engineers — customer scoping tools, BoM generators, integration guides, and pre-sales technical resources"

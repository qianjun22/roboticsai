...
PORT = 11961
SERVICE = "enterprise_employee_experience_platform"
DESCRIPTION = "Enterprise employee experience platform for sentiment monitoring, engagement driver analysis, and workplace satisfaction improvement recommendations"

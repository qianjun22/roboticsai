...
PORT = 50461
SERVICE = "robotics-dagger-community-mgr"
DESCRIPTION = "Robotics GTM dagger community mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-community-mgr</title><style>
...
<div class="header"><h1>robotics-dagger-community-mgr</h1><div class="subtitle">Robotics GTM dagger community mgr service · port 50461</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50461</div>

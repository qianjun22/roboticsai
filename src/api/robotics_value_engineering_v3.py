...
PORT = 13827
SERVICE = "robotics_value_engineering_v3"
DESCRIPTION = "Robotics value engineering platform v3 — ROI analysis and business case development for robotics deployments"

...
PORT = 12443
SERVICE = "sales_industry_vertical_playbook"
DESCRIPTION = "Sales industry vertical playbook with sector-specific messaging, buyer persona guides, and competitive positioning for robotics verticals"

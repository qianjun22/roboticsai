...
PORT = 13303
SERVICE = "robotics_demand_gen_v2"
DESCRIPTION = "Demand generation v2 for orchestrating robotics cloud pipeline creation across content, events, and NVIDIA co-marketing"

...
PORT = 13123
SERVICE = "robotics_workforce_productivity_tracker"
DESCRIPTION = "Workforce productivity tracker for measuring human-robot collaboration output and efficiency gains"

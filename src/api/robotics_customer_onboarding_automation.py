...
PORT = 12879
SERVICE = "robotics_customer_onboarding_automation"
DESCRIPTION = "Automates robotics customer onboarding — environment setup scripts, API key provisioning, first-task walkthrough, and 30/60/90 day success milestones"

...
PORT = 13657
SERVICE = "robotics_customer_delight_v2"
DESCRIPTION = "Robotics customer delight program platform v2 — designs and executes surprise-and-delight experiences for key accounts, tracks satisfaction metrics, and correlates delight investments with NPS improvement and churn reduction"

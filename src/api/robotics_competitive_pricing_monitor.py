...
PORT = 53399
SERVICE = "robotics-competitive-pricing-monitor"
DESCRIPTION = "Robotics GTM competitive pricing monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-competitive-pricing-monitor</title><style>
...
<div class="header"><h1>robotics-competitive-pricing-monitor</h1><div class="subtitle">Robotics GTM competitive pricing monitor service · port 53399</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53399</div>

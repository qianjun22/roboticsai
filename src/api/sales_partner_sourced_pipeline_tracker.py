...
PORT = 12245
SERVICE = "sales-partner-sourced-pipeline-tracker"
DESCRIPTION = "Partner-sourced pipeline tracker attributing inbound leads and opportunities to specific partner referrals, with conversion rate analytics and ROI per partner"

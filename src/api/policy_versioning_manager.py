"""Policy Versioning Manager — FastAPI port 8990"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Policy Versioning Manager</title>
...
<body><h1>Policy Versioning Manager</h1>
...
if USE_FASTAPI:
    app = FastAPI(title="Policy Versioning Manager")

...
PORT = 13831
SERVICE = "robotics_launch_readiness_v3"
DESCRIPTION = "Robotics launch readiness platform v3 — pre-launch validation and readiness scoring for robotics product releases"

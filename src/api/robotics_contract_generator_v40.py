...
PORT = 40323
SERVICE = "robotics_contract_generator"
DESCRIPTION = "GTM service: contract generator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_contract_generator</title><style>
...
<div class="header"><h1>robotics_contract_generator</h1><div class="subtitle">GTM service: contract generator port 40323</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40323</div>

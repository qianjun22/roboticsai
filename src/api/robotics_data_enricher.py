...
DESCRIPTION = "GTM platform for data enricher automation"
...
<div class="header"><h1>robotics-data-enricher</h1><div class="sub">GTM platform for data enricher automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15025 | <b>Status:</b> <span style="color:#4ade80">Live</span>

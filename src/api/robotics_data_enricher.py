...
PORT = 15223
SERVICE = "robotics-data-enricher"
DESCRIPTION = "GTM platform for data enricher optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-data-enricher</title><style>
...
<div class="header"><h1>robotics-data-enricher</h1><div class="sub">GTM platform for data enricher optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15223 | <b>Status:</b> <span style="color:#4ade80">Live</span>

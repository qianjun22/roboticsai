...
PORT = 50135
SERVICE = "robotics-solution-brief-generator"
DESCRIPTION = "Robotics GTM solution brief generator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-solution-brief-generator</title><style>
...
<div class="header"><h1>robotics-solution-brief-generator</h1><div class="subtitle">Robotics GTM solution brief generator service · port 50135</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50135</div>

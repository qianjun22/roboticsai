...
PORT = 12355
SERVICE = "enterprise_robotics_incident_response_hub"
DESCRIPTION = "Enterprise robotics incident response hub for automated safety event triage and escalation management"

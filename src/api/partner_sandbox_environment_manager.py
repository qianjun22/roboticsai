...
PORT = 12185
SERVICE = "partner-sandbox-environment-manager"
DESCRIPTION = "Sandbox environment manager provisioning isolated OCI Robot Cloud tenancies for partner development, testing, and customer demonstration purposes"

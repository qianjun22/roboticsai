...
PORT = 12797
SERVICE = "robotics_customer_advisory_board_tracker"
DESCRIPTION = "Manages customer advisory board for robotics — member profiles, meeting cadence, feedback themes, and product influence tracking"

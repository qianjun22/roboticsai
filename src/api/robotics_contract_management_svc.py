...
PORT = 52019
SERVICE = "robotics-contract-management-svc"
DESCRIPTION = "Robotics GTM contract management svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-contract-management-svc</title><style>
...
<div class="header"><h1>robotics-contract-management-svc</h1><div class="subtitle">Robotics GTM contract management svc service · port 52019</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52019</div>

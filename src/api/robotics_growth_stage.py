...
PORT = 46843
SERVICE = "robotics_growth_stage"
DESCRIPTION = "Growth stage robotics enterprise expansion tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_growth_stage</title><style>
...
<div class="header"><h1>robotics_growth_stage</h1><div class="subtitle">Growth stage robotics enterprise expansion tracker · port 46843</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46843</div>

...
PORT = 13623
SERVICE = "robotics_competitive_response_v2"
DESCRIPTION = "Robotics competitive intelligence and response platform v2 — monitors competitor product launches and pricing changes, generates real-time battle cards, and coordinates field sales response strategies"

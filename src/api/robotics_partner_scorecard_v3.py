...
PORT = 13253
SERVICE = "robotics_partner_scorecard_v3"
DESCRIPTION = "Partner scorecard v3 for evaluating partner performance across revenue, enablement, and customer satisfaction dimensions"

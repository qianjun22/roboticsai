...
PORT = 15349
SERVICE = "robotics-partner-portal"
DESCRIPTION = "GTM platform for partner portal automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-portal</title><style>
...
<div class="header"><h1>robotics-partner-portal</h1><div class="sub">GTM platform for partner portal automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15349 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15367
SERVICE = "robotics-goal-tracker"
DESCRIPTION = "GTM platform for goal tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-goal-tracker</title><style>
...
<div class="header"><h1>robotics-goal-tracker</h1><div class="sub">GTM platform for goal tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15367 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50171
SERVICE = "robotics-analyst-briefing-coordinator"
DESCRIPTION = "Robotics GTM analyst briefing coordinator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-analyst-briefing-coordinator</title><style>
...
<div class="header"><h1>robotics-analyst-briefing-coordinator</h1><div class="subtitle">Robotics GTM analyst briefing coordinator service · port 50171</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50171</div>

...
PORT = 53187
SERVICE = "robotics-success-plan-generator"
DESCRIPTION = "Robotics GTM success plan generator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-success-plan-generator</title><style>
...
<div class="header"><h1>robotics-success-plan-generator</h1><div class="subtitle">Robotics GTM success plan generator service · port 53187</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53187</div>

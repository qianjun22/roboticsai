...
PORT = 50223
SERVICE = "robotics-developer-nps-tracker"
DESCRIPTION = "Robotics GTM developer nps tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-nps-tracker</title><style>
...
<div class="header"><h1>robotics-developer-nps-tracker</h1><div class="subtitle">Robotics GTM developer nps tracker service · port 50223</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50223</div>

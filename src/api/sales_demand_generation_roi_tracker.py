...
PORT = 12689
SERVICE = "sales-demand-generation-roi-tracker"
DESCRIPTION = "Tracks ROI of demand generation programs for enterprise robotics — event, content, and paid channel attribution"

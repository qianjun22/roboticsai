...
PORT = 16721
SERVICE = "robotics_activation_rate_optimizer_v5"
DESCRIPTION = "Robotics GTM activation rate optimizer improving trial-to-paid conversion through guided onboarding flows"

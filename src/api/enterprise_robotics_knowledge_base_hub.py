...
PORT = 12541
SERVICE = "enterprise_robotics_knowledge_base_hub"
DESCRIPTION = "Enterprise robotics knowledge base hub centralizing maintenance guides, troubleshooting runbooks, and best practices for robot operators"

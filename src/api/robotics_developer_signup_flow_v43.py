...
<div class="header"><h1>robotics_developer_signup_flow</h1><div class="subtitle">GTM service: developer signup flow port 42831</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42831</div>

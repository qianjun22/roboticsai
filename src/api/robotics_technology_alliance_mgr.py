...
PORT = 50799
SERVICE = "robotics-technology-alliance-mgr"
DESCRIPTION = "Robotics GTM technology alliance mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technology-alliance-mgr</title><style>
...
<div class="header"><h1>robotics-technology-alliance-mgr</h1><div class="subtitle">Robotics GTM technology alliance mgr service · port 50799</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50799</div>

...
PORT = 11725
SERVICE = "enterprise-deal-intelligence-platform"
DESCRIPTION = "Enterprise deal intelligence platform for multi-stakeholder mapping, objection tracking, and close planning"

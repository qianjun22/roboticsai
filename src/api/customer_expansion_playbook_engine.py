...
PORT = 11735
SERVICE = "customer-expansion-playbook-engine"
DESCRIPTION = "Customer expansion playbook engine for land-and-expand motion orchestration and multi-product adoption"

...
PORT = 54015
SERVICE = "robotics-seo-rank-tracker"
DESCRIPTION = "Robotics GTM seo rank tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-seo-rank-tracker</title><style>
...
<div class="header"><h1>robotics-seo-rank-tracker</h1><div class="subtitle">Robotics GTM seo rank tracker service · port 54015</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54015</div>

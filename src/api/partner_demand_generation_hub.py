...
PORT = 11887
SERVICE = "partner_demand_generation_hub"
DESCRIPTION = "Partner demand generation hub for co-marketing campaign orchestration, lead sharing workflows, and joint pipeline attribution"

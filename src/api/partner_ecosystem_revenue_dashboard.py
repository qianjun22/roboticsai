...
PORT = 11865
SERVICE = "partner_ecosystem_revenue_dashboard"
DESCRIPTION = "Partner ecosystem revenue dashboard for channel mix analysis, partner-influenced pipeline tracking, and ecosystem health scoring"

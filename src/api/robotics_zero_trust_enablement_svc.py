...
PORT = 50723
SERVICE = "robotics-zero-trust-enablement-svc"
DESCRIPTION = "Robotics GTM zero trust enablement svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-zero-trust-enablement-svc</title><style>
...
<div class="header"><h1>robotics-zero-trust-enablement-svc</h1><div class="subtitle">Robotics GTM zero trust enablement svc service · port 50723</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50723</div>

...
PORT = 13799
SERVICE = "robotics_sales_excellence_v5"
DESCRIPTION = "Robotics sales excellence platform v5 — rep performance analytics, deal coaching, and sales methodology enforcement for robotics enterprise teams"

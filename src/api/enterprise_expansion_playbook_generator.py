...
PORT = 11639
SERVICE = "enterprise-expansion-playbook-generator"
DESCRIPTION = "Generates customized expansion playbooks for enterprise accounts based on usage patterns and identified growth opportunities"

...
PORT = 13295
SERVICE = "robotics_partner_co_innovation_hub"
DESCRIPTION = "Partner co-innovation hub for managing joint R&D initiatives, prototype sharing, and IP agreements with NVIDIA and robotics partners"

...
PORT = 11731
SERVICE = "partner-managed-services-tracker"
DESCRIPTION = "Partner managed services tracker for SLA compliance, service delivery quality, and renewal opportunity identification"

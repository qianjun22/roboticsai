...
PORT = 13577
SERVICE = "robotics_customer_intelligence_v3"
DESCRIPTION = "Robotics customer intelligence platform v3 — 360-degree account insights, intent signal monitoring, buying committee mapping, and AI-driven engagement recommendations for robotics accounts"

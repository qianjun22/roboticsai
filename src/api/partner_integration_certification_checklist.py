...
PORT = 12713
SERVICE = "partner-integration-certification-checklist"
DESCRIPTION = "Automated certification checklist for robotics partner integrations — API compliance, security, and performance validation"

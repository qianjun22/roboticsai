...
PORT = 11615
SERVICE = "enterprise-pilot-to-production-tracker"
DESCRIPTION = "Tracks enterprise pilot conversion to production with milestone gates, blockers, and expansion opportunity scoring"

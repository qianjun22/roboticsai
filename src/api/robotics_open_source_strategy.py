...
PORT = 13075
SERVICE = "robotics_open_source_strategy"
DESCRIPTION = "Open source strategy tracker for robotics platform — manages OSS contributions, community growth, and developer ecosystem conversion to paid tiers"

...
PORT = 13299
SERVICE = "robotics_account_expansion_v2"
DESCRIPTION = "Account expansion v2 for identifying and executing upsell motions within existing robotics cloud customer accounts"

...
PORT = 50823
SERVICE = "robotics-ecosystem-health-monitor"
DESCRIPTION = "Robotics GTM ecosystem health monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-ecosystem-health-monitor</title><style>
...
<div class="header"><h1>robotics-ecosystem-health-monitor</h1><div class="subtitle">Robotics GTM ecosystem health monitor service · port 50823</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50823</div>

...
PORT = 13005
SERVICE = "robotics_proof_of_value_tracker"
DESCRIPTION = "Proof of value tracker for robotics pilots — measures KPI achievement against baseline, tracks milestones, and automates go/no-go scoring"

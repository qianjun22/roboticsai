...
PORT = 50683
SERVICE = "robotics-partner-portal-analytics"
DESCRIPTION = "Robotics GTM partner portal analytics service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-portal-analytics</title><style>
...
<div class="header"><h1>robotics-partner-portal-analytics</h1><div class="subtitle">Robotics GTM partner portal analytics service · port 50683</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50683</div>

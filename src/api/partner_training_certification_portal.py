...
PORT = 12385
SERVICE = "partner_training_certification_portal"
DESCRIPTION = "Partner training certification portal for robotics platform sales and technical competency programs"

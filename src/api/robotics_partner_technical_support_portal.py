...
PORT = 12847
SERVICE = "robotics_partner_technical_support_portal"
DESCRIPTION = "Technical support portal for robotics partners — ticket routing, escalation paths, knowledge base, and partner-specific SLA tracking"

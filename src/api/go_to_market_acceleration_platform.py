...
PORT = 11677
SERVICE = "go-to-market-acceleration-platform"
DESCRIPTION = "Accelerates GTM execution through automated playbook deployment, rep ramp optimization, and pipeline generation tracking"

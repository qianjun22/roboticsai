...
PORT = 50771
SERVICE = "robotics-enterprise-demo-scheduler"
DESCRIPTION = "Robotics GTM enterprise demo scheduler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-enterprise-demo-scheduler</title><style>
...
<div class="header"><h1>robotics-enterprise-demo-scheduler</h1><div class="subtitle">Robotics GTM enterprise demo scheduler service · port 50771</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50771</div>

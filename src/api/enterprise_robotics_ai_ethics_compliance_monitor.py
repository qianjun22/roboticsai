...
PORT = 12733
SERVICE = "enterprise-robotics-ai-ethics-compliance"
DESCRIPTION = "Monitors AI ethics compliance for enterprise robot deployments — bias auditing, explainability, and human override logging"

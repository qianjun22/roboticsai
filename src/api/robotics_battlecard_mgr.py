...
PORT = 15281
SERVICE = "robotics-battlecard-mgr"
DESCRIPTION = "GTM platform for battlecard mgr automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-battlecard-mgr</title><style>
...
<div class="header"><h1>robotics-battlecard-mgr</h1><div class="sub">GTM platform for battlecard mgr automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15281 | <b>Status:</b> <span style="color:#4ade80">Live</span>

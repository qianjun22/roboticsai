...
PORT = 11949
SERVICE = "sales_deal_room_intelligence"
DESCRIPTION = "Sales deal room intelligence platform for stakeholder engagement tracking, document interaction analytics, and buyer committee influence mapping"

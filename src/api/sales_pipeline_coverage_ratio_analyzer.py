...
PORT = 12735
SERVICE = "sales-pipeline-coverage-ratio-analyzer"
DESCRIPTION = "Analyzes pipeline coverage ratios for enterprise robotics — 3x coverage health checks and at-risk quarter forecasting"

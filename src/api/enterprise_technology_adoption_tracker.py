...
PORT = 12041
SERVICE = "enterprise-technology-adoption-tracker"
DESCRIPTION = "Enterprise technology adoption tracker for measuring robotics deployment velocity and user uptake"

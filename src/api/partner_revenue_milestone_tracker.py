...
PORT = 12681
SERVICE = "partner-revenue-milestone-tracker"
DESCRIPTION = "Tracks revenue milestone achievement for robotics channel partners — tier progression and incentive unlock status"

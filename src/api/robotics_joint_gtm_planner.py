...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-joint-gtm-planner</title><style>
...
<div class="header"><h1>robotics-joint-gtm-planner</h1><div class="subtitle">Robotics GTM joint gtm planner service · port 50815</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50815</div>

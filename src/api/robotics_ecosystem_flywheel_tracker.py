...
PORT = 13077
SERVICE = "robotics_ecosystem_flywheel_tracker"
DESCRIPTION = "Ecosystem flywheel tracker for robotics platform — measures virtuous cycle momentum: more robots → more data → better models → more customers"

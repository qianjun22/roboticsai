...
PORT = 12557
SERVICE = "enterprise_robotics_spare_parts_optimizer"
DESCRIPTION = "Enterprise robotics spare parts optimizer minimizing inventory carrying costs while ensuring critical component availability across fleet sites"

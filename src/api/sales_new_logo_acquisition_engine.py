...
PORT = 12059
SERVICE = "sales-new-logo-acquisition-engine"
DESCRIPTION = "Sales new logo acquisition engine for systematic pipeline building and first-time customer conversion"

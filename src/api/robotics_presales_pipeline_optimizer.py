...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-presales-pipeline-optimizer</title><style>
...
<div class="header"><h1>robotics-presales-pipeline-optimizer</h1><div class="subtitle">Robotics GTM presales pipeline optimizer service · port 53099</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53099</div>

...
PORT = 52079
SERVICE = "robotics-channel-forecast-engine"
DESCRIPTION = "Robotics GTM channel forecast engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-channel-forecast-engine</title><style>
...
<div class="header"><h1>robotics-channel-forecast-engine</h1><div class="subtitle">Robotics GTM channel forecast engine service · port 52079</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52079</div>

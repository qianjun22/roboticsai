...
PORT = 52599
SERVICE = "robotics-system-validation-engine"
DESCRIPTION = "Robotics GTM system validation engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-system-validation-engine</title><style>
...
<div class="header"><h1>robotics-system-validation-engine</h1><div class="subtitle">Robotics GTM system validation engine service · port 52599</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52599</div>

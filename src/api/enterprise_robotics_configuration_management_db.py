...
PORT = 12573
SERVICE = "enterprise_robotics_configuration_management_db"
DESCRIPTION = "Enterprise robotics configuration management database tracking firmware versions, parameter sets, and change history across distributed robot fleets"

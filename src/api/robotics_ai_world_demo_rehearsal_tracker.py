...
PORT = 12851
SERVICE = "robotics_ai_world_demo_rehearsal_tracker"
DESCRIPTION = "Tracks AI World demo rehearsal sessions — script versions, hardware readiness, latency benchmarks, and fallback scenario preparation"

...
PORT = 13227
SERVICE = "robotics_integration_health_v2"
DESCRIPTION = "Integration health v2 for monitoring API reliability, webhook latency, and SDK compatibility across robotics partners"

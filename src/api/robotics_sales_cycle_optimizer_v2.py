...
PORT = 13471
SERVICE = "robotics_sales_cycle_optimizer_v2"
DESCRIPTION = "Sales cycle optimizer v2 for compressing robotics enterprise deal timelines and removing blockers"

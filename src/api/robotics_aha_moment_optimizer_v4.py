...
PORT = 16719
SERVICE = "robotics_aha_moment_optimizer_v4"
DESCRIPTION = "Robotics GTM aha-moment optimizer accelerating user discovery of core value propositions during onboarding"

...
PORT = 11919
SERVICE = "sales_capacity_planning_optimizer"
DESCRIPTION = "Sales capacity planning optimizer for headcount modeling, ramp time analysis, and quota coverage ratio optimization across regions"

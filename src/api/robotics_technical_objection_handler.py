...
PORT = 50999
SERVICE = "robotics-technical-objection-handler"
DESCRIPTION = "Robotics GTM technical objection handler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-objection-handler</title><style>
...
<div class="header"><h1>robotics-technical-objection-handler</h1><div class="subtitle">Robotics GTM technical objection handler service · port 50999</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50999</div>

...
PORT = 13887
SERVICE = "robotics_sales_incentive_v4"
DESCRIPTION = "Robotics sales incentive platform v4 — SPIFs, MDF programs, and incentive compensation optimization for robotics sales"

...
PORT = 12729
SERVICE = "enterprise-robotics-multi-site-coordinator"
DESCRIPTION = "Coordinates robot fleet operations across multiple enterprise sites — unified dashboard, policy sync, and incident escalation"

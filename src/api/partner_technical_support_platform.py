...
PORT = 11765
SERVICE = "partner-technical-support-platform"
DESCRIPTION = "Partner technical support platform for escalation management, knowledge base curation, and support SLA tracking"

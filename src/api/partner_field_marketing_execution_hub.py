...
PORT = 12577
SERVICE = "partner_field_marketing_execution_hub"
DESCRIPTION = "Partner field marketing execution hub coordinating regional events, demo days, and local lead generation campaigns for robotics partners"

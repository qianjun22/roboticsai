...
PORT = 11837
SERVICE = "enterprise_talent_intelligence_platform"
DESCRIPTION = "Enterprise talent intelligence platform for skills gap analysis, workforce planning, and retention risk scoring"

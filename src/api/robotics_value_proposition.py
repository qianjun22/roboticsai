...
PORT = 15051
SERVICE = "robotics-value-proposition"
DESCRIPTION = "GTM platform for value proposition optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-value-proposition</title><style>
...
<div class="header"><h1>robotics-value-proposition</h1><div class="sub">GTM platform for value proposition optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15051 | <b>Status:</b> <span style="color:#4ade80">Live</span>

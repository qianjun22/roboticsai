...
PORT = 13321
SERVICE = "robotics_ecosystem_partner_v2"
DESCRIPTION = "Ecosystem partner v2 for managing OCI Robot Cloud integrations with simulation, hardware, and data platform partners"

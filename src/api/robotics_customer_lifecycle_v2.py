...
PORT = 13561
SERVICE = "robotics_customer_lifecycle_v2"
DESCRIPTION = "Robotics customer lifecycle platform v2 — acquisition-to-renewal journey orchestration, churn prediction, health scoring, and lifetime value optimization for robotics customers"

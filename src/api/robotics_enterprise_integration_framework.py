...
PORT = 12925
SERVICE = "robotics_enterprise_integration_framework"
DESCRIPTION = "Framework for enterprise robotics integrations — ERP connectors, MES interfaces, SCADA bridges, and data normalization for Industry 4.0 deployments"

...
PORT = 16821
SERVICE = "robotics_workflow_integration_v6"
DESCRIPTION = "Robotics GTM workflow integration v6 with no-code connectors for ERP, WMS and MES system orchestration"

...
PORT = 12439
SERVICE = "partner_solution_bundle_configurator"
DESCRIPTION = "Partner solution bundle configurator for assembling custom robotics solution packages with pricing and deployment options"

...
PORT = 50539
SERVICE = "robotics-email-campaign-engine"
DESCRIPTION = "Robotics GTM email campaign engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-email-campaign-engine</title><style>
...
<div class="header"><h1>robotics-email-campaign-engine</h1><div class="subtitle">Robotics GTM email campaign engine service · port 50539</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50539</div>

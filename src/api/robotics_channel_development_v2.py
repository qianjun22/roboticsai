...
PORT = 13637
SERVICE = "robotics_channel_development_v2"
DESCRIPTION = "Robotics channel development platform v2 — recruits and onboards reseller and VAR partners, manages tier certifications, tracks channel pipeline contribution, and drives joint go-to-market readiness"

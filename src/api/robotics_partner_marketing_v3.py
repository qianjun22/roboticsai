...
PORT = 13621
SERVICE = "robotics_partner_marketing_v3"
DESCRIPTION = "Robotics partner marketing collaboration platform v3 — manages joint marketing campaigns, co-branded content creation, MDF fund allocation, and partner-led demand generation programs"

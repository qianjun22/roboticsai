...
PORT = 13829
SERVICE = "robotics_account_based_marketing_v3"
DESCRIPTION = "Robotics account-based marketing platform v3 — targeted ABM campaigns for enterprise robotics sales"

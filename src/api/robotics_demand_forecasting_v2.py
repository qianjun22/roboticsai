...
PORT = 13583
SERVICE = "robotics_demand_forecasting_v2"
DESCRIPTION = "Demand forecasting v2 for robotics platform — predicts workload spikes, hardware procurement needs, and inference capacity requirements"

...
PORT = 13549
SERVICE = "robotics_customer_expansion_v2"
DESCRIPTION = "Robotics customer expansion platform v2 — AI-powered upsell identification, account growth analytics, and expansion revenue optimization for robotics deployments"

...
PORT = 12831
SERVICE = "robotics_revenue_operations_v2"
DESCRIPTION = "Second-generation revenue operations for robotics — pipeline hygiene automation, forecast roll-up, and cross-functional GTM alignment"

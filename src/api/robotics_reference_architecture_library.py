...
PORT = 12801
SERVICE = "robotics_reference_architecture_library"
DESCRIPTION = "Library of validated robotics reference architectures — deployment patterns, integration blueprints, and certified stack configurations"

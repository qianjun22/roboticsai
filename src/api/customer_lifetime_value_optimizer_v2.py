...
PORT = 11659
SERVICE = "customer-lifetime-value-optimizer-v2"
DESCRIPTION = "V2 CLV optimizer with improved ML models for expansion prediction, churn risk scoring, and LTV-based resource allocation"

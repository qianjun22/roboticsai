...
PORT = 50093
SERVICE = "robotics-dagger-expansion-engine"
DESCRIPTION = "Robotics GTM dagger expansion engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-expansion-engine</title><style>
...
<div class="header"><h1>robotics-dagger-expansion-engine</h1><div class="subtitle">Robotics GTM dagger expansion engine service · port 50093</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50093</div>

...
PORT = 50809
SERVICE = "robotics-dagger-renewal-tracker"
DESCRIPTION = "Robotics GTM dagger renewal tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-renewal-tracker</title><style>
...
<div class="header"><h1>robotics-dagger-renewal-tracker</h1><div class="subtitle">Robotics GTM dagger renewal tracker service · port 50809</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50809</div>

...
PORT = 13567
SERVICE = "robotics_strategic_planning_v2"
DESCRIPTION = "Robotics strategic planning platform v2 — long-range business roadmapping, OKR alignment, competitive positioning, and investment prioritization for robotics product and market strategy"

...
PORT = 12069
SERVICE = "sales-pricing-strategy-optimizer"
DESCRIPTION = "Sales pricing strategy optimizer for dynamic deal pricing based on market conditions and competition"

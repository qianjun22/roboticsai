...
PORT = 13687
SERVICE = "robotics_technical_marketing_v2"
DESCRIPTION = "Robotics technical marketing API v2 — technical content generation, developer outreach, and solution engineering enablement"

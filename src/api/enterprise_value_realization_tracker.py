...
PORT = 11565
SERVICE = "enterprise-value-realization-tracker"
DESCRIPTION = "Tracks value realization milestones for enterprise customers from deployment to measurable ROI outcomes"

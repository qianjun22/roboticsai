...
PORT = 12809
SERVICE = "robotics_field_service_dispatch_optimizer"
DESCRIPTION = "Optimizes field service dispatch for robotics hardware — technician routing, parts inventory, SLA prioritization, and first-visit fix rate"

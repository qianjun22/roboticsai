...
PORT = 13767
SERVICE = "robotics_account_based_marketing_v2"
DESCRIPTION = "Robotics account-based marketing service v2 — targeted campaign orchestration and ABM pipeline for enterprise robotics accounts"

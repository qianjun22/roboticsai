...
PORT = 16779
SERVICE = "robotics_monetization_model_v6"
DESCRIPTION = "Robotics GTM monetization model v6 integrating outcome-based pricing and robot-as-a-service subscriptions"

...
PORT = 13609
SERVICE = "robotics_customer_maturity_v2"
DESCRIPTION = "Robotics customer maturity assessment platform v2 — evaluates organizational readiness for robot fleet deployment, scores digital maturity across dimensions, and prescribes adoption roadmaps"

...
PORT = 15145
SERVICE = "robotics-survey-dispatcher"
DESCRIPTION = "GTM platform for survey dispatcher automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-survey-dispatcher</title><style>
...
<div class="header"><h1>robotics-survey-dispatcher</h1><div class="sub">GTM platform for survey dispatcher automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15145 | <b>Status:</b> <span style="color:#4ade80">Live</span>

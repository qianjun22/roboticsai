...
PORT = 50711
SERVICE = "robotics-gdpr-compliance-svc"
DESCRIPTION = "Robotics GTM gdpr compliance svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-gdpr-compliance-svc</title><style>
...
<div class="header"><h1>robotics-gdpr-compliance-svc</h1><div class="subtitle">Robotics GTM gdpr compliance svc service · port 50711</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50711</div>

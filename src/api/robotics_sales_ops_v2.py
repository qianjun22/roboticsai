...
PORT = 13319
SERVICE = "robotics_sales_ops_v2"
DESCRIPTION = "Sales ops v2 for managing CRM hygiene, pipeline velocity metrics, and forecast accuracy across robotics cloud deals"

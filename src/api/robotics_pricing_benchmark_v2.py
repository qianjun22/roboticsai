...
PORT = 13279
SERVICE = "robotics_pricing_benchmark_v2"
DESCRIPTION = "Pricing benchmark v2 for comparing OCI Robot Cloud rates against AWS, Azure, and GCP robotics inference offerings"

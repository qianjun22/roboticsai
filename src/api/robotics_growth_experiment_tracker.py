...
PORT = 12913
SERVICE = "robotics_growth_experiment_tracker"
DESCRIPTION = "Tracks growth experiments for robotics platform — hypothesis registry, experiment design review, statistical significance monitoring, and learnings database"

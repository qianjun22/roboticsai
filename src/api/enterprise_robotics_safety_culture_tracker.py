...
PORT = 12435
SERVICE = "enterprise_robotics_safety_culture_tracker"
DESCRIPTION = "Enterprise robotics safety culture tracker monitoring training compliance, incident reporting, and safety metric trends"

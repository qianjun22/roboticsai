...
PORT = 11759
SERVICE = "partner-cloud-marketplace-optimizer"
DESCRIPTION = "Partner cloud marketplace optimizer for listing conversion, co-sell motion, and marketplace revenue analytics"

...
PORT = 12621
SERVICE = "enterprise-robotics-procurement-workflow"
DESCRIPTION = "Automates procurement workflows for enterprise robotics — RFP generation, vendor comparison, and approval routing"

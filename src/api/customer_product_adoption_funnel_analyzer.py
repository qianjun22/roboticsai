...
PORT = 12693
SERVICE = "customer-product-adoption-funnel-analyzer"
DESCRIPTION = "Analyzes product adoption funnels for enterprise robotics customers — feature activation, depth of use, and expansion signals"

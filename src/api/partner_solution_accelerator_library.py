...
PORT = 12241
SERVICE = "partner-solution-accelerator-library"
DESCRIPTION = "Solution accelerator library providing partners with pre-built robotics integration templates, reference architectures, and certified OCI Robot Cloud deployment patterns"

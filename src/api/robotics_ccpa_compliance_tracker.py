...
PORT = 50715
SERVICE = "robotics-ccpa-compliance-tracker"
DESCRIPTION = "Robotics GTM ccpa compliance tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-ccpa-compliance-tracker</title><style>
...
<div class="header"><h1>robotics-ccpa-compliance-tracker</h1><div class="subtitle">Robotics GTM ccpa compliance tracker service · port 50715</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50715</div>

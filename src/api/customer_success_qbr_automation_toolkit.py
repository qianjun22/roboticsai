...
PORT = 12707
SERVICE = "customer-success-qbr-automation"
DESCRIPTION = "Automates quarterly business review preparation for enterprise robotics customers — data gathering, slide generation, and action tracking"

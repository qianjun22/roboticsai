...
PORT = 50923
SERVICE = "robotics-product-led-growth-engine"
DESCRIPTION = "Robotics GTM product led growth engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-product-led-growth-engine</title><style>
...
<div class="header"><h1>robotics-product-led-growth-engine</h1><div class="subtitle">Robotics GTM product led growth engine service · port 50923</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50923</div>

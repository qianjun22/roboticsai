...
PORT = 11581
SERVICE = "account-based-marketing-optimizer"
DESCRIPTION = "Optimizes ABM campaigns targeting robotics startup decision-makers with personalized content and multi-touch attribution"

...
PORT = 11669
SERVICE = "product-differentiation-engine"
DESCRIPTION = "Analyzes and sharpens product differentiation messaging based on competitive landscape, customer feedback, and win/loss data"

...
PORT = 52355
SERVICE = "robotics-plg-experiment-runner"
DESCRIPTION = "Robotics GTM plg experiment runner service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-plg-experiment-runner</title><style>
...
<div class="header"><h1>robotics-plg-experiment-runner</h1><div class="subtitle">Robotics GTM plg experiment runner service · port 52355</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52355</div>

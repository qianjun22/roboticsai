...
PORT = 13139
SERVICE = "robotics_customer_advocacy_platform"
DESCRIPTION = "Customer advocacy platform for cultivating robotics champions, reference programs, and peer community"

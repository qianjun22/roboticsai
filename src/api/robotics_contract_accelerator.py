...
PORT = 15305
SERVICE = "robotics-contract-accelerator"
DESCRIPTION = "GTM platform for contract accelerator automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-contract-accelerator</title><style>
...
<div class="header"><h1>robotics-contract-accelerator</h1><div class="sub">GTM platform for contract accelerator automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15305 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15151
SERVICE = "robotics-whitespace-analyzer"
DESCRIPTION = "GTM platform for whitespace analyzer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-whitespace-analyzer</title><style>
...
<div class="header"><h1>robotics-whitespace-analyzer</h1><div class="sub">GTM platform for whitespace analyzer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15151 | <b>Status:</b> <span style="color:#4ade80">Live</span>

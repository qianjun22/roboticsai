...
DESCRIPTION = "GTM platform for whitespace analyzer automation"
...
<div class="header"><h1>robotics-whitespace-analyzer</h1><div class="sub">GTM platform for whitespace analyzer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15393 | <b>Status:</b> <span style="color:#4ade80">Live</span>

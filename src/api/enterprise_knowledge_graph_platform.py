...
PORT = 11885
SERVICE = "enterprise_knowledge_graph_platform"
DESCRIPTION = "Enterprise knowledge graph platform for organizational expertise mapping, cross-team knowledge discovery, and institutional memory preservation"

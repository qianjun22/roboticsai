...
PORT = 13769
SERVICE = "robotics_launch_readiness_v2"
DESCRIPTION = "Robotics launch readiness service v2 — pre-launch checklist automation and go/no-go decision support for robotics product releases"

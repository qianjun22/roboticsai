...
PORT = 13017
SERVICE = "robotics_ecosystem_partner_analytics"
DESCRIPTION = "Ecosystem partner analytics for robotics platform — tracks integration usage, co-sell contributions, and partner-sourced pipeline by tier"

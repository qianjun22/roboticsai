...
PORT = 13779
SERVICE = "robotics_partner_co_sell_v4"
DESCRIPTION = "Robotics partner co-sell platform v4 — joint pipeline management, co-sell motion automation, and partner revenue attribution for robotics"

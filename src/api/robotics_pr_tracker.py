...
PORT = 15279
SERVICE = "robotics-pr-tracker"
DESCRIPTION = "GTM platform for pr tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pr-tracker</title><style>
...
<div class="header"><h1>robotics-pr-tracker</h1><div class="sub">GTM platform for pr tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15279 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
DESCRIPTION = "GTM platform for exec dashboard automation"
...
<div class="header"><h1>robotics-exec-dashboard</h1><div class="sub">GTM platform for exec dashboard automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15157 | <b>Status:</b> <span style="color:#4ade80">Live</span>

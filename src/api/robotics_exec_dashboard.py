...
PORT = 15355
SERVICE = "robotics-exec-dashboard"
DESCRIPTION = "GTM platform for exec dashboard optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-exec-dashboard</title><style>
...
<div class="header"><h1>robotics-exec-dashboard</h1><div class="sub">GTM platform for exec dashboard optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15355 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15265
SERVICE = "robotics-forecast-accuracy"
DESCRIPTION = "GTM platform for forecast accuracy automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-forecast-accuracy</title><style>
...
<div class="header"><h1>robotics-forecast-accuracy</h1><div class="sub">GTM platform for forecast accuracy automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15265 | <b>Status:</b> <span style="color:#4ade80">Live</span>

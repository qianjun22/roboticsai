...
PORT = 12927
SERVICE = "robotics_oci_preferred_cloud_dashboard"
DESCRIPTION = "Tracks OCI preferred cloud status in NVIDIA robotics ecosystem — partner program metrics, joint customer wins, co-sell pipeline, and NVIDIA relationship health"

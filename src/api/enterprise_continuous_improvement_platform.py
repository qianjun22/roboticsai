...
PORT = 12247
SERVICE = "enterprise-continuous-improvement-platform"
DESCRIPTION = "Continuous improvement platform applying Kaizen methodologies to robot fleet operations — defect root cause analysis, process standardization, and improvement cycle tracking"

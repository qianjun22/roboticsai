...
PORT = 12921
SERVICE = "robotics_partner_joint_go_to_market_planner"
DESCRIPTION = "Plans joint GTM motions with robotics partners — co-sell plays, demand generation campaigns, pipeline attribution, and quarterly business reviews"

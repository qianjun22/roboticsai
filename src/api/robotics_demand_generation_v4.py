...
PORT = 13795
SERVICE = "robotics_demand_generation_v4"
DESCRIPTION = "Robotics demand generation service v4 — inbound and outbound demand orchestration, lead scoring, and pipeline contribution for robotics cloud"

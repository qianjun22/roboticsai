...
DESCRIPTION = "GTM platform for demo scheduler automation"
...
<div class="header"><h1>robotics-demo-scheduler</h1><div class="sub">GTM platform for demo scheduler automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15377 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15135
SERVICE = "robotics-demo-scheduler"
DESCRIPTION = "GTM platform for demo scheduler optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-demo-scheduler</title><style>
...
<div class="header"><h1>robotics-demo-scheduler</h1><div class="sub">GTM platform for demo scheduler optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15135 | <b>Status:</b> <span style="color:#4ade80">Live</span>

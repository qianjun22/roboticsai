...
PORT = 15225
SERVICE = "robotics-revenue-acceleration"
DESCRIPTION = "GTM platform for revenue acceleration automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-revenue-acceleration</title><style>
...
<div class="header"><h1>robotics-revenue-acceleration</h1><div class="sub">GTM platform for revenue acceleration automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15225 | <b>Status:</b> <span style="color:#4ade80">Live</span>

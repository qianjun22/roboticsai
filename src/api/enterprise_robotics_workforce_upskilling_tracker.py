...
PORT = 12679
SERVICE = "enterprise-robotics-workforce-upskilling"
DESCRIPTION = "Tracks workforce upskilling programs for enterprise robotics operators — certifications, skills matrices, and training ROI"

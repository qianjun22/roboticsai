...
PORT = 12215
SERVICE = "enterprise-data-sovereignty-compliance-hub"
DESCRIPTION = "Data sovereignty compliance hub ensuring robot training data and inference logs meet regional data residency requirements across OCI multi-region deployments"

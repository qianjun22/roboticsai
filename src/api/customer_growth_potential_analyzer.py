...
PORT = 11783
SERVICE = "customer-growth-potential-analyzer"
DESCRIPTION = "Customer growth potential analyzer for whitespace mapping, expansion scoring, and cross-sell opportunity ranking"

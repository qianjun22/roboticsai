...
PORT = 12509
SERVICE = "enterprise_robotics_downtime_cost_calculator"
DESCRIPTION = "Enterprise robotics downtime cost calculator quantifying production loss, maintenance costs, and SLA penalty exposure per failure event"

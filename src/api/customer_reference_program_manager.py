...
PORT = 11619
SERVICE = "customer-reference-program-manager"
DESCRIPTION = "Manages customer reference program including reference requests, peer matching, case study pipeline, and speaker bureau"

...
PORT = 12885
SERVICE = "robotics_ai_ethics_framework_tracker"
DESCRIPTION = "Tracks AI ethics framework compliance for robotics — bias audits, explainability requirements, human oversight checkpoints, and incident logging"

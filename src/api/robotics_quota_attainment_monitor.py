...
PORT = 50759
SERVICE = "robotics-quota-attainment-monitor"
DESCRIPTION = "Robotics GTM quota attainment monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-quota-attainment-monitor</title><style>
...
<div class="header"><h1>robotics-quota-attainment-monitor</h1><div class="subtitle">Robotics GTM quota attainment monitor service · port 50759</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50759</div>

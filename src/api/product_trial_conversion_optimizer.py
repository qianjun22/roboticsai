...
PORT = 11743
SERVICE = "product-trial-conversion-optimizer"
DESCRIPTION = "Product trial conversion optimizer for freemium-to-paid funnel analysis and activation trigger identification"

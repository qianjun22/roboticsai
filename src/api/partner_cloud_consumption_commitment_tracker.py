...
PORT = 12727
SERVICE = "partner-cloud-consumption-commitment-tracker"
DESCRIPTION = "Tracks cloud consumption commitments for robotics channel partners — OCI credits, burn-down rate, and renewal forecasts"

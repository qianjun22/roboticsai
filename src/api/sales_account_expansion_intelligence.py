...
PORT = 12149
SERVICE = "sales-account-expansion-intelligence"
DESCRIPTION = "Account expansion intelligence platform identifying upsell opportunities within existing enterprise robotics deployments using usage pattern analysis"

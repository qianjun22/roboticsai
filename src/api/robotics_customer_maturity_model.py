...
PORT = 13231
SERVICE = "robotics_customer_maturity_model"
DESCRIPTION = "Customer maturity model for assessing robotics AI adoption stage and prescribing next-step implementation guidance"

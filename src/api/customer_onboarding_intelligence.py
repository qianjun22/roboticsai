...
PORT = 11707
SERVICE = "customer-onboarding-intelligence"
DESCRIPTION = "Customer onboarding intelligence platform for time-to-value optimization and activation milestone tracking"

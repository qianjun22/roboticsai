"""Investor Due Diligence Kit — structured DD data room with automated Q&A and document tracking.
...
PORT = 10687
SERVICE = "investor_due_diligence_kit"
DESCRIPTION = "Structured DD data room with automated Q&A and document completeness tracking"

...
PORT = 12583
SERVICE = "partner_pipeline_acceleration_platform"
DESCRIPTION = "Partner pipeline acceleration platform providing deal coaching, proof-of-value templates, and executive sponsor matching for faster close"

...
PORT = 12529
SERVICE = "partner_sales_acceleration_program"
DESCRIPTION = "Partner sales acceleration program with deal coaching, competitive battlecard distribution, and live pipeline review orchestration"

...
PORT = 50827
SERVICE = "robotics-technical-content-engine"
DESCRIPTION = "Robotics GTM technical content engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-content-engine</title><style>
...
<div class="header"><h1>robotics-technical-content-engine</h1><div class="subtitle">Robotics GTM technical content engine service · port 50827</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50827</div>

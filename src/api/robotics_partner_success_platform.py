...
PORT = 13345
SERVICE = "robotics_partner_success_platform"
DESCRIPTION = "Partner success platform for tracking partner-deployed customer outcomes and driving expansion through robotics ecosystem"

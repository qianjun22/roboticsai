"""Growth Metrics Dashboard V2 — real-time ARR, NRR, and Rule-of-40 board metrics dashboard.
...
PORT = 10699
SERVICE = "growth_metrics_dashboard_v2"
DESCRIPTION = "Real-time ARR, NRR, and Rule-of-40 board metrics with cohort drill-down"

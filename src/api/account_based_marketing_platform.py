"""Account based marketing platform — personalized multi-touch campaigns for 25 tier-1 NVIDIA-partner robotics accounts with 4.2x ROI vs non-ABM
...
DESCRIPTION = "Account based marketing platform — personalized multi-touch campaigns for 25 tier-1 NVIDIA-partner robotics accounts with 4.2x ROI vs non-ABM"
if _has_fastapi:

...
PORT = 11933
SERVICE = "sales_customer_reference_program"
DESCRIPTION = "Sales customer reference program for reference matching, peer testimonial orchestration, and reference activity ROI measurement"

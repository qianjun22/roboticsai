...
PORT = 12113
SERVICE = "partner-innovation-showcase-platform"
DESCRIPTION = "Partner innovation showcase platform for demonstrating joint robotics solutions to enterprise buyers"

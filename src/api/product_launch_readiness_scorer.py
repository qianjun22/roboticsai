...
PORT = 11661
SERVICE = "product-launch-readiness-scorer"
DESCRIPTION = "Scores product launch readiness across engineering, sales, support, marketing, and partner enablement dimensions"

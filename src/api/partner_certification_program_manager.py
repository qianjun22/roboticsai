...
PORT = 12481
SERVICE = "partner_certification_program_manager"
DESCRIPTION = "Partner certification program manager tracking technical training completion, exam results, and competency badge issuance for robotics integrators"

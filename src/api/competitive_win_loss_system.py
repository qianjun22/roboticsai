"""Competitive win-loss system — automated capture of deal outcomes via Gong analysis, ML pattern detection, and product feedback loops for roadmap signals
...
try:
    ...
    _has_fastapi = False
PORT = 10933
SERVICE = "competitive_win_loss_system"
DESCRIPTION = "Competitive win-loss system — automated capture of deal outcomes via Gong analysis, ML pattern detection, and product feedback loops for roadmap signals"
if _has_fastapi:

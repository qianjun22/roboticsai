...
PORT = 12775
SERVICE = "robotics_talent_acquisition_tracker"
DESCRIPTION = "Tracks robotics AI talent pipeline — candidate sourcing, technical interview scoring, offer status, and competitive compensation benchmarks"

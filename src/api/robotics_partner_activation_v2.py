...
PORT = 13211
SERVICE = "robotics_partner_activation_v2"
DESCRIPTION = "Partner activation v2 for accelerating new partner onboarding, first deal, and joint pipeline generation"

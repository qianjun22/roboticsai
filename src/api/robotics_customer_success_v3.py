...
PORT = 13073
SERVICE = "robotics_customer_success_v3"
DESCRIPTION = "Customer success v3 for robotics platform — proactive health monitoring, QBR automation, and expansion opportunity identification at scale"

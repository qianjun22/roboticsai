...
PORT = 40491
SERVICE = "robotics_pilot_tracker"
DESCRIPTION = "GTM service: pilot tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_pilot_tracker</title><style>
...
<div class="header"><h1>robotics_pilot_tracker</h1><div class="subtitle">GTM service: pilot tracker port 40491</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40491</div>

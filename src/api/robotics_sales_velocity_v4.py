...
PORT = 13809
SERVICE = "robotics_sales_velocity_v4"
DESCRIPTION = "Robotics sales velocity platform v4 — deal speed optimization, cycle time reduction, and velocity metrics for robotics enterprise deals"

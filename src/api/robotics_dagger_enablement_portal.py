...
PORT = 50145
SERVICE = "robotics-dagger-enablement-portal"
DESCRIPTION = "Robotics GTM dagger enablement portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-enablement-portal</title><style>
...
<div class="header"><h1>robotics-dagger-enablement-portal</h1><div class="subtitle">Robotics GTM dagger enablement portal service · port 50145</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50145</div>

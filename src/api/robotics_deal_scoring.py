...
PORT = 15027
SERVICE = "robotics-deal-scoring"
DESCRIPTION = "GTM platform for deal scoring optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-deal-scoring</title><style>
...
<div class="header"><h1>robotics-deal-scoring</h1><div class="sub">GTM platform for deal scoring optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15027 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
DESCRIPTION = "GTM platform for deal scoring automation"
...
<div class="header"><h1>robotics-deal-scoring</h1><div class="sub">GTM platform for deal scoring automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15269 | <b>Status:</b> <span style="color:#4ade80">Live</span>

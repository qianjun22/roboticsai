...
PORT = 11889
SERVICE = "sales_incentive_compensation_optimizer"
DESCRIPTION = "Sales incentive compensation optimizer for commission plan modeling, accelerator threshold analysis, and rep motivation scoring"

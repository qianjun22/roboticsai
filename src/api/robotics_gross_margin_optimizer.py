...
PORT = 12789
SERVICE = "robotics_gross_margin_optimizer"
DESCRIPTION = "Optimizes gross margin for robotics cloud services — compute cost allocation, pricing tier analysis, and margin improvement recommendations"

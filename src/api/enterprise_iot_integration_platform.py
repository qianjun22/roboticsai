...
PORT = 12137
SERVICE = "enterprise-iot-integration-platform"
DESCRIPTION = "Enterprise IoT integration platform connecting robot fleets with industrial sensors, PLCs, and SCADA systems for unified operations"

...
PORT = 50995
SERVICE = "robotics-custom-demo-builder"
DESCRIPTION = "Robotics GTM custom demo builder service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-custom-demo-builder</title><style>
...
<div class="header"><h1>robotics-custom-demo-builder</h1><div class="subtitle">Robotics GTM custom demo builder service · port 50995</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50995</div>

...
PORT = 13807
SERVICE = "robotics_channel_partner_v5"
DESCRIPTION = "Robotics channel partner platform v5 — reseller pipeline management, deal registration, and channel incentive automation for robotics distribution"

...
PORT = 12711
SERVICE = "sales-incentive-compensation-calculator"
DESCRIPTION = "Calculates sales incentive compensation for enterprise robotics reps — accelerators, SPIFs, and quota attainment tiers"

...
PORT = 12143
SERVICE = "sales-competitive-intelligence-radar"
DESCRIPTION = "Real-time competitive intelligence radar tracking competitor product launches, pricing changes, and customer wins/losses for robotics sales teams"

...
PORT = 38557
SERVICE = "robotics_reference_customer_db"
DESCRIPTION = "GTM service: reference customer db"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_reference_customer_db</title><style>
...
<div class="header"><h1>robotics_reference_customer_db</h1><div class="subtitle">GTM service: reference customer db port 38557</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38557</div>

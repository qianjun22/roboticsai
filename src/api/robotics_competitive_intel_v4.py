...
PORT = 13803
SERVICE = "robotics_competitive_intel_v4"
DESCRIPTION = "Robotics competitive intelligence platform v4 — automated competitor tracking, battlecard generation, and win-rate analysis for robotics market"

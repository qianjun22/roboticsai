...
PORT = 12969
SERVICE = "robotics_developer_relations_hub"
DESCRIPTION = "Developer relations hub for robotics platform — manages community engagement, hackathon coordination, and developer advocate programs"

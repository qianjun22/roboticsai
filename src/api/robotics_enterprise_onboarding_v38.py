...
PORT = 38567
SERVICE = "robotics_enterprise_onboarding"
DESCRIPTION = "GTM service: enterprise onboarding"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_enterprise_onboarding</title><style>
...
<div class="header"><h1>robotics_enterprise_onboarding</h1><div class="subtitle">GTM service: enterprise onboarding port 38567</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38567</div>

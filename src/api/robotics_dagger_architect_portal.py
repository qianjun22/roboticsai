...
PORT = 50233
SERVICE = "robotics-dagger-architect-portal"
DESCRIPTION = "Robotics GTM dagger architect portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-architect-portal</title><style>
...
<div class="header"><h1>robotics-dagger-architect-portal</h1><div class="subtitle">Robotics GTM dagger architect portal service · port 50233</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50233</div>

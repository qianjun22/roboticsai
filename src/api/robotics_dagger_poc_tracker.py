...
PORT = 50949
SERVICE = "robotics-dagger-poc-tracker"
DESCRIPTION = "Robotics GTM dagger poc tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-poc-tracker</title><style>
...
<div class="header"><h1>robotics-dagger-poc-tracker</h1><div class="subtitle">Robotics GTM dagger poc tracker service · port 50949</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50949</div>

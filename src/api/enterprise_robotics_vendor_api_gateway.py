...
PORT = 12393
SERVICE = "enterprise_robotics_vendor_api_gateway"
DESCRIPTION = "Enterprise robotics vendor API gateway for third-party hardware integration and unified telemetry"

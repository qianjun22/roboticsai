...
PORT = 12991
SERVICE = "robotics_demand_generation_hub"
DESCRIPTION = "Demand generation hub for robotics platform — coordinates webinars, content syndication, and inbound lead capture across all marketing channels"

...
PORT = 50639
SERVICE = "robotics-territory-planning-tool"
DESCRIPTION = "Robotics GTM territory planning tool service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-territory-planning-tool</title><style>
...
<div class="header"><h1>robotics-territory-planning-tool</h1><div class="subtitle">Robotics GTM territory planning tool service · port 50639</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50639</div>

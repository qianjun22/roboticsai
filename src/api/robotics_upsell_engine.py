...
DESCRIPTION = "GTM platform for upsell engine automation"
...
<div class="header"><h1>robotics-upsell-engine</h1><div class="sub">GTM platform for upsell engine automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15245 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15003
SERVICE = "robotics-upsell-engine"
DESCRIPTION = "GTM platform for upsell engine optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-upsell-engine</title><style>
...
<div class="header"><h1>robotics-upsell-engine</h1><div class="sub">GTM platform for upsell engine optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15003 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12243
SERVICE = "enterprise-robotics-insurance-platform"
DESCRIPTION = "Robotics insurance platform providing usage-based coverage recommendations, incident reporting, liability risk scoring, and claims management for enterprise robot fleets"

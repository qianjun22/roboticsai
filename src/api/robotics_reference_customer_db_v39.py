...
<div class="header"><h1>robotics_reference_customer_db</h1><div class="subtitle">GTM service: reference customer db port 39519</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39519</div>

...
PORT = 15283
SERVICE = "robotics-analyst-relations"
DESCRIPTION = "GTM platform for analyst relations optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-analyst-relations</title><style>
...
<div class="header"><h1>robotics-analyst-relations</h1><div class="sub">GTM platform for analyst relations optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15283 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 46837
SERVICE = "robotics_series_a_v19"
DESCRIPTION = "Series A robotics growth pipeline and fundraising tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_series_a_v19</title><style>
...
<div class="header"><h1>robotics_series_a_v19</h1><div class="subtitle">Series A robotics growth pipeline and fundraising tracker · port 46837</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46837</div>

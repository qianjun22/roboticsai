...
PORT = 12985
SERVICE = "robotics_channel_sales_tracker"
DESCRIPTION = "Channel sales tracker for robotics platform — manages reseller performance, deal registration, and co-sell pipeline with cloud providers"

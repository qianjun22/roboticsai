...
PORT = 15055
SERVICE = "robotics-pricing-optimizer"
DESCRIPTION = "GTM platform for pricing optimizer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pricing-optimizer</title><style>
...
<div class="header"><h1>robotics-pricing-optimizer</h1><div class="sub">GTM platform for pricing optimizer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15055 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
DESCRIPTION = "GTM platform for pricing optimizer automation"
...
<div class="header"><h1>robotics-pricing-optimizer</h1><div class="sub">GTM platform for pricing optimizer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15297 | <b>Status:</b> <span style="color:#4ade80">Live</span>

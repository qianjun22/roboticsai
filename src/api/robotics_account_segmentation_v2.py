...
PORT = 13643
SERVICE = "robotics_account_segmentation_v2"
DESCRIPTION = "Robotics account segmentation and prioritization platform v2 — applies AI-driven scoring to classify accounts by revenue potential, automation readiness, and competitive exposure, enabling focused sales resource allocation"

...
PORT = 12219
SERVICE = "enterprise-human-robot-collaboration-hub"
DESCRIPTION = "Human-robot collaboration hub providing safety protocols, task handoff workflows, and ergonomics analytics for enterprises deploying cobots alongside human workers"

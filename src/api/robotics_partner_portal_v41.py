...
PORT = 41615
SERVICE = "robotics_partner_portal"
DESCRIPTION = "GTM service: partner portal"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_partner_portal</title><style>
...
<div class="header"><h1>robotics_partner_portal</h1><div class="subtitle">GTM service: partner portal port 41615</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41615</div>

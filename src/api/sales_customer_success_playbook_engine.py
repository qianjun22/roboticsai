...
PORT = 12163
SERVICE = "sales-customer-success-playbook-engine"
DESCRIPTION = "Customer success playbook engine generating personalized onboarding and expansion plans based on enterprise robotics deployment patterns and health signals"

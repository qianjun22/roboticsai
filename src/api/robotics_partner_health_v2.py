...
PORT = 13281
SERVICE = "robotics_partner_health_v2"
DESCRIPTION = "Partner health v2 for scoring robotics ecosystem partners on deal activity, certification status, and customer outcomes"

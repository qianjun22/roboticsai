...
PORT = 12703
SERVICE = "sales-account-tiering-segmentation"
DESCRIPTION = "Dynamic account tiering and segmentation engine for enterprise robotics — strategic, growth, and transactional tiers"

...
PORT = 12609
SERVICE = "partner-co-sell-pipeline-tracker"
DESCRIPTION = "Tracks co-sell pipeline activity with robotics channel partners — opportunity status and revenue attribution"

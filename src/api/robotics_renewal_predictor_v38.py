...
PORT = 39191
SERVICE = "robotics_renewal_predictor"
DESCRIPTION = "GTM service: renewal predictor"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_renewal_predictor</title><style>
...
<div class="header"><h1>robotics_renewal_predictor</h1><div class="subtitle">GTM service: renewal predictor port 39191</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39191</div>

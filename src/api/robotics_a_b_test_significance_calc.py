...
PORT = 40861
SERVICE = "robotics_a_b_test_significance_calc"
DESCRIPTION = "GTM analytics: A/B test significance calculator for robotics market expansion"
...
<div class="header"><h1>{SERVICE}</h1><div class="subtitle">{DESCRIPTION} port {PORT}</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> {PORT}</div>

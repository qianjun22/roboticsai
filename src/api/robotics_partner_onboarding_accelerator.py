...
PORT = 50819
SERVICE = "robotics-partner-onboarding-accelerator"
DESCRIPTION = "Robotics GTM partner onboarding accelerator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-onboarding-accelerator</title><style>
...
<div class="header"><h1>robotics-partner-onboarding-accelerator</h1><div class="subtitle">Robotics GTM partner onboarding accelerator service · port 50819</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50819</div>

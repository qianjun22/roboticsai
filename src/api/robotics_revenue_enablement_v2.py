...
PORT = 13501
SERVICE = "robotics_revenue_enablement_v2"
DESCRIPTION = "Robotics revenue enablement v2 — sales tooling, deal acceleration, and revenue pipeline management for OCI Robot Cloud commercial growth"

...
PORT = 13099
SERVICE = "robotics_customer_success_lifecycle"
DESCRIPTION = "Customer success lifecycle health score optimizer for maximizing net revenue retention in robotics"

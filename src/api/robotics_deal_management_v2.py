...
PORT = 13627
SERVICE = "robotics_deal_management_v2"
DESCRIPTION = "Robotics enterprise deal management platform v2 — orchestrates complex multi-stakeholder deals with structured approval workflows, discount governance, and executive escalation paths for large robotics contracts"

...
PORT = 51047
SERVICE = "robotics-scalability-assessment-svc"
DESCRIPTION = "Robotics GTM scalability assessment svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-scalability-assessment-svc</title><style>
...
<div class="header"><h1>robotics-scalability-assessment-svc</h1><div class="subtitle">Robotics GTM scalability assessment svc service · port 51047</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51047</div>

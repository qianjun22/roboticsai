...
PORT = 50747
SERVICE = "robotics-c-suite-engagement-engine"
DESCRIPTION = "Robotics GTM c suite engagement engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-c-suite-engagement-engine</title><style>
...
<div class="header"><h1>robotics-c-suite-engagement-engine</h1><div class="subtitle">Robotics GTM c suite engagement engine service · port 50747</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50747</div>

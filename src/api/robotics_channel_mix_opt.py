...
DESCRIPTION = "GTM platform for channel mix opt automation"
...
<div class="header"><h1>robotics-channel-mix-opt</h1><div class="sub">GTM platform for channel mix opt automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15045 | <b>Status:</b> <span style="color:#4ade80">Live</span>

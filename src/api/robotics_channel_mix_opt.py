...
PORT = 15243
SERVICE = "robotics-channel-mix-opt"
DESCRIPTION = "GTM platform for channel mix opt optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-channel-mix-opt</title><style>
...
<div class="header"><h1>robotics-channel-mix-opt</h1><div class="sub">GTM platform for channel mix opt optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15243 | <b>Status:</b> <span style="color:#4ade80">Live</span>

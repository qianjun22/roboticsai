...
PORT = 12547
SERVICE = "enterprise_robotics_integration_complexity_scorer"
DESCRIPTION = "Enterprise robotics integration complexity scorer assessing MES, ERP, and WMS connectivity requirements for deployment scoping"

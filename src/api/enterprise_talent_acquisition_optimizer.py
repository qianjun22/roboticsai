...
PORT = 11777
SERVICE = "enterprise-talent-acquisition-optimizer"
DESCRIPTION = "Enterprise talent acquisition optimizer for pipeline velocity, offer acceptance rates, and hiring funnel analytics"

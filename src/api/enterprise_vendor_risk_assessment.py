...
PORT = 12087
SERVICE = "enterprise-vendor-risk-assessment"
DESCRIPTION = "Enterprise vendor risk assessment platform for evaluating robotics hardware and software suppliers"

...
PORT = 12431
SERVICE = "sales_channel_partner_scorecard"
DESCRIPTION = "Sales channel partner scorecard tracking partner performance, deal registration, enablement completion, and revenue contribution"

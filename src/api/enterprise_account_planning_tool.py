...
PORT = 11687
SERVICE = "enterprise-account-planning-tool"
DESCRIPTION = "Enterprise account planning tool for strategic opportunity mapping and executive relationship tracking"

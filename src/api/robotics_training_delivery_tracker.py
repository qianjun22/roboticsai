...
PORT = 52587
SERVICE = "robotics-training-delivery-tracker"
DESCRIPTION = "Robotics GTM training delivery tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-training-delivery-tracker</title><style>
...
<div class="header"><h1>robotics-training-delivery-tracker</h1><div class="subtitle">Robotics GTM training delivery tracker service · port 52587</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52587</div>

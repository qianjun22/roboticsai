...
PORT = 52767
SERVICE = "robotics-mdf-management-svc"
DESCRIPTION = "Robotics GTM mdf management svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-mdf-management-svc</title><style>
...
<div class="header"><h1>robotics-mdf-management-svc</h1><div class="subtitle">Robotics GTM mdf management svc service · port 52767</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52767</div>

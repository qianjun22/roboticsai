...
PORT = 13223
SERVICE = "robotics_cohort_retention_analyzer"
DESCRIPTION = "Cohort retention analyzer for measuring multi-year customer stickiness and expansion in robotics cloud"

...
PORT = 50915
SERVICE = "robotics-tech-talk-scheduler"
DESCRIPTION = "Robotics GTM tech talk scheduler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-tech-talk-scheduler</title><style>
...
<div class="header"><h1>robotics-tech-talk-scheduler</h1><div class="subtitle">Robotics GTM tech talk scheduler service · port 50915</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50915</div>

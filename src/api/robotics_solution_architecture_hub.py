...
PORT = 13047
SERVICE = "robotics_solution_architecture_hub"
DESCRIPTION = "Solution architecture hub for robotics platform — stores reference architectures, integration patterns, and deployment blueprints for common use cases"

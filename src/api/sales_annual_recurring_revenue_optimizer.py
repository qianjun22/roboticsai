...
PORT = 12187
SERVICE = "sales-annual-recurring-revenue-optimizer"
DESCRIPTION = "ARR optimization platform modeling pricing strategies, contract structures, and expansion levers to maximize annual recurring revenue from robotics enterprise accounts"

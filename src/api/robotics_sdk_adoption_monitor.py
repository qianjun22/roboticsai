...
PORT = 50895
SERVICE = "robotics-sdk-adoption-monitor"
DESCRIPTION = "Robotics GTM sdk adoption monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sdk-adoption-monitor</title><style>
...
<div class="header"><h1>robotics-sdk-adoption-monitor</h1><div class="subtitle">Robotics GTM sdk adoption monitor service · port 50895</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50895</div>

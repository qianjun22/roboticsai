...
PORT = 12067
SERVICE = "enterprise-digital-operations-platform"
DESCRIPTION = "Enterprise digital operations platform for integrating robot data into business intelligence systems"

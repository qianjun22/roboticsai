...
PORT = 12823
SERVICE = "robotics_ai_safety_red_team_tracker"
DESCRIPTION = "Tracks AI safety red team exercises for robotics — adversarial scenarios, failure modes discovered, mitigations applied, and residual risk scoring"

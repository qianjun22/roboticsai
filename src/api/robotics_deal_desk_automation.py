...
PORT = 50623
SERVICE = "robotics-deal-desk-automation"
DESCRIPTION = "Robotics GTM deal desk automation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-deal-desk-automation</title><style>
...
<div class="header"><h1>robotics-deal-desk-automation</h1><div class="subtitle">Robotics GTM deal desk automation service · port 50623</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50623</div>

...
PORT = 15237
SERVICE = "robotics-account-growth"
DESCRIPTION = "GTM platform for account growth automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-account-growth</title><style>
...
<div class="header"><h1>robotics-account-growth</h1><div class="sub">GTM platform for account growth automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15237 | <b>Status:</b> <span style="color:#4ade80">Live</span>

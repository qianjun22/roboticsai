...
DESCRIPTION = "GTM platform for health scorer automation"
...
<div class="header"><h1>robotics-health-scorer</h1><div class="sub">GTM platform for health scorer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15313 | <b>Status:</b> <span style="color:#4ade80">Live</span>

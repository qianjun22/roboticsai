...
PORT = 15071
SERVICE = "robotics-health-scorer"
DESCRIPTION = "GTM platform for health scorer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-health-scorer</title><style>
...
<div class="header"><h1>robotics-health-scorer</h1><div class="sub">GTM platform for health scorer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15071 | <b>Status:</b> <span style="color:#4ade80">Live</span>

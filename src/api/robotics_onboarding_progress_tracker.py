...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-onboarding-progress-tracker</title><style>
...
<div class="header"><h1>robotics-onboarding-progress-tracker</h1><div class="subtitle">Robotics GTM onboarding progress tracker service · port 51799</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51799</div>

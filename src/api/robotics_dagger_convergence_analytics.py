...
PORT = 12929
SERVICE = "robotics_dagger_convergence_analytics"
DESCRIPTION = "Analytics for DAgger training convergence — intervention rate decay curves, policy improvement per iteration, and early stopping recommendations"

...
PORT = 12157
SERVICE = "enterprise-procurement-automation-hub"
DESCRIPTION = "Enterprise procurement automation hub streamlining robot hardware/software purchasing with vendor evaluation, RFP generation, and contract management"

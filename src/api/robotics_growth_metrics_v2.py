...
PORT = 13541
SERVICE = "robotics_growth_metrics_v2"
DESCRIPTION = "Growth metrics service v2 — tracks ARR growth, customer acquisition rates, expansion revenue, and cohort analysis for the robotics cloud platform"

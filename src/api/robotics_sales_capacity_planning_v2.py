...
PORT = 13747
SERVICE = "robotics_sales_capacity_planning_v2"
DESCRIPTION = "Robotics sales capacity planning v2 — headcount modeling, quota allocation, territory coverage, and ramp-time forecasting for robotics cloud"

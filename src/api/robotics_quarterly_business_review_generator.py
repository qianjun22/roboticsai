...
PORT = 12881
SERVICE = "robotics_quarterly_business_review_generator"
DESCRIPTION = "Auto-generates quarterly business review decks for robotics — pipeline health, product milestones, customer wins, and next-quarter OKRs"

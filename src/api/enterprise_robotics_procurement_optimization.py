...
PORT = 12467
SERVICE = "enterprise_robotics_procurement_optimization"
DESCRIPTION = "Enterprise robotics procurement optimization with vendor negotiation analytics, bulk pricing models, and lifecycle cost forecasting"

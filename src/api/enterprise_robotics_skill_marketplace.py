...
PORT = 12183
SERVICE = "enterprise-robotics-skill-marketplace"
DESCRIPTION = "Marketplace platform for discovering, purchasing, and deploying pre-trained robot skill modules across enterprise OCI Robot Cloud deployments"

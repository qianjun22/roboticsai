...
PORT = 11967
SERVICE = "sales_social_selling_intelligence"
DESCRIPTION = "Sales social selling intelligence platform for LinkedIn engagement tracking, executive relationship mapping, and social signal-to-pipeline attribution"

...
PORT = 50887
SERVICE = "robotics-open-source-contribution-tracker"
DESCRIPTION = "Robotics GTM open source contribution tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-open-source-contribution-tracker</title><style>
...
<div class="header"><h1>robotics-open-source-contribution-tracker</h1><div class="subtitle">Robotics GTM open source contribution tracker service · port 50887</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50887</div>

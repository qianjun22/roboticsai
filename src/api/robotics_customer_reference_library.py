...
PORT = 13127
SERVICE = "robotics_customer_reference_library"
DESCRIPTION = "Customer reference library for curating case studies, ROI evidence, and proof points for robotics sales"

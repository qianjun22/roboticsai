...
PORT = 12463
SERVICE = "sales_account_based_marketing_engine"
DESCRIPTION = "Sales account-based marketing engine orchestrating targeted campaigns, intent signals, and personalized outreach for strategic robotics accounts"

...
DESCRIPTION = "GTM platform for benefit delivery automation"
...
<div class="header"><h1>robotics-benefit-delivery</h1><div class="sub">GTM platform for benefit delivery automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15117 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15315
SERVICE = "robotics-benefit-delivery"
DESCRIPTION = "GTM platform for benefit delivery optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-benefit-delivery</title><style>
...
<div class="header"><h1>robotics-benefit-delivery</h1><div class="sub">GTM platform for benefit delivery optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15315 | <b>Status:</b> <span style="color:#4ade80">Live</span>

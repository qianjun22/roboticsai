...
PORT = 13361
SERVICE = "robotics_platform_roadmap_v2"
DESCRIPTION = "Platform roadmap v2 for sequencing OCI Robot Cloud infrastructure investments aligned to NVIDIA stack releases and customer demand"

...
PORT = 12845
SERVICE = "robotics_product_usage_telemetry_v2"
DESCRIPTION = "Second-generation product usage telemetry — feature adoption heatmaps, session analytics, and usage-based pricing signal generation"

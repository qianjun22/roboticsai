...
PORT = 12437
SERVICE = "sales_enterprise_reference_program"
DESCRIPTION = "Sales enterprise reference program managing customer advocates, case study development, and reference call coordination"

...
PORT = 12419
SERVICE = "enterprise_robotics_fleet_insurance_hub"
DESCRIPTION = "Enterprise robotics fleet insurance hub for automated liability coverage and claims management"

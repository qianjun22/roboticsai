...
PORT = 12373
SERVICE = "sales_global_account_management_hub"
DESCRIPTION = "Global account management hub for multinational robotics platform enterprise relationship coordination"

...
PORT = 13007
SERVICE = "robotics_vertical_expansion_planner"
DESCRIPTION = "Vertical expansion planner for robotics platform — prioritizes new industry verticals by TAM, competitive gap, and integration complexity"

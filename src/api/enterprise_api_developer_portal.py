...
PORT = 12233
SERVICE = "enterprise-api-developer-portal"
DESCRIPTION = "Developer portal providing enterprise robotics teams with OCI Robot Cloud API documentation, interactive sandboxes, SDKs, and integration tutorials"

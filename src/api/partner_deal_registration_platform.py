...
PORT = 12263
SERVICE = "partner-deal-registration-platform"
DESCRIPTION = "Deal registration platform allowing OCI Robot Cloud partners to register opportunities, protect margins, and coordinate with Oracle sales on joint pursuit strategies"

...
PORT = 12369
SERVICE = "partner_solution_architecture_hub"
DESCRIPTION = "Partner solution architecture hub for robotics platform reference designs and integration blueprints"

...
PORT = 11873
SERVICE = "enterprise_ai_governance_platform"
DESCRIPTION = "Enterprise AI governance platform for model risk tracking, bias monitoring, regulatory compliance reporting, and AI audit trail management"

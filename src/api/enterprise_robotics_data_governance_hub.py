...
PORT = 12333
SERVICE = "enterprise_robotics_data_governance_hub"
DESCRIPTION = "Enterprise robotics data governance hub for training data privacy compliance and lineage tracking"

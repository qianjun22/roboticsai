...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-twitter-engagement-tracker</title><style>
...
<div class="header"><h1>robotics-twitter-engagement-tracker</h1><div class="subtitle">Robotics GTM twitter engagement tracker service · port 51987</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51987</div>

...
PORT = 12889
SERVICE = "robotics_sales_forecasting_engine_v2"
DESCRIPTION = "Second-generation sales forecasting for robotics — ML-based pipeline scoring, scenario modeling, and rep-level commit accuracy tracking"

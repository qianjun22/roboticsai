...
PORT = 13115
SERVICE = "robotics_knowledge_base_engine"
DESCRIPTION = "Knowledge base engine for organizing robotics integration docs, troubleshooting guides, and best practices"

...
PORT = 50203
SERVICE = "robotics-api-usage-analytics-svc"
DESCRIPTION = "Robotics GTM api usage analytics svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-api-usage-analytics-svc</title><style>
...
<div class="header"><h1>robotics-api-usage-analytics-svc</h1><div class="subtitle">Robotics GTM api usage analytics svc service · port 50203</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50203</div>

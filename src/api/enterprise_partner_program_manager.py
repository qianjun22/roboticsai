...
PORT = 11771
SERVICE = "enterprise-partner-program-manager"
DESCRIPTION = "Enterprise partner program manager for tier management, MDF allocation, and program benefit tracking"

...
PORT = 12475
SERVICE = "enterprise_robotics_insurance_risk_profiler"
DESCRIPTION = "Enterprise robotics insurance risk profiler for liability assessment, coverage gap analysis, and risk mitigation recommendations"

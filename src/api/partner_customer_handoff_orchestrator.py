...
PORT = 12225
SERVICE = "partner-customer-handoff-orchestrator"
DESCRIPTION = "Customer handoff orchestrator managing smooth transitions from OCI Robot Cloud sales to partner-led implementation with SLA tracking and escalation workflows"

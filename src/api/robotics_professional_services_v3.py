...
PORT = 13773
SERVICE = "robotics_professional_services_v3"
DESCRIPTION = "Robotics professional services platform v3 — deployment consulting, integration support, and managed services for enterprise robotics"

...
PORT = 12599
SERVICE = "partner-ecosystem-revenue-attribution"
DESCRIPTION = "Multi-touch revenue attribution model for partner ecosystem contributions to robotics pipeline"

...
PORT = 50797
SERVICE = "robotics-dagger-professional-svc"
DESCRIPTION = "Robotics GTM dagger professional svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-professional-svc</title><style>
...
<div class="header"><h1>robotics-dagger-professional-svc</h1><div class="subtitle">Robotics GTM dagger professional svc service · port 50797</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50797</div>

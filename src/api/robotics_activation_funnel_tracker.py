...
PORT = 50239
SERVICE = "robotics-activation-funnel-tracker"
DESCRIPTION = "Robotics GTM activation funnel tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-activation-funnel-tracker</title><style>
...
<div class="header"><h1>robotics-activation-funnel-tracker</h1><div class="subtitle">Robotics GTM activation funnel tracker service · port 50239</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50239</div>

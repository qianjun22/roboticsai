...
PORT = 12659
SERVICE = "customer-expansion-revenue-predictor"
DESCRIPTION = "Predicts expansion revenue potential for enterprise robotics accounts based on usage growth and fleet size signals"

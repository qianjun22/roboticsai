...
PORT = 50367
SERVICE = "robotics-architecture-debt-tracker"
DESCRIPTION = "Robotics GTM architecture debt tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-architecture-debt-tracker</title><style>
...
<div class="header"><h1>robotics-architecture-debt-tracker</h1><div class="subtitle">Robotics GTM architecture debt tracker service · port 50367</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50367</div>

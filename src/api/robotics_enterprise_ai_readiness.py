...
PORT = 13197
SERVICE = "robotics_enterprise_ai_readiness"
DESCRIPTION = "Enterprise AI readiness assessor for evaluating customer infrastructure maturity for robotics cloud adoption"

...
PORT = 16803
SERVICE = "robotics_first_value_moment_v6"
DESCRIPTION = "Robotics GTM first value moment v6 with guided commissioning workflows and time-to-first-task metrics"

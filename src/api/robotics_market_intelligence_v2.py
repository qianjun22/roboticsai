...
PORT = 13283
SERVICE = "robotics_market_intelligence_v2"
DESCRIPTION = "Market intelligence v2 for tracking robotics cloud funding rounds, product launches, and competitive positioning shifts"

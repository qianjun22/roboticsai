...
PORT = 50883
SERVICE = "robotics-hackathon-organizer"
DESCRIPTION = "Robotics GTM hackathon organizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-hackathon-organizer</title><style>
...
<div class="header"><h1>robotics-hackathon-organizer</h1><div class="subtitle">Robotics GTM hackathon organizer service · port 50883</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50883</div>

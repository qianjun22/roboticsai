...
PORT = 12335
SERVICE = "sales_competitive_battlecard_generator"
DESCRIPTION = "Competitive battlecard generator for robotics platform sales enablement and objection handling"

...
PORT = 52731
SERVICE = "robotics-headcount-planning-svc"
DESCRIPTION = "Robotics GTM headcount planning svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-headcount-planning-svc</title><style>
...
<div class="header"><h1>robotics-headcount-planning-svc</h1><div class="subtitle">Robotics GTM headcount planning svc service · port 52731</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52731</div>

...
PORT = 13029
SERVICE = "robotics_technical_roadmap_communicator"
DESCRIPTION = "Technical roadmap communicator for robotics platform — translates engineering milestones into customer-facing capability timelines and release notes"

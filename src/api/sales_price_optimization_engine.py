...
PORT = 12191
SERVICE = "sales-price-optimization-engine"
DESCRIPTION = "Dynamic pricing optimization engine recommending optimal OCI Robot Cloud contract pricing based on deal size, competitive context, and customer strategic value"

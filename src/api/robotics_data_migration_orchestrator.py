...
PORT = 53987
SERVICE = "robotics-data-migration-orchestrator"
DESCRIPTION = "Robotics GTM data migration orchestrator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-data-migration-orchestrator</title><style>
...
<div class="header"><h1>robotics-data-migration-orchestrator</h1><div class="subtitle">Robotics GTM data migration orchestrator service · port 53987</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53987</div>

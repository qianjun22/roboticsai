...
PORT = 50531
SERVICE = "robotics-paid-media-optimizer"
DESCRIPTION = "Robotics GTM paid media optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-paid-media-optimizer</title><style>
...
<div class="header"><h1>robotics-paid-media-optimizer</h1><div class="subtitle">Robotics GTM paid media optimizer service · port 50531</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50531</div>

...
PORT = 12391
SERVICE = "partner_field_marketing_coordinator"
DESCRIPTION = "Partner field marketing coordinator for robotics platform regional event and campaign execution"

...
PORT = 11607
SERVICE = "partnership-pipeline-accelerator"
DESCRIPTION = "Accelerates partnership pipeline with automated outreach, co-sell coordination, and joint pipeline reviews"

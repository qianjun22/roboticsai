...
DESCRIPTION = "GTM platform for account segmenter automation"
...
<div class="header"><h1>robotics-account-segmenter</h1><div class="sub">GTM platform for account segmenter automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15033 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15231
SERVICE = "robotics-account-segmenter"
DESCRIPTION = "GTM platform for account segmenter optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-account-segmenter</title><style>
...
<div class="header"><h1>robotics-account-segmenter</h1><div class="sub">GTM platform for account segmenter optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15231 | <b>Status:</b> <span style="color:#4ade80">Live</span>

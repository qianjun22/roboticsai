...
DESCRIPTION = "Competitive win rate v2 for robotics platform — tracks head-to-head outcomes by competitor, deal size, and industry vertical with trend analysis"

...
PORT = 12897
SERVICE = "robotics_enterprise_sandbox_provisioner"
DESCRIPTION = "Provisions isolated sandbox environments for enterprise robotics trials — OCI tenancy setup, model deployment, data isolation, and usage metering"

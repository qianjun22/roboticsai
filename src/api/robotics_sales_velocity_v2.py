...
PORT = 13625
SERVICE = "robotics_sales_velocity_v2"
DESCRIPTION = "Robotics sales velocity optimization platform v2 — measures and improves deal cycle time across pipeline stages, identifies velocity blockers, and recommends interventions to accelerate time-to-close"

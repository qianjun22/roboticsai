...
PORT = 12307
SERVICE = "enterprise_robotics_sustainability_tracker"
DESCRIPTION = "Enterprise robotics sustainability tracker for energy consumption and carbon footprint monitoring"

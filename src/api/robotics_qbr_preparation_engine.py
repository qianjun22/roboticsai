...
PORT = 50383
SERVICE = "robotics-qbr-preparation-engine"
DESCRIPTION = "Robotics GTM qbr preparation engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-qbr-preparation-engine</title><style>
...
<div class="header"><h1>robotics-qbr-preparation-engine</h1><div class="subtitle">Robotics GTM qbr preparation engine service · port 50383</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50383</div>

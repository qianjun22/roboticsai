...
PORT = 50707
SERVICE = "robotics-data-privacy-mgr"
DESCRIPTION = "Robotics GTM data privacy mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-data-privacy-mgr</title><style>
...
<div class="header"><h1>robotics-data-privacy-mgr</h1><div class="subtitle">Robotics GTM data privacy mgr service · port 50707</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50707</div>

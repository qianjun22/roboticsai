...
PORT = 12483
SERVICE = "enterprise_robotics_energy_efficiency_monitor"
DESCRIPTION = "Enterprise robotics energy efficiency monitor tracking per-task power consumption, idle optimization, and carbon footprint reduction"

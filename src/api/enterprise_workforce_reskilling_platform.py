...
PORT = 12121
SERVICE = "enterprise-workforce-reskilling-platform"
DESCRIPTION = "Enterprise workforce reskilling platform for training employees to collaborate with robots"

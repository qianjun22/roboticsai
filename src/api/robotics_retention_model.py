...
PORT = 15319
SERVICE = "robotics-retention-model"
DESCRIPTION = "GTM platform for retention model optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-retention-model</title><style>
...
<div class="header"><h1>robotics-retention-model</h1><div class="sub">GTM platform for retention model optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15319 | <b>Status:</b> <span style="color:#4ade80">Live</span>

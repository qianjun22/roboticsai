...
PORT = 40065
SERVICE = "robotics_sdk_download_tracker"
DESCRIPTION = "GTM service: sdk download tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_sdk_download_tracker</title><style>
...
<div class="header"><h1>robotics_sdk_download_tracker</h1><div class="subtitle">GTM service: sdk download tracker port 40065</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40065</div>

...
PORT = 12345
SERVICE = "enterprise_robotics_audit_trail_manager"
DESCRIPTION = "Enterprise robotics audit trail manager for regulatory compliance logging and incident investigation"

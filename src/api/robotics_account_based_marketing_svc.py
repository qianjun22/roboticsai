...
PORT = 51247
SERVICE = "robotics-account-based-marketing-svc"
DESCRIPTION = "Robotics GTM account based marketing svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-account-based-marketing-svc</title><style>
...
<div class="header"><h1>robotics-account-based-marketing-svc</h1><div class="subtitle">Robotics GTM account based marketing svc service · port 51247</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51247</div>

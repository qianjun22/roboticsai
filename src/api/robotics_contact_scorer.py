...
DESCRIPTION = "GTM platform for contact scorer automation"
...
<div class="header"><h1>robotics-contact-scorer</h1><div class="sub">GTM platform for contact scorer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15029 | <b>Status:</b> <span style="color:#4ade80">Live</span>

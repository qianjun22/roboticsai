...
PORT = 15227
SERVICE = "robotics-contact-scorer"
DESCRIPTION = "GTM platform for contact scorer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-contact-scorer</title><style>
...
<div class="header"><h1>robotics-contact-scorer</h1><div class="sub">GTM platform for contact scorer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15227 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15031
SERVICE = "robotics-opportunity-ranker"
DESCRIPTION = "GTM platform for opportunity ranker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-opportunity-ranker</title><style>
...
<div class="header"><h1>robotics-opportunity-ranker</h1><div class="sub">GTM platform for opportunity ranker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15031 | <b>Status:</b> <span style="color:#4ade80">Live</span>

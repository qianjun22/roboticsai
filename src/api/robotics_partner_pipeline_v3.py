...
PORT = 13199
SERVICE = "robotics_partner_pipeline_v3"
DESCRIPTION = "Partner pipeline v3 for managing NVIDIA co-sell opportunities, referral tracking, and joint revenue forecasting"

...
PORT = 13721
SERVICE = "robotics_channel_development_v3"
DESCRIPTION = "Robotics channel development API v3 — reseller recruitment, channel conflict resolution, and indirect sales pipeline management"

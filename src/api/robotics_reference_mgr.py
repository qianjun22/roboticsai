...
PORT = 15079
SERVICE = "robotics-reference-mgr"
DESCRIPTION = "GTM platform for reference mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reference-mgr</title><style>
...
<div class="header"><h1>robotics-reference-mgr</h1><div class="sub">GTM platform for reference mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15079 | <b>Status:</b> <span style="color:#4ade80">Live</span>

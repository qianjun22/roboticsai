...
DESCRIPTION = "GTM platform for reference mgr automation"
...
<div class="header"><h1>robotics-reference-mgr</h1><div class="sub">GTM platform for reference mgr automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15321 | <b>Status:</b> <span style="color:#4ade80">Live</span>

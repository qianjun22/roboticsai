...
PORT = 13031
SERVICE = "robotics_field_operations_dashboard"
DESCRIPTION = "Field operations dashboard for robotics deployments — tracks robot uptime, maintenance schedules, operator utilization, and site performance KPIs"

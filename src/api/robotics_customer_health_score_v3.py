...
PORT = 12941
SERVICE = "robotics_customer_health_score_v3"
DESCRIPTION = "Customer health scoring v3 for robotics deployments — tracks adoption, uptime, and expansion signals across enterprise accounts"

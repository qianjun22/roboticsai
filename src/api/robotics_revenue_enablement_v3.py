...
PORT = 13735
SERVICE = "robotics_revenue_enablement_v3"
DESCRIPTION = "Robotics revenue enablement API v3 — sales training content, playbook distribution, tool adoption, and field enablement effectiveness measurement"

...
PORT = 13711
SERVICE = "robotics_customer_lifecycle_v3"
DESCRIPTION = "Robotics customer lifecycle API v3 — onboarding automation, adoption milestones, renewal triggers, and churn risk signals"

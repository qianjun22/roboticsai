...
PORT = 50891
SERVICE = "robotics-developer-feedback-aggregator"
DESCRIPTION = "Robotics GTM developer feedback aggregator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-feedback-aggregator</title><style>
...
<div class="header"><h1>robotics-developer-feedback-aggregator</h1><div class="subtitle">Robotics GTM developer feedback aggregator service · port 50891</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50891</div>

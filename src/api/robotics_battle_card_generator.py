...
PORT = 52739
SERVICE = "robotics-battle-card-generator"
DESCRIPTION = "Robotics GTM battle card generator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-battle-card-generator</title><style>
...
<div class="header"><h1>robotics-battle-card-generator</h1><div class="subtitle">Robotics GTM battle card generator service · port 52739</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52739</div>

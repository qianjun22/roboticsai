...
PORT = 12047
SERVICE = "enterprise-product-portfolio-optimizer"
DESCRIPTION = "Enterprise product portfolio optimizer for maximizing ROI across robotics deployment investments"

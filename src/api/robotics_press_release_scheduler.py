...
PORT = 50579
SERVICE = "robotics-press-release-scheduler"
DESCRIPTION = "Robotics GTM press release scheduler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-press-release-scheduler</title><style>
...
<div class="header"><h1>robotics-press-release-scheduler</h1><div class="subtitle">Robotics GTM press release scheduler service · port 50579</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50579</div>

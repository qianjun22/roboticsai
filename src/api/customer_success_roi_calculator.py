...
PORT = 11749
SERVICE = "customer-success-roi-calculator"
DESCRIPTION = "Customer success ROI calculator for quantifying value delivered, cost savings, and productivity improvements"

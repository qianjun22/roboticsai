...
PORT = 11975
SERVICE = "sales_revenue_attribution_engine"
DESCRIPTION = "Sales revenue attribution engine for multi-touch campaign credit modeling, channel contribution analysis, and marketing-sales alignment scoring"

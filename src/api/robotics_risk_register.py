...
PORT = 15383
SERVICE = "robotics-risk-register"
DESCRIPTION = "GTM platform for risk register optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-risk-register</title><style>
...
<div class="header"><h1>robotics-risk-register</h1><div class="sub">GTM platform for risk register optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15383 | <b>Status:</b> <span style="color:#4ade80">Live</span>

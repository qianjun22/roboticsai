...
PORT = 50755
SERVICE = "robotics-enterprise-renewal-tracker"
DESCRIPTION = "Robotics GTM enterprise renewal tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-enterprise-renewal-tracker</title><style>
...
<div class="header"><h1>robotics-enterprise-renewal-tracker</h1><div class="subtitle">Robotics GTM enterprise renewal tracker service · port 50755</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50755</div>

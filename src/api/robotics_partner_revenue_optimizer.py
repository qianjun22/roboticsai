...
PORT = 50811
SERVICE = "robotics-partner-revenue-optimizer"
DESCRIPTION = "Robotics GTM partner revenue optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-revenue-optimizer</title><style>
...
<div class="header"><h1>robotics-partner-revenue-optimizer</h1><div class="subtitle">Robotics GTM partner revenue optimizer service · port 50811</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50811</div>

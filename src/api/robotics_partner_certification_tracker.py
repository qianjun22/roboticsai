...
PORT = 12813
SERVICE = "robotics_partner_certification_tracker"
DESCRIPTION = "Tracks robotics partner certification progress — training completion, exam scores, hands-on lab results, and badge issuance"

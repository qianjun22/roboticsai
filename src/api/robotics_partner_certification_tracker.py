...
PORT = 52891
SERVICE = "robotics-partner-certification-tracker"
DESCRIPTION = "Robotics GTM partner certification tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-certification-tracker</title><style>
...
<div class="header"><h1>robotics-partner-certification-tracker</h1><div class="subtitle">Robotics GTM partner certification tracker service · port 52891</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52891</div>

...
PORT = 15347
SERVICE = "robotics-insight-extractor"
DESCRIPTION = "GTM platform for insight extractor optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-insight-extractor</title><style>
...
<div class="header"><h1>robotics-insight-extractor</h1><div class="sub">GTM platform for insight extractor optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15347 | <b>Status:</b> <span style="color:#4ade80">Live</span>

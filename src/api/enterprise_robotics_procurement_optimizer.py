...
PORT = 12285
SERVICE = "enterprise_robotics_procurement_optimizer"
DESCRIPTION = "Enterprise robotics procurement optimizer for hardware sourcing cost reduction and vendor management"

...
PORT = 12705
SERVICE = "partner-technical-sandbox-access-manager"
DESCRIPTION = "Manages sandbox environment access for robotics ISV partners — provisioning, quota limits, and usage telemetry"

...
PORT = 15335
SERVICE = "robotics-cancel-interceptor"
DESCRIPTION = "GTM platform for cancel interceptor optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-cancel-interceptor</title><style>
...
<div class="header"><h1>robotics-cancel-interceptor</h1><div class="sub">GTM platform for cancel interceptor optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15335 | <b>Status:</b> <span style="color:#4ade80">Live</span>

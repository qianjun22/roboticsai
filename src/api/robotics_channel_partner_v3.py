...
PORT = 13503
SERVICE = "robotics_channel_partner_v3"
DESCRIPTION = "Robotics channel partner management v3 — partner onboarding, co-sell pipeline tracking, and reseller program administration for OCI Robot Cloud"

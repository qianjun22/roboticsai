...
PORT = 50175
SERVICE = "robotics-technical-seo-optimizer"
DESCRIPTION = "Robotics GTM technical seo optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-seo-optimizer</title><style>
...
<div class="header"><h1>robotics-technical-seo-optimizer</h1><div class="subtitle">Robotics GTM technical seo optimizer service · port 50175</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50175</div>

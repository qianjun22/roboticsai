...
PORT = 12217
SERVICE = "sales-customer-reference-program-manager"
DESCRIPTION = "Customer reference program manager cultivating referenceable robotics customers for case studies, peer calls, and conference speaking opportunities"

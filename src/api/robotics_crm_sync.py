...
DESCRIPTION = "GTM platform for crm sync automation"
...
<div class="header"><h1>robotics-crm-sync</h1><div class="sub">GTM platform for crm sync automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15021 | <b>Status:</b> <span style="color:#4ade80">Live</span>

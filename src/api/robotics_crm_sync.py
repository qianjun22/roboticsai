...
PORT = 15219
SERVICE = "robotics-crm-sync"
DESCRIPTION = "GTM platform for crm sync optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-crm-sync</title><style>
...
<div class="header"><h1>robotics-crm-sync</h1><div class="sub">GTM platform for crm sync optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15219 | <b>Status:</b> <span style="color:#4ade80">Live</span>

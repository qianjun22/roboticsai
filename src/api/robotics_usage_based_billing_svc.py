...
PORT = 50959
SERVICE = "robotics-usage-based-billing-svc"
DESCRIPTION = "Robotics GTM usage based billing svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-usage-based-billing-svc</title><style>
...
<div class="header"><h1>robotics-usage-based-billing-svc</h1><div class="subtitle">Robotics GTM usage based billing svc service · port 50959</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50959</div>

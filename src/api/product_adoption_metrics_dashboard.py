...
PORT = 11721
SERVICE = "product-adoption-metrics-dashboard"
DESCRIPTION = "Product adoption metrics dashboard for feature usage funnel analysis and activation event tracking"

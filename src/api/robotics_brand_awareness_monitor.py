...
PORT = 50599
SERVICE = "robotics-brand-awareness-monitor"
DESCRIPTION = "Robotics GTM brand awareness monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-brand-awareness-monitor</title><style>
...
<div class="header"><h1>robotics-brand-awareness-monitor</h1><div class="subtitle">Robotics GTM brand awareness monitor service · port 50599</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50599</div>

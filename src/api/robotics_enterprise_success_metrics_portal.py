...
PORT = 12867
SERVICE = "robotics_enterprise_success_metrics_portal"
DESCRIPTION = "Customer-facing portal showing enterprise success metrics — robot uptime, task completion rates, ROI realized, and support ticket resolution"

...
PORT = 13729
SERVICE = "robotics_sales_excellence_v3"
DESCRIPTION = "Robotics sales excellence API v3 — sales methodology enforcement, coaching insights, best practice sharing, and rep performance benchmarking"

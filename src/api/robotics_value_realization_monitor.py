...
PORT = 53891
SERVICE = "robotics-value-realization-monitor"
DESCRIPTION = "Robotics GTM value realization monitor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-value-realization-monitor</title><style>
...
<div class="header"><h1>robotics-value-realization-monitor</h1><div class="subtitle">Robotics GTM value realization monitor service · port 53891</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53891</div>

...
PORT = 12613
SERVICE = "enterprise-robotics-capex-opex-calculator"
DESCRIPTION = "Financial modeling tool comparing CapEx vs OpEx trade-offs for enterprise robotics deployments"

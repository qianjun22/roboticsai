...
PORT = 50429
SERVICE = "robotics-dagger-channel-mgr"
DESCRIPTION = "Robotics GTM dagger channel mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-channel-mgr</title><style>
...
<div class="header"><h1>robotics-dagger-channel-mgr</h1><div class="subtitle">Robotics GTM dagger channel mgr service · port 50429</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50429</div>

...
PORT = 11817
SERVICE = "enterprise-contract-intelligence-hub"
DESCRIPTION = "Enterprise contract intelligence hub for obligation tracking, renewal forecasting, and risk clause detection"

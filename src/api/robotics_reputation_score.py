...
PORT = 15275
SERVICE = "robotics-reputation-score"
DESCRIPTION = "GTM platform for reputation score optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reputation-score</title><style>
...
<div class="header"><h1>robotics-reputation-score</h1><div class="sub">GTM platform for reputation score optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15275 | <b>Status:</b> <span style="color:#4ade80">Live</span>

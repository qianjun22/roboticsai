...
PORT = 50457
SERVICE = "robotics-dagger-onboarding-svc"
DESCRIPTION = "Robotics GTM dagger onboarding svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-onboarding-svc</title><style>
...
<div class="header"><h1>robotics-dagger-onboarding-svc</h1><div class="subtitle">Robotics GTM dagger onboarding svc service · port 50457</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50457</div>

...
PORT = 15143
SERVICE = "robotics-pilot-mgr"
DESCRIPTION = "GTM platform for pilot mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pilot-mgr</title><style>
...
<div class="header"><h1>robotics-pilot-mgr</h1><div class="sub">GTM platform for pilot mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15143 | <b>Status:</b> <span style="color:#4ade80">Live</span>

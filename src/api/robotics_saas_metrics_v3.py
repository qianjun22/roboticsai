...
PORT = 12959
SERVICE = "robotics_saas_metrics_v3"
DESCRIPTION = "SaaS metrics v3 for robotics platform — tracks MRR, churn rate, NPS, and product engagement across the entire customer lifecycle"

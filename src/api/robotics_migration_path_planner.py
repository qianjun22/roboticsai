...
PORT = 50343
SERVICE = "robotics-migration-path-planner"
DESCRIPTION = "Robotics GTM migration path planner service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-migration-path-planner</title><style>
...
<div class="header"><h1>robotics-migration-path-planner</h1><div class="subtitle">Robotics GTM migration path planner service · port 50343</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50343</div>

...
PORT = 13775
SERVICE = "robotics_win_loss_analysis_v2"
DESCRIPTION = "Robotics win/loss analysis service v2 — deal outcome pattern analysis, competitive insight extraction, and sales coaching recommendations"

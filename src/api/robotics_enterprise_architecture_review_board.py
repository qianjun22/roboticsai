...
PORT = 12891
SERVICE = "robotics_enterprise_architecture_review_board"
DESCRIPTION = "Manages enterprise architecture review process for robotics deployments — integration patterns, security review, scalability sign-off, and compliance checklist"

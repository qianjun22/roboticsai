...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-account-mgmt</title><style>
...
<div class="header"><h1>robotics-dagger-account-mgmt</h1><div class="subtitle">Robotics GTM dagger account mgmt service · port 50325</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50325</div>

...
PORT = 12839
SERVICE = "robotics_developer_experience_scorer"
DESCRIPTION = "Scores developer experience for robotics SDK — onboarding friction, time-to-first-inference, documentation quality, and support responsiveness"

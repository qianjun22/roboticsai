...
PORT = 50913
SERVICE = "robotics-dagger-implementation-svc"
DESCRIPTION = "Robotics GTM dagger implementation svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-implementation-svc</title><style>
...
<div class="header"><h1>robotics-dagger-implementation-svc</h1><div class="subtitle">Robotics GTM dagger implementation svc service · port 50913</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50913</div>

...
PORT = 13343
SERVICE = "robotics_product_operations_v2"
DESCRIPTION = "Product operations v2 for managing OCI Robot Cloud release cadence, feature flag governance, and API versioning lifecycle"

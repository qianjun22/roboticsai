...
PORT = 12977
SERVICE = "robotics_investor_relations_v3"
DESCRIPTION = "Investor relations v3 for robotics startup — manages quarterly updates, cap table analytics, and fundraising pipeline with milestone tracking"

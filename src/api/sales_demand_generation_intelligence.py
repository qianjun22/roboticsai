...
PORT = 12203
SERVICE = "sales-demand-generation-intelligence"
DESCRIPTION = "Demand generation intelligence platform attributing robotics pipeline sourcing to marketing campaigns, events, and partner referrals with funnel conversion analytics"

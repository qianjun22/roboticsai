...
PORT = 11579
SERVICE = "design-partner-activation-tracker"
DESCRIPTION = "Tracks design partner activation milestones: API access, first inference call, pilot deployment, and production go-live"

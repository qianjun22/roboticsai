...
PORT = 12999
SERVICE = "robotics_usage_metering_service"
DESCRIPTION = "Usage metering service for robotics platform — tracks API calls, inference minutes, and training compute per customer for accurate billing"

...
PORT = 12129
SERVICE = "partner-alliances-program-director"
DESCRIPTION = "Strategic alliance program management platform for coordinating joint go-to-market initiatives with robotics ecosystem partners"

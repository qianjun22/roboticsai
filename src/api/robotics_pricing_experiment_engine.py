...
PORT = 12865
SERVICE = "robotics_pricing_experiment_engine"
DESCRIPTION = "Runs pricing experiments for robotics cloud — A/B tests, willingness-to-pay surveys, elasticity modeling, and tier optimization"

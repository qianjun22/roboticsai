...
PORT = 13751
SERVICE = "robotics_digital_transformation_v2"
DESCRIPTION = "Robotics digital transformation v2 — enterprise DX journey mapping, automation maturity assessment, and cloud-native robotics adoption playbooks"

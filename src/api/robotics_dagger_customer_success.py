...
PORT = 50533
SERVICE = "robotics-dagger-customer-success"
DESCRIPTION = "Robotics GTM dagger customer success service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-customer-success</title><style>
...
<div class="header"><h1>robotics-dagger-customer-success</h1><div class="subtitle">Robotics GTM dagger customer success service · port 50533</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50533</div>

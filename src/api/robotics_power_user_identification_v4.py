...
PORT = 16731
SERVICE = "robotics_power_user_identification_v4"
DESCRIPTION = "Robotics GTM power user identifier detecting high-value customers for advocacy and expansion programs"

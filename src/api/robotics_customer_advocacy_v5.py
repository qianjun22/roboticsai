...
PORT = 13885
SERVICE = "robotics_customer_advocacy_v5"
DESCRIPTION = "Robotics customer advocacy platform v5 — reference program management, case study development, and NPS improvement"

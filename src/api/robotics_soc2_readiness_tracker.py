...
PORT = 50727
SERVICE = "robotics-soc2-readiness-tracker"
DESCRIPTION = "Robotics GTM soc2 readiness tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-soc2-readiness-tracker</title><style>
...
<div class="header"><h1>robotics-soc2-readiness-tracker</h1><div class="subtitle">Robotics GTM soc2 readiness tracker service · port 50727</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50727</div>

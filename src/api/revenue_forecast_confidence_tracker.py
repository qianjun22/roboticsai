...
PORT = 11599
SERVICE = "revenue-forecast-confidence-tracker"
DESCRIPTION = "Tracks confidence intervals on revenue forecasts using Monte Carlo simulation and pipeline coverage analysis"

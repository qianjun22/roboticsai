...
PORT = 22833
SERVICE = "robotics_hydrogen_electrolyzer_v2"
DESCRIPTION = "Hydrogen electrolyzer robotics API v2 — renewable curtailment scheduling and compression optimization"

...
PORT = 15303
SERVICE = "robotics-loyalty-tracker"
DESCRIPTION = "GTM platform for loyalty tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-loyalty-tracker</title><style>
...
<div class="header"><h1>robotics-loyalty-tracker</h1><div class="sub">GTM platform for loyalty tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15303 | <b>Status:</b> <span style="color:#4ade80">Live</span>

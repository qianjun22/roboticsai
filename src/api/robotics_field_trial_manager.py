...
PORT = 12957
SERVICE = "robotics_field_trial_manager"
DESCRIPTION = "Field trial manager for robotics deployments — coordinates pilot scheduling, data collection protocols, and success criteria tracking at customer sites"

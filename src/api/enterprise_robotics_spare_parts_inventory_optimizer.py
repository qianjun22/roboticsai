...
PORT = 12741
SERVICE = "enterprise-robotics-spare-parts-optimizer"
DESCRIPTION = "Optimizes spare parts inventory for enterprise robot fleets — predictive reorder, vendor lead times, and criticality scoring"

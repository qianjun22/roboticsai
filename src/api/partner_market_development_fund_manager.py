...
PORT = 11807
SERVICE = "partner-market-development-fund-manager"
DESCRIPTION = "Partner MDF manager for activity pre-approval, spend verification, and ROI reporting automation"

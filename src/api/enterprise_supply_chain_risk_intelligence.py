...
PORT = 12227
SERVICE = "enterprise-supply-chain-risk-intelligence"
DESCRIPTION = "Supply chain risk intelligence platform identifying single-source dependencies, geopolitical risks, and disruption scenarios affecting robot component supply chains"

...
PORT = 50957
SERVICE = "robotics-dagger-field-marketing"
DESCRIPTION = "Robotics GTM dagger field marketing service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-field-marketing</title><style>
...
<div class="header"><h1>robotics-dagger-field-marketing</h1><div class="subtitle">Robotics GTM dagger field marketing service · port 50957</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50957</div>

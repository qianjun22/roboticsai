"""Executive sponsor program — Oracle SVP/VP pairing with strategic accounts delivering NRR 134% vs 112% and 2.1x expansion velocity
...
try:
    ...
    _has_fastapi = False
PORT = 10961
SERVICE = "executive_sponsor_program"
DESCRIPTION = "Executive sponsor program — Oracle SVP/VP pairing with strategic accounts delivering NRR 134% vs 112% and 2.1x expansion velocity"
if _has_fastapi:

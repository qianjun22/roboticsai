...
PORT = 15295
SERVICE = "robotics-advocacy-program"
DESCRIPTION = "GTM platform for advocacy program optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-advocacy-program</title><style>
...
<div class="header"><h1>robotics-advocacy-program</h1><div class="sub">GTM platform for advocacy program optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15295 | <b>Status:</b> <span style="color:#4ade80">Live</span>

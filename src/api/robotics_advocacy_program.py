...
DESCRIPTION = "GTM platform for advocacy program automation"
...
<div class="header"><h1>robotics-advocacy-program</h1><div class="sub">GTM platform for advocacy program automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15097 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13475
SERVICE = "robotics_technical_support_metrics_v2"
DESCRIPTION = "Technical support metrics v2 platform for tracking robotics customer issue resolution and SLA compliance"

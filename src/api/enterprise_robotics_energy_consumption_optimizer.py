...
PORT = 12717
SERVICE = "enterprise-robotics-energy-consumption-optimizer"
DESCRIPTION = "Optimizes energy consumption for enterprise robot fleets — duty cycle scheduling, charging coordination, and green energy integration"

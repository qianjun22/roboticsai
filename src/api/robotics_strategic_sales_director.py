...
PORT = 50039
SERVICE = "robotics-strategic-sales-director"
DESCRIPTION = "Robotics GTM strategic sales director service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-strategic-sales-director</title><style>
...
<div class="header"><h1>robotics-strategic-sales-director</h1><div class="subtitle">Robotics GTM strategic sales director service · port 50039</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50039</div>

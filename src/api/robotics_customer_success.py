...
PORT = 15221
SERVICE = "robotics-customer-success"
DESCRIPTION = "GTM platform for customer success automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-success</title><style>
...
<div class="header"><h1>robotics-customer-success</h1><div class="sub">GTM platform for customer success automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15221 | <b>Status:</b> <span style="color:#4ade80">Live</span>

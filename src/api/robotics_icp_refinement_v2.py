...
PORT = 13745
SERVICE = "robotics_icp_refinement_v2"
DESCRIPTION = "Robotics ideal customer profile refinement v2 — data-driven ICP scoring, firmographic clustering, and TAM segmentation for robotics cloud sales"

...
DESCRIPTION = "GTM platform for mdf tracker automation"
...
<div class="header"><h1>robotics-mdf-tracker</h1><div class="sub">GTM platform for mdf tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15353 | <b>Status:</b> <span style="color:#4ade80">Live</span>

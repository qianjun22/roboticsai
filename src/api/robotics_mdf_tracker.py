...
PORT = 15111
SERVICE = "robotics-mdf-tracker"
DESCRIPTION = "GTM platform for mdf tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-mdf-tracker</title><style>
...
<div class="header"><h1>robotics-mdf-tracker</h1><div class="sub">GTM platform for mdf tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15111 | <b>Status:</b> <span style="color:#4ade80">Live</span>

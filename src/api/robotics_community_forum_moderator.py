...
PORT = 50211
SERVICE = "robotics-community-forum-moderator"
DESCRIPTION = "Robotics GTM community forum moderator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-community-forum-moderator</title><style>
...
<div class="header"><h1>robotics-community-forum-moderator</h1><div class="subtitle">Robotics GTM community forum moderator service · port 50211</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50211</div>

...
PORT = 50139
SERVICE = "robotics-whitepaper-distribution-mgr"
DESCRIPTION = "Robotics GTM whitepaper distribution mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-whitepaper-distribution-mgr</title><style>
...
<div class="header"><h1>robotics-whitepaper-distribution-mgr</h1><div class="subtitle">Robotics GTM whitepaper distribution mgr service · port 50139</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50139</div>

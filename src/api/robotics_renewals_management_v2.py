...
PORT = 13491
SERVICE = "robotics_renewals_management_v2"
DESCRIPTION = "Renewals management v2 platform for robotics subscription renewal forecasting and retention campaigns"

...
PORT = 12965
SERVICE = "robotics_sales_engineering_portal"
DESCRIPTION = "Sales engineering portal for robotics platform — manages POC requests, technical demo resources, and integration assessment workflows"

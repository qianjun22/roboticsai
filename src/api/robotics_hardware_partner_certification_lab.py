...
PORT = 12901
SERVICE = "robotics_hardware_partner_certification_lab"
DESCRIPTION = "Manages hardware partner certification lab — compatibility test suites, latency benchmarks, power envelope validation, and certified hardware registry"

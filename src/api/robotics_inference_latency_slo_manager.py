...
PORT = 12883
SERVICE = "robotics_inference_latency_slo_manager"
DESCRIPTION = "Manages inference latency SLOs for robotics cloud — p50/p95/p99 targets, breach alerting, capacity scaling triggers, and SLA credit calculations"

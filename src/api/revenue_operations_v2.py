"""Revenue Operations V2 — unified RevOps platform with pipeline velocity and process automation.
...
DESCRIPTION = "Unified RevOps platform with pipeline velocity and automated process workflows"

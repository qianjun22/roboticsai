...
PORT = 13527
SERVICE = "robotics_product_positioning_v2"
DESCRIPTION = "Product positioning service v2 — manages competitive messaging, differentiator tracking, and value proposition frameworks for robotics products"

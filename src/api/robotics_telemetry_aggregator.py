...
PORT = 38459
SERVICE = "robotics_telemetry_aggregator"
DESCRIPTION = "Telemetry aggregation service for multi-robot sensor streams"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_telemetry_aggregator</title><style>
...
<div class="header"><h1>robotics_telemetry_aggregator</h1><div class="subtitle">Telemetry aggregation service for multi-robot sensor streams · port 38459</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38459</div>

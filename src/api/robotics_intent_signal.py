...
PORT = 15009
SERVICE = "robotics-intent-signal"
DESCRIPTION = "GTM platform for intent signal automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-intent-signal</title><style>
...
<div class="header"><h1>robotics-intent-signal</h1><div class="sub">GTM platform for intent signal automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15009 | <b>Status:</b> <span style="color:#4ade80">Live</span>

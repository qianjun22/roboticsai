...
PORT = 50763
SERVICE = "robotics-sales-cycle-accelerator"
DESCRIPTION = "Robotics GTM sales cycle accelerator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sales-cycle-accelerator</title><style>
...
<div class="header"><h1>robotics-sales-cycle-accelerator</h1><div class="subtitle">Robotics GTM sales cycle accelerator service · port 50763</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50763</div>

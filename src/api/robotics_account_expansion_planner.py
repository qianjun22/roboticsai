...
PORT = 50767
SERVICE = "robotics-account-expansion-planner"
DESCRIPTION = "Robotics GTM account expansion planner service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-account-expansion-planner</title><style>
...
<div class="header"><h1>robotics-account-expansion-planner</h1><div class="subtitle">Robotics GTM account expansion planner service · port 50767</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50767</div>

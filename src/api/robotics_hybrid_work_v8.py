...
PORT = 40863
SERVICE = "robotics-hybrid-work-v8"
DESCRIPTION = "Hybrid work model optimizer for robotics GTM teams balancing in-person collaboration with remote productivity"

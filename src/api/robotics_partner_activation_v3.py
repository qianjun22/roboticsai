...
PORT = 13731
SERVICE = "robotics_partner_activation_v3"
DESCRIPTION = "Robotics partner activation API v3 — new partner onboarding, GTM activation campaigns, and partner readiness certification workflows"

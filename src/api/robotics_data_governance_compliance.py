...
PORT = 12849
SERVICE = "robotics_data_governance_compliance"
DESCRIPTION = "Manages data governance compliance for robotics training data — consent tracking, data residency, GDPR/CCPA controls, and audit trail"

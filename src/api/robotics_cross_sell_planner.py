...
PORT = 15249
SERVICE = "robotics-cross-sell-planner"
DESCRIPTION = "GTM platform for cross sell planner automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-cross-sell-planner</title><style>
...
<div class="header"><h1>robotics-cross-sell-planner</h1><div class="sub">GTM platform for cross sell planner automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15249 | <b>Status:</b> <span style="color:#4ade80">Live</span>

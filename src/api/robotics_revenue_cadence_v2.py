...
PORT = 13593
SERVICE = "robotics_revenue_cadence_v2"
DESCRIPTION = "Revenue cadence management v2 for robotics platform — automates weekly/monthly pipeline reviews, forecast submissions, and deal progression nudges"

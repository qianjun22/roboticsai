...
PORT = 12825
SERVICE = "robotics_geographic_expansion_planner"
DESCRIPTION = "Plans geographic expansion for robotics cloud — market sizing by country, regulatory readiness, data residency requirements, and launch sequencing"

...
PORT = 51019
SERVICE = "robotics-solutions-architect-portal"
DESCRIPTION = "Robotics GTM solutions architect portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-solutions-architect-portal</title><style>
...
<div class="header"><h1>robotics-solutions-architect-portal</h1><div class="subtitle">Robotics GTM solutions architect portal service · port 51019</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51019</div>

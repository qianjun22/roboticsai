...
PORT = 51009
SERVICE = "robotics-dagger-sales-engineering"
DESCRIPTION = "Robotics GTM dagger sales engineering service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-sales-engineering</title><style>
...
<div class="header"><h1>robotics-dagger-sales-engineering</h1><div class="subtitle">Robotics GTM dagger sales engineering service · port 51009</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51009</div>

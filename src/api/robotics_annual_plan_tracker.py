...
PORT = 13033
SERVICE = "robotics_annual_plan_tracker"
DESCRIPTION = "Annual plan tracker for robotics business — monitors progress against headcount, revenue, and product milestones with variance analysis"

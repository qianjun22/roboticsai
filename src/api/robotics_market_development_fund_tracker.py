...
PORT = 12799
SERVICE = "robotics_market_development_fund_tracker"
DESCRIPTION = "Tracks market development fund allocations for robotics partners — campaign approvals, spend verification, and ROI measurement"

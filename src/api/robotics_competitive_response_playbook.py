...
PORT = 13207
SERVICE = "robotics_competitive_response_playbook"
DESCRIPTION = "Competitive response playbook for real-time objection handling against AWS, Azure, and GCP robotics offerings"

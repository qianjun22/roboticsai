...
PORT = 50859
SERVICE = "robotics-technical-webinar-engine"
DESCRIPTION = "Robotics GTM technical webinar engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-webinar-engine</title><style>
...
<div class="header"><h1>robotics-technical-webinar-engine</h1><div class="subtitle">Robotics GTM technical webinar engine service · port 50859</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50859</div>

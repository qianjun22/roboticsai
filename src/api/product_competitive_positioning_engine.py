...
PORT = 11815
SERVICE = "product-competitive-positioning-engine"
DESCRIPTION = "Product competitive positioning engine for differentiation mapping, messaging optimization, and win theme analysis"

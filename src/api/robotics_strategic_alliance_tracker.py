...
PORT = 13051
SERVICE = "robotics_strategic_alliance_tracker"
DESCRIPTION = "Strategic alliance tracker for robotics platform — manages NVIDIA, OEM, and cloud provider relationships with milestone and deliverable tracking"

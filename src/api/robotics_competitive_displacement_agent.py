...
PORT = 50775
SERVICE = "robotics-competitive-displacement-agent"
DESCRIPTION = "Robotics GTM competitive displacement agent service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-competitive-displacement-agent</title><style>
...
<div class="header"><h1>robotics-competitive-displacement-agent</h1><div class="subtitle">Robotics GTM competitive displacement agent service · port 50775</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50775</div>

"""Partner Ecosystem Analytics — tracks revenue contribution and health across full partner ecosystem.
...
PORT = 10657
SERVICE = "partner_ecosystem_analytics"
DESCRIPTION = "Revenue contribution and health tracking across full partner ecosystem"

...
PORT = 50973
SERVICE = "robotics-dagger-pricing-optimizer"
DESCRIPTION = "Robotics GTM dagger pricing optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-pricing-optimizer</title><style>
...
<div class="header"><h1>robotics-dagger-pricing-optimizer</h1><div class="subtitle">Robotics GTM dagger pricing optimizer service · port 50973</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50973</div>

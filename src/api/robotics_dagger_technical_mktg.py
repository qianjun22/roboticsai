...
PORT = 50901
SERVICE = "robotics-dagger-technical-mktg"
DESCRIPTION = "Robotics GTM dagger technical mktg service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-technical-mktg</title><style>
...
<div class="header"><h1>robotics-dagger-technical-mktg</h1><div class="subtitle">Robotics GTM dagger technical mktg service · port 50901</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50901</div>

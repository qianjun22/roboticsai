...
PORT = 13323
SERVICE = "robotics_product_differentiation_v2"
DESCRIPTION = "Product differentiation v2 for articulating OCI Robot Cloud unique advantages in NVIDIA stack integration, cost, and US-origin compute"

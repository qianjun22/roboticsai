...
PORT = 13053
SERVICE = "robotics_sales_coaching_platform"
DESCRIPTION = "Sales coaching platform for robotics go-to-market — analyzes call recordings, deal patterns, and win/loss data to improve rep performance"

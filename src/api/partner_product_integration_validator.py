...
PORT = 12165
SERVICE = "partner-product-integration-validator"
DESCRIPTION = "Automated integration validation platform testing partner robotics product compatibility with OCI Robot Cloud APIs and certification compliance"

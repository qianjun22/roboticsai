...
PORT = 30669
SERVICE = "robotics_anomaly_detection_v5"
DESCRIPTION = "Anomaly detection GTM microservice for robotics behavioral drift and operational outlier identification"

...
PORT = 13701
SERVICE = "robotics_revenue_quality_v3"
DESCRIPTION = "Robotics revenue quality API v3 — deal quality scoring, discount governance, contract compliance, and ARR health monitoring"

...
PORT = 50719
SERVICE = "robotics-enterprise-security-advisor"
DESCRIPTION = "Robotics GTM enterprise security advisor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-enterprise-security-advisor</title><style>
...
<div class="header"><h1>robotics-enterprise-security-advisor</h1><div class="subtitle">Robotics GTM enterprise security advisor service · port 50719</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50719</div>

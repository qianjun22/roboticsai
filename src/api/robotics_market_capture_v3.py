...
PORT = 13705
SERVICE = "robotics_market_capture_v3"
DESCRIPTION = "Robotics market capture API v3 — market share tracking, competitive win/loss analysis, and segment penetration strategy"

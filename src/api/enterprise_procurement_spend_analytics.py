...
PORT = 11931
SERVICE = "enterprise_procurement_spend_analytics"
DESCRIPTION = "Enterprise procurement spend analytics platform for category management, maverick spend detection, and supplier consolidation opportunity identification"

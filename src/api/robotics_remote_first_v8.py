...
PORT = 40865
SERVICE = "robotics-remote-first-v8"
DESCRIPTION = "Remote-first operations platform for robotics GTM with distributed team coordination and async-native tooling"

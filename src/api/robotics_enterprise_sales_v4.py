...
PORT = 13633
SERVICE = "robotics_enterprise_sales_v4"
DESCRIPTION = "Robotics enterprise sales orchestration platform v4 — manages large account planning, executive alignment, multi-product bundling, and enterprise-wide adoption programs for robotics deployments at Fortune 500 scale"

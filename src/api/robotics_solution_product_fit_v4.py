...
PORT = 16679
SERVICE = "robotics_solution_product_fit_v4"
DESCRIPTION = "Robotics GTM solution-to-product fit tracker mapping technical capabilities to commercial product features"

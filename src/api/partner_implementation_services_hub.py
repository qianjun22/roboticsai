...
PORT = 12135
SERVICE = "partner-implementation-services-hub"
DESCRIPTION = "Centralized hub for managing partner-led implementation services, SOW tracking, and delivery quality assurance for robotics deployments"

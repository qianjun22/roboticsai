...
PORT = 15235
SERVICE = "robotics-industry-vertical"
DESCRIPTION = "GTM platform for industry vertical optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-industry-vertical</title><style>
...
<div class="header"><h1>robotics-industry-vertical</h1><div class="sub">GTM platform for industry vertical optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15235 | <b>Status:</b> <span style="color:#4ade80">Live</span>

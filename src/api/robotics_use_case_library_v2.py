...
PORT = 13755
SERVICE = "robotics_use_case_library_v2"
DESCRIPTION = "Robotics use case library v2 — curated industry solution blueprints, ROI calculators, and deployment templates for robotics cloud customers"

...
PORT = 13009
SERVICE = "robotics_customer_community_platform"
DESCRIPTION = "Customer community platform for robotics users — facilitates peer knowledge sharing, feature requests, and user group coordination"

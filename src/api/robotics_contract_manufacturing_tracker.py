...
PORT = 12827
SERVICE = "robotics_contract_manufacturing_tracker"
DESCRIPTION = "Tracks contract manufacturing relationships for robotics hardware — production schedules, quality metrics, cost variance, and supplier risk"

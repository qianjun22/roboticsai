...
PORT = 13619
SERVICE = "robotics_customer_advocacy_v3"
DESCRIPTION = "Robotics customer advocacy program platform v3 — identifies and nurtures champion customers, manages reference programs, coordinates case study development, and tracks NPS-driven advocacy activities"

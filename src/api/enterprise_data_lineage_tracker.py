...
PORT = 11879
SERVICE = "enterprise_data_lineage_tracker"
DESCRIPTION = "Enterprise data lineage tracker for end-to-end data flow visualization, impact analysis, and regulatory data provenance reporting"

...
PORT = 16765
SERVICE = "robotics_finance_approval_v4"
DESCRIPTION = "Robotics GTM finance approval workflow automating budget approval and CapEx/OpEx classification for robot purchases"

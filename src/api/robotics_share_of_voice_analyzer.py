...
PORT = 51995
SERVICE = "robotics-share-of-voice-analyzer"
DESCRIPTION = "Robotics GTM share of voice analyzer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-share-of-voice-analyzer</title><style>
...
<div class="header"><h1>robotics-share-of-voice-analyzer</h1><div class="subtitle">Robotics GTM share of voice analyzer service · port 51995</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51995</div>

...
PORT = 52751
SERVICE = "robotics-deal-coaching-engine"
DESCRIPTION = "Robotics GTM deal coaching engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-deal-coaching-engine</title><style>
...
<div class="header"><h1>robotics-deal-coaching-engine</h1><div class="subtitle">Robotics GTM deal coaching engine service · port 52751</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52751</div>

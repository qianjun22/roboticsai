"""Account expansion radar — automated detection and prioritization of upsell/expansion opportunities across all customer accounts
...
try:
    ...
    _has_fastapi = False
PORT = 10925
SERVICE = "account_expansion_radar"
DESCRIPTION = "Account expansion radar — automated detection and prioritization of upsell/expansion opportunities across all customer accounts"
if _has_fastapi:

...
PORT = 13837
SERVICE = "robotics_customer_journey_v5"
DESCRIPTION = "Robotics customer journey platform v5 — end-to-end customer lifecycle mapping and touchpoint optimization"

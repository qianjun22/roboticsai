"""Partner Certification Tracker — tracks certifications, exam progress, and renewal across partner tiers.
...
DESCRIPTION = "Tracks certifications, exam progress, and renewal across partner tiers"

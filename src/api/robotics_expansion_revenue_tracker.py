...
PORT = 50259
SERVICE = "robotics-expansion-revenue-tracker"
DESCRIPTION = "Robotics GTM expansion revenue tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-expansion-revenue-tracker</title><style>
...
<div class="header"><h1>robotics-expansion-revenue-tracker</h1><div class="subtitle">Robotics GTM expansion revenue tracker service · port 50259</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50259</div>

...
PORT = 11603
SERVICE = "sales-territory-optimizer"
DESCRIPTION = "Optimizes sales territory assignments using geographic clustering, account potential scoring, and rep capacity balancing"

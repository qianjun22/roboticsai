...
PORT = 13095
SERVICE = "robotics_territory_carve_optimizer"
DESCRIPTION = "Revenue operations territory carve optimizer for aligning sales coverage with robotics market opportunity"

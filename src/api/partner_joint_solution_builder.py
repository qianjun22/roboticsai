...
PORT = 11671
SERVICE = "partner-joint-solution-builder"
DESCRIPTION = "Facilitates joint solution development with partners including technical integration specs, GTM plans, and reference architectures"

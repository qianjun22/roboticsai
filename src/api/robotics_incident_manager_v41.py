...
PORT = 41055
SERVICE = "robotics_incident_manager"
DESCRIPTION = "GTM service: incident manager"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_incident_manager</title><style>
...
<div class="header"><h1>robotics_incident_manager</h1><div class="subtitle">GTM service: incident manager port 41055</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41055</div>

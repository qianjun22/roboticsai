...
PORT = 11635
SERVICE = "channel-conflict-resolution-manager"
DESCRIPTION = "Manages channel conflict resolution with deal registration, territory rules, and partner escalation workflows"

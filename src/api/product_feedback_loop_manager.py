...
PORT = 11651
SERVICE = "product-feedback-loop-manager"
DESCRIPTION = "Manages closed-loop product feedback from customers to engineering with prioritization scoring and response tracking"

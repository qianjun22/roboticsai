...
PORT = 11801
SERVICE = "product-growth-experiment-tracker"
DESCRIPTION = "Product growth experiment tracker for A/B test management, metric impact analysis, and rollout decision support"

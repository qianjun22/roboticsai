...
PORT = 12701
SERVICE = "enterprise-robotics-data-governance-framework"
DESCRIPTION = "Data governance framework for enterprise robotics — robot telemetry ownership, retention policies, and compliance controls"

...
PORT = 10545
SERVICE = "customer_reference_engine"
DESCRIPTION = "Customer reference engine: auto-match prospects to references, +22% close rate"
...
if FastAPI:
    ...
    def dashboard():
        lift = round(random.uniform(0.19, 0.25), 3); bar = int(lift * 220 * 4)

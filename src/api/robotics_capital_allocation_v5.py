...
PORT = 30509
SERVICE = "robotics_capital_allocation_v5"
DESCRIPTION = "Capital allocation GTM API microservice for robotics investment prioritization and budget distribution"

...
PORT = 13757
SERVICE = "robotics_event_led_pipeline_v2"
DESCRIPTION = "Robotics event-led pipeline v2 — conference and trade show demand generation, booth lead capture, and post-event nurture sequencing for robotics cloud"

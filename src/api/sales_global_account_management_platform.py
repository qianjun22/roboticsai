...
PORT = 12235
SERVICE = "sales-global-account-management-platform"
DESCRIPTION = "Global account management platform coordinating multi-region OCI Robot Cloud sales strategies, stakeholder mapping, and executive alignment for multinational enterprise customers"

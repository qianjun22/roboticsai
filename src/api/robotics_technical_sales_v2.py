...
PORT = 13605
SERVICE = "robotics_technical_sales_v2"
DESCRIPTION = "Robotics technical sales enablement platform v2 — manages proof-of-concept workflows, technical evaluation scoring, and solution engineering collaboration for enterprise deals"

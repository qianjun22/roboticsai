...
PORT = 16735
SERVICE = "robotics_workflow_integration_v5"
DESCRIPTION = "Robotics GTM workflow integration advisor embedding robot services into existing manufacturing and logistics flows"

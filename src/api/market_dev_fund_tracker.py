"""Market Dev Fund Tracker — manages partner MDF allocation, activities, and ROI measurement.
...
PORT = 10643
SERVICE = "market_dev_fund_tracker"
DESCRIPTION = "Manages partner MDF allocation, activities, and ROI measurement"

...
PORT = 15375
SERVICE = "robotics-initiative-planner"
DESCRIPTION = "GTM platform for initiative planner optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-initiative-planner</title><style>
...
<div class="header"><h1>robotics-initiative-planner</h1><div class="sub">GTM platform for initiative planner optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15375 | <b>Status:</b> <span style="color:#4ade80">Live</span>

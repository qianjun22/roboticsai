...
PORT = 12805
SERVICE = "robotics_churn_prevention_engine"
DESCRIPTION = "Identifies at-risk robotics customers and triggers interventions — usage decline detection, health score modeling, and automated outreach"

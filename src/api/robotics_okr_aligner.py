...
PORT = 15371
SERVICE = "robotics-okr-aligner"
DESCRIPTION = "GTM platform for okr aligner optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-okr-aligner</title><style>
...
<div class="header"><h1>robotics-okr-aligner</h1><div class="sub">GTM platform for okr aligner optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15371 | <b>Status:</b> <span style="color:#4ade80">Live</span>

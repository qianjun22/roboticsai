...
PORT = 12791
SERVICE = "robotics_design_partner_pipeline_v2"
DESCRIPTION = "Second-generation design partner pipeline — structured engagement tracking, co-development milestones, and commercial conversion metrics"

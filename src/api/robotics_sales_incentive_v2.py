...
PORT = 13587
SERVICE = "robotics_sales_incentive_v2"
DESCRIPTION = "Sales incentive management v2 for robotics platform — configures SPIFs, accelerators, and quota attainment bonuses for field sales teams"

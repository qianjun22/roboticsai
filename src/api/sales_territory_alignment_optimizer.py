...
PORT = 12653
SERVICE = "sales-territory-alignment-optimizer"
DESCRIPTION = "Optimizes enterprise robotics sales territory alignment based on market potential, rep capacity, and deal complexity"

...
PORT = 11959
SERVICE = "partner_cloud_migration_advisor"
DESCRIPTION = "Partner cloud migration advisor for workload assessment, migration wave planning, and partner-led cloud transition ROI modeling"

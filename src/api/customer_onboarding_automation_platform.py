...
PORT = 12485
SERVICE = "customer_onboarding_automation_platform"
DESCRIPTION = "Customer onboarding automation platform streamlining robotics deployment setup, training scheduling, and go-live milestone tracking"

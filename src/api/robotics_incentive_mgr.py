...
PORT = 15119
SERVICE = "robotics-incentive-mgr"
DESCRIPTION = "GTM platform for incentive mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-incentive-mgr</title><style>
...
<div class="header"><h1>robotics-incentive-mgr</h1><div class="sub">GTM platform for incentive mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15119 | <b>Status:</b> <span style="color:#4ade80">Live</span>

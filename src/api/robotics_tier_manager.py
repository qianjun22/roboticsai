...
PORT = 15311
SERVICE = "robotics-tier-manager"
DESCRIPTION = "GTM platform for tier manager optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-tier-manager</title><style>
...
<div class="header"><h1>robotics-tier-manager</h1><div class="sub">GTM platform for tier manager optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15311 | <b>Status:</b> <span style="color:#4ade80">Live</span>

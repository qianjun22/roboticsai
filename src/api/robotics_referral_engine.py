...
PORT = 15299
SERVICE = "robotics-referral-engine"
DESCRIPTION = "GTM platform for referral engine optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-referral-engine</title><style>
...
<div class="header"><h1>robotics-referral-engine</h1><div class="sub">GTM platform for referral engine optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15299 | <b>Status:</b> <span style="color:#4ade80">Live</span>

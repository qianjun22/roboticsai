...
PORT = 13723
SERVICE = "robotics_competitive_response_v3"
DESCRIPTION = "Robotics competitive response API v3 — competitive displacement campaigns, counter-messaging, and win-back strategy automation"

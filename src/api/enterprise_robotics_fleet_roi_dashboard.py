...
PORT = 12669
SERVICE = "enterprise-robotics-fleet-roi-dashboard"
DESCRIPTION = "Real-time ROI dashboard for enterprise robot fleets — throughput, uptime, cost-per-unit, and payback period"

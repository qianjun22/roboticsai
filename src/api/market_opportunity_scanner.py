"""Market Opportunity Scanner — AI-powered detection of new market opportunities via industry signals.
...
PORT = 10681
SERVICE = "market_opportunity_scanner"
DESCRIPTION = "AI-powered detection of new market opportunities via industry signals"

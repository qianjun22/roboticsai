...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sales-forecast-engine</title><style>
...
<div class="header"><h1>robotics-sales-forecast-engine</h1><div class="subtitle">Robotics GTM sales forecast engine service · port 50635</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50635</div>

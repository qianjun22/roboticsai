...
PORT = 50987
SERVICE = "robotics-technical-evaluation-tracker"
DESCRIPTION = "Robotics GTM technical evaluation tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-evaluation-tracker</title><style>
...
<div class="header"><h1>robotics-technical-evaluation-tracker</h1><div class="subtitle">Robotics GTM technical evaluation tracker service · port 50987</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50987</div>

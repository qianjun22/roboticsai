...
PORT = 50035
SERVICE = "robotics-enterprise-account-manager"
DESCRIPTION = "Robotics GTM enterprise account manager service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-enterprise-account-manager</title><style>
...
<div class="header"><h1>robotics-enterprise-account-manager</h1><div class="subtitle">Robotics GTM enterprise account manager service · port 50035</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50035</div>

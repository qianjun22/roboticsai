...
PORT = 13355
SERVICE = "robotics_customer_data_platform"
DESCRIPTION = "Customer data platform for unifying robotics cloud usage signals, health scores, and engagement telemetry across accounts"

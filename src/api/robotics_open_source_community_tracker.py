...
PORT = 12829
SERVICE = "robotics_open_source_community_tracker"
DESCRIPTION = "Tracks open source community engagement for robotics SDK — GitHub stars, fork activity, contributor growth, and issue resolution velocity"

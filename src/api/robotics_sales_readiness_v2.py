...
PORT = 13655
SERVICE = "robotics_sales_readiness_v2"
DESCRIPTION = "Robotics sales readiness assessment platform v2 — evaluates field rep knowledge, certification status, and territory coverage to identify readiness gaps and prescribe targeted enablement programs before key selling seasons"

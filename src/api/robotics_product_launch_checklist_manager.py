...
PORT = 12877
SERVICE = "robotics_product_launch_checklist_manager"
DESCRIPTION = "Manages product launch checklists for robotics features — cross-functional task tracking, go/no-go criteria, and launch readiness scoring"

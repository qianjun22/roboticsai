...
PORT = 12627
SERVICE = "customer-renewal-risk-scoring"
DESCRIPTION = "Predicts renewal risk for enterprise robotics customers using usage signals, NPS, and support ticket trends"

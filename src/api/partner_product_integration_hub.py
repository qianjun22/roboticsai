...
PORT = 11969
SERVICE = "partner_product_integration_hub"
DESCRIPTION = "Partner product integration hub for API connectivity tracking, joint solution testing coordination, and integration marketplace listing management"

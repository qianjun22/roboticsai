...
PORT = 11649
SERVICE = "competitive-win-rate-optimizer"
DESCRIPTION = "Analyzes win/loss patterns against each competitor and recommends positioning, pricing, and battle card improvements"

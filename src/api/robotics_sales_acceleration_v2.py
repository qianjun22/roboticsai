...
PORT = 13575
SERVICE = "robotics_sales_acceleration_v2"
DESCRIPTION = "Robotics sales acceleration platform v2 — AI-powered prospecting, deal coaching, competitive battlecard delivery, and sales play automation to accelerate robotics revenue growth"

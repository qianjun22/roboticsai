...
PORT = 11945
SERVICE = "partner_ecosystem_analytics_engine"
DESCRIPTION = "Partner ecosystem analytics engine for network effect measurement, partner interdependency mapping, and ecosystem health composite scoring"

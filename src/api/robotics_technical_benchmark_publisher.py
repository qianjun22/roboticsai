...
PORT = 50843
SERVICE = "robotics-technical-benchmark-publisher"
DESCRIPTION = "Robotics GTM technical benchmark publisher service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-benchmark-publisher</title><style>
...
<div class="header"><h1>robotics-technical-benchmark-publisher</h1><div class="subtitle">Robotics GTM technical benchmark publisher service · port 50843</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50843</div>

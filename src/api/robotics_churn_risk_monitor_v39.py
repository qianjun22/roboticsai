...
PORT = 39559
SERVICE = "robotics_churn_risk_monitor"
DESCRIPTION = "GTM service: churn risk monitor"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_churn_risk_monitor</title><style>
...
<div class="header"><h1>robotics_churn_risk_monitor</h1><div class="subtitle">GTM service: churn risk monitor port 39559</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39559</div>

...
PORT = 50471
SERVICE = "robotics-deployment-automation-svc"
DESCRIPTION = "Robotics GTM deployment automation svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-deployment-automation-svc</title><style>
...
<div class="header"><h1>robotics-deployment-automation-svc</h1><div class="subtitle">Robotics GTM deployment automation svc service · port 50471</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50471</div>

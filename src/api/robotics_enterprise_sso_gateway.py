...
PORT = 38461
SERVICE = "robotics_enterprise_sso_gateway"
DESCRIPTION = "Enterprise SSO gateway for robot cloud authentication"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_enterprise_sso_gateway</title><style>
...
<div class="header"><h1>robotics_enterprise_sso_gateway</h1><div class="subtitle">Enterprise SSO gateway for robot cloud authentication · port 38461</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38461</div>

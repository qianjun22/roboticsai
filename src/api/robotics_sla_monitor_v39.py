...
PORT = 39607
SERVICE = "robotics_sla_monitor"
DESCRIPTION = "GTM service: sla monitor"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_sla_monitor</title><style>
...
<div class="header"><h1>robotics_sla_monitor</h1><div class="subtitle">GTM service: sla monitor port 39607</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39607</div>

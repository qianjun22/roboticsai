...
PORT = 39563
SERVICE = "robotics_nps_collector"
DESCRIPTION = "GTM service: nps collector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_nps_collector</title><style>
...
<div class="header"><h1>robotics_nps_collector</h1><div class="subtitle">GTM service: nps collector port 39563</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39563</div>

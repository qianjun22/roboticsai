...
PORT = 53919
SERVICE = "robotics-milestone-billing-engine"
DESCRIPTION = "Robotics GTM milestone billing engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-milestone-billing-engine</title><style>
...
<div class="header"><h1>robotics-milestone-billing-engine</h1><div class="subtitle">Robotics GTM milestone billing engine service · port 53919</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53919</div>

...
DESCRIPTION = "GTM platform for spend tracker automation"
...
<div class="header"><h1>robotics-spend-tracker</h1><div class="sub">GTM platform for spend tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15057 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15255
SERVICE = "robotics-spend-tracker"
DESCRIPTION = "GTM platform for spend tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-spend-tracker</title><style>
...
<div class="header"><h1>robotics-spend-tracker</h1><div class="sub">GTM platform for spend tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15255 | <b>Status:</b> <span style="color:#4ade80">Live</span>

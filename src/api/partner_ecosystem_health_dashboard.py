...
PORT = 12497
SERVICE = "partner_ecosystem_health_dashboard"
DESCRIPTION = "Partner ecosystem health dashboard aggregating partner activity, pipeline contribution, enablement status, and satisfaction scores"

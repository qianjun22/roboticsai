...
PORT = 11621
SERVICE = "product-roadmap-customer-alignment"
DESCRIPTION = "Aligns product roadmap priorities with top customer requests using voting weights and strategic account scoring"

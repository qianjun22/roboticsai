...
PORT = 13695
SERVICE = "robotics_customer_advisory_v3"
DESCRIPTION = "Robotics customer advisory API v3 — advisory board management, customer feedback loops, and strategic input collection"

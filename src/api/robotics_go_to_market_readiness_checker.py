...
PORT = 12815
SERVICE = "robotics_go_to_market_readiness_checker"
DESCRIPTION = "Assesses GTM readiness for robotics product launches — pricing, packaging, sales enablement, partner readiness, and launch risk scoring"

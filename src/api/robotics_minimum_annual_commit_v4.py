...
PORT = 16707
SERVICE = "robotics_minimum_annual_commit_v4"
DESCRIPTION = "Robotics GTM minimum annual commitment calculator ensuring deal floor profitability and customer retention"

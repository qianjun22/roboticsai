...
PORT = 41127
SERVICE = "robotics_feature_adoption_tracker"
DESCRIPTION = "GTM service: feature adoption tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_feature_adoption_tracker</title><style>
...
<div class="header"><h1>robotics_feature_adoption_tracker</h1><div class="subtitle">GTM service: feature adoption tracker port 41127</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41127</div>

...
PORT = 53475
SERVICE = "robotics-distributor-enablement-svc"
DESCRIPTION = "Robotics GTM distributor enablement svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-distributor-enablement-svc</title><style>
...
<div class="header"><h1>robotics-distributor-enablement-svc</h1><div class="subtitle">Robotics GTM distributor enablement svc service · port 53475</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53475</div>

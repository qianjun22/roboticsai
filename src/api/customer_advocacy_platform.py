...
DESCRIPTION = "Customer advocacy platform: reference program, case studies, community"
...
if FastAPI:
    ...
    def dashboard():
        nps = round(random.uniform(72, 88), 1); bar = int((nps/100) * 220)

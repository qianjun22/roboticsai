...
PORT = 13615
SERVICE = "robotics_revenue_growth_v2"
DESCRIPTION = "Robotics revenue growth analytics platform v2 — tracks ARR expansion, identifies growth levers across segments and geos, and models revenue scenarios for quarterly planning"

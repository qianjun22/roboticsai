...
PORT = 13603
SERVICE = "robotics_partner_scorecard_v2"
DESCRIPTION = "Partner scorecard v2 for robotics platform — evaluates partner performance across certifications, deal registrations, revenue contribution, and customer satisfaction"

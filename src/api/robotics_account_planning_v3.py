...
PORT = 13805
SERVICE = "robotics_account_planning_v3"
DESCRIPTION = "Robotics account planning service v3 — strategic account plan generation, whitespace analysis, and multi-year growth roadmapping for robotics enterprise accounts"

...
PORT = 12785
SERVICE = "robotics_competitive_win_rate_analyzer"
DESCRIPTION = "Analyzes competitive win/loss patterns in robotics deals — differentiators, loss reasons, and strategic positioning recommendations"

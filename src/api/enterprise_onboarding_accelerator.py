"""Enterprise Onboarding Accelerator — structured 30-60-90 day enterprise time-to-value program.
...
DESCRIPTION = "Structured 30-60-90 day enterprise time-to-value program"

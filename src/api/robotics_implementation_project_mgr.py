...
PORT = 51119
SERVICE = "robotics-implementation-project-mgr"
DESCRIPTION = "Robotics GTM implementation project mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-implementation-project-mgr</title><style>
...
<div class="header"><h1>robotics-implementation-project-mgr</h1><div class="subtitle">Robotics GTM implementation project mgr service · port 51119</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51119</div>

...
PORT = 15229
SERVICE = "robotics-pipeline-velocity"
DESCRIPTION = "GTM platform for pipeline velocity automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pipeline-velocity</title><style>
...
<div class="header"><h1>robotics-pipeline-velocity</h1><div class="sub">GTM platform for pipeline velocity automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15229 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13213
SERVICE = "robotics_community_growth_tracker"
DESCRIPTION = "Community growth tracker for measuring developer forum activity, GitHub stars, and robotics SDK adoption"

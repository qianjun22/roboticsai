...
PORT = 11601
SERVICE = "customer-onboarding-optimizer"
DESCRIPTION = "Optimizes customer onboarding workflows with time-to-value tracking, milestone automation, and dropout prevention"

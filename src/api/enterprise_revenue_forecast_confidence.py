...
PORT = 11917
SERVICE = "enterprise_revenue_forecast_confidence"
DESCRIPTION = "Enterprise revenue forecast confidence engine for prediction interval modeling, forecast accuracy tracking, and variance root cause analysis"

...
PORT = 12807
SERVICE = "robotics_annual_recurring_revenue_model"
DESCRIPTION = "Models ARR growth for robotics cloud — cohort analysis, expansion revenue, churn impact, and path to $10M ARR projections"

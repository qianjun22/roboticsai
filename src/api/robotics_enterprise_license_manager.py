...
PORT = 12793
SERVICE = "robotics_enterprise_license_manager"
DESCRIPTION = "Manages enterprise robotics software licenses — seat tracking, renewal forecasting, compliance auditing, and multi-site allocation"

...
PORT = 13065
SERVICE = "robotics_customer_advisory_board_v2"
DESCRIPTION = "Customer advisory board v2 for robotics platform — manages CAB member selection, agenda planning, and feature feedback collection"

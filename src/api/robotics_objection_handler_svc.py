...
PORT = 50655
SERVICE = "robotics-objection-handler-svc"
DESCRIPTION = "Robotics GTM objection handler svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-objection-handler-svc</title><style>
...
<div class="header"><h1>robotics-objection-handler-svc</h1><div class="subtitle">Robotics GTM objection handler svc service · port 50655</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50655</div>

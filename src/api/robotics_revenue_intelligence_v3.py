...
PORT = 13793
SERVICE = "robotics_revenue_intelligence_v3"
DESCRIPTION = "Robotics revenue intelligence platform v3 — AI-driven revenue signal detection, deal scoring, and predictive revenue analytics"

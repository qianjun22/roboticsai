...
PORT = 18873
SERVICE = "robotics_tutoring_platform_v2"
DESCRIPTION = "Tutoring platform robotics service for adaptive one-on-one student instruction and progress monitoring"

...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_roadmap_voter</title><style>
...
<div class="header"><h1>robotics_roadmap_voter</h1><div class="subtitle">GTM service: roadmap voter port 39631</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39631</div>

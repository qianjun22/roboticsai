...
PORT = 11793
SERVICE = "enterprise-sales-training-platform"
DESCRIPTION = "Enterprise sales training platform for onboarding acceleration, skill assessment, and certification tracking"

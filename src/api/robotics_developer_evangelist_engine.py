...
PORT = 50879
SERVICE = "robotics-developer-evangelist-engine"
DESCRIPTION = "Robotics GTM developer evangelist engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-evangelist-engine</title><style>
...
<div class="header"><h1>robotics-developer-evangelist-engine</h1><div class="subtitle">Robotics GTM developer evangelist engine service · port 50879</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50879</div>

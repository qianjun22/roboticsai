...
PORT = 11767
SERVICE = "customer-value-acceleration-platform"
DESCRIPTION = "Customer value acceleration platform for fast-tracking time-to-value and driving early adoption milestones"

...
PORT = 11693
SERVICE = "product-value-realization-tracker"
DESCRIPTION = "Product value realization tracker for measuring customer ROI achievement and success milestone progression"

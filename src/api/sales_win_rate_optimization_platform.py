...
PORT = 11805
SERVICE = "sales-win-rate-optimization-platform"
DESCRIPTION = "Sales win rate optimization platform for deal quality scoring, coaching triggers, and methodology adherence"

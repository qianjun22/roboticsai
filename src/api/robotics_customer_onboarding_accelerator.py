...
PORT = 12975
SERVICE = "robotics_customer_onboarding_accelerator"
DESCRIPTION = "Customer onboarding accelerator for robotics platform — automates environment setup, integration validation, and first-value milestone tracking"

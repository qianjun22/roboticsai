...
PORT = 13145
SERVICE = "robotics_roi_calculator_v2"
DESCRIPTION = "ROI calculator v2 for quantifying cost savings, throughput gains, and payback period for robotics deployments"

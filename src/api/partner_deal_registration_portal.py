...
PORT = 12473
SERVICE = "partner_deal_registration_portal"
DESCRIPTION = "Partner deal registration portal with opportunity protection, conflict resolution workflows, and co-sell pipeline visibility"

...
PORT = 15363
SERVICE = "robotics-kpi-monitor"
DESCRIPTION = "GTM platform for kpi monitor optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-kpi-monitor</title><style>
...
<div class="header"><h1>robotics-kpi-monitor</h1><div class="sub">GTM platform for kpi monitor optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15363 | <b>Status:</b> <span style="color:#4ade80">Live</span>

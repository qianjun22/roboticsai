...
PORT = 13341
SERVICE = "robotics_annual_recurring_revenue_v3"
DESCRIPTION = "ARR v3 for modeling OCI Robot Cloud subscription growth, cohort expansion, and net revenue retention across robotics accounts"

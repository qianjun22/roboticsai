...
PORT = 11913
SERVICE = "partner_program_roi_calculator"
DESCRIPTION = "Partner program ROI calculator for investment-to-revenue attribution, partner tier benefit analysis, and program efficiency benchmarking"

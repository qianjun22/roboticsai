...
PORT = 50787
SERVICE = "robotics-partner-ecosystem-tracker"
DESCRIPTION = "Robotics GTM partner ecosystem tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-ecosystem-tracker</title><style>
...
<div class="header"><h1>robotics-partner-ecosystem-tracker</h1><div class="subtitle">Robotics GTM partner ecosystem tracker service · port 50787</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50787</div>

...
PORT = 15259
SERVICE = "robotics-roas-optimizer"
DESCRIPTION = "GTM platform for roas optimizer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-roas-optimizer</title><style>
...
<div class="header"><h1>robotics-roas-optimizer</h1><div class="sub">GTM platform for roas optimizer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15259 | <b>Status:</b> <span style="color:#4ade80">Live</span>

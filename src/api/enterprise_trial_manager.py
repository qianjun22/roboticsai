"""Enterprise trial manager — 30/60-day POC orchestration with defined success criteria, health dashboards, and 74% trial-to-paid conversion
...
DESCRIPTION = "Enterprise trial manager — 30/60-day POC orchestration with defined success criteria, health dashboards, and 74% trial-to-paid conversion"
if _has_fastapi:

...
PORT = 11665
SERVICE = "enterprise-contract-intelligence"
DESCRIPTION = "AI-powered contract intelligence extracting obligations, renewal dates, pricing clauses, and compliance requirements"

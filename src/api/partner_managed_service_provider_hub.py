...
PORT = 12231
SERVICE = "partner-managed-service-provider-hub"
DESCRIPTION = "Managed service provider hub enabling MSP partners to offer OCI Robot Cloud as a fully managed robotics AI service with white-glove support and SLA guarantees"

...
PORT = 50479
SERVICE = "robotics-integration-testing-orchestrator"
DESCRIPTION = "Robotics GTM integration testing orchestrator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-integration-testing-orchestrator</title><style>
...
<div class="header"><h1>robotics-integration-testing-orchestrator</h1><div class="subtitle">Robotics GTM integration testing orchestrator service · port 50479</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50479</div>

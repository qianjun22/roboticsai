...
PORT = 12421
SERVICE = "sales_conversion_rate_optimizer"
DESCRIPTION = "Conversion rate optimizer for robotics platform demo-to-close pipeline and sales velocity improvement"

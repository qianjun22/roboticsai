...
PORT = 12265
SERVICE = "enterprise-robotics-standards-compliance-hub"
DESCRIPTION = "Standards compliance hub tracking ISO 10218, ANSI/RIA R15.06, CE marking, and industry-specific safety certifications for enterprise robot deployments"

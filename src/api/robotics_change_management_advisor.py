...
PORT = 51895
SERVICE = "robotics-change-management-advisor"
DESCRIPTION = "Robotics GTM change management advisor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-change-management-advisor</title><style>
...
<div class="header"><h1>robotics-change-management-advisor</h1><div class="subtitle">Robotics GTM change management advisor service · port 51895</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51895</div>

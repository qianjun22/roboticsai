...
PORT = 13025
SERVICE = "robotics_product_led_growth_v2"
DESCRIPTION = "Product-led growth v2 for robotics platform — tracks free trial conversion, in-product expansion signals, and viral loop amplification"

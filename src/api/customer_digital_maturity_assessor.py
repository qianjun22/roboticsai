...
PORT = 11869
SERVICE = "customer_digital_maturity_assessor"
DESCRIPTION = "Customer digital maturity assessor for technology adoption scoring, transformation readiness analysis, and cloud migration pathway recommendations"

...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_series_a</title><style>
...
<div class="header"><h1>robotics_series_a</h1><div class="subtitle">Series A robotics growth pipeline and fundraising tracker · port 46839</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46839</div>

...
PORT = 12237
SERVICE = "enterprise-multi-tenant-robotics-platform"
DESCRIPTION = "Multi-tenant robotics platform providing isolated data, model, and compute environments for enterprise subsidiaries sharing OCI Robot Cloud infrastructure"

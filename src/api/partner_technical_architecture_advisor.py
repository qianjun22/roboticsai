...
PORT = 11951
SERVICE = "partner_technical_architecture_advisor"
DESCRIPTION = "Partner technical architecture advisor for solution design review, integration complexity scoring, and implementation risk assessment"

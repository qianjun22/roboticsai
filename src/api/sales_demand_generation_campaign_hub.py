...
PORT = 12377
SERVICE = "sales_demand_generation_campaign_hub"
DESCRIPTION = "Demand generation campaign hub for robotics platform inbound lead acquisition and nurture programs"

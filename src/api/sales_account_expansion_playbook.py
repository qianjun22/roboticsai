...
PORT = 11997
SERVICE = "sales-account-expansion-playbook"
DESCRIPTION = "Sales account expansion playbook for systematic upsell and cross-sell execution in enterprise accounts"

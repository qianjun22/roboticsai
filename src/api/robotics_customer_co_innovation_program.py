...
PORT = 12917
SERVICE = "robotics_customer_co_innovation_program"
DESCRIPTION = "Manages customer co-innovation program for robotics — joint research projects, IP sharing agreements, publication rights, and commercialization pathways"

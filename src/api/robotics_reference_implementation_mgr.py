...
<div class="header"><h1>robotics-reference-implementation-mgr</h1><div class="subtitle">Robotics GTM reference implementation mgr service · port 53111</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53111</div>

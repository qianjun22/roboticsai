...
PORT = 51023
SERVICE = "robotics-reference-implementation-mgr"
DESCRIPTION = "Robotics GTM reference implementation mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reference-implementation-mgr</title><style>
...
<div class="header"><h1>robotics-reference-implementation-mgr</h1><div class="subtitle">Robotics GTM reference implementation mgr service · port 51023</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51023</div>

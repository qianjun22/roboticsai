...
PORT = 13433
SERVICE = "robotics_executive_sponsorship_tracker"
DESCRIPTION = "Executive sponsorship tracker for managing C-suite relationships in robotics enterprise deals"

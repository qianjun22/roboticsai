...
PORT = 42477
SERVICE = "robotics_freemium_limiter"
DESCRIPTION = "GTM service: freemium limiter"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_freemium_limiter</title><style>
...
<div class="header"><h1>robotics_freemium_limiter</h1><div class="subtitle">GTM service: freemium limiter port 42477</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42477</div>

...
PORT = 50851
SERVICE = "robotics-reference-architecture-mgr"
DESCRIPTION = "Robotics GTM reference architecture mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-reference-architecture-mgr</title><style>
...
<div class="header"><h1>robotics-reference-architecture-mgr</h1><div class="subtitle">Robotics GTM reference architecture mgr service · port 50851</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50851</div>

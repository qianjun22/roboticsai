...
<div class="header"><h1>robotics-reference-architecture-mgr</h1><div class="subtitle">Robotics GTM reference architecture mgr service · port 53635</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53635</div>

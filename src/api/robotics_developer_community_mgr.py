...
PORT = 50875
SERVICE = "robotics-developer-community-mgr"
DESCRIPTION = "Robotics GTM developer community mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-developer-community-mgr</title><style>
...
<div class="header"><h1>robotics-developer-community-mgr</h1><div class="subtitle">Robotics GTM developer community mgr service · port 50875</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50875</div>

...
PORT = 15351
SERVICE = "robotics-report-generator"
DESCRIPTION = "GTM platform for report generator optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-report-generator</title><style>
...
<div class="header"><h1>robotics-report-generator</h1><div class="sub">GTM platform for report generator optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15351 | <b>Status:</b> <span style="color:#4ade80">Live</span>

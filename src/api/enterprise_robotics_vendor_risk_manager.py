...
PORT = 12459
SERVICE = "enterprise_robotics_vendor_risk_manager"
DESCRIPTION = "Enterprise robotics vendor risk manager for supplier concentration analysis, single-source mitigation, and supply chain resilience scoring"

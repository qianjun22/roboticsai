...
PORT = 11979
SERVICE = "enterprise_hr_analytics_platform"
DESCRIPTION = "Enterprise HR analytics platform for attrition prediction, compensation equity analysis, and talent acquisition funnel optimization"

...
PORT = 50947
SERVICE = "robotics-self-serve-onboarding-mgr"
DESCRIPTION = "Robotics GTM self serve onboarding mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-self-serve-onboarding-mgr</title><style>
...
<div class="header"><h1>robotics-self-serve-onboarding-mgr</h1><div class="subtitle">Robotics GTM self serve onboarding mgr service · port 50947</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50947</div>

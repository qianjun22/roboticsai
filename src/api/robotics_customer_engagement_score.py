...
PORT = 13081
SERVICE = "robotics_customer_engagement_score"
DESCRIPTION = "Customer engagement score for robotics platform — composite metric combining login frequency, API usage, support interactions, and community activity"

...
PORT = 50399
SERVICE = "robotics-customer-feedback-aggregator"
DESCRIPTION = "Robotics GTM customer feedback aggregator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-feedback-aggregator</title><style>
...
<div class="header"><h1>robotics-customer-feedback-aggregator</h1><div class="subtitle">Robotics GTM customer feedback aggregator service · port 50399</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50399</div>

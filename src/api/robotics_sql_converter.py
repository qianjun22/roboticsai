...
DESCRIPTION = "GTM platform for sql converter automation"
...
<div class="header"><h1>robotics-sql-converter</h1><div class="sub">GTM platform for sql converter automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15373 | <b>Status:</b> <span style="color:#4ade80">Live</span>

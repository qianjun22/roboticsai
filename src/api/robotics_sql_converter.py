...
PORT = 15131
SERVICE = "robotics-sql-converter"
DESCRIPTION = "GTM platform for sql converter optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sql-converter</title><style>
...
<div class="header"><h1>robotics-sql-converter</h1><div class="sub">GTM platform for sql converter optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15131 | <b>Status:</b> <span style="color:#4ade80">Live</span>

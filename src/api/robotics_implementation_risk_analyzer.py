...
<div class="header"><h1>robotics-implementation-risk-analyzer</h1><div class="subtitle">Robotics GTM implementation risk analyzer service · port 50495</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50495</div>

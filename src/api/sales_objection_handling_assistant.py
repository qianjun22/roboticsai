...
PORT = 11927
SERVICE = "sales_objection_handling_assistant"
DESCRIPTION = "Sales objection handling assistant for real-time counter-argument generation, competitor differentiation coaching, and deal risk mitigation"

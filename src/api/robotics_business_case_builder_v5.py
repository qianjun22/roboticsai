...
PORT = 16769
SERVICE = "robotics_business_case_builder_v5"
DESCRIPTION = "Robotics GTM business case builder generating executive-ready investment justifications for robot platform adoption"

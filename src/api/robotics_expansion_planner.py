...
DESCRIPTION = "GTM platform for expansion planner automation"
...
<div class="header"><h1>robotics-expansion-planner</h1><div class="sub">GTM platform for expansion planner automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15389 | <b>Status:</b> <span style="color:#4ade80">Live</span>

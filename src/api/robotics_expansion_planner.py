...
PORT = 15147
SERVICE = "robotics-expansion-planner"
DESCRIPTION = "GTM platform for expansion planner optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-expansion-planner</title><style>
...
<div class="header"><h1>robotics-expansion-planner</h1><div class="sub">GTM platform for expansion planner optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15147 | <b>Status:</b> <span style="color:#4ade80">Live</span>

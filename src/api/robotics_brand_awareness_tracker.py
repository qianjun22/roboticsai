...
PORT = 13111
SERVICE = "robotics_brand_awareness_tracker"
DESCRIPTION = "Brand awareness tracker for measuring OCI Robot Cloud visibility across robotics industry channels"

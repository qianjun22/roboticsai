...
PORT = 11855
SERVICE = "sales_deal_acceleration_platform"
DESCRIPTION = "Sales deal acceleration platform for mutual action plan tracking, stakeholder engagement scoring, and close date prediction"

...
PORT = 50311
SERVICE = "robotics-technical-win-analyzer"
DESCRIPTION = "Robotics GTM technical win analyzer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-technical-win-analyzer</title><style>
...
<div class="header"><h1>robotics-technical-win-analyzer</h1><div class="subtitle">Robotics GTM technical win analyzer service · port 50311</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50311</div>

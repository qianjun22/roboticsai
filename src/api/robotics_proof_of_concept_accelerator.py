...
PORT = 12803
SERVICE = "robotics_proof_of_concept_accelerator"
DESCRIPTION = "Accelerates robotics POC engagements — pre-built evaluation templates, data collection playbooks, and fast-track success metrics"

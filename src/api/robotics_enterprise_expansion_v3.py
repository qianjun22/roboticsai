...
PORT = 13209
SERVICE = "robotics_enterprise_expansion_v3"
DESCRIPTION = "Enterprise expansion v3 for managing multi-site, multi-use-case robotics deployments within strategic accounts"

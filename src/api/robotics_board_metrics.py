...
PORT = 15359
SERVICE = "robotics-board-metrics"
DESCRIPTION = "GTM platform for board metrics optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-board-metrics</title><style>
...
<div class="header"><h1>robotics-board-metrics</h1><div class="sub">GTM platform for board metrics optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15359 | <b>Status:</b> <span style="color:#4ade80">Live</span>

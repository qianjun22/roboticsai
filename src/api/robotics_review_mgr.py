...
PORT = 15271
SERVICE = "robotics-review-mgr"
DESCRIPTION = "GTM platform for review mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-review-mgr</title><style>
...
<div class="header"><h1>robotics-review-mgr</h1><div class="sub">GTM platform for review mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15271 | <b>Status:</b> <span style="color:#4ade80">Live</span>

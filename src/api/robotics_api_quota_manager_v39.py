...
PORT = 39691
SERVICE = "robotics_api_quota_manager"
DESCRIPTION = "GTM service: api quota manager"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_api_quota_manager</title><style>
...
<div class="header"><h1>robotics_api_quota_manager</h1><div class="subtitle">GTM service: api quota manager port 39691</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39691</div>

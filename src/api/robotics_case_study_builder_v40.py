...
PORT = 40483
SERVICE = "robotics_case_study_builder"
DESCRIPTION = "GTM service: case study builder"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_case_study_builder</title><style>
...
<div class="header"><h1>robotics_case_study_builder</h1><div class="subtitle">GTM service: case study builder port 40483</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40483</div>

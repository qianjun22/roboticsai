...
PORT = 40867
SERVICE = "robotics-async-first-v8"
DESCRIPTION = "Async-first communication platform for robotics GTM with structured handoffs, decision logs, and written culture"

...
PORT = 13363
SERVICE = "robotics_customer_advisory_board"
DESCRIPTION = "Customer advisory board for engaging top robotics accounts in product direction, roadmap feedback, and co-development initiatives"

...
PORT = 13647
SERVICE = "robotics_go_to_market_v6"
DESCRIPTION = "Robotics go-to-market strategy orchestration platform v6 — coordinates product launches, segment prioritization, pricing strategy, and field readiness programs across all robotics-as-a-service offerings"

...
PORT = 13347
SERVICE = "robotics_technical_account_mgmt"
DESCRIPTION = "Technical account management for providing dedicated robotics cloud expertise to strategic enterprise customers"

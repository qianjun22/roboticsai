...
PORT = 12155
SERVICE = "sales-market-penetration-tracker"
DESCRIPTION = "Market penetration tracking platform monitoring OCI Robot Cloud adoption across robotics verticals with segment-level pipeline and revenue analytics"

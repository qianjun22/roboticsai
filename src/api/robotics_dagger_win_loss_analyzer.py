...
PORT = 50149
SERVICE = "robotics-dagger-win-loss-analyzer"
DESCRIPTION = "Robotics GTM dagger win loss analyzer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-win-loss-analyzer</title><style>
...
<div class="header"><h1>robotics-dagger-win-loss-analyzer</h1><div class="subtitle">Robotics GTM dagger win loss analyzer service · port 50149</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50149</div>

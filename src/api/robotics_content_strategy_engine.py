...
PORT = 13015
SERVICE = "robotics_content_strategy_engine"
DESCRIPTION = "Content strategy engine for robotics marketing — plans technical blog posts, case studies, and white papers aligned with sales pipeline needs"

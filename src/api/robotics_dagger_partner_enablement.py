...
PORT = 50037
SERVICE = "robotics-dagger-partner-enablement"
DESCRIPTION = "Robotics GTM dagger partner enablement service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-partner-enablement</title><style>
...
<div class="header"><h1>robotics-dagger-partner-enablement</h1><div class="subtitle">Robotics GTM dagger partner enablement service · port 50037</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50037</div>

...
PORT = 16755
SERVICE = "robotics_user_buyer_v4"
DESCRIPTION = "Robotics GTM end-user buyer profiler identifying frontline operators and technicians influencing purchase decisions"

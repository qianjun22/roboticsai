...
PORT = 13759
SERVICE = "robotics_competitive_displacement_v2"
DESCRIPTION = "Robotics competitive displacement v2 — win/loss analysis, competitive battlecard automation, and displacement campaign tracking for robotics cloud"

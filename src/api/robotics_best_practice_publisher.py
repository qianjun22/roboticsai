...
PORT = 51031
SERVICE = "robotics-best-practice-publisher"
DESCRIPTION = "Robotics GTM best practice publisher service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-best-practice-publisher</title><style>
...
<div class="header"><h1>robotics-best-practice-publisher</h1><div class="subtitle">Robotics GTM best practice publisher service · port 51031</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51031</div>

...
PORT = 50467
SERVICE = "robotics-implementation-accelerator"
DESCRIPTION = "Robotics GTM implementation accelerator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-implementation-accelerator</title><style>
...
<div class="header"><h1>robotics-implementation-accelerator</h1><div class="subtitle">Robotics GTM implementation accelerator service · port 50467</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50467</div>

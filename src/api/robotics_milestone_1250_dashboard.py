...
PORT = 13057
SERVICE = "robotics_milestone_1250_dashboard"
DESCRIPTION = "Milestone dashboard for cycle 1250 — marks OCI Robot Cloud reaching 2500 services (1250 cycles × 2 files), with DAgger run 875+ in continuous training"

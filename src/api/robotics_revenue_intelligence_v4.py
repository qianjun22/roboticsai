...
PORT = 13847
SERVICE = "robotics_revenue_intelligence_v4"
DESCRIPTION = "Robotics revenue intelligence platform v4 — AI-powered revenue insights and predictive analytics for robotics deals"

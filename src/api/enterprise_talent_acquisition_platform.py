...
PORT = 12079
SERVICE = "enterprise-talent-acquisition-platform"
DESCRIPTION = "Enterprise talent acquisition platform for hiring robotics engineers and automation specialists"

...
PORT = 13507
SERVICE = "robotics_demand_generation_v2"
DESCRIPTION = "Robotics demand generation v2 — inbound lead capture, campaign attribution, and marketing-to-sales handoff automation for OCI Robot Cloud growth"

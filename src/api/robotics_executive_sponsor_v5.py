...
PORT = 16833
SERVICE = "robotics_executive_sponsor_v5"
DESCRIPTION = "Robotics GTM executive sponsor v5 with QBR automation and success milestone tracking for C-suite engagement"

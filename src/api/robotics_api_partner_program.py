...
PORT = 13013
SERVICE = "robotics_api_partner_program"
DESCRIPTION = "API partner program manager for robotics platform — handles ISV onboarding, API key governance, and co-marketing agreements"

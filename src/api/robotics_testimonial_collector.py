...
PORT = 50571
SERVICE = "robotics-testimonial-collector"
DESCRIPTION = "Robotics GTM testimonial collector service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-testimonial-collector</title><style>
...
<div class="header"><h1>robotics-testimonial-collector</h1><div class="subtitle">Robotics GTM testimonial collector service · port 50571</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50571</div>

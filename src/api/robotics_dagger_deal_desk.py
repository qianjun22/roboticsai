...
PORT = 50497
SERVICE = "robotics-dagger-deal-desk"
DESCRIPTION = "Robotics GTM dagger deal desk service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-deal-desk</title><style>
...
<div class="header"><h1>robotics-dagger-deal-desk</h1><div class="subtitle">Robotics GTM dagger deal desk service · port 50497</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50497</div>

...
PORT = 13285
SERVICE = "robotics_sales_cycle_optimizer"
DESCRIPTION = "Sales cycle optimizer for reducing time-to-close on robotics cloud deals through stage-specific playbook automation"

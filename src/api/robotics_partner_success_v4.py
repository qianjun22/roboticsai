...
PORT = 13713
SERVICE = "robotics_partner_success_v4"
DESCRIPTION = "Robotics partner success API v4 — partner health scoring, enablement program tracking, and joint customer success orchestration"

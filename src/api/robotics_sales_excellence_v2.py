...
PORT = 13611
SERVICE = "robotics_sales_excellence_v2"
DESCRIPTION = "Robotics sales excellence framework v2 — drives best-practice adoption across field sales teams with playbook enforcement, deal review automation, and win/loss pattern analysis"

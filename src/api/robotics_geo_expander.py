...
DESCRIPTION = "GTM platform for geo expander automation"
...
<div class="header"><h1>robotics-geo-expander</h1><div class="sub">GTM platform for geo expander automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15041 | <b>Status:</b> <span style="color:#4ade80">Live</span>

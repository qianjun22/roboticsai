...
PORT = 15239
SERVICE = "robotics-geo-expander"
DESCRIPTION = "GTM platform for geo expander optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-geo-expander</title><style>
...
<div class="header"><h1>robotics-geo-expander</h1><div class="sub">GTM platform for geo expander optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15239 | <b>Status:</b> <span style="color:#4ade80">Live</span>

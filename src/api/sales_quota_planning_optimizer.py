...
PORT = 11729
SERVICE = "sales-quota-planning-optimizer"
DESCRIPTION = "Sales quota planning optimizer for territory-based allocation, historical attainment analysis, and bottoms-up modeling"

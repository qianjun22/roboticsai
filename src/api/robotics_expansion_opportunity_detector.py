...
PORT = 51771
SERVICE = "robotics-expansion-opportunity-detector"
DESCRIPTION = "Robotics GTM expansion opportunity detector service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-expansion-opportunity-detector</title><style>
...
<div class="header"><h1>robotics-expansion-opportunity-detector</h1><div class="subtitle">Robotics GTM expansion opportunity detector service · port 51771</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51771</div>

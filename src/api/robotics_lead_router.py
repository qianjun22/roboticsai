...
PORT = 15123
SERVICE = "robotics-lead-router"
DESCRIPTION = "GTM platform for lead router optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-lead-router</title><style>
...
<div class="header"><h1>robotics-lead-router</h1><div class="sub">GTM platform for lead router optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15123 | <b>Status:</b> <span style="color:#4ade80">Live</span>

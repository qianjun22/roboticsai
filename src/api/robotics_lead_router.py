...
DESCRIPTION = "GTM platform for lead router automation"
...
<div class="header"><h1>robotics-lead-router</h1><div class="sub">GTM platform for lead router automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15365 | <b>Status:</b> <span style="color:#4ade80">Live</span>

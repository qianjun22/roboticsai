...
PORT = 12549
SERVICE = "sales_strategic_account_planning_platform"
DESCRIPTION = "Sales strategic account planning platform with multi-year growth modeling, stakeholder mapping, and executive relationship tracking"

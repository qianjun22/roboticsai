...
PORT = 12819
SERVICE = "robotics_ecosystem_integration_catalog"
DESCRIPTION = "Catalog of validated robotics ecosystem integrations — third-party sensors, actuators, simulators, and cloud services with compatibility matrix"

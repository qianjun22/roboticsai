"""Partner deal flow manager — tracks joint sales opportunities, co-sell pipeline, and deal registration for OCI robotics partners
...
try:
    ...
    _has_fastapi = False
PORT = 10923
SERVICE = "partner_deal_flow_manager"
DESCRIPTION = "Partner deal flow manager — tracks joint sales opportunities, co-sell pipeline, and deal registration for OCI robotics partners"
if _has_fastapi:

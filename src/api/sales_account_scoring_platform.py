...
PORT = 11819
SERVICE = "sales-account-scoring-platform"
DESCRIPTION = "Sales account scoring platform for ICP fit rating, propensity to buy modeling, and prioritization ranking"

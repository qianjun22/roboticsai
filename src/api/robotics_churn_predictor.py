...
DESCRIPTION = "GTM platform for churn predictor automation"
...
<div class="header"><h1>robotics-churn-predictor</h1><div class="sub">GTM platform for churn predictor automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15241 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 14999
SERVICE = "robotics-churn-predictor"
DESCRIPTION = "GTM platform for churn predictor optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-churn-predictor</title><style>
...
<div class="header"><h1>robotics-churn-predictor</h1><div class="sub">GTM platform for churn predictor optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14999 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13183
SERVICE = "robotics_market_timing_analyzer"
DESCRIPTION = "Market timing analyzer for identifying optimal windows for OCI Robot Cloud product launches and partnership announcements"

...
PORT = 12915
SERVICE = "robotics_sales_engineering_toolkit"
DESCRIPTION = "Toolkit for robotics sales engineers — demo environment management, technical proposal templates, integration checklist, and competitive technical objection library"

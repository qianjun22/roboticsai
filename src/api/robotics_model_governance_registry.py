...
PORT = 12923
SERVICE = "robotics_model_governance_registry"
DESCRIPTION = "Maintains governance registry for robotics AI models — approval workflows, deployment authorization, version lineage, and audit trail for production models"

...
PORT = 12527
SERVICE = "sales_contract_intelligence_platform"
DESCRIPTION = "Sales contract intelligence platform extracting key terms, renewal dates, expansion clauses, and risk flags from robotics customer agreements"

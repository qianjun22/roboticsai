...
PORT = 11737
SERVICE = "revenue-predictability-platform"
DESCRIPTION = "Revenue predictability platform for ARR forecasting, churn modeling, and expansion revenue projection"

...
PORT = 15139
SERVICE = "robotics-poc-tracker"
DESCRIPTION = "GTM platform for poc tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-poc-tracker</title><style>
...
<div class="header"><h1>robotics-poc-tracker</h1><div class="sub">GTM platform for poc tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15139 | <b>Status:</b> <span style="color:#4ade80">Live</span>

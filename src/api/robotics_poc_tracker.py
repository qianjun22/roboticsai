...
DESCRIPTION = "GTM platform for poc tracker automation"
...
<div class="header"><h1>robotics-poc-tracker</h1><div class="sub">GTM platform for poc tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15381 | <b>Status:</b> <span style="color:#4ade80">Live</span>

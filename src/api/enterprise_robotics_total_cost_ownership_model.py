...
PORT = 12637
SERVICE = "enterprise-robotics-tco-model"
DESCRIPTION = "Total cost of ownership modeling for enterprise robotics deployments including hardware, cloud, and training costs"

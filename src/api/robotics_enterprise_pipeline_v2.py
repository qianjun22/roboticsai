...
PORT = 13325
SERVICE = "robotics_enterprise_pipeline_v2"
DESCRIPTION = "Enterprise pipeline v2 for tracking large robotics cloud opportunities through discovery, POC, and commercial stages"

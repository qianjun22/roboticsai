...
PORT = 50155
SERVICE = "robotics-channel-fit-v9"
DESCRIPTION = "Channel-fit v9 optimizer for robotics GTM with multi-touch attribution modeling and channel ROI maximization"

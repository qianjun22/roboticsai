...
PORT = 12445
SERVICE = "enterprise_robotics_roi_calculator_v2"
DESCRIPTION = "Enterprise robotics ROI calculator v2 with TCO modeling, payback period analysis, and labor cost displacement projections"

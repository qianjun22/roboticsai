...
PORT = 41623
SERVICE = "robotics_marketplace_listing"
DESCRIPTION = "GTM service: marketplace listing"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_marketplace_listing</title><style>
...
<div class="header"><h1>robotics_marketplace_listing</h1><div class="subtitle">GTM service: marketplace listing port 41623</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41623</div>

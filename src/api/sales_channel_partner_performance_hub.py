...
PORT = 12267
SERVICE = "sales-channel-partner-performance-hub"
DESCRIPTION = "Channel partner performance hub benchmarking reseller effectiveness, tracking partner-influenced pipeline, and optimizing incentive structures for OCI Robot Cloud distribution"

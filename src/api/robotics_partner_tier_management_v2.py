...
PORT = 13367
SERVICE = "robotics_partner_tier_management_v2"
DESCRIPTION = "Partner tier management v2 for structuring silver, gold, and platinum robotics cloud partner tiers with differentiated benefits"

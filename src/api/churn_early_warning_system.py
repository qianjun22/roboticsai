...
PORT = 11609
SERVICE = "churn-early-warning-system"
DESCRIPTION = "Detects early churn signals using usage decline patterns, support ticket spikes, and engagement score drops"

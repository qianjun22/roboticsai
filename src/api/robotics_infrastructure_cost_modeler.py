...
PORT = 12843
SERVICE = "robotics_infrastructure_cost_modeler"
DESCRIPTION = "Models robotics cloud infrastructure costs — compute, storage, networking per workload type with optimization recommendations and reserved capacity planning"

...
PORT = 12945
SERVICE = "robotics_partner_pipeline_analytics"
DESCRIPTION = "Partner pipeline analytics for robotics ecosystem — tracks deal progression, integration stages, and revenue potential by partner tier"

...
PORT = 51787
SERVICE = "robotics-renewal-risk-alerter"
DESCRIPTION = "Robotics GTM renewal risk alerter service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-renewal-risk-alerter</title><style>
...
<div class="header"><h1>robotics-renewal-risk-alerter</h1><div class="subtitle">Robotics GTM renewal risk alerter service · port 51787</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51787</div>

...
<div class="header"><h1>robotics-demo-environment-provisioner</h1><div class="subtitle">Robotics GTM demo environment provisioner service · port 52935</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52935</div>

...
PORT = 11577
SERVICE = "nvidia-partnership-pipeline-tracker"
DESCRIPTION = "Tracks NVIDIA partnership pipeline including Isaac team contacts, co-engineering requests, and joint GTM milestones"

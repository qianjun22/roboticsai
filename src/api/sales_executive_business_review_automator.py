...
PORT = 12501
SERVICE = "sales_executive_business_review_automator"
DESCRIPTION = "Sales executive business review automator generating QBR decks with pipeline health, forecast accuracy, and strategic account summaries"

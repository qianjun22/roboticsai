...
PORT = 13635
SERVICE = "robotics_sales_coaching_v2"
DESCRIPTION = "Robotics sales coaching and enablement platform v2 — delivers personalized coaching recommendations to AEs based on call analysis, pipeline patterns, and performance gaps to drive quota attainment"

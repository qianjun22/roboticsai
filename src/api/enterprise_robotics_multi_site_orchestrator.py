...
PORT = 12413
SERVICE = "enterprise_robotics_multi_site_orchestrator"
DESCRIPTION = "Enterprise robotics multi-site orchestrator for coordinated fleet deployment across factory locations"

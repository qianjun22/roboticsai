...
PORT = 50779
SERVICE = "robotics-channel-partner-enabler"
DESCRIPTION = "Robotics GTM channel partner enabler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-channel-partner-enabler</title><style>
...
<div class="header"><h1>robotics-channel-partner-enabler</h1><div class="subtitle">Robotics GTM channel partner enabler service · port 50779</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50779</div>

...
PORT = 12579
SERVICE = "enterprise_robotics_capability_maturity_model"
DESCRIPTION = "Enterprise robotics capability maturity model assessing automation readiness across people, process, technology, and data dimensions"

...
PORT = 13607
SERVICE = "robotics_renewal_management_v2"
DESCRIPTION = "Robotics contract renewal management platform v2 — tracks renewal timelines, automates early warning alerts, and manages upsell motions for robotics-as-a-service subscriptions"

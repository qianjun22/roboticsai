...
PORT = 12173
SERVICE = "enterprise-sustainability-roi-calculator"
DESCRIPTION = "ROI calculator quantifying sustainability benefits of robotic automation — energy savings, waste reduction, carbon footprint, and ESG reporting metrics"

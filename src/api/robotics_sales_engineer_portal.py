...
PORT = 50971
SERVICE = "robotics-sales-engineer-portal"
DESCRIPTION = "Robotics GTM sales engineer portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sales-engineer-portal</title><style>
...
<div class="header"><h1>robotics-sales-engineer-portal</h1><div class="subtitle">Robotics GTM sales engineer portal service · port 50971</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50971</div>

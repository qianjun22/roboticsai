...
PORT = 30689
SERVICE = "robotics_terraform_ops_v5"
DESCRIPTION = "Terraform operations GTM microservice for robotics infrastructure-as-code provisioning and state management"

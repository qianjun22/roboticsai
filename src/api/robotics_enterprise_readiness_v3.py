...
PORT = 13791
SERVICE = "robotics_enterprise_readiness_v3"
DESCRIPTION = "Robotics enterprise readiness service v3 — enterprise qualification scoring, compliance gap analysis, and deployment readiness assessment"

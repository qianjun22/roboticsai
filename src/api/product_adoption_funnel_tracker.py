...
PORT = 11605
SERVICE = "product-adoption-funnel-tracker"
DESCRIPTION = "Tracks product adoption funnel stages from signup through power-user status with cohort-level visibility"

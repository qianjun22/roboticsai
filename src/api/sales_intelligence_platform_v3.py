...
PORT = 11679
SERVICE = "sales-intelligence-platform-v3"
DESCRIPTION = "V3 sales intelligence platform with GPT-powered prospect research, intent signal aggregation, and conversation intelligence"

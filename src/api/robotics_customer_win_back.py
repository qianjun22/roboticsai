...
PORT = 13585
SERVICE = "robotics_customer_win_back"
DESCRIPTION = "Customer win-back service for robotics platform — identifies churned or at-risk accounts and triggers re-engagement campaigns with tailored offers"

...
PORT = 50845
SERVICE = "robotics-dagger-content-mgr"
DESCRIPTION = "Robotics GTM dagger content mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-content-mgr</title><style>
...
<div class="header"><h1>robotics-dagger-content-mgr</h1><div class="subtitle">Robotics GTM dagger content mgr service · port 50845</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50845</div>

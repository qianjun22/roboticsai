...
PORT = 13169
SERVICE = "robotics_pricing_governance"
DESCRIPTION = "Pricing governance framework for managing discount approvals, deal desk escalations, and margin floors in robotics"

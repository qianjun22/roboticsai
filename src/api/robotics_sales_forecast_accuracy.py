...
PORT = 13109
SERVICE = "robotics_sales_forecast_accuracy"
DESCRIPTION = "Sales forecast accuracy tracker for measuring and improving pipeline prediction reliability in robotics"

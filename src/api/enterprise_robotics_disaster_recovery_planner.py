...
PORT = 12371
SERVICE = "enterprise_robotics_disaster_recovery_planner"
DESCRIPTION = "Enterprise robotics disaster recovery planner for fleet failover continuity and backup policy management"

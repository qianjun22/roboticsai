...
PORT = 16787
SERVICE = "robotics_packaging_strategy_v6"
DESCRIPTION = "Robotics GTM packaging strategy v6 with modular add-ons, vertical-specific bundles and fleet-size tiers"

...
PORT = 12655
SERVICE = "enterprise-robotics-regulatory-compliance"
DESCRIPTION = "Monitors regulatory compliance for enterprise robot deployments — ISO 10218, OSHA, CE marking status tracking"

...
PORT = 50839
SERVICE = "robotics-roi-calculator-service"
DESCRIPTION = "Robotics GTM roi calculator service service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-roi-calculator-service</title><style>
...
<div class="header"><h1>robotics-roi-calculator-service</h1><div class="subtitle">Robotics GTM roi calculator service service · port 50839</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50839</div>

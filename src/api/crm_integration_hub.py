"""CRM Integration Hub — FastAPI port 9001"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>CRM Integration Hub</title>
...
<body><h1>CRM Integration Hub</h1>
<div class="card"><h2>CRM Pipeline</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="CRM Integration Hub")

"""Partner pipeline accelerator — co-sell playbooks and joint pursuit cadence delivering 31% faster close with NVIDIA co-sell at 42% acceleration
...
DESCRIPTION = "Partner pipeline accelerator — co-sell playbooks and joint pursuit cadence delivering 31% faster close with NVIDIA co-sell at 42% acceleration"
if _has_fastapi:

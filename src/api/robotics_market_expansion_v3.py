...
PORT = 13789
SERVICE = "robotics_market_expansion_v3"
DESCRIPTION = "Robotics market expansion service v3 — new geography entry planning, TAM analysis, and expansion readiness scoring for robotics cloud"

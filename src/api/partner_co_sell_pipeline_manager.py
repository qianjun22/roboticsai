...
PORT = 11625
SERVICE = "partner-co-sell-pipeline-manager"
DESCRIPTION = "Manages partner co-sell pipeline with joint opportunity tracking, influence attribution, and revenue sharing calculations"

...
PORT = 50931
SERVICE = "robotics-viral-loop-analyzer"
DESCRIPTION = "Robotics GTM viral loop analyzer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-viral-loop-analyzer</title><style>
...
<div class="header"><h1>robotics-viral-loop-analyzer</h1><div class="subtitle">Robotics GTM viral loop analyzer service · port 50931</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50931</div>

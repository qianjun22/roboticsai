...
PORT = 50043
SERVICE = "robotics-enterprise-pipeline-tracker"
DESCRIPTION = "Robotics GTM enterprise pipeline tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-enterprise-pipeline-tracker</title><style>
...
<div class="header"><h1>robotics-enterprise-pipeline-tracker</h1><div class="subtitle">Robotics GTM enterprise pipeline tracker service · port 50043</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50043</div>

...
PORT = 50555
SERVICE = "robotics-intent-data-aggregator"
DESCRIPTION = "Robotics GTM intent data aggregator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-intent-data-aggregator</title><style>
...
<div class="header"><h1>robotics-intent-data-aggregator</h1><div class="subtitle">Robotics GTM intent data aggregator service · port 50555</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50555</div>

...
PORT = 12423
SERVICE = "partner_channel_conflict_resolver"
DESCRIPTION = "Partner channel conflict resolver for robotics platform territory overlap and account assignment management"

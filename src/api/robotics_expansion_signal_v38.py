...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_expansion_signal</title><style>
...
<div class="header"><h1>robotics_expansion_signal</h1><div class="subtitle">GTM service: expansion signal port 38835</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38835</div>

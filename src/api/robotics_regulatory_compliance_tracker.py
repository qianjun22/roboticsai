...
PORT = 52095
SERVICE = "robotics-regulatory-compliance-tracker"
DESCRIPTION = "Robotics GTM regulatory compliance tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-regulatory-compliance-tracker</title><style>
...
<div class="header"><h1>robotics-regulatory-compliance-tracker</h1><div class="subtitle">Robotics GTM regulatory compliance tracker service · port 52095</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52095</div>

...
PORT = 11631
SERVICE = "strategic-account-health-monitor"
DESCRIPTION = "Monitors strategic account health across product adoption, executive engagement, support tickets, and renewal risk signals"

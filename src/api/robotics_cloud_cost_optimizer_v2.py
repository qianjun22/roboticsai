...
PORT = 12971
SERVICE = "robotics_cloud_cost_optimizer_v2"
DESCRIPTION = "Cloud cost optimizer v2 for robotics workloads — recommends instance types, spot usage, and training schedule adjustments for maximum cost efficiency"

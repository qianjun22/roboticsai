...
PORT = 52463
SERVICE = "robotics-churn-risk-predictor"
DESCRIPTION = "Robotics GTM churn risk predictor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-churn-risk-predictor</title><style>
...
<div class="header"><h1>robotics-churn-risk-predictor</h1><div class="subtitle">Robotics GTM churn risk predictor service · port 52463</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52463</div>

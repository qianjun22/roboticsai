...
PORT = 15011
SERVICE = "robotics-territory-mapper"
DESCRIPTION = "GTM platform for territory mapper optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-territory-mapper</title><style>
...
<div class="header"><h1>robotics-territory-mapper</h1><div class="sub">GTM platform for territory mapper optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15011 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
DESCRIPTION = "GTM platform for territory mapper automation"
...
<div class="header"><h1>robotics-territory-mapper</h1><div class="sub">GTM platform for territory mapper automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15253 | <b>Status:</b> <span style="color:#4ade80">Live</span>

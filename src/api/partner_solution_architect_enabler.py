...
PORT = 11713
SERVICE = "partner-solution-architect-enabler"
DESCRIPTION = "Partner solution architect enablement platform for technical certification and customer demo readiness"

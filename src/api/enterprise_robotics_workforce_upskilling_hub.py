...
PORT = 12381
SERVICE = "enterprise_robotics_workforce_upskilling_hub"
DESCRIPTION = "Enterprise robotics workforce upskilling hub for operator training and certification programs"

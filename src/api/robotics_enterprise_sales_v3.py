...
PORT = 13277
SERVICE = "robotics_enterprise_sales_v3"
DESCRIPTION = "Enterprise sales v3 for managing complex multi-stakeholder robotics deals with procurement, legal, and technical evaluation tracks"

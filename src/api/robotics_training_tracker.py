...
DESCRIPTION = "GTM platform for training tracker automation"
...
<div class="header"><h1>robotics-training-tracker</h1><div class="sub">GTM platform for training tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15337 | <b>Status:</b> <span style="color:#4ade80">Live</span>

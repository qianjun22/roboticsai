...
PORT = 15095
SERVICE = "robotics-training-tracker"
DESCRIPTION = "GTM platform for training tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-training-tracker</title><style>
...
<div class="header"><h1>robotics-training-tracker</h1><div class="sub">GTM platform for training tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15095 | <b>Status:</b> <span style="color:#4ade80">Live</span>

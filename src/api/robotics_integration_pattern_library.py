...
PORT = 50347
SERVICE = "robotics-integration-pattern-library"
DESCRIPTION = "Robotics GTM integration pattern library service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-integration-pattern-library</title><style>
...
<div class="header"><h1>robotics-integration-pattern-library</h1><div class="subtitle">Robotics GTM integration pattern library service · port 50347</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50347</div>

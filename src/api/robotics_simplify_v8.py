...
PORT = 36075
SERVICE = "robotics-simplify-v8"
DESCRIPTION = "Simplification engine for robotics GTM reducing complexity to core value propositions and streamlined workflows"

...
DESCRIPTION = "GTM platform for brand monitor automation"
...
<div class="header"><h1>robotics-brand-monitor</h1><div class="sub">GTM platform for brand monitor automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15065 | <b>Status:</b> <span style="color:#4ade80">Live</span>

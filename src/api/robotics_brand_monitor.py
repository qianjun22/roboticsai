...
PORT = 15263
SERVICE = "robotics-brand-monitor"
DESCRIPTION = "GTM platform for brand monitor optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-brand-monitor</title><style>
...
<div class="header"><h1>robotics-brand-monitor</h1><div class="sub">GTM platform for brand monitor optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15263 | <b>Status:</b> <span style="color:#4ade80">Live</span>

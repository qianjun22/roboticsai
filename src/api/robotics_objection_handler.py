...
PORT = 15043
SERVICE = "robotics-objection-handler"
DESCRIPTION = "GTM platform for objection handler optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-objection-handler</title><style>
...
<div class="header"><h1>robotics-objection-handler</h1><div class="sub">GTM platform for objection handler optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15043 | <b>Status:</b> <span style="color:#4ade80">Live</span>

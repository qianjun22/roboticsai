...
DESCRIPTION = "GTM platform for objection handler automation"
...
<div class="header"><h1>robotics-objection-handler</h1><div class="sub">GTM platform for objection handler automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15285 | <b>Status:</b> <span style="color:#4ade80">Live</span>

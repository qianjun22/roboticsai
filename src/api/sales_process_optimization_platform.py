...
PORT = 11667
SERVICE = "sales-process-optimization-platform"
DESCRIPTION = "Optimizes sales process efficiency by identifying bottlenecks, automating workflows, and standardizing winning patterns"

...
PORT = 38795
SERVICE = "robotics_beta_program"
DESCRIPTION = "GTM service: beta program"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_beta_program</title><style>
...
<div class="header"><h1>robotics_beta_program</h1><div class="subtitle">GTM service: beta program port 38795</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38795</div>

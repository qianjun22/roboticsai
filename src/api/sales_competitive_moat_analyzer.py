...
PORT = 12559
SERVICE = "sales_competitive_moat_analyzer"
DESCRIPTION = "Sales competitive moat analyzer mapping proprietary data advantages, switching costs, and network effects to support robotics value selling"

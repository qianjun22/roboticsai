...
PORT = 15099
SERVICE = "robotics-certification-mgr"
DESCRIPTION = "GTM platform for certification mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-certification-mgr</title><style>
...
<div class="header"><h1>robotics-certification-mgr</h1><div class="sub">GTM platform for certification mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15099 | <b>Status:</b> <span style="color:#4ade80">Live</span>

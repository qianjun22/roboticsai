...
PORT = 13545
SERVICE = "robotics_channel_ops_v2"
DESCRIPTION = "Channel operations service v2 — streamlines indirect sales channel management, deal registration, MDF allocation, and reseller performance tracking for robotics"

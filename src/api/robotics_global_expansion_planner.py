...
PORT = 53479
SERVICE = "robotics-global-expansion-planner"
DESCRIPTION = "Robotics GTM global expansion planner service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-global-expansion-planner</title><style>
...
<div class="header"><h1>robotics-global-expansion-planner</h1><div class="subtitle">Robotics GTM global expansion planner service · port 53479</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53479</div>

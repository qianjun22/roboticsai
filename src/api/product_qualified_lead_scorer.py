"""Product qualified lead scorer — LightGBM PQL model on 23 behavioral signals, 34% PQL-to-paid conversion vs 8% outbound
...
try:
    ...
    _has_fastapi = False
PORT = 10987
SERVICE = "product_qualified_lead_scorer"
DESCRIPTION = "Product qualified lead scorer — LightGBM PQL model on 23 behavioral signals, 34% PQL-to-paid conversion vs 8% outbound"
if _has_fastapi:

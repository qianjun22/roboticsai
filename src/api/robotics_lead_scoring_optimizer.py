...
PORT = 52635
SERVICE = "robotics-lead-scoring-optimizer"
DESCRIPTION = "Robotics GTM lead scoring optimizer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-lead-scoring-optimizer</title><style>
...
<div class="header"><h1>robotics-lead-scoring-optimizer</h1><div class="subtitle">Robotics GTM lead scoring optimizer service · port 52635</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52635</div>

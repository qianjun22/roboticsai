"""GTM Attribution Platform — Shapley-value multi-touch attribution across all go-to-market channels.
...
PORT = 10677
SERVICE = "gtm_attribution_platform"
DESCRIPTION = "Shapley-value multi-touch attribution across all go-to-market channels"

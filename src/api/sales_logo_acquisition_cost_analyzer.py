...
PORT = 12683
SERVICE = "sales-logo-acquisition-cost-analyzer"
DESCRIPTION = "Analyzes customer acquisition cost per logo for enterprise robotics — CAC trends by segment, channel, and deal size"

...
PORT = 15069
SERVICE = "robotics-sentiment-tracker"
DESCRIPTION = "GTM platform for sentiment tracker automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-sentiment-tracker</title><style>
...
<div class="header"><h1>robotics-sentiment-tracker</h1><div class="sub">GTM platform for sentiment tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15069 | <b>Status:</b> <span style="color:#4ade80">Live</span>

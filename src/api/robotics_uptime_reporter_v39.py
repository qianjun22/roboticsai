...
PORT = 39971
SERVICE = "robotics_uptime_reporter"
DESCRIPTION = "GTM service: uptime reporter"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_uptime_reporter</title><style>
...
<div class="header"><h1>robotics_uptime_reporter</h1><div class="subtitle">GTM service: uptime reporter port 39971</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39971</div>

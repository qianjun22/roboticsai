...
PORT = 12625
SERVICE = "partner-technical-enablement-tracker"
DESCRIPTION = "Tracks technical enablement progress for robotics channel partners — certifications, labs, and sandbox usage"

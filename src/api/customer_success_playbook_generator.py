...
PORT = 11673
SERVICE = "customer-success-playbook-generator"
DESCRIPTION = "Generates customized customer success playbooks based on segment, use case, and maturity stage with automated milestone tracking"

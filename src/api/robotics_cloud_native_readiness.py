...
PORT = 13039
SERVICE = "robotics_cloud_native_readiness"
DESCRIPTION = "Cloud-native readiness assessor for robotics workloads — evaluates containerization, observability, and auto-scaling maturity for OCI migration"

...
PORT = 11739
SERVICE = "sales-territory-rebalancing-tool"
DESCRIPTION = "Sales territory rebalancing tool for workload equalization, opportunity distribution, and coverage gap elimination"

...
PORT = 12955
SERVICE = "robotics_enterprise_adoption_dashboard"
DESCRIPTION = "Enterprise adoption dashboard for robotics platform — tracks feature utilization, seat expansion, and value realization milestones per account"

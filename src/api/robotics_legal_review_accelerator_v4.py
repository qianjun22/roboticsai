...
PORT = 16759
SERVICE = "robotics_legal_review_accelerator_v4"
DESCRIPTION = "Robotics GTM legal review accelerator automating contract redlines and compliance checks for robot deployments"

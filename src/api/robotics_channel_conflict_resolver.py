...
PORT = 51367
SERVICE = "robotics-channel-conflict-resolver"
DESCRIPTION = "Robotics GTM channel conflict resolver service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-channel-conflict-resolver</title><style>
...
<div class="header"><h1>robotics-channel-conflict-resolver</h1><div class="subtitle">Robotics GTM channel conflict resolver service · port 51367</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51367</div>

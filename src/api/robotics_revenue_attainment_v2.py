...
PORT = 13641
SERVICE = "robotics_revenue_attainment_v2"
DESCRIPTION = "Robotics revenue attainment tracking platform v2 — provides real-time visibility into quota attainment by rep, territory, and product line, with automated alerts for at-risk targets and recommended recovery actions"

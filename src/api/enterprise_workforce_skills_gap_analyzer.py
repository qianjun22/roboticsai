...
PORT = 11941
SERVICE = "enterprise_workforce_skills_gap_analyzer"
DESCRIPTION = "Enterprise workforce skills gap analyzer for competency matrix assessment, learning path recommendation, and future role readiness scoring"

...
PORT = 12677
SERVICE = "sales-contract-value-expander"
DESCRIPTION = "Identifies contract expansion opportunities for enterprise robotics accounts — module add-ons and fleet scale triggers"

...
PORT = 13177
SERVICE = "robotics_competitive_moat_analyzer"
DESCRIPTION = "Competitive moat analyzer for quantifying OCI Robot Cloud defensibility across data, NVIDIA access, and cost dimensions"

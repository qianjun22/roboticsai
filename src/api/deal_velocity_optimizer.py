"""Deal Velocity Optimizer — identifies and removes friction points to accelerate deal cycles.
...
PORT = 10695
SERVICE = "deal_velocity_optimizer"
DESCRIPTION = "Identifies and removes friction points to accelerate sales deal cycles"

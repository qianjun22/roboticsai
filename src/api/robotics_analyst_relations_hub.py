...
PORT = 13221
SERVICE = "robotics_analyst_relations_hub"
DESCRIPTION = "Analyst relations hub for managing Gartner, Forrester, and IDC briefings on OCI Robot Cloud positioning"

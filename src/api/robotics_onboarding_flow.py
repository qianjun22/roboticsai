...
DESCRIPTION = "GTM platform for onboarding flow automation"
...
<div class="header"><h1>robotics-onboarding-flow</h1><div class="sub">GTM platform for onboarding flow automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15345 | <b>Status:</b> <span style="color:#4ade80">Live</span>

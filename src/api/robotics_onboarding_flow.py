...
PORT = 15103
SERVICE = "robotics-onboarding-flow"
DESCRIPTION = "GTM platform for onboarding flow optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-onboarding-flow</title><style>
...
<div class="header"><h1>robotics-onboarding-flow</h1><div class="sub">GTM platform for onboarding flow optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15103 | <b>Status:</b> <span style="color:#4ade80">Live</span>

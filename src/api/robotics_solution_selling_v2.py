...
PORT = 13543
SERVICE = "robotics_solution_selling_v2"
DESCRIPTION = "Solution selling service v2 — guides sales teams through consultative robotics solution design, ROI modeling, and industry-specific value selling frameworks"

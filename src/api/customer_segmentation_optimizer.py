...
PORT = 11663
SERVICE = "customer-segmentation-optimizer"
DESCRIPTION = "Optimizes customer segmentation models using behavioral clustering, firmographic signals, and product usage patterns"

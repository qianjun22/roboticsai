...
PORT = 12451
SERVICE = "sales_demand_generation_engine"
DESCRIPTION = "Sales demand generation engine orchestrating inbound campaigns, content syndication, and lead scoring for robotics market development"

...
PORT = 13155
SERVICE = "robotics_customer_summit_planner"
DESCRIPTION = "Customer summit planner for organizing robotics AI showcase events and executive briefing programs"

...
PORT = 53371
SERVICE = "robotics-social-selling-enabler"
DESCRIPTION = "Robotics GTM social selling enabler service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-social-selling-enabler</title><style>
...
<div class="header"><h1>robotics-social-selling-enabler</h1><div class="subtitle">Robotics GTM social selling enabler service · port 53371</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53371</div>

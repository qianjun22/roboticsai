...
PORT = 41499
SERVICE = "robotics_reseller_dashboard"
DESCRIPTION = "GTM service: reseller dashboard"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_reseller_dashboard</title><style>
...
<div class="header"><h1>robotics_reseller_dashboard</h1><div class="subtitle">GTM service: reseller dashboard port 41499</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41499</div>

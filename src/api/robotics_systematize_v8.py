...
PORT = 36079
SERVICE = "robotics-systematize-v8"
DESCRIPTION = "Systematization framework for robotics GTM converting repeatable wins into scalable playbooks and processes"

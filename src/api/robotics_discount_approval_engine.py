...
PORT = 53403
SERVICE = "robotics-discount-approval-engine"
DESCRIPTION = "Robotics GTM discount approval engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-discount-approval-engine</title><style>
...
<div class="header"><h1>robotics-discount-approval-engine</h1><div class="subtitle">Robotics GTM discount approval engine service · port 53403</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53403</div>

...
PORT = 50087
SERVICE = "robotics-alliance-manager-portal"
DESCRIPTION = "Robotics GTM alliance manager portal service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-alliance-manager-portal</title><style>
...
<div class="header"><h1>robotics-alliance-manager-portal</h1><div class="subtitle">Robotics GTM alliance manager portal service · port 50087</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50087</div>

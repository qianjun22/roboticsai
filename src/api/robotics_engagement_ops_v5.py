...
PORT = 30115
SERVICE = "robotics_engagement_ops_v5"
DESCRIPTION = "Engagement Ops v5 — customer interaction analytics, digital touchpoint optimization, and multi-channel journey tracking"

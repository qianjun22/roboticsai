...
PORT = 12755
SERVICE = "enterprise_deployment_readiness_scorer"
DESCRIPTION = "Scores enterprise customers on deployment readiness — infra, team capability, data pipeline maturity, and risk factors"

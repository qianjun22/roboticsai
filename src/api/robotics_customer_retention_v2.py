...
PORT = 13531
SERVICE = "robotics_customer_retention_v2"
DESCRIPTION = "Customer retention service v2 — monitors churn signals, automates renewal campaigns, and drives upsell for existing robotics cloud customers"

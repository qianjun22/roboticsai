...
PORT = 13563
SERVICE = "robotics_revenue_intelligence_v2"
DESCRIPTION = "Robotics revenue intelligence platform v2 — AI-driven win/loss analysis, competitive insights, pricing optimization, and predictive revenue modeling for robotics business growth"

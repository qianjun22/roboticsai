...
PORT = 12767
SERVICE = "robotics_patent_landscape_tracker"
DESCRIPTION = "Tracks robotics AI patent landscape — competitor filings, white space analysis, and IP strategy recommendations"

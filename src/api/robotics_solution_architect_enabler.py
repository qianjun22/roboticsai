...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-solution-architect-enabler</title><style>
...
<div class="header"><h1>robotics-solution-architect-enabler</h1><div class="subtitle">Robotics GTM solution architect enabler service · port 53079</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53079</div>

...
PORT = 11841
SERVICE = "partner_technical_enablement_hub"
DESCRIPTION = "Partner technical enablement hub for certification tracking, technical resource delivery, and integration support analytics"

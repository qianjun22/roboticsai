...
PORT = 15017
SERVICE = "robotics-workflow-automate"
DESCRIPTION = "GTM platform for workflow automate automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-workflow-automate</title><style>
...
<div class="header"><h1>robotics-workflow-automate</h1><div class="sub">GTM platform for workflow automate automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15017 | <b>Status:</b> <span style="color:#4ade80">Live</span>

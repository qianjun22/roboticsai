...
PORT = 51907
SERVICE = "robotics-field-marketing-engine"
DESCRIPTION = "Robotics GTM field marketing engine service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-field-marketing-engine</title><style>
...
<div class="header"><h1>robotics-field-marketing-engine</h1><div class="subtitle">Robotics GTM field marketing engine service · port 51907</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51907</div>

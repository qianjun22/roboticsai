...
PORT = 13349
SERVICE = "robotics_solution_architect_enablement"
DESCRIPTION = "Solution architect enablement for certifying technical staff on OCI Robot Cloud architecture patterns and deployment best practices"

...
PORT = 12357
SERVICE = "sales_partner_incentive_program_manager"
DESCRIPTION = "Partner incentive program manager for robotics reseller quota attainment and reward tracking"

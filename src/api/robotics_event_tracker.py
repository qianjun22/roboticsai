...
PORT = 15001
SERVICE = "robotics-event-tracker"
DESCRIPTION = "GTM platform for event tracker automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-event-tracker</title><style>
...
<div class="header"><h1>robotics-event-tracker</h1><div class="sub">GTM platform for event tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15001 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-product-qualified-lead-scorer</title><style>
...
<div class="header"><h1>robotics-product-qualified-lead-scorer</h1><div class="subtitle">Robotics GTM product qualified lead scorer service · port 50951</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50951</div>

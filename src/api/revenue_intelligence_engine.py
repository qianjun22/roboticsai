"""Revenue Intelligence Engine — AI-driven deal scoring, forecast, and churn risk detection.
...
PORT = 10649
SERVICE = "revenue_intelligence_engine"
DESCRIPTION = "AI-driven deal scoring, forecast, and churn risk detection"

...
PORT = 12049
SERVICE = "partner-field-enablement-platform"
DESCRIPTION = "Partner field enablement platform for equipping sales teams with robotics demos and technical tools"

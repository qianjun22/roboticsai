...
PORT = 50969
SERVICE = "robotics-dagger-abm-svc"
DESCRIPTION = "Robotics GTM dagger abm svc service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-abm-svc</title><style>
...
<div class="header"><h1>robotics-dagger-abm-svc</h1><div class="subtitle">Robotics GTM dagger abm svc service · port 50969</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50969</div>

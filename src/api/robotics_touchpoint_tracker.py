...
PORT = 14969
SERVICE = "robotics-touchpoint-tracker"
DESCRIPTION = "GTM platform for touchpoint tracker automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-touchpoint-tracker</title><style>
...
<div class="header"><h1>robotics-touchpoint-tracker</h1><div class="sub">GTM platform for touchpoint tracker automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14969 |&nbsp; <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12919
SERVICE = "robotics_platform_health_scorecard"
DESCRIPTION = "Comprehensive platform health scorecard — API availability, model freshness, data pipeline throughput, cost efficiency, and security posture metrics"

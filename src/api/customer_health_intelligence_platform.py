...
PORT = 11695
SERVICE = "customer-health-intelligence-platform"
DESCRIPTION = "Customer health intelligence platform for predictive churn detection and proactive intervention scoring"

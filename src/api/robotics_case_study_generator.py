...
PORT = 50567
SERVICE = "robotics-case-study-generator"
DESCRIPTION = "Robotics GTM case study generator service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-case-study-generator</title><style>
...
<div class="header"><h1>robotics-case-study-generator</h1><div class="subtitle">Robotics GTM case study generator service · port 50567</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50567</div>

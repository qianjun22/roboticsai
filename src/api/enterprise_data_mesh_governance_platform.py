...
PORT = 11983
SERVICE = "enterprise-data-mesh-governance-platform"
DESCRIPTION = "Enterprise data mesh governance platform for distributed data ownership and quality enforcement"

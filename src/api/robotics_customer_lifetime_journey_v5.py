...
PORT = 16801
SERVICE = "robotics_customer_lifetime_journey_v5"
DESCRIPTION = "Robotics GTM customer lifetime journey v5 with predictive churn models and automated renewal plays"

...
PORT = 13551
SERVICE = "robotics_sales_operations_v3"
DESCRIPTION = "Robotics sales operations platform v3 — end-to-end pipeline management, quota tracking, forecast accuracy, and deal velocity analytics for robotics sales teams"

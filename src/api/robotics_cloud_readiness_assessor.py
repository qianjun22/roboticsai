...
PORT = 50363
SERVICE = "robotics-cloud-readiness-assessor"
DESCRIPTION = "Robotics GTM cloud readiness assessor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-cloud-readiness-assessor</title><style>
...
<div class="header"><h1>robotics-cloud-readiness-assessor</h1><div class="subtitle">Robotics GTM cloud readiness assessor service · port 50363</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50363</div>

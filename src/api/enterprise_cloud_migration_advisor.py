...
PORT = 11745
SERVICE = "enterprise-cloud-migration-advisor"
DESCRIPTION = "Enterprise cloud migration advisor for workload assessment, TCO modeling, and migration roadmap planning"

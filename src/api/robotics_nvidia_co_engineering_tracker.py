...
PORT = 12859
SERVICE = "robotics_nvidia_co_engineering_tracker"
DESCRIPTION = "Tracks NVIDIA co-engineering collaboration — joint roadmap items, Isaac Sim optimization tickets, Cosmos integration milestones, and GR00T eval parity"

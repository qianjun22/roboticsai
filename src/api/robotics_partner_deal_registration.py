...
PORT = 53459
SERVICE = "robotics-partner-deal-registration"
DESCRIPTION = "Robotics GTM partner deal registration service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-partner-deal-registration</title><style>
...
<div class="header"><h1>robotics-partner-deal-registration</h1><div class="subtitle">Robotics GTM partner deal registration service · port 53459</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53459</div>

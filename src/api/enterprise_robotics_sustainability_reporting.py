...
PORT = 12515
SERVICE = "enterprise_robotics_sustainability_reporting"
DESCRIPTION = "Enterprise robotics sustainability reporting platform for ESG metrics, energy consumption benchmarks, and circular economy compliance"

...
PORT = 14971
SERVICE = "robotics-solution-selling"
DESCRIPTION = "GTM platform for solution selling optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-solution-selling</title><style>
...
<div class="header"><h1>robotics-solution-selling</h1><div class="sub">GTM platform for solution selling optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14971 |&nbsp; <b>Status:</b> <span style="color:#4ade80">Live</span>

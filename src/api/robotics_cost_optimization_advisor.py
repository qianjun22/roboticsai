...
PORT = 50359
SERVICE = "robotics-cost-optimization-advisor"
DESCRIPTION = "Robotics GTM cost optimization advisor service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-cost-optimization-advisor</title><style>
...
<div class="header"><h1>robotics-cost-optimization-advisor</h1><div class="subtitle">Robotics GTM cost optimization advisor service · port 50359</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50359</div>

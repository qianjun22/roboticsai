...
PORT = 12649
SERVICE = "sales-poc-success-tracker"
DESCRIPTION = "Tracks proof-of-concept success metrics for enterprise robotics pilots — conversion rate and expansion signals"

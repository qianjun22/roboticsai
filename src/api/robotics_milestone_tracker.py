...
PORT = 15379
SERVICE = "robotics-milestone-tracker"
DESCRIPTION = "GTM platform for milestone tracker optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-milestone-tracker</title><style>
...
<div class="header"><h1>robotics-milestone-tracker</h1><div class="sub">GTM platform for milestone tracker optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15379 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12499
SERVICE = "enterprise_robotics_procurement_risk_tracker"
DESCRIPTION = "Enterprise robotics procurement risk tracker for geopolitical supply chain exposure, component lead times, and alternative sourcing"

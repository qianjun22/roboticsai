...
PORT = 13079
SERVICE = "robotics_sales_ops_automation"
DESCRIPTION = "Sales operations automation for robotics platform — streamlines quote-to-cash, CRM hygiene, and forecast roll-up with AI-assisted workflows"

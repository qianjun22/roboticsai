...
PORT = 11829
SERVICE = "sales_forecasting_intelligence_platform"
DESCRIPTION = "Sales forecasting intelligence platform for pipeline analysis, quota attainment prediction, and territory optimization"

...
PORT = 40945
SERVICE = "robotics_changelog_publisher"
DESCRIPTION = "GTM service: changelog publisher"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_changelog_publisher</title><style>
...
<div class="header"><h1>robotics_changelog_publisher</h1><div class="subtitle">GTM service: changelog publisher port 40945</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40945</div>

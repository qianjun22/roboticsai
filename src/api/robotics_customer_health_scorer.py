...
PORT = 53851
SERVICE = "robotics-customer-health-scorer"
DESCRIPTION = "Robotics GTM customer health scorer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-health-scorer</title><style>
...
<div class="header"><h1>robotics-customer-health-scorer</h1><div class="subtitle">Robotics GTM customer health scorer service · port 53851</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53851</div>

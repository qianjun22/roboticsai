...
PORT = 12697
SERVICE = "sales-revenue-operations-efficiency-scorer"
DESCRIPTION = "Scores revenue operations efficiency for enterprise robotics — pipeline hygiene, forecast accuracy, and process automation"

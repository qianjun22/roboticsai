...
PORT = 11675
SERVICE = "enterprise-renewal-intelligence"
DESCRIPTION = "AI-powered renewal intelligence predicting renewal risk 90 days out with engagement scoring and intervention recommendations"

...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-pricing-strategy-optimizer</title><style>
...
<div class="header"><h1>robotics-pricing-strategy-optimizer</h1><div class="subtitle">Robotics GTM pricing strategy optimizer service · port 51307</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51307</div>

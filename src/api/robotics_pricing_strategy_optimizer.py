...
PORT = 13087
SERVICE = "robotics_pricing_strategy_optimizer"
DESCRIPTION = "Pricing strategy optimizer for robotics platform — models usage-based, seat-based, and outcome-based pricing structures for maximum ARR growth"

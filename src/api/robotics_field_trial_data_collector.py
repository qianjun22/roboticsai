...
PORT = 12911
SERVICE = "robotics_field_trial_data_collector"
DESCRIPTION = "Collects and structures field trial data for robotics — sensor logs, operator annotations, failure events, and environmental condition tagging"

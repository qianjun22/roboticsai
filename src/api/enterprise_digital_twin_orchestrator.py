...
PORT = 12153
SERVICE = "enterprise-digital-twin-orchestrator"
DESCRIPTION = "Digital twin orchestration platform synchronizing physical robot fleet states with virtual models for predictive maintenance and scenario simulation"

"""NVIDIA relationship manager — tracks OCI-NVIDIA partnership milestones, contacts, and co-engineering agreements
...
try:
    ...
    _has_fastapi = False
PORT = 10909
SERVICE = "nvidia_relationship_manager"
DESCRIPTION = "NVIDIA relationship manager — tracks OCI-NVIDIA partnership milestones, contacts, and co-engineering agreements"
if _has_fastapi:

...
PORT = 12759
SERVICE = "customer_use_case_library"
DESCRIPTION = "Curated library of validated robotics use cases — industry verticals, ROI benchmarks, implementation patterns, and customer proof points"

...
PORT = 13599
SERVICE = "robotics_sales_productivity_v2"
DESCRIPTION = "Sales productivity analytics v2 for robotics platform — measures rep activity, pipeline coverage ratios, and time-to-close benchmarks to optimize sales efficiency"

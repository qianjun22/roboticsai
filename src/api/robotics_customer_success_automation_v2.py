...
PORT = 13771
SERVICE = "robotics_customer_success_automation_v2"
DESCRIPTION = "Robotics customer success automation service v2 — automated health scoring, renewal risk detection, and success playbook orchestration"

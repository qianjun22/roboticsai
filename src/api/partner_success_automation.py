"""Partner success automation — automated onboarding, milestone, health, and renewal workflows reducing CSM workload by 60%
...
try:
    ...
    _has_fastapi = False
PORT = 10935
SERVICE = "partner_success_automation"
DESCRIPTION = "Partner success automation — automated onboarding, milestone, health, and renewal workflows reducing CSM workload by 60%"
if _has_fastapi:

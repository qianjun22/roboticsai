...
PORT = 12909
SERVICE = "robotics_competitive_positioning_engine"
DESCRIPTION = "Maintains competitive positioning for robotics cloud — feature gap analysis, messaging differentiation, battle cards, and objection handling playbooks"

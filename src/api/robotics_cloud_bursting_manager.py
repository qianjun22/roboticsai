...
PORT = 12871
SERVICE = "robotics_cloud_bursting_manager"
DESCRIPTION = "Manages cloud bursting for robotics training workloads — OCI spot instance scheduling, cost caps, and automatic fallback to on-demand capacity"

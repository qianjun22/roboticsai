...
PORT = 12983
SERVICE = "robotics_market_entry_strategy"
DESCRIPTION = "Market entry strategy tool for robotics verticals — analyzes addressable segments, competitive density, and regulatory readiness by geography"

...
PORT = 16815
SERVICE = "robotics_monthly_active_v5"
DESCRIPTION = "Robotics GTM monthly active user v5 with facility-level cohort segmentation and expansion opportunity scoring"

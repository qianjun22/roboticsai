...
PORT = 53347
SERVICE = "robotics-customer-reference-mgr"
DESCRIPTION = "Robotics GTM customer reference mgr service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-customer-reference-mgr</title><style>
...
<div class="header"><h1>robotics-customer-reference-mgr</h1><div class="subtitle">Robotics GTM customer reference mgr service · port 53347</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53347</div>

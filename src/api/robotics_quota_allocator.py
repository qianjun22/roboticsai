...
PORT = 15015
SERVICE = "robotics-quota-allocator"
DESCRIPTION = "GTM platform for quota allocator optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-quota-allocator</title><style>
...
<div class="header"><h1>robotics-quota-allocator</h1><div class="sub">GTM platform for quota allocator optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15015 | <b>Status:</b> <span style="color:#4ade80">Live</span>

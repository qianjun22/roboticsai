...
PORT = 15287
SERVICE = "robotics-influencer-mgr"
DESCRIPTION = "GTM platform for influencer mgr optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-influencer-mgr</title><style>
...
<div class="header"><h1>robotics-influencer-mgr</h1><div class="sub">GTM platform for influencer mgr optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15287 | <b>Status:</b> <span style="color:#4ade80">Live</span>

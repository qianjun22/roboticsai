...
PORT = 53415
SERVICE = "robotics-revenue-recognition-tracker"
DESCRIPTION = "Robotics GTM revenue recognition tracker service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-revenue-recognition-tracker</title><style>
...
<div class="header"><h1>robotics-revenue-recognition-tracker</h1><div class="subtitle">Robotics GTM revenue recognition tracker service · port 53415</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53415</div>

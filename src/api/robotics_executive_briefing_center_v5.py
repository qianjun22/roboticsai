...
PORT = 15713
SERVICE = "robotics_executive_briefing_center_v5"
DESCRIPTION = "Executive briefing center v5: strategic account engagement and C-suite demo orchestration platform"

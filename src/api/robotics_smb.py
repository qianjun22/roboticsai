...
PORT = 46851
SERVICE = "robotics_smb"
DESCRIPTION = "SMB robotics solution sales and support tracker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics_smb</title><style>
...
<div class="header"><h1>robotics_smb</h1><div class="subtitle">SMB robotics solution sales and support tracker · port 46851</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46851</div>

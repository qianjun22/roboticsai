...
PORT = 12105
SERVICE = "enterprise-regulatory-compliance-hub"
DESCRIPTION = "Enterprise regulatory compliance hub for tracking robotics safety certifications and audit readiness"

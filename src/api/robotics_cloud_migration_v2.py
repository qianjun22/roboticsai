...
PORT = 13171
SERVICE = "robotics_cloud_migration_v2"
DESCRIPTION = "Cloud migration v2 advisor for guiding robotics workloads to OCI with cost modeling and risk assessment"

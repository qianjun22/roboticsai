...
PORT = 12169
SERVICE = "sales-executive-sponsorship-tracker"
DESCRIPTION = "Executive sponsorship tracking platform mapping C-suite relationships, engagement cadence, and strategic alignment for enterprise robotics accounts"

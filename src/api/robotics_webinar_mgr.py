...
PORT = 14997
SERVICE = "robotics-webinar-mgr"
DESCRIPTION = "GTM platform for webinar mgr automation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-webinar-mgr</title><style>
...
<div class="header"><h1>robotics-webinar-mgr</h1><div class="sub">GTM platform for webinar mgr automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14997 | <b>Status:</b> <span style="color:#4ade80">Live</span>

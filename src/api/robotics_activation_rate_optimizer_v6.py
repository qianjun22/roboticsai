...
PORT = 16807
SERVICE = "robotics_activation_rate_optimizer_v6"
DESCRIPTION = "Robotics GTM activation rate optimizer v6 with role-based onboarding tracks and in-app robot task walkthroughs"

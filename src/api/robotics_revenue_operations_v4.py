...
PORT = 13781
SERVICE = "robotics_revenue_operations_v4"
DESCRIPTION = "Robotics revenue operations platform v4 — RevOps automation, funnel analytics, and cross-functional alignment for robotics cloud sales"

...
PORT = 50885
SERVICE = "robotics-dagger-developer-advocacy"
DESCRIPTION = "Robotics GTM dagger developer advocacy service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-developer-advocacy</title><style>
...
<div class="header"><h1>robotics-dagger-developer-advocacy</h1><div class="subtitle">Robotics GTM dagger developer advocacy service · port 50885</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50885</div>

...
PORT = 12211
SERVICE = "sales-revenue-forecasting-engine"
DESCRIPTION = "Revenue forecasting engine applying ML models to robotics sales pipeline data for accurate quarterly and annual ARR predictions with confidence intervals"

...
PORT = 15391
SERVICE = "robotics-decision-log"
DESCRIPTION = "GTM platform for decision log optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-decision-log</title><style>
...
<div class="header"><h1>robotics-decision-log</h1><div class="sub">GTM platform for decision log optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15391 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13691
SERVICE = "robotics_sales_ops_v3"
DESCRIPTION = "Robotics sales operations API v3 — pipeline hygiene, forecast accuracy, quota attainment, and sales process optimization"

...
PORT = 13819
SERVICE = "robotics_customer_onboarding_v5"
DESCRIPTION = "Robotics customer onboarding platform v5 — automated onboarding workflow, time-to-value tracking, and new customer activation for robotics deployments"

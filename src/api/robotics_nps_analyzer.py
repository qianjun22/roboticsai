...
PORT = 15075
SERVICE = "robotics-nps-analyzer"
DESCRIPTION = "GTM platform for nps analyzer optimization"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-nps-analyzer</title><style>
...
<div class="header"><h1>robotics-nps-analyzer</h1><div class="sub">GTM platform for nps analyzer optimization</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15075 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
DESCRIPTION = "GTM platform for nps analyzer automation"
...
<div class="header"><h1>robotics-nps-analyzer</h1><div class="sub">GTM platform for nps analyzer automation</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15317 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12737
SERVICE = "partner-program-tier-advancement-tracker"
DESCRIPTION = "Tracks partner program tier advancement progress — requirements completion, revenue thresholds, and certification milestones"

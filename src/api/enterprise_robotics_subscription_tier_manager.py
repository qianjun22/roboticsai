...
PORT = 12663
SERVICE = "enterprise-robotics-subscription-tier-manager"
DESCRIPTION = "Manages subscription tier upgrades and downgrades for enterprise robotics cloud services — usage-based triggers"

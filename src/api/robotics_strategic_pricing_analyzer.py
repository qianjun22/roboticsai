...
PORT = 12997
SERVICE = "robotics_strategic_pricing_analyzer"
DESCRIPTION = "Strategic pricing analyzer for robotics platform — models value-based pricing, competitive positioning, and discount governance by segment"

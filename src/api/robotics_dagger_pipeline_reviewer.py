...
PORT = 50993
SERVICE = "robotics-dagger-pipeline-reviewer"
DESCRIPTION = "Robotics GTM dagger pipeline reviewer service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robotics-dagger-pipeline-reviewer</title><style>
...
<div class="header"><h1>robotics-dagger-pipeline-reviewer</h1><div class="subtitle">Robotics GTM dagger pipeline reviewer service · port 50993</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50993</div>

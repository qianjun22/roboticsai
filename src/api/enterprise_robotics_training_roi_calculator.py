...
PORT = 12601
SERVICE = "enterprise-robotics-training-roi"
DESCRIPTION = "Calculates ROI of robot training programs including time-to-competency and error reduction metrics"

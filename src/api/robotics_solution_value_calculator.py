...
PORT = 12981
SERVICE = "robotics_solution_value_calculator"
DESCRIPTION = "Solution value calculator for robotics deployments — quantifies ROI from labor cost reduction, throughput gains, and error rate improvements"

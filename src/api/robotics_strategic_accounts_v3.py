...
PORT = 13737
SERVICE = "robotics_strategic_accounts_v3"
DESCRIPTION = "Robotics strategic accounts API v3 — named account planning, executive sponsorship matching, and strategic customer relationship management"

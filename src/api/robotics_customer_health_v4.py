...
PORT = 13797
SERVICE = "robotics_customer_health_v4"
DESCRIPTION = "Robotics customer health platform v4 — real-time health scoring, churn prediction, and proactive intervention triggers for robotics subscriptions"

...
PORT = 13023
SERVICE = "robotics_customer_segmentation_v2"
DESCRIPTION = "Customer segmentation v2 for robotics platform — classifies accounts by robot fleet size, deployment maturity, and expansion potential"

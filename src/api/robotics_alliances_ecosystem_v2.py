...
PORT = 13749
SERVICE = "robotics_alliances_ecosystem_v2"
DESCRIPTION = "Robotics alliances ecosystem v2 — strategic alliance mapping, ISV integration catalog, and co-sell motion orchestration for robotics cloud"

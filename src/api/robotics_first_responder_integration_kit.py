...
PORT = 12895
SERVICE = "robotics_first_responder_integration_kit"
DESCRIPTION = "Integration kit for robotics in first-responder scenarios — emergency communication protocols, operator override interfaces, and incident command system compatibility"

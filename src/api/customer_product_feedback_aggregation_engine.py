...
PORT = 12739
SERVICE = "customer-product-feedback-aggregation"
DESCRIPTION = "Aggregates product feedback from enterprise robotics customers — NPS, support tickets, and feature request prioritization"

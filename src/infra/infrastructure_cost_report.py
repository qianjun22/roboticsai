"""Infrastructure Cost Report — FastAPI port 8997"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Infrastructure Cost Report</title>
...
<body><h1>Infrastructure Cost Report</h1>
...
if USE_FASTAPI:
    app = FastAPI(title="Infrastructure Cost Report")

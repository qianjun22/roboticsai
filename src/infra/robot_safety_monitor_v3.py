"""Robot Safety Monitor V3 — proactive predictive fault detection with SIL-2 emergency stop.
...
DESCRIPTION = "Proactive predictive fault detection with SIL-2 emergency stop and audit trail"

"""Event-Driven Architecture Monitor — FastAPI port 8999"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Event-Driven Architecture Monitor</title>
...
<body><h1>Event-Driven Architecture Monitor</h1>
<div class="card"><h2>Event Stream</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="Event-Driven Architecture Monitor")

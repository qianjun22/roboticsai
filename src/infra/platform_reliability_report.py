"""Platform Reliability Report — FastAPI port 9003"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Platform Reliability Report</title>
...
<body><h1>Platform Reliability Report</h1>
<div class="card"><h2>Reliability Metrics</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="Platform Reliability Report")

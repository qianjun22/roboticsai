...
PORT = 11666
SERVICE = "dagger-run528-planner"
DESCRIPTION = "DAgger run 528 training planner with SpatialVLM spatial reasoning for robotic task planning from visual question answering"

"""DAgger run204 — multi-embodiment DAgger training one policy across Franka, UR5, and Kuka robot arms
...
PORT = 10354
SERVICE = "dagger_run204_planner"
DESCRIPTION = "DAgger run204 — multi-embodiment DAgger training one policy across Franka, UR5, and Kuka robot arms"

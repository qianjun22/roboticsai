...
PORT = 51908
SERVICE = "dagger-run10587-planner"
DESCRIPTION = "DAgger run 10587 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10587-planner</title><style>
...
<div class="header"><h1>dagger-run10587-planner</h1><div class="subtitle">DAgger run 10587 policy planning and online correction · port 51908</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51908</div>

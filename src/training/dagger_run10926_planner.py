...
PORT = 53264
SERVICE = "dagger-run10926-planner"
DESCRIPTION = "DAgger run 10926 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10926-planner</title><style>
...
<div class="header"><h1>dagger-run10926-planner</h1><div class="subtitle">DAgger run 10926 policy planning and online correction · port 53264</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53264</div>

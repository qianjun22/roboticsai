...
PORT = 42124
SERVICE = "dagger_run8141_planner"
DESCRIPTION = "DAgger run 8141 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8141_planner</title><style>
...
<div class="header"><h1>dagger_run8141_planner</h1><div class="subtitle">DAgger run 8141 online learning planner port 42124</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42124</div>

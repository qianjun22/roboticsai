...
PORT = 41092
SERVICE = "dagger_run7883_planner"
DESCRIPTION = "DAgger run 7883 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7883_planner</title><style>
...
<div class="header"><h1>dagger_run7883_planner</h1><div class="subtitle">DAgger run 7883 online learning planner port 41092</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41092</div>

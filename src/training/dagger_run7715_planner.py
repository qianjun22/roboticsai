...
PORT = 40420
SERVICE = "dagger_run7715_planner"
DESCRIPTION = "DAgger run 7715 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7715_planner</title><style>
...
<div class="header"><h1>dagger_run7715_planner</h1><div class="subtitle">DAgger run 7715 online learning planner port 40420</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40420</div>

...
PORT = 13054
SERVICE = "dagger_run875_planner"
DESCRIPTION = "DAgger run 875 training planner — implements batch active DAgger with memory-efficient replay and prioritized correction scheduling"

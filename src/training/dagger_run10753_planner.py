...
PORT = 52572
SERVICE = "dagger-run10753-planner"
DESCRIPTION = "DAgger run 10753 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10753-planner</title><style>
...
<div class="header"><h1>dagger-run10753-planner</h1><div class="subtitle">DAgger run 10753 policy planning and online correction · port 52572</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52572</div>

"""DAgger run230 — goal-conditioned universal policy across 20 goals, 20x deployment efficiency at 2pp SR cost
...
PORT = 10458
SERVICE = "dagger_run230_planner"
DESCRIPTION = "DAgger run230 — goal-conditioned universal policy across 20 goals, 20x deployment efficiency at 2pp SR cost"

...
PORT = 53552
SERVICE = "dagger-run10998-planner"
DESCRIPTION = "DAgger run 10998 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10998-planner</title><style>
...
<div class="header"><h1>dagger-run10998-planner</h1><div class="subtitle">DAgger run 10998 policy planning and online correction · port 53552</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53552</div>

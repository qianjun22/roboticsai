...
PORT = 52116
SERVICE = "dagger-run10639-planner"
DESCRIPTION = "DAgger run 10639 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10639-planner</title><style>
...
<div class="header"><h1>dagger-run10639-planner</h1><div class="subtitle">DAgger run 10639 policy planning and online correction · port 52116</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52116</div>

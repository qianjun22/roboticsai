...
PORT = 51456
SERVICE = "dagger-run10474-planner"
DESCRIPTION = "DAgger run 10474 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10474-planner</title><style>
...
<div class="header"><h1>dagger-run10474-planner</h1><div class="subtitle">DAgger run 10474 policy planning and online correction · port 51456</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51456</div>

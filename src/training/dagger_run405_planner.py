"""DAgger run405 planner using goal-conditioned BC with cross-attention between goal image and current observation for flexible task specification
...
try:
    ...
    _has_fastapi = False
PORT = 11174
SERVICE = "dagger_run405_planner"
DESCRIPTION = "DAgger run405 planner using goal-conditioned BC with cross-attention between goal image and current observation for flexible task specification"
if _has_fastapi:

"""DAgger run 328 planner with graph neural network attention for multi-object relational manipulation corrections
...
try:
    ...
    _has_fastapi = False
PORT = 10866
SERVICE = "dagger_run328_planner"
DESCRIPTION = "DAgger run 328 planner with graph neural network attention for multi-object relational manipulation corrections"
if _has_fastapi:

...
DESCRIPTION = "Tactile sensing integration: GelSight fingertip arrays fused with vision in GR00T"
...
if FastAPI:
    ...
    def dashboard():
        slip_acc = round(random.uniform(0.91, 0.97), 3); bar = int(slip_acc * 220)
...
<p>Port: {PORT} | Slip Detection Accuracy: {slip_acc}</p>
<svg width='260' height='40'><rect width='220' height='30' fill='#1e293b' rx='4'/>
<rect width='{bar}' height='30' fill='#38bdf8' rx='4'/>
<text x='10' y='20' font-size='12'>Slip Detection: {slip_acc}</text></svg>
</body></html>"""

...
PORT = 38604
SERVICE = "dagger_run7261_planner"
DESCRIPTION = "DAgger run 7261 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7261_planner</title><style>
...
<div class="header"><h1>dagger_run7261_planner</h1><div class="subtitle">DAgger run 7261 online learning planner port 38604</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38604</div>

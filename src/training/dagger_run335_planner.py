"""DAgger run 335 planner with MPC receding horizon planning and OSQP solver for constraint-aware policy correction
...
try:
    ...
    _has_fastapi = False
PORT = 10894
SERVICE = "dagger_run335_planner"
DESCRIPTION = "DAgger run 335 planner with MPC receding horizon planning and OSQP solver for constraint-aware policy correction"
if _has_fastapi:

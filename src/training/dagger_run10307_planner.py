...
PORT = 50788
SERVICE = "dagger-run10307-planner"
DESCRIPTION = "DAgger run 10307 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10307-planner</title><style>
...
<div class="header"><h1>dagger-run10307-planner</h1><div class="subtitle">DAgger run 10307 policy planning and online correction · port 50788</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50788</div>

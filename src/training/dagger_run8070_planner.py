...
PORT = 41840
SERVICE = "dagger_run8070_planner"
DESCRIPTION = "DAgger run 8070 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8070_planner</title><style>
...
<div class="header"><h1>dagger_run8070_planner</h1><div class="subtitle">DAgger run 8070 online learning planner port 41840</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41840</div>

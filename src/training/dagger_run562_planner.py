...
PORT = 11802
SERVICE = "dagger-run562-planner"
DESCRIPTION = "DAgger run 562 training planner using multi-modal sensor fusion for robust robot perception in unstructured environments"

...
PORT = 50884
SERVICE = "dagger-run10331-planner"
DESCRIPTION = "DAgger run 10331 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10331-planner</title><style>
...
<div class="header"><h1>dagger-run10331-planner</h1><div class="subtitle">DAgger run 10331 policy planning and online correction · port 50884</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50884</div>

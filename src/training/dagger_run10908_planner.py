...
PORT = 53192
SERVICE = "dagger-run10908-planner"
DESCRIPTION = "DAgger run 10908 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10908-planner</title><style>
...
<div class="header"><h1>dagger-run10908-planner</h1><div class="subtitle">DAgger run 10908 policy planning and online correction · port 53192</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53192</div>

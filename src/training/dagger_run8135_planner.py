...
PORT = 42100
SERVICE = "dagger_run8135_planner"
DESCRIPTION = "DAgger run 8135 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8135_planner</title><style>
...
<div class="header"><h1>dagger_run8135_planner</h1><div class="subtitle">DAgger run 8135 online learning planner port 42100</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42100</div>

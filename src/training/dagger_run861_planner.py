...
PORT = 12998
SERVICE = "dagger_run861_planner"
DESCRIPTION = "DAgger run 861 training planner — orchestrates environment-conditioned rollout strategies and tracks generalization metrics across robot task families"

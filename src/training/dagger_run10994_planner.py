...
PORT = 53536
SERVICE = "dagger-run10994-planner"
DESCRIPTION = "DAgger run 10994 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10994-planner</title><style>
...
<div class="header"><h1>dagger-run10994-planner</h1><div class="subtitle">DAgger run 10994 policy planning and online correction · port 53536</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53536</div>

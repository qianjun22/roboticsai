...
PORT = 43916
SERVICE = "dagger_run8589_planner"
DESCRIPTION = "DAgger run 8589 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8589_planner</title><style>
...
<div class="header"><h1>dagger_run8589_planner</h1><div class="subtitle">DAgger run 8589 online learning planner port 43916</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43916</div>

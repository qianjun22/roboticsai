...
PORT = 50996
SERVICE = "dagger-run10359-planner"
DESCRIPTION = "DAgger run 10359 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10359-planner</title><style>
...
<div class="header"><h1>dagger-run10359-planner</h1><div class="subtitle">DAgger run 10359 policy planning and online correction · port 50996</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50996</div>

...
PORT = 41556
SERVICE = "dagger_run7999_planner"
DESCRIPTION = "DAgger run 7999 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7999_planner</title><style>
...
<div class="header"><h1>dagger_run7999_planner</h1><div class="subtitle">DAgger run 7999 online learning planner port 41556</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41556</div>

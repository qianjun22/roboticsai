...
PORT = 11558
SERVICE = "dagger-run501-planner"
DESCRIPTION = "DAgger run 501 training planner with RT-X cross-embodiment dataset integration and transfer learning scheduling"

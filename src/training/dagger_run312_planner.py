"""DAgger run 312 planner — language-grounded NL correction DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10802
SERVICE = "dagger_run312_planner"
DESCRIPTION = "DAgger run 312 planner — language-grounded NL correction DAgger — OCI Robot Cloud"
if _has_fastapi:

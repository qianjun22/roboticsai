...
PORT = 41372
SERVICE = "dagger_run7953_planner"
DESCRIPTION = "DAgger run 7953 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7953_planner</title><style>
...
<div class="header"><h1>dagger_run7953_planner</h1><div class="subtitle">DAgger run 7953 online learning planner port 41372</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41372</div>

...
PORT = 52552
SERVICE = "dagger-run10748-planner"
DESCRIPTION = "DAgger run 10748 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10748-planner</title><style>
...
<div class="header"><h1>dagger-run10748-planner</h1><div class="subtitle">DAgger run 10748 policy planning and online correction · port 52552</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52552</div>

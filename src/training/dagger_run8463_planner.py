...
PORT = 43412
SERVICE = "dagger_run8463_planner"
DESCRIPTION = "DAgger run 8463 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8463_planner</title><style>
...
<div class="header"><h1>dagger_run8463_planner</h1><div class="subtitle">DAgger run 8463 online learning planner port 43412</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43412</div>

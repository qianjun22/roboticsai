"""Online grasp refinement using tactile feedback — 3-step adjust loop in 150ms, 8pp SR gain over initial-only grasping
...
PORT = 10444
SERVICE = "grasp_refinement_policy"
DESCRIPTION = "Online grasp refinement using tactile feedback — 3-step adjust loop in 150ms, 8pp SR gain over initial-only grasping"

...
PORT = 53836
SERVICE = "dagger-run11069-planner"
DESCRIPTION = "DAgger run 11069 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11069-planner</title><style>
...
<div class="header"><h1>dagger-run11069-planner</h1><div class="subtitle">DAgger run 11069 policy planning and online correction · port 53836</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53836</div>

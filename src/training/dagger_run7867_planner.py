...
PORT = 41028
SERVICE = "dagger_run7867_planner"
DESCRIPTION = "DAgger run 7867 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7867_planner</title><style>
...
<div class="header"><h1>dagger_run7867_planner</h1><div class="subtitle">DAgger run 7867 online learning planner port 41028</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41028</div>

...
PORT = 52988
SERVICE = "dagger-run10857-planner"
DESCRIPTION = "DAgger run 10857 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10857-planner</title><style>
...
<div class="header"><h1>dagger-run10857-planner</h1><div class="subtitle">DAgger run 10857 policy planning and online correction · port 52988</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52988</div>

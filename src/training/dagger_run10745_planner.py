...
PORT = 52540
SERVICE = "dagger-run10745-planner"
DESCRIPTION = "DAgger run 10745 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10745-planner</title><style>
...
<div class="header"><h1>dagger-run10745-planner</h1><div class="subtitle">DAgger run 10745 policy planning and online correction · port 52540</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52540</div>

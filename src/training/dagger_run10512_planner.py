...
PORT = 51608
SERVICE = "dagger-run10512-planner"
DESCRIPTION = "DAgger run 10512 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10512-planner</title><style>
...
<div class="header"><h1>dagger-run10512-planner</h1><div class="subtitle">DAgger run 10512 policy planning and online correction · port 51608</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51608</div>

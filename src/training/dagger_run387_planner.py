"""DAgger run387 with MBPO model-based policy optimization using ensemble dynamics for synthetic rollouts
...
try:
    ...
    _has_fastapi = False
PORT = 11102
SERVICE = "dagger_run387_planner"
DESCRIPTION = "DAgger run387 with MBPO model-based policy optimization using ensemble dynamics for synthetic rollouts"
if _has_fastapi:

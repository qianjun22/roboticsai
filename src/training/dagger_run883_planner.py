...
PORT = 13086
SERVICE = "dagger_run883_planner"
DESCRIPTION = "DAgger run 883 training planner — adaptive query frequency controller that balances annotation cost with policy convergence rate"

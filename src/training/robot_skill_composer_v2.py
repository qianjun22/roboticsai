"""HTN-based robot skill composer v2 — synthesize skill programs from 27 primitives covering 200 tasks in 50ms
...
PORT = 10412
SERVICE = "robot_skill_composer_v2"
DESCRIPTION = "HTN-based robot skill composer v2 — synthesize skill programs from 27 primitives covering 200 tasks in 50ms"

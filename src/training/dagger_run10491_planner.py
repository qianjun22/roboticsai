...
PORT = 51524
SERVICE = "dagger-run10491-planner"
DESCRIPTION = "DAgger run 10491 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10491-planner</title><style>
...
<div class="header"><h1>dagger-run10491-planner</h1><div class="subtitle">DAgger run 10491 policy planning and online correction · port 51524</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51524</div>

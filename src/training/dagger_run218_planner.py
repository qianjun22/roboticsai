"""DAgger run218 — meta-DAgger auto-configuring hyperparameters from 20 prior runs, 40% fewer iterations on new tasks
...
PORT = 10410
SERVICE = "dagger_run218_planner"
DESCRIPTION = "DAgger run218 — meta-DAgger auto-configuring hyperparameters from 20 prior runs, 40% fewer iterations on new tasks"

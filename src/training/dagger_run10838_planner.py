...
PORT = 52912
SERVICE = "dagger-run10838-planner"
DESCRIPTION = "DAgger run 10838 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10838-planner</title><style>
...
<div class="header"><h1>dagger-run10838-planner</h1><div class="subtitle">DAgger run 10838 policy planning and online correction · port 52912</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52912</div>

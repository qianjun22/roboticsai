...
PORT = 52208
SERVICE = "dagger-run10662-planner"
DESCRIPTION = "DAgger run 10662 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10662-planner</title><style>
...
<div class="header"><h1>dagger-run10662-planner</h1><div class="subtitle">DAgger run 10662 policy planning and online correction · port 52208</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52208</div>

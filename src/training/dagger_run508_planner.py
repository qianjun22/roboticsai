...
PORT = 11586
SERVICE = "dagger-run508-planner"
DESCRIPTION = "DAgger run 508 training planner with Contact-GraspNet 6-DOF grasp synthesis from partial point clouds in cluttered scenes"

...
PORT = 12914
SERVICE = "dagger_run840_planner"
DESCRIPTION = "DAgger run 840 planning and orchestration service — milestone run at 840 DAgger iterations with comprehensive policy quality report"

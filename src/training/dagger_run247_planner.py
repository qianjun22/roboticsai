"""DAgger Run247 Planner — Transfer DAgger
...
PORT = 10526
SERVICE = "dagger_run247_planner"
DESCRIPTION = "DAgger run247: transfer DAgger — pre-trained source policy enables 7x faster convergence"

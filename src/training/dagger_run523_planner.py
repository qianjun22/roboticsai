...
PORT = 11646
SERVICE = "dagger-run523-planner"
DESCRIPTION = "DAgger run 523 training planner with ManipLLM large language model guided manipulation with natural language task specification"

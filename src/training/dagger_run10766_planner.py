...
PORT = 52624
SERVICE = "dagger-run10766-planner"
DESCRIPTION = "DAgger run 10766 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10766-planner</title><style>
...
<div class="header"><h1>dagger-run10766-planner</h1><div class="subtitle">DAgger run 10766 policy planning and online correction · port 52624</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52624</div>

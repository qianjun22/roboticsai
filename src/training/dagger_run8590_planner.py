...
PORT = 43920
SERVICE = "dagger_run8590_planner"
DESCRIPTION = "DAgger run 8590 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8590_planner</title><style>
...
<div class="header"><h1>dagger_run8590_planner</h1><div class="subtitle">DAgger run 8590 online learning planner port 43920</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43920</div>

...
PORT = 52664
SERVICE = "dagger-run10776-planner"
DESCRIPTION = "DAgger run 10776 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10776-planner</title><style>
...
<div class="header"><h1>dagger-run10776-planner</h1><div class="subtitle">DAgger run 10776 policy planning and online correction · port 52664</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52664</div>

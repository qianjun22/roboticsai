...
PORT = 52456
SERVICE = "dagger-run10724-planner"
DESCRIPTION = "DAgger run 10724 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10724-planner</title><style>
...
<div class="header"><h1>dagger-run10724-planner</h1><div class="subtitle">DAgger run 10724 policy planning and online correction · port 52456</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52456</div>

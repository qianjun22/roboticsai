"""DAgger run375 with relational reasoning module for structured object-relation state prediction
...
try:
    ...
    _has_fastapi = False
PORT = 11054
SERVICE = "dagger_run375_planner"
DESCRIPTION = "DAgger run375 with relational reasoning module for structured object-relation state prediction"
if _has_fastapi:

"""Visual servoing controller — image-based and position-based VS at 30Hz for sub-millimeter precision insertion tasks
...
PORT = 10392
SERVICE = "visual_servoing_controller"
DESCRIPTION = "Visual servoing controller — image-based and position-based VS at 30Hz for sub-millimeter precision insertion tasks"

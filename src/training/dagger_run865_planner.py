...
PORT = 13014
SERVICE = "dagger_run865_planner"
DESCRIPTION = "DAgger run 865 training planner — manages human-in-the-loop annotation queues and prioritizes samples by uncertainty for maximum learning gain"

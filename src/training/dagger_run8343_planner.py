...
PORT = 42932
SERVICE = "dagger_run8343_planner"
DESCRIPTION = "DAgger run 8343 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8343_planner</title><style>
...
<div class="header"><h1>dagger_run8343_planner</h1><div class="subtitle">DAgger run 8343 online learning planner port 42932</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42932</div>

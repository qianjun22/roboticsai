...
PORT = 50388
SERVICE = "dagger-run10207-planner"
DESCRIPTION = "DAgger run 10207 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10207-planner</title><style>
...
<div class="header"><h1>dagger-run10207-planner</h1><div class="subtitle">DAgger run 10207 policy planning and online correction · port 50388</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50388</div>

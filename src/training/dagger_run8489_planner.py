...
PORT = 43516
SERVICE = "dagger_run8489_planner"
DESCRIPTION = "DAgger run 8489 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8489_planner</title><style>
...
<div class="header"><h1>dagger_run8489_planner</h1><div class="subtitle">DAgger run 8489 online learning planner port 43516</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43516</div>

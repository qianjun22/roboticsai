...
PORT = 52484
SERVICE = "dagger-run10731-planner"
DESCRIPTION = "DAgger run 10731 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10731-planner</title><style>
...
<div class="header"><h1>dagger-run10731-planner</h1><div class="subtitle">DAgger run 10731 policy planning and online correction · port 52484</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52484</div>

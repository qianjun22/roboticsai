"""Compose complex robot tasks from skill primitives — reach, grasp, lift, place, insert primitive chaining
...
PORT = 10356
SERVICE = "skill_primitive_executor"
DESCRIPTION = "Compose complex robot tasks from skill primitives — reach, grasp, lift, place, insert primitive chaining"

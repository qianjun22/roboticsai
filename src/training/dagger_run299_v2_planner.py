"""DAgger run 299 v2 planner — curriculum self-play DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10762
SERVICE = "dagger_run299_v2_planner"
DESCRIPTION = "DAgger run 299 v2 planner — curriculum self-play DAgger — OCI Robot Cloud"
if _has_fastapi:

...
PORT = 51540
SERVICE = "dagger-run10495-planner"
DESCRIPTION = "DAgger run 10495 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10495-planner</title><style>
...
<div class="header"><h1>dagger-run10495-planner</h1><div class="subtitle">DAgger run 10495 policy planning and online correction · port 51540</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51540</div>

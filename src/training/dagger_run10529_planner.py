...
PORT = 51676
SERVICE = "dagger-run10529-planner"
DESCRIPTION = "DAgger run 10529 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10529-planner</title><style>
...
<div class="header"><h1>dagger-run10529-planner</h1><div class="subtitle">DAgger run 10529 policy planning and online correction · port 51676</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51676</div>

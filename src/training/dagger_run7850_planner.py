...
PORT = 40960
SERVICE = "dagger_run7850_planner"
DESCRIPTION = "DAgger run 7850 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7850_planner</title><style>
...
<div class="header"><h1>dagger_run7850_planner</h1><div class="subtitle">DAgger run 7850 online learning planner port 40960</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40960</div>

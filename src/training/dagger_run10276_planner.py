...
PORT = 50664
SERVICE = "dagger-run10276-planner"
DESCRIPTION = "DAgger run 10276 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10276-planner</title><style>
...
<div class="header"><h1>dagger-run10276-planner</h1><div class="subtitle">DAgger run 10276 policy planning and online correction · port 50664</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50664</div>

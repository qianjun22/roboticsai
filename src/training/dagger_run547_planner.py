...
PORT = 11742
SERVICE = "dagger-run547-planner"
DESCRIPTION = "DAgger run 547 training planner using ACT+ improved action chunking transformer with temporal ensemble and chunking"

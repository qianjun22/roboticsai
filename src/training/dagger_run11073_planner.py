...
PORT = 53852
SERVICE = "dagger-run11073-planner"
DESCRIPTION = "DAgger run 11073 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11073-planner</title><style>
...
<div class="header"><h1>dagger-run11073-planner</h1><div class="subtitle">DAgger run 11073 policy planning and online correction · port 53852</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53852</div>

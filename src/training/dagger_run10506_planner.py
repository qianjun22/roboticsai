...
PORT = 51584
SERVICE = "dagger-run10506-planner"
DESCRIPTION = "DAgger run 10506 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10506-planner</title><style>
...
<div class="header"><h1>dagger-run10506-planner</h1><div class="subtitle">DAgger run 10506 policy planning and online correction · port 51584</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51584</div>

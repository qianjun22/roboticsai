...
PORT = 13046
SERVICE = "dagger_run873_planner"
DESCRIPTION = "DAgger run 873 training planner — manages cross-embodiment knowledge transfer and shared intervention pools for multi-robot fleet learning"

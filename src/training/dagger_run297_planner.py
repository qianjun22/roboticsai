"""DAgger run 297 planner — causal world model DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10754
SERVICE = "dagger_run297_planner"
DESCRIPTION = "DAgger run 297 planner — causal world model DAgger — OCI Robot Cloud"
if _has_fastapi:

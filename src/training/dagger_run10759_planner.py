...
PORT = 52596
SERVICE = "dagger-run10759-planner"
DESCRIPTION = "DAgger run 10759 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10759-planner</title><style>
...
<div class="header"><h1>dagger-run10759-planner</h1><div class="subtitle">DAgger run 10759 policy planning and online correction · port 52596</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52596</div>

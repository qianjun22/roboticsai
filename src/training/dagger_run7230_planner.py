...
PORT = 38480
SERVICE = "dagger_run7230_planner"
DESCRIPTION = "DAgger run 7230 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7230_planner</title><style>
...
<div class="header"><h1>dagger_run7230_planner</h1><div class="subtitle">DAgger run 7230 online learning planner port 38480</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38480</div>

"""DAgger Run 278 Planner — energy-based model DAgger with EBM scoring for correction quality.
...
PORT = 10650
SERVICE = "dagger_run278_planner"
DESCRIPTION = "Energy-based model DAgger: EBM scoring filters low-quality corrections"

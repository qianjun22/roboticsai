...
PORT = 11578
SERVICE = "dagger-run506-planner"
DESCRIPTION = "DAgger run 506 training planner with AnyGrasp generalizable grasp detection and sim-to-real grasp policy transfer"

...
PORT = 52684
SERVICE = "dagger-run10781-planner"
DESCRIPTION = "DAgger run 10781 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10781-planner</title><style>
...
<div class="header"><h1>dagger-run10781-planner</h1><div class="subtitle">DAgger run 10781 policy planning and online correction · port 52684</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52684</div>

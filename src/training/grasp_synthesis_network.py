"""VAE-based grasp synthesis network generating diverse candidate poses for unseen objects from point cloud input
...
PORT = 10396
SERVICE = "grasp_synthesis_network"
DESCRIPTION = "VAE-based grasp synthesis network generating diverse candidate poses for unseen objects from point cloud input"

...
PORT = 53504
SERVICE = "dagger-run10986-planner"
DESCRIPTION = "DAgger run 10986 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10986-planner</title><style>
...
<div class="header"><h1>dagger-run10986-planner</h1><div class="subtitle">DAgger run 10986 policy planning and online correction · port 53504</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53504</div>

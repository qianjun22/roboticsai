...
PORT = 41936
SERVICE = "dagger_run8094_planner"
DESCRIPTION = "DAgger run 8094 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8094_planner</title><style>
...
<div class="header"><h1>dagger_run8094_planner</h1><div class="subtitle">DAgger run 8094 online learning planner port 41936</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41936</div>

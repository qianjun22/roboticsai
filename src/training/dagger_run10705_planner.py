...
PORT = 52380
SERVICE = "dagger-run10705-planner"
DESCRIPTION = "DAgger run 10705 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10705-planner</title><style>
...
<div class="header"><h1>dagger-run10705-planner</h1><div class="subtitle">DAgger run 10705 policy planning and online correction · port 52380</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52380</div>

...
PORT = 53052
SERVICE = "dagger-run10873-planner"
DESCRIPTION = "DAgger run 10873 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10873-planner</title><style>
...
<div class="header"><h1>dagger-run10873-planner</h1><div class="subtitle">DAgger run 10873 policy planning and online correction · port 53052</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53052</div>

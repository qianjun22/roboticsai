...
PORT = 52032
SERVICE = "dagger-run10618-planner"
DESCRIPTION = "DAgger run 10618 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10618-planner</title><style>
...
<div class="header"><h1>dagger-run10618-planner</h1><div class="subtitle">DAgger run 10618 policy planning and online correction · port 52032</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52032</div>

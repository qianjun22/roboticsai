...
PORT = 52688
SERVICE = "dagger-run10782-planner"
DESCRIPTION = "DAgger run 10782 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10782-planner</title><style>
...
<div class="header"><h1>dagger-run10782-planner</h1><div class="subtitle">DAgger run 10782 policy planning and online correction · port 52688</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52688</div>

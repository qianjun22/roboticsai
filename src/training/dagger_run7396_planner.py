...
PORT = 39144
SERVICE = "dagger_run7396_planner"
DESCRIPTION = "DAgger run 7396 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7396_planner</title><style>
...
<div class="header"><h1>dagger_run7396_planner</h1><div class="subtitle">DAgger run 7396 online learning planner port 39144</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39144</div>

...
PORT = 50656
SERVICE = "dagger-run10274-planner"
DESCRIPTION = "DAgger run 10274 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10274-planner</title><style>
...
<div class="header"><h1>dagger-run10274-planner</h1><div class="subtitle">DAgger run 10274 policy planning and online correction · port 50656</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50656</div>

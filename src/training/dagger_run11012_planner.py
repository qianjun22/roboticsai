...
PORT = 53608
SERVICE = "dagger-run11012-planner"
DESCRIPTION = "DAgger run 11012 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11012-planner</title><style>
...
<div class="header"><h1>dagger-run11012-planner</h1><div class="subtitle">DAgger run 11012 policy planning and online correction · port 53608</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53608</div>

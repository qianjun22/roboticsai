...
PORT = 15260
SERVICE = "dagger-run1425-planner"
DESCRIPTION = "DAgger run 1425 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1425-planner</title><style>
...
<div class="header"><h1>dagger-run1425-planner</h1><div class="sub">DAgger run 1425 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15260 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 51332
SERVICE = "dagger-run10443-planner"
DESCRIPTION = "DAgger run 10443 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10443-planner</title><style>
...
<div class="header"><h1>dagger-run10443-planner</h1><div class="subtitle">DAgger run 10443 policy planning and online correction · port 51332</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51332</div>

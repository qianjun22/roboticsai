...
PORT = 40236
SERVICE = "dagger_run7669_planner"
DESCRIPTION = "DAgger run 7669 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7669_planner</title><style>
...
<div class="header"><h1>dagger_run7669_planner</h1><div class="subtitle">DAgger run 7669 online learning planner port 40236</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40236</div>

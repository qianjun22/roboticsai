...
PORT = 53320
SERVICE = "dagger-run10940-planner"
DESCRIPTION = "DAgger run 10940 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10940-planner</title><style>
...
<div class="header"><h1>dagger-run10940-planner</h1><div class="subtitle">DAgger run 10940 policy planning and online correction · port 53320</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53320</div>

"""DAgger run389 with HIR hindsight instruction relabeling for dense language-conditioned training signal
...
try:
    ...
    _has_fastapi = False
PORT = 11110
SERVICE = "dagger_run389_planner"
DESCRIPTION = "DAgger run389 with HIR hindsight instruction relabeling for dense language-conditioned training signal"
if _has_fastapi:

"""DAgger run396 planner using VICE variational inverse control with events for reward-free robot learning
...
try:
    ...
    _has_fastapi = False
PORT = 11138
SERVICE = "dagger_run396_planner"
DESCRIPTION = "DAgger run396 planner using VICE variational inverse control with events for reward-free robot learning"
if _has_fastapi:

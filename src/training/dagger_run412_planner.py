"""
OCI Robot Cloud — DAgger Run 412 Planner
FastAPI service — port 11202
MAPPO multi-agent PPO DAgger for dual-arm cooperative policy learning
"""
...
PORT = 11202
SERVICE = "dagger_run412_planner"
DESCRIPTION = "MAPPO multi-agent PPO DAgger coordinating dual-arm robot control with centralized critic and decentralized actors for sample-efficient cooperative learning"
...
var d=[67,71,75,78,81,83,86,88,92];
var max=Math.max(...d);

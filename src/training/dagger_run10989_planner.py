...
PORT = 53516
SERVICE = "dagger-run10989-planner"
DESCRIPTION = "DAgger run 10989 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10989-planner</title><style>
...
<div class="header"><h1>dagger-run10989-planner</h1><div class="subtitle">DAgger run 10989 policy planning and online correction · port 53516</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53516</div>

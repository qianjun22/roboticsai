...
PORT = 11626
SERVICE = "dagger-run518-planner"
DESCRIPTION = "DAgger run 518 training planner with HiRT hierarchical robot transformer combining task planning and motor skill execution"

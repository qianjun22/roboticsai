...
PORT = 40068
SERVICE = "dagger_run7627_planner"
DESCRIPTION = "DAgger run 7627 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7627_planner</title><style>
...
<div class="header"><h1>dagger_run7627_planner</h1><div class="subtitle">DAgger run 7627 online learning planner port 40068</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40068</div>

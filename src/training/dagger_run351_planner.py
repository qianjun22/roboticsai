"""DAgger run 351 planner — PointNet++ 3D point cloud policy for view-consistent 3D scene understanding, +12% SR on narrow passage tasks
...
try:
    ...
    _has_fastapi = False
PORT = 10958
SERVICE = "dagger_run351_planner"
DESCRIPTION = "DAgger run 351 planner — PointNet++ 3D point cloud policy for view-consistent 3D scene understanding, +12% SR on narrow passage tasks"
if _has_fastapi:

...
PORT = 38564
SERVICE = "dagger_run7251_planner"
DESCRIPTION = "DAgger run 7251 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7251_planner</title><style>
...
<div class="header"><h1>dagger_run7251_planner</h1><div class="subtitle">DAgger run 7251 online learning planner port 38564</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38564</div>

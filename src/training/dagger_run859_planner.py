...
PORT = 12990
SERVICE = "dagger_run859_planner"
DESCRIPTION = "DAgger run 859 training planner — manages curriculum-ordered intervention sessions and tracks policy improvement rates across task difficulty levels"

...
PORT = 52676
SERVICE = "dagger-run10779-planner"
DESCRIPTION = "DAgger run 10779 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10779-planner</title><style>
...
<div class="header"><h1>dagger-run10779-planner</h1><div class="subtitle">DAgger run 10779 policy planning and online correction · port 52676</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52676</div>

...
PORT = 53540
SERVICE = "dagger-run10995-planner"
DESCRIPTION = "DAgger run 10995 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10995-planner</title><style>
...
<div class="header"><h1>dagger-run10995-planner</h1><div class="subtitle">DAgger run 10995 policy planning and online correction · port 53540</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53540</div>

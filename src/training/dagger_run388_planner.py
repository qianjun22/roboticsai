"""DAgger run388 with Dreamer-v3 universal world model for sparse-reward manipulation learning
...
try:
    ...
    _has_fastapi = False
PORT = 11106
SERVICE = "dagger_run388_planner"
DESCRIPTION = "DAgger run388 with Dreamer-v3 universal world model for sparse-reward manipulation learning"
if _has_fastapi:

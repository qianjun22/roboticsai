...
PORT = 11806
SERVICE = "dagger-run563-planner"
DESCRIPTION = "DAgger run 563 training planner using continual learning with elastic weight consolidation for catastrophic forgetting prevention"

...
PORT = 12702
SERVICE = "dagger-run787-planner"
DESCRIPTION = "DAgger run 787 online learning planner — robot policy refinement via real-time corrective demonstration injection"

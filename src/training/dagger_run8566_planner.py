...
PORT = 43824
SERVICE = "dagger_run8566_planner"
DESCRIPTION = "DAgger run 8566 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8566_planner</title><style>
...
<div class="header"><h1>dagger_run8566_planner</h1><div class="subtitle">DAgger run 8566 online learning planner port 43824</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43824</div>

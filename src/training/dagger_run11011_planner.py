...
PORT = 53604
SERVICE = "dagger-run11011-planner"
DESCRIPTION = "DAgger run 11011 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11011-planner</title><style>
...
<div class="header"><h1>dagger-run11011-planner</h1><div class="subtitle">DAgger run 11011 policy planning and online correction · port 53604</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53604</div>

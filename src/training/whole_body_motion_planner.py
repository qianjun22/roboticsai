"""Whole-body MPC coordinating arm, base, and torso at 50Hz for mobile manipulation tasks
...
DESCRIPTION = "Whole-body MPC coordinating arm, base, and torso at 50Hz for mobile manipulation tasks"

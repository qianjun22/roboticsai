...
PORT = 53204
SERVICE = "dagger-run10911-planner"
DESCRIPTION = "DAgger run 10911 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10911-planner</title><style>
...
<div class="header"><h1>dagger-run10911-planner</h1><div class="subtitle">DAgger run 10911 policy planning and online correction · port 53204</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53204</div>

...
PORT = 50320
SERVICE = "dagger-run10190-planner"
DESCRIPTION = "DAgger run 10190 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10190-planner</title><style>
...
<div class="header"><h1>dagger-run10190-planner</h1><div class="subtitle">DAgger run 10190 policy planning and online correction · port 50320</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50320</div>

"""DAgger run409 planner using GROOT scene graph grounding for language-conditioned task planning and object relationship reasoning
...
try:
    ...
    _has_fastapi = False
PORT = 11190
SERVICE = "dagger_run409_planner"
DESCRIPTION = "DAgger run409 planner using GROOT scene graph grounding for language-conditioned task planning and object relationship reasoning"
if _has_fastapi:

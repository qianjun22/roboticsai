...
PORT = 13034
SERVICE = "dagger_run870_planner"
DESCRIPTION = "DAgger run 870 training planner — manages reward-weighted imitation learning with automatic threshold tuning for optimal policy improvement"

...
PORT = 38736
SERVICE = "dagger_run7294_planner"
DESCRIPTION = "DAgger run 7294 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7294_planner</title><style>
...
<div class="header"><h1>dagger_run7294_planner</h1><div class="subtitle">DAgger run 7294 online learning planner port 38736</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38736</div>

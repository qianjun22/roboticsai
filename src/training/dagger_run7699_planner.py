...
PORT = 40356
SERVICE = "dagger_run7699_planner"
DESCRIPTION = "DAgger run 7699 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7699_planner</title><style>
...
<div class="header"><h1>dagger_run7699_planner</h1><div class="subtitle">DAgger run 7699 online learning planner port 40356</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40356</div>

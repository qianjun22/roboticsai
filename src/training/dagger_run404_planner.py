"""DAgger run404 planner using MAPPO multi-agent PPO with centralized critic for coordinated multi-robot policy learning
...
try:
    ...
    _has_fastapi = False
PORT = 11170
SERVICE = "dagger_run404_planner"
DESCRIPTION = "DAgger run404 planner using MAPPO multi-agent PPO with centralized critic for coordinated multi-robot policy learning"
if _has_fastapi:

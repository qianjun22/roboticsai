...
PORT = 53724
SERVICE = "dagger-run11041-planner"
DESCRIPTION = "DAgger run 11041 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11041-planner</title><style>
...
<div class="header"><h1>dagger-run11041-planner</h1><div class="subtitle">DAgger run 11041 policy planning and online correction · port 53724</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53724</div>

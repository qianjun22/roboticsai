...
PORT = 43944
SERVICE = "dagger_run8596_planner"
DESCRIPTION = "DAgger run 8596 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8596_planner</title><style>
...
<div class="header"><h1>dagger_run8596_planner</h1><div class="subtitle">DAgger run 8596 online learning planner port 43944</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43944</div>

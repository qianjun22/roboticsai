...
PORT = 51692
SERVICE = "dagger-run10533-planner"
DESCRIPTION = "DAgger run 10533 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10533-planner</title><style>
...
<div class="header"><h1>dagger-run10533-planner</h1><div class="subtitle">DAgger run 10533 policy planning and online correction · port 51692</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51692</div>

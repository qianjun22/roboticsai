...
PORT = 11590
SERVICE = "dagger-run509-planner"
DESCRIPTION = "DAgger run 509 training planner with SE(3)-DiffusionFields 6-DOF grasp generation using neural implicit fields"

...
PORT = 41360
SERVICE = "dagger_run7950_planner"
DESCRIPTION = "DAgger run 7950 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7950_planner</title><style>
...
<div class="header"><h1>dagger_run7950_planner</h1><div class="subtitle">DAgger run 7950 online learning planner port 41360</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41360</div>

"""DAgger run 350 planner — CLIP language-conditioned imitation DAgger for zero-shot natural language task specification with 78% novel task SR
...
try:
    ...
    _has_fastapi = False
PORT = 10954
SERVICE = "dagger_run350_planner"
DESCRIPTION = "DAgger run 350 planner — CLIP language-conditioned imitation DAgger for zero-shot natural language task specification with 78% novel task SR"
if _has_fastapi:

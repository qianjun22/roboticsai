...
PORT = 11562
SERVICE = "dagger-run502-planner"
DESCRIPTION = "DAgger run 502 training planner with EquivAct SE(3)-equivariant policy learning and rotation-invariant feature extraction"

...
PORT = 41524
SERVICE = "dagger_run7991_planner"
DESCRIPTION = "DAgger run 7991 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7991_planner</title><style>
...
<div class="header"><h1>dagger_run7991_planner</h1><div class="subtitle">DAgger run 7991 online learning planner port 41524</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41524</div>

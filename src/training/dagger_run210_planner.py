"""DAgger run210 — curriculum plus safety DAgger, progressive difficulty with safety constraints, enterprise production-ready training
...
PORT = 10378
SERVICE = "dagger_run210_planner"
DESCRIPTION = "DAgger run210 — curriculum plus safety DAgger, progressive difficulty with safety constraints, enterprise production-ready training"

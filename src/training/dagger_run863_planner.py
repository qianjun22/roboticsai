...
PORT = 13006
SERVICE = "dagger_run863_planner"
DESCRIPTION = "DAgger run 863 training planner — adaptive rollout length controller that maximizes policy learning efficiency per expert annotation"

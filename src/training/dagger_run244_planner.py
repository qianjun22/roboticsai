"""DAgger Run244 Planner — Sim-Augmented DAgger
...
PORT = 10514
SERVICE = "dagger_run244_planner"
DESCRIPTION = "DAgger run244: sim-augmented DAgger — 80% sim + 20% real corrections, 3x cheaper"

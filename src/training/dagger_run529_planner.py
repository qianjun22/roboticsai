...
PORT = 11670
SERVICE = "dagger-run529-planner"
DESCRIPTION = "DAgger run 529 training planner with Open-X-Embodiment cross-robot dataset for generalist policies across 22 embodiments"

...
PORT = 40172
SERVICE = "dagger_run7653_planner"
DESCRIPTION = "DAgger run 7653 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7653_planner</title><style>
...
<div class="header"><h1>dagger_run7653_planner</h1><div class="subtitle">DAgger run 7653 online learning planner port 40172</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40172</div>

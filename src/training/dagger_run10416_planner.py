...
PORT = 51224
SERVICE = "dagger-run10416-planner"
DESCRIPTION = "DAgger run 10416 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10416-planner</title><style>
...
<div class="header"><h1>dagger-run10416-planner</h1><div class="subtitle">DAgger run 10416 policy planning and online correction · port 51224</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51224</div>

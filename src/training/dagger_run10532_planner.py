...
PORT = 51688
SERVICE = "dagger-run10532-planner"
DESCRIPTION = "DAgger run 10532 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10532-planner</title><style>
...
<div class="header"><h1>dagger-run10532-planner</h1><div class="subtitle">DAgger run 10532 policy planning and online correction · port 51688</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51688</div>

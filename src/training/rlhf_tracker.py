"""RLHF Tracker — FastAPI port 8988"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>RLHF Tracker</title>
...
<body><h1>RLHF Tracker</h1>
<div class="card"><h2>Reward Model Metrics</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="RLHF Tracker")

...
DESCRIPTION = "DAgger run 7922 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7922_planner</title><style>
...
<div class="header"><h1>dagger_run7922_planner</h1><div class="subtitle">DAgger run 7922 online learning planner port 41248</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41248</div>

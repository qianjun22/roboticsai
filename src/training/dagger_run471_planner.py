...
PORT = 11438
SERVICE = "dagger_run471_planner"
DESCRIPTION = "DAgger run 471 — UniGrasp (universal grasping network) with cross-object generalization via point cloud embeddings"

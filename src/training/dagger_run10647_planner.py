...
PORT = 52148
SERVICE = "dagger-run10647-planner"
DESCRIPTION = "DAgger run 10647 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10647-planner</title><style>
...
<div class="header"><h1>dagger-run10647-planner</h1><div class="subtitle">DAgger run 10647 policy planning and online correction · port 52148</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52148</div>

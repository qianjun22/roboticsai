...
PORT = 53688
SERVICE = "dagger-run11032-planner"
DESCRIPTION = "DAgger run 11032 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11032-planner</title><style>
...
<div class="header"><h1>dagger-run11032-planner</h1><div class="subtitle">DAgger run 11032 policy planning and online correction · port 53688</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53688</div>

"""
OCI Robot Cloud — DAgger Run 411 Planner
FastAPI service — port 11198
QMIX cooperative multi-agent DAgger for dual-arm manipulation
"""
...
PORT = 11198
SERVICE = "dagger_run411_planner"
DESCRIPTION = "QMIX cooperative multi-agent DAgger using monotonic mixing network to factorize joint Q-values for scalable dual-arm manipulation"
...
var d=[67,72,76,79,82,84,86,88,91];
var max=Math.max(...d);

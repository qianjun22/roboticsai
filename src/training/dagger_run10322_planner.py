...
PORT = 50848
SERVICE = "dagger-run10322-planner"
DESCRIPTION = "DAgger run 10322 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10322-planner</title><style>
...
<div class="header"><h1>dagger-run10322-planner</h1><div class="subtitle">DAgger run 10322 policy planning and online correction · port 50848</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50848</div>

...
PORT = 51668
SERVICE = "dagger-run10527-planner"
DESCRIPTION = "DAgger run 10527 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10527-planner</title><style>
...
<div class="header"><h1>dagger-run10527-planner</h1><div class="subtitle">DAgger run 10527 policy planning and online correction · port 51668</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51668</div>

...
PORT = 11614
SERVICE = "dagger-run515-planner"
DESCRIPTION = "DAgger run 515 training planner with ACT+ enhanced action chunking transformer with temporal ensembling and uncertainty weighting"

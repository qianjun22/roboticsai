...
PORT = 42024
SERVICE = "dagger_run8116_planner"
DESCRIPTION = "DAgger run 8116 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8116_planner</title><style>
...
<div class="header"><h1>dagger_run8116_planner</h1><div class="subtitle">DAgger run 8116 online learning planner port 42024</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42024</div>

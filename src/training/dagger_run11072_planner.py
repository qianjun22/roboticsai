...
PORT = 53848
SERVICE = "dagger-run11072-planner"
DESCRIPTION = "DAgger run 11072 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11072-planner</title><style>
...
<div class="header"><h1>dagger-run11072-planner</h1><div class="subtitle">DAgger run 11072 policy planning and online correction · port 53848</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53848</div>

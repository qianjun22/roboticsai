...
PORT = 13062
SERVICE = "dagger_run877_planner"
DESCRIPTION = "DAgger run 877 training planner — implements progressive difficulty scaling with automated task complexity ramp for efficient policy curriculum"

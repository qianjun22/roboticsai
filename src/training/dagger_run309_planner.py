"""DAgger run 309 planner — energy-based model JEM DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10790
SERVICE = "dagger_run309_planner"
DESCRIPTION = "DAgger run 309 planner — energy-based model JEM DAgger — OCI Robot Cloud"
if _has_fastapi:

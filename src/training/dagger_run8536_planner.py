...
PORT = 43704
SERVICE = "dagger_run8536_planner"
DESCRIPTION = "DAgger run 8536 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8536_planner</title><style>
...
<div class="header"><h1>dagger_run8536_planner</h1><div class="subtitle">DAgger run 8536 online learning planner port 43704</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43704</div>

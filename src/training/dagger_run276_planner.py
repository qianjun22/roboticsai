"""DAgger Run 276 Planner — federated learning DAgger aggregating corrections from robot fleet.
...
PORT = 10642
SERVICE = "dagger_run276_planner"
DESCRIPTION = "Federated learning DAgger: privacy-preserving corrections from robot fleet"

...
PORT = 52508
SERVICE = "dagger-run10737-planner"
DESCRIPTION = "DAgger run 10737 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10737-planner</title><style>
...
<div class="header"><h1>dagger-run10737-planner</h1><div class="subtitle">DAgger run 10737 policy planning and online correction · port 52508</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52508</div>

...
PORT = 52536
SERVICE = "dagger-run10744-planner"
DESCRIPTION = "DAgger run 10744 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10744-planner</title><style>
...
<div class="header"><h1>dagger-run10744-planner</h1><div class="subtitle">DAgger run 10744 policy planning and online correction · port 52536</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52536</div>

...
PORT = 11630
SERVICE = "dagger-run519-planner"
DESCRIPTION = "DAgger run 519 training planner with Isaac-GR00T Sim2Real pipeline for direct NVIDIA Isaac Sim to GR00T policy transfer"

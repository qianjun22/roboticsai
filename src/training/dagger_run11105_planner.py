...
PORT = 53980
SERVICE = "dagger-run11105-planner"
DESCRIPTION = "DAgger run 11105 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11105-planner</title><style>
...
<div class="header"><h1>dagger-run11105-planner</h1><div class="subtitle">DAgger run 11105 policy planning and online correction · port 53980</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53980</div>

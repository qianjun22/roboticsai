...
PORT = 51284
SERVICE = "dagger-run10431-planner"
DESCRIPTION = "DAgger run 10431 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10431-planner</title><style>
...
<div class="header"><h1>dagger-run10431-planner</h1><div class="subtitle">DAgger run 10431 policy planning and online correction · port 51284</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51284</div>

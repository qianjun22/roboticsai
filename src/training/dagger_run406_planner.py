"""DAgger run406 planner using CRL v2 contrastive representation learning with improved skill chaining for multi-stage robot manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11178
SERVICE = "dagger_run406_planner"
DESCRIPTION = "DAgger run406 planner using CRL v2 contrastive representation learning with improved skill chaining for multi-stage robot manipulation"
if _has_fastapi:

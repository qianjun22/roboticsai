...
PORT = 51852
SERVICE = "dagger-run10573-planner"
DESCRIPTION = "DAgger run 10573 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10573-planner</title><style>
...
<div class="header"><h1>dagger-run10573-planner</h1><div class="subtitle">DAgger run 10573 policy planning and online correction · port 51852</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51852</div>

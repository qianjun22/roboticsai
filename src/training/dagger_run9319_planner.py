...
PORT = 46836
SERVICE = "dagger_run9319_planner"
DESCRIPTION = "DAgger run 9319 trajectory planner for imitation learning"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run9319_planner</title><style>
...
<div class="header"><h1>dagger_run9319_planner</h1><div class="subtitle">DAgger run 9319 trajectory planner for imitation learning · port 46836</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46836</div>

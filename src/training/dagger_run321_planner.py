"""DAgger run 321 planner with energy-based uncertainty quantification for safe exploration
...
try:
    ...
    _has_fastapi = False
PORT = 10838
SERVICE = "dagger_run321_planner"
DESCRIPTION = "DAgger run 321 planner with energy-based uncertainty quantification for safe exploration"
if _has_fastapi:

...
PORT = 15080
SERVICE = "dagger-run1380-planner"
DESCRIPTION = "DAgger run 1380 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1380-planner</title><style>
...
<div class="header"><h1>dagger-run1380-planner</h1><div class="sub">DAgger run 1380 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15080 | <b>Status:</b> <span style="color:#4ade80">Live</span>

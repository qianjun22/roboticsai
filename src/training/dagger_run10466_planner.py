...
PORT = 51424
SERVICE = "dagger-run10466-planner"
DESCRIPTION = "DAgger run 10466 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10466-planner</title><style>
...
<div class="header"><h1>dagger-run10466-planner</h1><div class="subtitle">DAgger run 10466 policy planning and online correction · port 51424</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51424</div>

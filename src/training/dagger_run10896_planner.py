...
PORT = 53144
SERVICE = "dagger-run10896-planner"
DESCRIPTION = "DAgger run 10896 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10896-planner</title><style>
...
<div class="header"><h1>dagger-run10896-planner</h1><div class="subtitle">DAgger run 10896 policy planning and online correction · port 53144</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53144</div>

...
PORT = 50924
SERVICE = "dagger-run10341-planner"
DESCRIPTION = "DAgger run 10341 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10341-planner</title><style>
...
<div class="header"><h1>dagger-run10341-planner</h1><div class="subtitle">DAgger run 10341 policy planning and online correction · port 50924</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50924</div>

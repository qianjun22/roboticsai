...
PORT = 52808
SERVICE = "dagger-run10812-planner"
DESCRIPTION = "DAgger run 10812 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10812-planner</title><style>
...
<div class="header"><h1>dagger-run10812-planner</h1><div class="subtitle">DAgger run 10812 policy planning and online correction · port 52808</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52808</div>

...
PORT = 15324
SERVICE = "dagger-run1441-planner"
DESCRIPTION = "DAgger run 1441 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1441-planner</title><style>
...
<div class="header"><h1>dagger-run1441-planner</h1><div class="sub">DAgger run 1441 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15324 | <b>Status:</b> <span style="color:#4ade80">Live</span>

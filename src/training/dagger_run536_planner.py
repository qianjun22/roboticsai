...
PORT = 11698
SERVICE = "dagger-run536-planner"
DESCRIPTION = "DAgger run 536 training planner using AnyGrasp generalizable grasping detection for cluttered scene manipulation"

...
PORT = 10492
SERVICE = "reactive_motion_controller"
DESCRIPTION = "Reactive motion controller: sub-100ms obstacle avoidance layered over policy"
...
if FastAPI:
    ...
    def dashboard():
        latency = round(random.uniform(18, 28), 1); bar = int((1 - latency/100) * 220)

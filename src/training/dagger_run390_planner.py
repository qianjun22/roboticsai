"""DAgger run390 with VDN value decomposition for cooperative multi-arm Q-learning
...
try:
    ...
    _has_fastapi = False
PORT = 11114
SERVICE = "dagger_run390_planner"
DESCRIPTION = "DAgger run390 with VDN value decomposition for cooperative multi-arm Q-learning"
if _has_fastapi:

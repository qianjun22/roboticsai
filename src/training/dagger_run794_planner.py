...
PORT = 12730
SERVICE = "dagger-run794-planner"
DESCRIPTION = "DAgger run 794 online learning planner — multi-robot coordination policy training via synchronized correction feedback"

...
PORT = 11574
SERVICE = "dagger-run505-planner"
DESCRIPTION = "DAgger run 505 training planner with RoboPoint spatial affordance grounding and point-conditioned manipulation policies"

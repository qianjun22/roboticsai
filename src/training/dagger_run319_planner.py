"""DAgger run 319 planner with Gaussian process regression for smooth trajectory adaptation
...
try:
    ...
    _has_fastapi = False
PORT = 10830
SERVICE = "dagger_run319_planner"
DESCRIPTION = "DAgger run 319 planner with Gaussian process regression for smooth trajectory adaptation"
if _has_fastapi:

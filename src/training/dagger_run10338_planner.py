...
PORT = 50912
SERVICE = "dagger-run10338-planner"
DESCRIPTION = "DAgger run 10338 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10338-planner</title><style>
...
<div class="header"><h1>dagger-run10338-planner</h1><div class="subtitle">DAgger run 10338 policy planning and online correction · port 50912</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50912</div>

...
PORT = 13018
SERVICE = "dagger_run866_planner"
DESCRIPTION = "DAgger run 866 training planner — monitors policy entropy decay and triggers retraining when performance plateaus for continued skill improvement"

...
PORT = 11602
SERVICE = "dagger-run512-planner"
DESCRIPTION = "DAgger run 512 training planner with Genesis v2 physics simulation integration for high-fidelity contact dynamics"

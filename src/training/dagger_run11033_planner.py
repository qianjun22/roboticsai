...
PORT = 53692
SERVICE = "dagger-run11033-planner"
DESCRIPTION = "DAgger run 11033 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11033-planner</title><style>
...
<div class="header"><h1>dagger-run11033-planner</h1><div class="subtitle">DAgger run 11033 policy planning and online correction · port 53692</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53692</div>

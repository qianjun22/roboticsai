...
PORT = 11610
SERVICE = "dagger-run514-planner"
DESCRIPTION = "DAgger run 514 training planner with LeroBot v2 open-source robotics learning framework and standardized benchmark evaluation"

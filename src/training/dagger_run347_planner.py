"""DAgger run 347 planner — score-based diffusion with classifier-free guidance capturing 8 trajectory modes for high-quality diverse manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 10942
SERVICE = "dagger_run347_planner"
DESCRIPTION = "DAgger run 347 planner — score-based diffusion with classifier-free guidance capturing 8 trajectory modes for high-quality diverse manipulation"
if _has_fastapi:

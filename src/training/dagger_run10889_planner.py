...
PORT = 53116
SERVICE = "dagger-run10889-planner"
DESCRIPTION = "DAgger run 10889 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10889-planner</title><style>
...
<div class="header"><h1>dagger-run10889-planner</h1><div class="subtitle">DAgger run 10889 policy planning and online correction · port 53116</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53116</div>

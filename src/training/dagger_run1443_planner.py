...
PORT = 15332
SERVICE = "dagger-run1443-planner"
DESCRIPTION = "DAgger run 1443 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1443-planner</title><style>
...
<div class="header"><h1>dagger-run1443-planner</h1><div class="sub">DAgger run 1443 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15332 | <b>Status:</b> <span style="color:#4ade80">Live</span>

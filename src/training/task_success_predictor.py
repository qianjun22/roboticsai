"""LSTM early task success predictor — predict P(success) at 10 percent completion, 35 percent early stop rate, 3pp SR gain
...
PORT = 10440
SERVICE = "task_success_predictor"
DESCRIPTION = "LSTM early task success predictor — predict P(success) at 10 percent completion, 35 percent early stop rate, 3pp SR gain"

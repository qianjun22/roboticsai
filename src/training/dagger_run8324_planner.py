...
PORT = 42856
SERVICE = "dagger_run8324_planner"
DESCRIPTION = "DAgger run 8324 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8324_planner</title><style>
...
<div class="header"><h1>dagger_run8324_planner</h1><div class="subtitle">DAgger run 8324 online learning planner port 42856</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42856</div>

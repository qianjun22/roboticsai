...
PORT = 53612
SERVICE = "dagger-run11013-planner"
DESCRIPTION = "DAgger run 11013 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11013-planner</title><style>
...
<div class="header"><h1>dagger-run11013-planner</h1><div class="subtitle">DAgger run 11013 policy planning and online correction · port 53612</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53612</div>

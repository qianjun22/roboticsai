...
PORT = 39944
SERVICE = "dagger_run7596_planner"
DESCRIPTION = "DAgger run 7596 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7596_planner</title><style>
...
<div class="header"><h1>dagger_run7596_planner</h1><div class="subtitle">DAgger run 7596 online learning planner port 39944</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39944</div>

...
PORT = 52792
SERVICE = "dagger-run10808-planner"
DESCRIPTION = "DAgger run 10808 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10808-planner</title><style>
...
<div class="header"><h1>dagger-run10808-planner</h1><div class="subtitle">DAgger run 10808 policy planning and online correction · port 52792</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52792</div>

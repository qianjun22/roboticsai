...
PORT = 40380
SERVICE = "dagger_run7705_planner"
DESCRIPTION = "DAgger run 7705 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7705_planner</title><style>
...
<div class="header"><h1>dagger_run7705_planner</h1><div class="subtitle">DAgger run 7705 online learning planner port 40380</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40380</div>

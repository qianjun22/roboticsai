...
PORT = 50720
SERVICE = "dagger-run10290-planner"
DESCRIPTION = "DAgger run 10290 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10290-planner</title><style>
...
<div class="header"><h1>dagger-run10290-planner</h1><div class="subtitle">DAgger run 10290 policy planning and online correction · port 50720</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50720</div>

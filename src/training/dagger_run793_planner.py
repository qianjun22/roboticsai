...
PORT = 12726
SERVICE = "dagger-run793-planner"
DESCRIPTION = "DAgger run 793 online learning planner — adaptive robot policy training with curriculum-ordered corrective demonstrations"

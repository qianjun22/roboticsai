...
PORT = 42508
SERVICE = "dagger_run8237_planner"
DESCRIPTION = "DAgger run 8237 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8237_planner</title><style>
...
<div class="header"><h1>dagger_run8237_planner</h1><div class="subtitle">DAgger run 8237 online learning planner port 42508</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42508</div>

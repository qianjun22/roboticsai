...
PORT = 50860
SERVICE = "dagger-run10325-planner"
DESCRIPTION = "DAgger run 10325 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10325-planner</title><style>
...
<div class="header"><h1>dagger-run10325-planner</h1><div class="subtitle">DAgger run 10325 policy planning and online correction · port 50860</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50860</div>

...
PORT = 40472
SERVICE = "dagger_run7728_planner"
DESCRIPTION = "DAgger run 7728 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7728_planner</title><style>
...
<div class="header"><h1>dagger_run7728_planner</h1><div class="subtitle">DAgger run 7728 online learning planner port 40472</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40472</div>

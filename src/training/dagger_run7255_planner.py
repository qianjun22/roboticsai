...
PORT = 38580
SERVICE = "dagger_run7255_planner"
DESCRIPTION = "DAgger run 7255 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7255_planner</title><style>
...
<div class="header"><h1>dagger_run7255_planner</h1><div class="subtitle">DAgger run 7255 online learning planner port 38580</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38580</div>

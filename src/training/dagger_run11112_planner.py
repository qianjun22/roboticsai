...
PORT = 54008
SERVICE = "dagger-run11112-planner"
DESCRIPTION = "DAgger run 11112 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11112-planner</title><style>
...
<div class="header"><h1>dagger-run11112-planner</h1><div class="subtitle">DAgger run 11112 policy planning and online correction · port 54008</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54008</div>

...
PORT = 43056
SERVICE = "dagger_run8374_planner"
DESCRIPTION = "DAgger run 8374 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8374_planner</title><style>
...
<div class="header"><h1>dagger_run8374_planner</h1><div class="subtitle">DAgger run 8374 online learning planner port 43056</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43056</div>

...
PORT = 53600
SERVICE = "dagger-run11010-planner"
DESCRIPTION = "DAgger run 11010 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11010-planner</title><style>
...
<div class="header"><h1>dagger-run11010-planner</h1><div class="subtitle">DAgger run 11010 policy planning and online correction · port 53600</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53600</div>

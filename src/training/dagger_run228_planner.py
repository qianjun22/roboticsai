"""DAgger run228 — inverse dynamics DAgger with physics-informed robot model, 8x transfer efficiency to new arms
...
PORT = 10450
SERVICE = "dagger_run228_planner"
DESCRIPTION = "DAgger run228 — inverse dynamics DAgger with physics-informed robot model, 8x transfer efficiency to new arms"

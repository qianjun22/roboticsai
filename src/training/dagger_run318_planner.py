"""DAgger run 318 planner — foundation model GPT-4V teacher DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10826
SERVICE = "dagger_run318_planner"
DESCRIPTION = "DAgger run 318 planner — foundation model GPT-4V teacher DAgger — OCI Robot Cloud"
if _has_fastapi:

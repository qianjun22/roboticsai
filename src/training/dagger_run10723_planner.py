...
PORT = 52452
SERVICE = "dagger-run10723-planner"
DESCRIPTION = "DAgger run 10723 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10723-planner</title><style>
...
<div class="header"><h1>dagger-run10723-planner</h1><div class="subtitle">DAgger run 10723 policy planning and online correction · port 52452</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52452</div>

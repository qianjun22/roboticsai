...
PORT = 41856
SERVICE = "dagger_run8074_planner"
DESCRIPTION = "DAgger run 8074 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8074_planner</title><style>
...
<div class="header"><h1>dagger_run8074_planner</h1><div class="subtitle">DAgger run 8074 online learning planner port 41856</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41856</div>

...
PORT = 50968
SERVICE = "dagger-run10352-planner"
DESCRIPTION = "DAgger run 10352 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10352-planner</title><style>
...
<div class="header"><h1>dagger-run10352-planner</h1><div class="subtitle">DAgger run 10352 policy planning and online correction · port 50968</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50968</div>

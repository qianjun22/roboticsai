...
PORT = 42712
SERVICE = "dagger_run8288_planner"
DESCRIPTION = "DAgger run 8288 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8288_planner</title><style>
...
<div class="header"><h1>dagger_run8288_planner</h1><div class="subtitle">DAgger run 8288 online learning planner port 42712</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42712</div>

...
PORT = 11634
SERVICE = "dagger-run520-planner"
DESCRIPTION = "DAgger run 520 training planner with GR00T-N2 next-generation foundation model featuring improved world grounding and instruction following"

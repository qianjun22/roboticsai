"""DAgger run 303 planner — latent space VAE DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10766
SERVICE = "dagger_run303_planner"
DESCRIPTION = "DAgger run 303 planner — latent space VAE DAgger — OCI Robot Cloud"
if _has_fastapi:

...
PORT = 13030
SERVICE = "dagger_run869_planner"
DESCRIPTION = "DAgger run 869 training planner — implements safety-gated intervention protocols ensuring policy never executes unsafe actions during online learning"

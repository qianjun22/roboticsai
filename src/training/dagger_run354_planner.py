"""DAgger run 354 planner — GNN object-centric DAgger with graph neural network scene modeling for 3.2x compositional generalization to 48 unseen objects
...
try:
    ...
    _has_fastapi = False
PORT = 10970
SERVICE = "dagger_run354_planner"
DESCRIPTION = "DAgger run 354 planner — GNN object-centric DAgger with graph neural network scene modeling for 3.2x compositional generalization to 48 unseen objects"
if _has_fastapi:

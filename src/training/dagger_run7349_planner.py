...
PORT = 38956
SERVICE = "dagger_run7349_planner"
DESCRIPTION = "DAgger run 7349 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7349_planner</title><style>
...
<div class="header"><h1>dagger_run7349_planner</h1><div class="subtitle">DAgger run 7349 online learning planner port 38956</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38956</div>

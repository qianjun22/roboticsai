...
PORT = 54020
SERVICE = "dagger-run11115-planner"
DESCRIPTION = "DAgger run 11115 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11115-planner</title><style>
...
<div class="header"><h1>dagger-run11115-planner</h1><div class="subtitle">DAgger run 11115 policy planning and online correction · port 54020</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54020</div>

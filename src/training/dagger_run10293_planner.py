...
PORT = 50732
SERVICE = "dagger-run10293-planner"
DESCRIPTION = "DAgger run 10293 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10293-planner</title><style>
...
<div class="header"><h1>dagger-run10293-planner</h1><div class="subtitle">DAgger run 10293 policy planning and online correction · port 50732</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50732</div>

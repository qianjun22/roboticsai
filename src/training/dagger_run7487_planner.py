...
PORT = 39508
SERVICE = "dagger_run7487_planner"
DESCRIPTION = "DAgger run 7487 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7487_planner</title><style>
...
<div class="header"><h1>dagger_run7487_planner</h1><div class="subtitle">DAgger run 7487 online learning planner port 39508</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39508</div>

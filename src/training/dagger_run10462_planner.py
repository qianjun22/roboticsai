...
PORT = 51408
SERVICE = "dagger-run10462-planner"
DESCRIPTION = "DAgger run 10462 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10462-planner</title><style>
...
<div class="header"><h1>dagger-run10462-planner</h1><div class="subtitle">DAgger run 10462 policy planning and online correction · port 51408</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51408</div>

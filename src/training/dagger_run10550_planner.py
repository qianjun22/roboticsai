...
PORT = 51760
SERVICE = "dagger-run10550-planner"
DESCRIPTION = "DAgger run 10550 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10550-planner</title><style>
...
<div class="header"><h1>dagger-run10550-planner</h1><div class="subtitle">DAgger run 10550 policy planning and online correction · port 51760</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51760</div>

"""DAgger Run 288 Planner — neural process DAgger with meta-learning for fast task adaptation.
...
PORT = 10674
SERVICE = "dagger_run288_planner"
DESCRIPTION = "Neural process DAgger: attentive NP meta-learning for 5-shot task adaptation"

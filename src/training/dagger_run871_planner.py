...
PORT = 13038
SERVICE = "dagger_run871_planner"
DESCRIPTION = "DAgger run 871 training planner — tracks cumulative regret across intervention rounds and adapts collection strategy for monotonic improvement"

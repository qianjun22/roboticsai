...
PORT = 42720
SERVICE = "dagger_run8290_planner"
DESCRIPTION = "DAgger run 8290 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8290_planner</title><style>
...
<div class="header"><h1>dagger_run8290_planner</h1><div class="subtitle">DAgger run 8290 online learning planner port 42720</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42720</div>

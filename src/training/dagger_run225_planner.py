"""DAgger run225 — cross-domain DAgger with 32-dim domain embedding, 27pp SR gain transferring across object categories
...
PORT = 10438
SERVICE = "dagger_run225_planner"
DESCRIPTION = "DAgger run225 — cross-domain DAgger with 32-dim domain embedding, 27pp SR gain transferring across object categories"

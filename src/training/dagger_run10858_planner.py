...
PORT = 52992
SERVICE = "dagger-run10858-planner"
DESCRIPTION = "DAgger run 10858 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10858-planner</title><style>
...
<div class="header"><h1>dagger-run10858-planner</h1><div class="subtitle">DAgger run 10858 policy planning and online correction · port 52992</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52992</div>

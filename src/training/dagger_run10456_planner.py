...
PORT = 51384
SERVICE = "dagger-run10456-planner"
DESCRIPTION = "DAgger run 10456 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10456-planner</title><style>
...
<div class="header"><h1>dagger-run10456-planner</h1><div class="subtitle">DAgger run 10456 policy planning and online correction · port 51384</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51384</div>

...
PORT = 12946
SERVICE = "dagger_run848_planner"
DESCRIPTION = "DAgger run 848 training planner — schedules expert intervention sessions and manages policy update frequency for robot learning"

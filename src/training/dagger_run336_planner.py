"""DAgger run 336 planner with control barrier functions guaranteeing zero safety constraint violations throughout training
...
try:
    ...
    _has_fastapi = False
PORT = 10898
SERVICE = "dagger_run336_planner"
DESCRIPTION = "DAgger run 336 planner with control barrier functions guaranteeing zero safety constraint violations throughout training"
if _has_fastapi:

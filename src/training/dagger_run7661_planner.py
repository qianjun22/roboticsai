...
PORT = 40204
SERVICE = "dagger_run7661_planner"
DESCRIPTION = "DAgger run 7661 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7661_planner</title><style>
...
<div class="header"><h1>dagger_run7661_planner</h1><div class="subtitle">DAgger run 7661 online learning planner port 40204</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40204</div>

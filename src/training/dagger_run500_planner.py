...
PORT = 11554
SERVICE = "dagger-run500-planner"
DESCRIPTION = "DAgger run 500 milestone training planner — ScaledDP with 500-run retrospective analysis and convergence benchmarking"

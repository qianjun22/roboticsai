"""DAgger run408 planner using RoboAgent multi-task behavior cloning with semantic retrieval for generalization across manipulation scenarios
...
try:
    ...
    _has_fastapi = False
PORT = 11186
SERVICE = "dagger_run408_planner"
DESCRIPTION = "DAgger run408 planner using RoboAgent multi-task behavior cloning with semantic retrieval for generalization across manipulation scenarios"
if _has_fastapi:

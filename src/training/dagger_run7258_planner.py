...
PORT = 38592
SERVICE = "dagger_run7258_planner"
DESCRIPTION = "DAgger run 7258 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7258_planner</title><style>
...
<div class="header"><h1>dagger_run7258_planner</h1><div class="subtitle">DAgger run 7258 online learning planner port 38592</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38592</div>

...
PORT = 43308
SERVICE = "dagger_run8437_planner"
DESCRIPTION = "DAgger run 8437 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8437_planner</title><style>
...
<div class="header"><h1>dagger_run8437_planner</h1><div class="subtitle">DAgger run 8437 online learning planner port 43308</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43308</div>

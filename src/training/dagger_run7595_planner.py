...
PORT = 39940
SERVICE = "dagger_run7595_planner"
DESCRIPTION = "DAgger run 7595 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7595_planner</title><style>
...
<div class="header"><h1>dagger_run7595_planner</h1><div class="subtitle">DAgger run 7595 online learning planner port 39940</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39940</div>

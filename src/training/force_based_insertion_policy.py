"""Force-controlled connector insertion policy — 5-phase spiral search, 98 percent USB-A SR, 27pp gain over position-only
...
PORT = 10456
SERVICE = "force_based_insertion_policy"
DESCRIPTION = "Force-controlled connector insertion policy — 5-phase spiral search, 98 percent USB-A SR, 27pp gain over position-only"

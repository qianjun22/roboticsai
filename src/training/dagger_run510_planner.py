...
PORT = 11594
SERVICE = "dagger-run510-planner"
DESCRIPTION = "DAgger run 510 training planner with CrossFormer cross-embodiment transformer policy and multi-robot transfer learning"

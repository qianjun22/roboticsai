...
PORT = 52012
SERVICE = "dagger-run10613-planner"
DESCRIPTION = "DAgger run 10613 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10613-planner</title><style>
...
<div class="header"><h1>dagger-run10613-planner</h1><div class="subtitle">DAgger run 10613 policy planning and online correction · port 52012</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52012</div>

...
PORT = 41012
SERVICE = "dagger_run7863_planner"
DESCRIPTION = "DAgger run 7863 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7863_planner</title><style>
...
<div class="header"><h1>dagger_run7863_planner</h1><div class="subtitle">DAgger run 7863 online learning planner port 41012</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41012</div>

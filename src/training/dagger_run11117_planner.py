...
PORT = 54028
SERVICE = "dagger-run11117-planner"
DESCRIPTION = "DAgger run 11117 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11117-planner</title><style>
...
<div class="header"><h1>dagger-run11117-planner</h1><div class="subtitle">DAgger run 11117 policy planning and online correction · port 54028</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54028</div>

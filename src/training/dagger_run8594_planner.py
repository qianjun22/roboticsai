...
PORT = 43936
SERVICE = "dagger_run8594_planner"
DESCRIPTION = "DAgger run 8594 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8594_planner</title><style>
...
<div class="header"><h1>dagger_run8594_planner</h1><div class="subtitle">DAgger run 8594 online learning planner port 43936</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43936</div>

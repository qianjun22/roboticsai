...
PORT = 15284
SERVICE = "dagger-run1431-planner"
DESCRIPTION = "DAgger run 1431 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1431-planner</title><style>
...
<div class="header"><h1>dagger-run1431-planner</h1><div class="sub">DAgger run 1431 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15284 | <b>Status:</b> <span style="color:#4ade80">Live</span>

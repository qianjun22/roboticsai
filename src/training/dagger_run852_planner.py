...
PORT = 12962
SERVICE = "dagger_run852_planner"
DESCRIPTION = "DAgger run 852 training planner — tracks intervention frequency decay and policy convergence metrics for iterative robot skill acquisition"

...
PORT = 51532
SERVICE = "dagger-run10493-planner"
DESCRIPTION = "DAgger run 10493 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10493-planner</title><style>
...
<div class="header"><h1>dagger-run10493-planner</h1><div class="subtitle">DAgger run 10493 policy planning and online correction · port 51532</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51532</div>

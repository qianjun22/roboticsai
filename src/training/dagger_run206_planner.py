"""DAgger run206 — asymmetric correction schedule, heavy corrections early tapering to light touch, 33% faster convergence
...
PORT = 10362
SERVICE = "dagger_run206_planner"
DESCRIPTION = "DAgger run206 — asymmetric correction schedule, heavy corrections early tapering to light touch, 33% faster convergence"

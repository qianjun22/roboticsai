...
PORT = 40712
SERVICE = "dagger_run7788_planner"
DESCRIPTION = "DAgger run 7788 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7788_planner</title><style>
...
<div class="header"><h1>dagger_run7788_planner</h1><div class="subtitle">DAgger run 7788 online learning planner port 40712</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40712</div>

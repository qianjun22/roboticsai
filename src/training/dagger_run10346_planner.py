...
PORT = 50944
SERVICE = "dagger-run10346-planner"
DESCRIPTION = "DAgger run 10346 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10346-planner</title><style>
...
<div class="header"><h1>dagger-run10346-planner</h1><div class="subtitle">DAgger run 10346 policy planning and online correction · port 50944</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50944</div>

"""DAgger Run 291 Planner — predictive coding DAgger with prediction error as correction signal.
...
PORT = 10686
SERVICE = "dagger_run291_planner"
DESCRIPTION = "Predictive coding DAgger: prediction error drives targeted corrections at surprising states"

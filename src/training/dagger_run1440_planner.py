...
PORT = 15320
SERVICE = "dagger-run1440-planner"
DESCRIPTION = "DAgger run 1440 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1440-planner</title><style>
...
<div class="header"><h1>dagger-run1440-planner</h1><div class="sub">DAgger run 1440 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15320 | <b>Status:</b> <span style="color:#4ade80">Live</span>

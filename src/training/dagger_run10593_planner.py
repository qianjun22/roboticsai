...
PORT = 51932
SERVICE = "dagger-run10593-planner"
DESCRIPTION = "DAgger run 10593 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10593-planner</title><style>
...
<div class="header"><h1>dagger-run10593-planner</h1><div class="subtitle">DAgger run 10593 policy planning and online correction · port 51932</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51932</div>

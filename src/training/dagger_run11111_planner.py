...
PORT = 54004
SERVICE = "dagger-run11111-planner"
DESCRIPTION = "DAgger run 11111 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11111-planner</title><style>
...
<div class="header"><h1>dagger-run11111-planner</h1><div class="subtitle">DAgger run 11111 policy planning and online correction · port 54004</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54004</div>

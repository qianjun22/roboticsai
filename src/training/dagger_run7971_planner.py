...
PORT = 41444
SERVICE = "dagger_run7971_planner"
DESCRIPTION = "DAgger run 7971 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7971_planner</title><style>
...
<div class="header"><h1>dagger_run7971_planner</h1><div class="subtitle">DAgger run 7971 online learning planner port 41444</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41444</div>

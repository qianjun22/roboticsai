...
PORT = 41732
SERVICE = "dagger_run8043_planner"
DESCRIPTION = "DAgger run 8043 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8043_planner</title><style>
...
<div class="header"><h1>dagger_run8043_planner</h1><div class="subtitle">DAgger run 8043 online learning planner port 41732</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41732</div>

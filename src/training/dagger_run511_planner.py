...
PORT = 11598
SERVICE = "dagger-run511-planner"
DESCRIPTION = "DAgger run 511 training planner with RDT-2B robotics diffusion transformer at 2B scale with multi-modal instruction following"

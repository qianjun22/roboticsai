...
PORT = 42096
SERVICE = "dagger_run8134_planner"
DESCRIPTION = "DAgger run 8134 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8134_planner</title><style>
...
<div class="header"><h1>dagger_run8134_planner</h1><div class="subtitle">DAgger run 8134 online learning planner port 42096</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42096</div>

"""
OCI Robot Cloud — DAgger Run 423 Planner
FastAPI service — port 11246
DrQ-v2 data-regularized Q DAgger with image augmentation for sample-efficient visual RL
"""
...
PORT = 11246
SERVICE = "dagger_run423_planner"
DESCRIPTION = "DrQ-v2 data-regularized Q DAgger combining image augmentation with n-step returns and soft actor-critic for sample-efficient visual policy learning"
...
var d=[80,82,84,85,87,88,89,91,93];
var max=Math.max(...d);

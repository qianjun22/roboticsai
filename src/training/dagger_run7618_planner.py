...
PORT = 40032
SERVICE = "dagger_run7618_planner"
DESCRIPTION = "DAgger run 7618 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7618_planner</title><style>
...
<div class="header"><h1>dagger_run7618_planner</h1><div class="subtitle">DAgger run 7618 online learning planner port 40032</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40032</div>

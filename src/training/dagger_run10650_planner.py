...
PORT = 52160
SERVICE = "dagger-run10650-planner"
DESCRIPTION = "DAgger run 10650 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10650-planner</title><style>
...
<div class="header"><h1>dagger-run10650-planner</h1><div class="subtitle">DAgger run 10650 policy planning and online correction · port 52160</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52160</div>

...
PORT = 53472
SERVICE = "dagger-run10978-planner"
DESCRIPTION = "DAgger run 10978 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10978-planner</title><style>
...
<div class="header"><h1>dagger-run10978-planner</h1><div class="subtitle">DAgger run 10978 policy planning and online correction · port 53472</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53472</div>

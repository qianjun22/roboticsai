...
PORT = 11718
SERVICE = "dagger-run541-planner"
DESCRIPTION = "DAgger run 541 training planner using RDT-2B robotics diffusion transformer 2B parameters for long-horizon tasks"

...
PORT = 13066
SERVICE = "dagger_run878_planner"
DESCRIPTION = "DAgger run 878 training planner — manages long-horizon task decomposition and hierarchical intervention scheduling for complex manipulation"

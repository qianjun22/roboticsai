...
PORT = 41960
SERVICE = "dagger_run8100_planner"
DESCRIPTION = "DAgger run 8100 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8100_planner</title><style>
...
<div class="header"><h1>dagger_run8100_planner</h1><div class="subtitle">DAgger run 8100 online learning planner port 41960</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41960</div>

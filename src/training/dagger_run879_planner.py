...
PORT = 13070
SERVICE = "dagger_run879_planner"
DESCRIPTION = "DAgger run 879 training planner — manages goal-conditioned rollout collection with per-goal intervention budgets for targeted policy improvement"

...
PORT = 50828
SERVICE = "dagger-run10317-planner"
DESCRIPTION = "DAgger run 10317 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10317-planner</title><style>
...
<div class="header"><h1>dagger-run10317-planner</h1><div class="subtitle">DAgger run 10317 policy planning and online correction · port 50828</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50828</div>

...
PORT = 11622
SERVICE = "dagger-run517-planner"
DESCRIPTION = "DAgger run 517 training planner with Cosmos-Robot world model pretraining for physics-consistent video prediction and policy learning"

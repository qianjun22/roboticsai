"""DAgger run 338 planner with federated learning across 8 robot instances using differential privacy for collaborative training
...
try:
    ...
    _has_fastapi = False
PORT = 10906
SERVICE = "dagger_run338_planner"
DESCRIPTION = "DAgger run 338 planner with federated learning across 8 robot instances using differential privacy for collaborative training"
if _has_fastapi:

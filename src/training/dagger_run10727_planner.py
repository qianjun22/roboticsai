...
PORT = 52468
SERVICE = "dagger-run10727-planner"
DESCRIPTION = "DAgger run 10727 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10727-planner</title><style>
...
<div class="header"><h1>dagger-run10727-planner</h1><div class="subtitle">DAgger run 10727 policy planning and online correction · port 52468</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52468</div>

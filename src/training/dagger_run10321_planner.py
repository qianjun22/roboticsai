...
PORT = 50844
SERVICE = "dagger-run10321-planner"
DESCRIPTION = "DAgger run 10321 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10321-planner</title><style>
...
<div class="header"><h1>dagger-run10321-planner</h1><div class="subtitle">DAgger run 10321 policy planning and online correction · port 50844</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50844</div>

...
PORT = 43076
SERVICE = "dagger_run8379_planner"
DESCRIPTION = "DAgger run 8379 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8379_planner</title><style>
...
<div class="header"><h1>dagger_run8379_planner</h1><div class="subtitle">DAgger run 8379 online learning planner port 43076</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43076</div>

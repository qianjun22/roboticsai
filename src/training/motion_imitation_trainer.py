"""Human video motion imitation trainer — MediaPipe pose retargeting to robot joints, 200 YouTube videos to 1000 primitives
...
PORT = 10436
SERVICE = "motion_imitation_trainer"
DESCRIPTION = "Human video motion imitation trainer — MediaPipe pose retargeting to robot joints, 200 YouTube videos to 1000 primitives"

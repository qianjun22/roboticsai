...
PORT = 42212
SERVICE = "dagger_run8163_planner"
DESCRIPTION = "DAgger run 8163 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8163_planner</title><style>
...
<div class="header"><h1>dagger_run8163_planner</h1><div class="subtitle">DAgger run 8163 online learning planner port 42212</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42212</div>

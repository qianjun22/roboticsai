...
PORT = 51860
SERVICE = "dagger-run10575-planner"
DESCRIPTION = "DAgger run 10575 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10575-planner</title><style>
...
<div class="header"><h1>dagger-run10575-planner</h1><div class="subtitle">DAgger run 10575 policy planning and online correction · port 51860</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51860</div>

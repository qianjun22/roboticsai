...
PORT = 52072
SERVICE = "dagger-run10628-planner"
DESCRIPTION = "DAgger run 10628 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10628-planner</title><style>
...
<div class="header"><h1>dagger-run10628-planner</h1><div class="subtitle">DAgger run 10628 policy planning and online correction · port 52072</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52072</div>

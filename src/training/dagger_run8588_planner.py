...
PORT = 43912
SERVICE = "dagger_run8588_planner"
DESCRIPTION = "DAgger run 8588 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8588_planner</title><style>
...
<div class="header"><h1>dagger_run8588_planner</h1><div class="subtitle">DAgger run 8588 online learning planner port 43912</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43912</div>

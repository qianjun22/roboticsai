...
PORT = 43404
SERVICE = "dagger_run8461_planner"
DESCRIPTION = "DAgger run 8461 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8461_planner</title><style>
...
<div class="header"><h1>dagger_run8461_planner</h1><div class="subtitle">DAgger run 8461 online learning planner port 43404</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43404</div>

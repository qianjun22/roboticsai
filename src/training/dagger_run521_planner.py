...
PORT = 11638
SERVICE = "dagger-run521-planner"
DESCRIPTION = "DAgger run 521 training planner with OmniGibson photorealistic simulation for household task generalization and scene diversity"

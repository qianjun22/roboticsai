"""Closed-loop force feedback policy v2 — 6-axis F/T sensing, compliance estimation, adaptive impedance control for peg-in-hole tasks
...
PORT = 10360
SERVICE = "force_feedback_policy_v2"
DESCRIPTION = "Closed-loop force feedback policy v2 — 6-axis F/T sensing, compliance estimation, adaptive impedance control for peg-in-hole tasks"

...
PORT = 42308
SERVICE = "dagger_run8187_planner"
DESCRIPTION = "DAgger run 8187 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8187_planner</title><style>
...
<div class="header"><h1>dagger_run8187_planner</h1><div class="subtitle">DAgger run 8187 online learning planner port 42308</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42308</div>

"""DAgger run 356 planner — causal representation learning DAgger with IDA-discovered disentangled factors for 84% SR on novel objects
...
try:
    ...
    _has_fastapi = False
PORT = 10978
SERVICE = "dagger_run356_planner"
DESCRIPTION = "DAgger run 356 planner — causal representation learning DAgger with IDA-discovered disentangled factors for 84% SR on novel objects"
if _has_fastapi:

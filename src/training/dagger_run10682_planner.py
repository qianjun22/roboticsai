...
PORT = 52288
SERVICE = "dagger-run10682-planner"
DESCRIPTION = "DAgger run 10682 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10682-planner</title><style>
...
<div class="header"><h1>dagger-run10682-planner</h1><div class="subtitle">DAgger run 10682 policy planning and online correction · port 52288</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52288</div>

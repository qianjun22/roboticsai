...
PORT = 52744
SERVICE = "dagger-run10796-planner"
DESCRIPTION = "DAgger run 10796 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10796-planner</title><style>
...
<div class="header"><h1>dagger-run10796-planner</h1><div class="subtitle">DAgger run 10796 policy planning and online correction · port 52744</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52744</div>

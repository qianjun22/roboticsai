...
PORT = 52880
SERVICE = "dagger-run10830-planner"
DESCRIPTION = "DAgger run 10830 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10830-planner</title><style>
...
<div class="header"><h1>dagger-run10830-planner</h1><div class="subtitle">DAgger run 10830 policy planning and online correction · port 52880</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52880</div>

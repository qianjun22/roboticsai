...
PORT = 40976
SERVICE = "dagger_run7854_planner"
DESCRIPTION = "DAgger run 7854 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7854_planner</title><style>
...
<div class="header"><h1>dagger_run7854_planner</h1><div class="subtitle">DAgger run 7854 online learning planner port 40976</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40976</div>

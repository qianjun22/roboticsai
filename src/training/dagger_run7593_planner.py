...
PORT = 39932
SERVICE = "dagger_run7593_planner"
DESCRIPTION = "DAgger run 7593 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7593_planner</title><style>
...
<div class="header"><h1>dagger_run7593_planner</h1><div class="subtitle">DAgger run 7593 online learning planner port 39932</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39932</div>

"""DAgger run 324 planner with sparse reward hindsight experience replay for 15x sample efficiency improvement
...
try:
    ...
    _has_fastapi = False
PORT = 10850
SERVICE = "dagger_run324_planner"
DESCRIPTION = "DAgger run 324 planner with sparse reward hindsight experience replay for 15x sample efficiency improvement"
if _has_fastapi:

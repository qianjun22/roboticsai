"""Motion Primitive Composer V2 — v2 composer with LLM-guided skill sequencing and pre/post-conditions.
...
PORT = 10688
SERVICE = "motion_primitive_composer_v2"
DESCRIPTION = "LLM-guided skill sequencing with pre/post-condition verification"

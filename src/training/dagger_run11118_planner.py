...
PORT = 54032
SERVICE = "dagger-run11118-planner"
DESCRIPTION = "DAgger run 11118 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11118-planner</title><style>
...
<div class="header"><h1>dagger-run11118-planner</h1><div class="subtitle">DAgger run 11118 policy planning and online correction · port 54032</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54032</div>

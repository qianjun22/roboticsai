...
PORT = 54016
SERVICE = "dagger-run11114-planner"
DESCRIPTION = "DAgger run 11114 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11114-planner</title><style>
...
<div class="header"><h1>dagger-run11114-planner</h1><div class="subtitle">DAgger run 11114 policy planning and online correction · port 54016</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54016</div>

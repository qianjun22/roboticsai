"""DAgger run223 — Bayesian neural network DAgger with principled posterior uncertainty for expert query criterion
...
PORT = 10430
SERVICE = "dagger_run223_planner"
DESCRIPTION = "DAgger run223 — Bayesian neural network DAgger with principled posterior uncertainty for expert query criterion"

...
PORT = 11798
SERVICE = "dagger-run561-planner"
DESCRIPTION = "DAgger run 561 training planner integrating robot foundation model pre-training with domain-specific fine-tuning"

...
PORT = 41724
SERVICE = "dagger_run8041_planner"
DESCRIPTION = "DAgger run 8041 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8041_planner</title><style>
...
<div class="header"><h1>dagger_run8041_planner</h1><div class="subtitle">DAgger run 8041 online learning planner port 41724</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41724</div>

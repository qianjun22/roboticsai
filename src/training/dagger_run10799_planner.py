...
PORT = 52756
SERVICE = "dagger-run10799-planner"
DESCRIPTION = "DAgger run 10799 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10799-planner</title><style>
...
<div class="header"><h1>dagger-run10799-planner</h1><div class="subtitle">DAgger run 10799 policy planning and online correction · port 52756</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52756</div>

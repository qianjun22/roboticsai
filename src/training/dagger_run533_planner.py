...
PORT = 11686
SERVICE = "dagger-run533-planner"
DESCRIPTION = "DAgger run 533 training planner using EquivAct equivariant action representation for rotation-invariant manipulation"

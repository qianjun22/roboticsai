...
PORT = 41516
SERVICE = "dagger_run7989_planner"
DESCRIPTION = "DAgger run 7989 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7989_planner</title><style>
...
<div class="header"><h1>dagger_run7989_planner</h1><div class="subtitle">DAgger run 7989 online learning planner port 41516</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41516</div>

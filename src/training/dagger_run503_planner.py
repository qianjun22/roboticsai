...
PORT = 11566
SERVICE = "dagger-run503-planner"
DESCRIPTION = "DAgger run 503 training planner with EquiBot SE(3)-equivariant diffusion policy and geometric consistency enforcement"

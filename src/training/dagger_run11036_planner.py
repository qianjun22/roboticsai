...
PORT = 53704
SERVICE = "dagger-run11036-planner"
DESCRIPTION = "DAgger run 11036 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11036-planner</title><style>
...
<div class="header"><h1>dagger-run11036-planner</h1><div class="subtitle">DAgger run 11036 policy planning and online correction · port 53704</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53704</div>

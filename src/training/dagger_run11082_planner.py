...
PORT = 53888
SERVICE = "dagger-run11082-planner"
DESCRIPTION = "DAgger run 11082 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11082-planner</title><style>
...
<div class="header"><h1>dagger-run11082-planner</h1><div class="subtitle">DAgger run 11082 policy planning and online correction · port 53888</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53888</div>

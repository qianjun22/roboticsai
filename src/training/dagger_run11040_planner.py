...
PORT = 53720
SERVICE = "dagger-run11040-planner"
DESCRIPTION = "DAgger run 11040 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11040-planner</title><style>
...
<div class="header"><h1>dagger-run11040-planner</h1><div class="subtitle">DAgger run 11040 policy planning and online correction · port 53720</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53720</div>

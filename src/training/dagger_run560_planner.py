...
PORT = 11794
SERVICE = "dagger-run560-planner"
DESCRIPTION = "DAgger run 560 training planner using SWIM-ACT sliding window imitation with action chunking for manipulation"

"""Estimate grasp quality before execution — force closure, slip margin, grasp wrench space scoring from point cloud
...
PORT = 10380
SERVICE = "grasp_quality_estimator"
DESCRIPTION = "Estimate grasp quality before execution — force closure, slip margin, grasp wrench space scoring from point cloud"

...
PORT = 40056
SERVICE = "dagger_run7624_planner"
DESCRIPTION = "DAgger run 7624 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7624_planner</title><style>
...
<div class="header"><h1>dagger_run7624_planner</h1><div class="subtitle">DAgger run 7624 online learning planner port 40056</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40056</div>

...
PORT = 53080
SERVICE = "dagger-run10880-planner"
DESCRIPTION = "DAgger run 10880 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10880-planner</title><style>
...
<div class="header"><h1>dagger-run10880-planner</h1><div class="subtitle">DAgger run 10880 policy planning and online correction · port 53080</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53080</div>

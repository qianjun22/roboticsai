...
PORT = 50964
SERVICE = "dagger-run10351-planner"
DESCRIPTION = "DAgger run 10351 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10351-planner</title><style>
...
<div class="header"><h1>dagger-run10351-planner</h1><div class="subtitle">DAgger run 10351 policy planning and online correction · port 50964</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50964</div>

...
PORT = 12982
SERVICE = "dagger_run857_planner"
DESCRIPTION = "DAgger run 857 training planner — coordinates safety-constrained online learning with intervention escalation protocols for high-stakes tasks"

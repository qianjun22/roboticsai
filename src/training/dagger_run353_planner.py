"""DAgger run 353 planner — multi-resolution temporal attention DAgger across 1/4/16-step horizons for +19% SR on long-horizon manipulation tasks
...
try:
    ...
    _has_fastapi = False
PORT = 10966
SERVICE = "dagger_run353_planner"
DESCRIPTION = "DAgger run 353 planner — multi-resolution temporal attention DAgger across 1/4/16-step horizons for +19% SR on long-horizon manipulation tasks"
if _has_fastapi:

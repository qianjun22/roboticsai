...
PORT = 15124
SERVICE = "dagger-run1391-planner"
DESCRIPTION = "DAgger run 1391 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1391-planner</title><style>
...
<div class="header"><h1>dagger-run1391-planner</h1><div class="sub">DAgger run 1391 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15124 | <b>Status:</b> <span style="color:#4ade80">Live</span>

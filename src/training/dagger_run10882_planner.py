...
PORT = 53088
SERVICE = "dagger-run10882-planner"
DESCRIPTION = "DAgger run 10882 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10882-planner</title><style>
...
<div class="header"><h1>dagger-run10882-planner</h1><div class="subtitle">DAgger run 10882 policy planning and online correction · port 53088</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53088</div>

...
PORT = 51644
SERVICE = "dagger-run10521-planner"
DESCRIPTION = "DAgger run 10521 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10521-planner</title><style>
...
<div class="header"><h1>dagger-run10521-planner</h1><div class="subtitle">DAgger run 10521 policy planning and online correction · port 51644</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51644</div>

...
PORT = 52568
SERVICE = "dagger-run10752-planner"
DESCRIPTION = "DAgger run 10752 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10752-planner</title><style>
...
<div class="header"><h1>dagger-run10752-planner</h1><div class="subtitle">DAgger run 10752 policy planning and online correction · port 52568</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52568</div>

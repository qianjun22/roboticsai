...
PORT = 50336
SERVICE = "dagger-run10194-planner"
DESCRIPTION = "DAgger run 10194 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10194-planner</title><style>
...
<div class="header"><h1>dagger-run10194-planner</h1><div class="subtitle">DAgger run 10194 policy planning and online correction · port 50336</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50336</div>

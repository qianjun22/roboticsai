"""NeRF scene reconstruction from 100 RGB images in 8 min — implicit occupancy for collision-free planning and sim data
...
PORT = 10408
SERVICE = "neural_field_reconstruction"
DESCRIPTION = "NeRF scene reconstruction from 100 RGB images in 8 min — implicit occupancy for collision-free planning and sim data"

...
PORT = 51496
SERVICE = "dagger-run10484-planner"
DESCRIPTION = "DAgger run 10484 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10484-planner</title><style>
...
<div class="header"><h1>dagger-run10484-planner</h1><div class="subtitle">DAgger run 10484 policy planning and online correction · port 51496</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51496</div>

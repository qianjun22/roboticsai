...
PORT = 53508
SERVICE = "dagger-run10987-planner"
DESCRIPTION = "DAgger run 10987 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10987-planner</title><style>
...
<div class="header"><h1>dagger-run10987-planner</h1><div class="subtitle">DAgger run 10987 policy planning and online correction · port 53508</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53508</div>

...
PORT = 12874
SERVICE = "dagger_run830_planner"
DESCRIPTION = "DAgger run 830 planning and orchestration service — milestone run at 830 iterations with policy quality assessment and training efficiency report"

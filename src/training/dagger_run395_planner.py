"""DAgger run395 planner using Hindsight Experience Replay (HER) for goal-conditioned robot manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11134
SERVICE = "dagger_run395_planner"
DESCRIPTION = "DAgger run395 planner using Hindsight Experience Replay (HER) for goal-conditioned robot manipulation"
if _has_fastapi:

...
PORT = 42656
SERVICE = "dagger_run8274_planner"
DESCRIPTION = "DAgger run 8274 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8274_planner</title><style>
...
<div class="header"><h1>dagger_run8274_planner</h1><div class="subtitle">DAgger run 8274 online learning planner port 42656</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42656</div>

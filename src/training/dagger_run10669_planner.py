...
PORT = 52236
SERVICE = "dagger-run10669-planner"
DESCRIPTION = "DAgger run 10669 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10669-planner</title><style>
...
<div class="header"><h1>dagger-run10669-planner</h1><div class="subtitle">DAgger run 10669 policy planning and online correction · port 52236</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52236</div>

...
PORT = 51488
SERVICE = "dagger-run10482-planner"
DESCRIPTION = "DAgger run 10482 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10482-planner</title><style>
...
<div class="header"><h1>dagger-run10482-planner</h1><div class="subtitle">DAgger run 10482 policy planning and online correction · port 51488</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51488</div>

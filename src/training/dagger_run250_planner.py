"""DAgger Run250 Planner — Bayesian DAgger
...
PORT = 10538
SERVICE = "dagger_run250_planner"
DESCRIPTION = "DAgger run250: Bayesian DAgger — principled uncertainty drives expert queries, 20% fewer"

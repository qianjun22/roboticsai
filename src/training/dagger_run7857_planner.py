...
PORT = 40988
SERVICE = "dagger_run7857_planner"
DESCRIPTION = "DAgger run 7857 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7857_planner</title><style>
...
<div class="header"><h1>dagger_run7857_planner</h1><div class="subtitle">DAgger run 7857 online learning planner port 40988</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40988</div>

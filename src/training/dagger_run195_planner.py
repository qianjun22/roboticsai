"""DAgger run195: federated DAgger — 3-customer private learning, +5% SR without data sharing
...
PORT = 10318
SERVICE = "dagger_run195_planner"
DESCRIPTION = "DAgger run195: federated DAgger — 3-customer private learning, +5% SR without data sharing"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/dagger/run195/config")
    def dagger_run195_config():
        return {
            "run": 195,
            "strategy": "federated_dagger",
            "participating_customers": 3,
            "privacy": "differential_privacy_eps_1",
            "sr_single": 0.89,
            "sr_federated": 0.94
        }

    @app.get("/dagger/run195/metrics")
    def dagger_run195_metrics():
        return {
            "rounds": 0,
            "participants": 0,
            "global_sr": 0.0,

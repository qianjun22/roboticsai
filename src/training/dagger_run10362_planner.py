...
PORT = 51008
SERVICE = "dagger-run10362-planner"
DESCRIPTION = "DAgger run 10362 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10362-planner</title><style>
...
<div class="header"><h1>dagger-run10362-planner</h1><div class="subtitle">DAgger run 10362 policy planning and online correction · port 51008</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51008</div>

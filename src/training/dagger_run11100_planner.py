...
PORT = 53960
SERVICE = "dagger-run11100-planner"
DESCRIPTION = "DAgger run 11100 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11100-planner</title><style>
...
<div class="header"><h1>dagger-run11100-planner</h1><div class="subtitle">DAgger run 11100 policy planning and online correction · port 53960</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53960</div>

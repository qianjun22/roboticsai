...
PORT = 53408
SERVICE = "dagger-run10962-planner"
DESCRIPTION = "DAgger run 10962 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10962-planner</title><style>
...
<div class="header"><h1>dagger-run10962-planner</h1><div class="subtitle">DAgger run 10962 policy planning and online correction · port 53408</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53408</div>

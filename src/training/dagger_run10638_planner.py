...
PORT = 52112
SERVICE = "dagger-run10638-planner"
DESCRIPTION = "DAgger run 10638 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10638-planner</title><style>
...
<div class="header"><h1>dagger-run10638-planner</h1><div class="subtitle">DAgger run 10638 policy planning and online correction · port 52112</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52112</div>

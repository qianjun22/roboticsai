...
PORT = 43436
SERVICE = "dagger_run8469_planner"
DESCRIPTION = "DAgger run 8469 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8469_planner</title><style>
...
<div class="header"><h1>dagger_run8469_planner</h1><div class="subtitle">DAgger run 8469 online learning planner port 43436</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43436</div>

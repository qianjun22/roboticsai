...
PORT = 53380
SERVICE = "dagger-run10955-planner"
DESCRIPTION = "DAgger run 10955 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10955-planner</title><style>
...
<div class="header"><h1>dagger-run10955-planner</h1><div class="subtitle">DAgger run 10955 policy planning and online correction · port 53380</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53380</div>

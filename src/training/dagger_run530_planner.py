...
PORT = 11674
SERVICE = "dagger-run530-planner"
DESCRIPTION = "DAgger run 530 training planner with GROOT-ACT diffusion-based action chunking with GR00T foundation model feature extraction"

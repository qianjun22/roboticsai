...
PORT = 12754
SERVICE = "dagger_run800_planner"
DESCRIPTION = "DAgger run 800 planning and orchestration service — milestone run marking 800 DAgger iterations with full convergence analytics"

...
PORT = 12834
SERVICE = "dagger_run820_planner"
DESCRIPTION = "DAgger run 820 planning and orchestration service — milestone run at 820 DAgger iterations with convergence diagnostics and policy snapshot"

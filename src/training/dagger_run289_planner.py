"""DAgger Run 289 Planner — world model imagination DAgger generating synthetic corrections via RSSM.
...
PORT = 10678
SERVICE = "dagger_run289_planner"
DESCRIPTION = "World model imagination DAgger: RSSM generates 70% synthetic correction data"

...
PORT = 14964
SERVICE = "dagger-run1351-planner"
DESCRIPTION = "DAgger run 1351 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1351-planner</title><style>
...
<div class="header"><h1>dagger-run1351-planner</h1><div class="sub">DAgger run 1351 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14964 | <b>Status:</b> <span style="color:#4ade80">Live</span>

"""
Visual planar pushing policy — push objects to goal positions without grasping
...
PORT = 10268
SERVICE = "visual_push_policy"
DESCRIPTION = "Visual planar pushing policy — push objects to goal positions without grasping"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    def push():
        return {
            "push_direction": round(random.uniform(0, 360), 1),
            "force_n": round(random.uniform(1, 8), 2),
            "contact_point": [
    ...
    @app.get("/manipulation/push_stats")
    def push_stats():
        return {
            "sr": 0.89,
            "avg_pushes_per_task": 2.3,
            "distance_accuracy_mm": 18.4
        }

...
PORT = 39372
SERVICE = "dagger_run7453_planner"
DESCRIPTION = "DAgger run 7453 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7453_planner</title><style>
...
<div class="header"><h1>dagger_run7453_planner</h1><div class="subtitle">DAgger run 7453 online learning planner port 39372</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39372</div>

"""DAgger run392 with MAPPO multi-agent PPO centralized critic for coordinated bimanual manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11122
SERVICE = "dagger_run392_planner"
DESCRIPTION = "DAgger run392 with MAPPO multi-agent PPO centralized critic for coordinated bimanual manipulation"
if _has_fastapi:

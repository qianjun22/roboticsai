...
PORT = 13058
SERVICE = "dagger_run876_planner"
DESCRIPTION = "DAgger run 876 training planner — manages temperature-scaled intervention sampling and tracks policy improvement efficiency per GPU hour"

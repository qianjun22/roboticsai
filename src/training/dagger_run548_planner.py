...
PORT = 11746
SERVICE = "dagger-run548-planner"
DESCRIPTION = "DAgger run 548 training planner using GR00T-N2 next-gen foundation model with improved multi-task generalization"

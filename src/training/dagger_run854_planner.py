...
PORT = 12970
SERVICE = "dagger_run854_planner"
DESCRIPTION = "DAgger run 854 training planner — adaptive intervention rate controller that balances expert query cost with policy improvement velocity"

"""DAgger run 337 planner with automatic curriculum scheduling advancing difficulty at 70% SR for 3.75x faster learning
...
try:
    ...
    _has_fastapi = False
PORT = 10902
SERVICE = "dagger_run337_planner"
DESCRIPTION = "DAgger run 337 planner with automatic curriculum scheduling advancing difficulty at 70% SR for 3.75x faster learning"
if _has_fastapi:

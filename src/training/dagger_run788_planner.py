...
PORT = 12706
SERVICE = "dagger-run788-planner"
DESCRIPTION = "DAgger run 788 online learning planner — autonomous navigation policy training with environment-specific corrections"

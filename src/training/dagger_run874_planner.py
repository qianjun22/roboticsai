...
PORT = 13050
SERVICE = "dagger_run874_planner"
DESCRIPTION = "DAgger run 874 training planner — coordinates uncertainty-aware rollout termination and prioritizes high-regret state corrections"

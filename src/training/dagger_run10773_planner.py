...
PORT = 52652
SERVICE = "dagger-run10773-planner"
DESCRIPTION = "DAgger run 10773 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10773-planner</title><style>
...
<div class="header"><h1>dagger-run10773-planner</h1><div class="subtitle">DAgger run 10773 policy planning and online correction · port 52652</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52652</div>

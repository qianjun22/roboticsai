...
PORT = 13042
SERVICE = "dagger_run872_planner"
DESCRIPTION = "DAgger run 872 training planner — implements ensemble-query active learning to minimize expert annotation burden while maximizing policy coverage"

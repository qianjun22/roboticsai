...
PORT = 50992
SERVICE = "dagger-run10358-planner"
DESCRIPTION = "DAgger run 10358 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10358-planner</title><style>
...
<div class="header"><h1>dagger-run10358-planner</h1><div class="subtitle">DAgger run 10358 policy planning and online correction · port 50992</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50992</div>

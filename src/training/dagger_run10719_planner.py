...
PORT = 52436
SERVICE = "dagger-run10719-planner"
DESCRIPTION = "DAgger run 10719 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10719-planner</title><style>
...
<div class="header"><h1>dagger-run10719-planner</h1><div class="subtitle">DAgger run 10719 policy planning and online correction · port 52436</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52436</div>

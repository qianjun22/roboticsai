...
PORT = 52416
SERVICE = "dagger-run10714-planner"
DESCRIPTION = "DAgger run 10714 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10714-planner</title><style>
...
<div class="header"><h1>dagger-run10714-planner</h1><div class="subtitle">DAgger run 10714 policy planning and online correction · port 52416</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52416</div>

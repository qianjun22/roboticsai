...
PORT = 51308
SERVICE = "dagger-run10437-planner"
DESCRIPTION = "DAgger run 10437 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10437-planner</title><style>
...
<div class="header"><h1>dagger-run10437-planner</h1><div class="subtitle">DAgger run 10437 policy planning and online correction · port 51308</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51308</div>

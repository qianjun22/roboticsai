...
PORT = 11658
SERVICE = "dagger-run526-planner"
DESCRIPTION = "DAgger run 526 training planner with PerAct perceiver-actor architecture for multi-task manipulation from RGB-D voxelized observations"

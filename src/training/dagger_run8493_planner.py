...
PORT = 43532
SERVICE = "dagger_run8493_planner"
DESCRIPTION = "DAgger run 8493 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8493_planner</title><style>
...
<div class="header"><h1>dagger_run8493_planner</h1><div class="subtitle">DAgger run 8493 online learning planner port 43532</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 43532</div>

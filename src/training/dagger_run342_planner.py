"""DAgger run 342 planner — diffusion policy with DDPM denoising for high-quality multimodal trajectory generation
...
try:
    ...
    _has_fastapi = False
PORT = 10922
SERVICE = "dagger_run342_planner"
DESCRIPTION = "DAgger run 342 planner — diffusion policy with DDPM denoising for high-quality multimodal trajectory generation"
if _has_fastapi:

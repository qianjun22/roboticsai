...
PORT = 11606
SERVICE = "dagger-run513-planner"
DESCRIPTION = "DAgger run 513 training planner with Isaac Lab v2 parallel simulation at 10K+ envs/second for fast policy iteration"

"""DAgger Run 294 Planner — preference learning DAgger using pairwise comparisons to infer expert preferences.
...
PORT = 10698
SERVICE = "dagger_run294_planner"
DESCRIPTION = "Preference learning DAgger: pairwise comparisons infer expert preferences without labels"

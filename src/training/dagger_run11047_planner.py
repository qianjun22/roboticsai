...
PORT = 53748
SERVICE = "dagger-run11047-planner"
DESCRIPTION = "DAgger run 11047 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11047-planner</title><style>
...
<div class="header"><h1>dagger-run11047-planner</h1><div class="subtitle">DAgger run 11047 policy planning and online correction · port 53748</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53748</div>

"""Visual affordance detection for robot grasping — detect graspable regions from RGB input
...
DESCRIPTION = "Visual affordance detection for robot grasping — detect graspable regions from RGB input"

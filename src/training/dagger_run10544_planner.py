...
PORT = 51736
SERVICE = "dagger-run10544-planner"
DESCRIPTION = "DAgger run 10544 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10544-planner</title><style>
...
<div class="header"><h1>dagger-run10544-planner</h1><div class="subtitle">DAgger run 10544 policy planning and online correction · port 51736</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51736</div>

"""DAgger run 298 planner — energy-based model DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10758
SERVICE = "dagger_run298_planner"
DESCRIPTION = "DAgger run 298 planner — energy-based model DAgger — OCI Robot Cloud"
if _has_fastapi:

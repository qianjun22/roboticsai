"""DAgger run 341 planner — flow matching trajectory distribution for smooth and efficient policy learning from demonstrations
...
try:
    ...
    _has_fastapi = False
PORT = 10918
SERVICE = "dagger_run341_planner"
DESCRIPTION = "DAgger run 341 planner — flow matching trajectory distribution for smooth and efficient policy learning from demonstrations"
if _has_fastapi:

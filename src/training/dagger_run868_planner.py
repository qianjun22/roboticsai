...
PORT = 13026
SERVICE = "dagger_run868_planner"
DESCRIPTION = "DAgger run 868 training planner — coordinates multi-robot intervention collection with synchronized expert feedback across parallel deployments"

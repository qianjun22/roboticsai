"""Multi-finger grasp contact point planner — force closure verification with friction cone sampling in under 5ms
...
PORT = 10428
SERVICE = "grasp_contact_planner"
DESCRIPTION = "Multi-finger grasp contact point planner — force closure verification with friction cone sampling in under 5ms"

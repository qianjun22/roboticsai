...
PORT = 53616
SERVICE = "dagger-run11014-planner"
DESCRIPTION = "DAgger run 11014 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11014-planner</title><style>
...
<div class="header"><h1>dagger-run11014-planner</h1><div class="subtitle">DAgger run 11014 policy planning and online correction · port 53616</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53616</div>

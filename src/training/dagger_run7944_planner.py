...
PORT = 41336
SERVICE = "dagger_run7944_planner"
DESCRIPTION = "DAgger run 7944 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7944_planner</title><style>
...
<div class="header"><h1>dagger_run7944_planner</h1><div class="subtitle">DAgger run 7944 online learning planner port 41336</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41336</div>

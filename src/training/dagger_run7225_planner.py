...
PORT = 38460
SERVICE = "dagger_run7225_planner"
DESCRIPTION = "DAgger run 7225 trajectory planner for iterative imitation learning"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7225_planner</title><style>
...
<div class="header"><h1>dagger_run7225_planner</h1><div class="subtitle">DAgger run 7225 trajectory planner for iterative imitation learning · port 38460</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38460</div>

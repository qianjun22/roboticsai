...
PORT = 53908
SERVICE = "dagger-run11087-planner"
DESCRIPTION = "DAgger run 11087 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11087-planner</title><style>
...
<div class="header"><h1>dagger-run11087-planner</h1><div class="subtitle">DAgger run 11087 policy planning and online correction · port 53908</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53908</div>

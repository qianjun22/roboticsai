...
PORT = 51960
SERVICE = "dagger-run10600-planner"
DESCRIPTION = "DAgger run 10600 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10600-planner</title><style>
...
<div class="header"><h1>dagger-run10600-planner</h1><div class="subtitle">DAgger run 10600 policy planning and online correction · port 51960</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51960</div>

...
PORT = 51040
SERVICE = "dagger-run10370-planner"
DESCRIPTION = "DAgger run 10370 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10370-planner</title><style>
...
<div class="header"><h1>dagger-run10370-planner</h1><div class="subtitle">DAgger run 10370 policy planning and online correction · port 51040</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51040</div>

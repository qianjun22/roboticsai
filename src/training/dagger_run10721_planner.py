...
PORT = 52444
SERVICE = "dagger-run10721-planner"
DESCRIPTION = "DAgger run 10721 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10721-planner</title><style>
...
<div class="header"><h1>dagger-run10721-planner</h1><div class="subtitle">DAgger run 10721 policy planning and online correction · port 52444</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52444</div>

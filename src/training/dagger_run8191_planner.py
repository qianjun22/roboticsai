...
PORT = 42324
SERVICE = "dagger_run8191_planner"
DESCRIPTION = "DAgger run 8191 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8191_planner</title><style>
...
<div class="header"><h1>dagger_run8191_planner</h1><div class="subtitle">DAgger run 8191 online learning planner port 42324</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42324</div>

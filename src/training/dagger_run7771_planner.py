...
PORT = 40644
SERVICE = "dagger_run7771_planner"
DESCRIPTION = "DAgger run 7771 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7771_planner</title><style>
...
<div class="header"><h1>dagger_run7771_planner</h1><div class="subtitle">DAgger run 7771 online learning planner port 40644</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40644</div>

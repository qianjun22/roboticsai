...
PORT = 52200
SERVICE = "dagger-run10660-planner"
DESCRIPTION = "DAgger run 10660 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10660-planner</title><style>
...
<div class="header"><h1>dagger-run10660-planner</h1><div class="subtitle">DAgger run 10660 policy planning and online correction · port 52200</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52200</div>

...
PORT = 51700
SERVICE = "dagger-run10535-planner"
DESCRIPTION = "DAgger run 10535 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10535-planner</title><style>
...
<div class="header"><h1>dagger-run10535-planner</h1><div class="subtitle">DAgger run 10535 policy planning and online correction · port 51700</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51700</div>

...
PORT = 11750
SERVICE = "dagger-run549-planner"
DESCRIPTION = "DAgger run 549 training planner using HiRT hierarchical robot transformer for long-horizon task decomposition"

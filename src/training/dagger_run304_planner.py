"""DAgger run 304 planner — reward-conditioned goal-aware DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10770
SERVICE = "dagger_run304_planner"
DESCRIPTION = "DAgger run 304 planner — reward-conditioned goal-aware DAgger — OCI Robot Cloud"
if _has_fastapi:

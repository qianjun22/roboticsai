...
PORT = 51528
SERVICE = "dagger-run10492-planner"
DESCRIPTION = "DAgger run 10492 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10492-planner</title><style>
...
<div class="header"><h1>dagger-run10492-planner</h1><div class="subtitle">DAgger run 10492 policy planning and online correction · port 51528</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51528</div>

...
PORT = 53632
SERVICE = "dagger-run11018-planner"
DESCRIPTION = "DAgger run 11018 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11018-planner</title><style>
...
<div class="header"><h1>dagger-run11018-planner</h1><div class="subtitle">DAgger run 11018 policy planning and online correction · port 53632</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53632</div>

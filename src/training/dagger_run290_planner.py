"""DAgger Run 290 Planner — foundation model teacher DAgger using GPT-4V for zero-shot novel task bootstrapping.
...
PORT = 10682
SERVICE = "dagger_run290_planner"
DESCRIPTION = "Foundation model teacher DAgger: GPT-4V zero-shot expert for novel task bootstrapping"

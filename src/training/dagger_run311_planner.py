"""DAgger run 311 planner — episodic memory transformer DAgger — OCI Robot Cloud
...
try:
    ...
    _has_fastapi = False
PORT = 10798
SERVICE = "dagger_run311_planner"
DESCRIPTION = "DAgger run 311 planner — episodic memory transformer DAgger — OCI Robot Cloud"
if _has_fastapi:

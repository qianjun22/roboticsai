...
PORT = 53048
SERVICE = "dagger-run10872-planner"
DESCRIPTION = "DAgger run 10872 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10872-planner</title><style>
...
<div class="header"><h1>dagger-run10872-planner</h1><div class="subtitle">DAgger run 10872 policy planning and online correction · port 53048</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53048</div>

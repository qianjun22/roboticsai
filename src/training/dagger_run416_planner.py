"""
OCI Robot Cloud — DAgger Run 416 Planner
FastAPI service — port 11218
RoboAgent generalization DAgger for novel object/scene generalization
"""
...
PORT = 11218
SERVICE = "dagger_run416_planner"
DESCRIPTION = "RoboAgent generalization DAgger using semantic action prediction with language-conditioned generalization to novel objects and scenes beyond training distribution"
...
var d=[74,77,80,82,84,86,88,90,91];
var max=Math.max(...d);

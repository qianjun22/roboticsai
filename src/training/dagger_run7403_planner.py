...
PORT = 39172
SERVICE = "dagger_run7403_planner"
DESCRIPTION = "DAgger run 7403 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7403_planner</title><style>
...
<div class="header"><h1>dagger_run7403_planner</h1><div class="subtitle">DAgger run 7403 online learning planner port 39172</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39172</div>

...
PORT = 11702
SERVICE = "dagger-run537-planner"
DESCRIPTION = "DAgger run 537 training planner using GraspNet-1B billion-scale grasp proposal network for dense object picking"

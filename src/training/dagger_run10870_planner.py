...
PORT = 53040
SERVICE = "dagger-run10870-planner"
DESCRIPTION = "DAgger run 10870 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10870-planner</title><style>
...
<div class="header"><h1>dagger-run10870-planner</h1><div class="subtitle">DAgger run 10870 policy planning and online correction · port 53040</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53040</div>

"""Robot Workspace Optimizer — optimizes robot base placement for maximum task coverage.
...
PORT = 10656
SERVICE = "robot_workspace_optimizer"
DESCRIPTION = "Optimizes robot base placement for maximum task coverage and dexterity"

...
PORT = 50612
SERVICE = "dagger-run10263-planner"
DESCRIPTION = "DAgger run 10263 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10263-planner</title><style>
...
<div class="header"><h1>dagger-run10263-planner</h1><div class="subtitle">DAgger run 10263 policy planning and online correction · port 50612</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50612</div>

...
PORT = 11662
SERVICE = "dagger-run527-planner"
DESCRIPTION = "DAgger run 527 training planner with VoxPoser zero-shot 3D value map composition for robot manipulation from LLM descriptions"

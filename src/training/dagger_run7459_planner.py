...
PORT = 39396
SERVICE = "dagger_run7459_planner"
DESCRIPTION = "DAgger run 7459 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7459_planner</title><style>
...
<div class="header"><h1>dagger_run7459_planner</h1><div class="subtitle">DAgger run 7459 online learning planner port 39396</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39396</div>

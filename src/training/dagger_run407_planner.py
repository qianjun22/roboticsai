"""DAgger run407 planner using PerAct voxel-based perception-action transformer for 3D spatial reasoning in robot manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11182
SERVICE = "dagger_run407_planner"
DESCRIPTION = "DAgger run407 planner using PerAct voxel-based perception-action transformer for 3D spatial reasoning in robot manipulation"
if _has_fastapi:

...
PORT = 53972
SERVICE = "dagger-run11103-planner"
DESCRIPTION = "DAgger run 11103 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11103-planner</title><style>
...
<div class="header"><h1>dagger-run11103-planner</h1><div class="subtitle">DAgger run 11103 policy planning and online correction · port 53972</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53972</div>

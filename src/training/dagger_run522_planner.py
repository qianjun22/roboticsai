...
PORT = 11642
SERVICE = "dagger-run522-planner"
DESCRIPTION = "DAgger run 522 training planner with GROOT open-vocabulary robot manipulation using vision-language grounding"

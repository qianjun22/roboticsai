...
PORT = 52408
SERVICE = "dagger-run10712-planner"
DESCRIPTION = "DAgger run 10712 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10712-planner</title><style>
...
<div class="header"><h1>dagger-run10712-planner</h1><div class="subtitle">DAgger run 10712 policy planning and online correction · port 52408</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52408</div>

"""DAgger run398 planner using MPPI model predictive path integral control for real-time robot trajectory optimization
...
try:
    ...
    _has_fastapi = False
PORT = 11146
SERVICE = "dagger_run398_planner"
DESCRIPTION = "DAgger run398 planner using MPPI model predictive path integral control for real-time robot trajectory optimization"
if _has_fastapi:

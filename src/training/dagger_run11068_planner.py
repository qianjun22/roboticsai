...
PORT = 53832
SERVICE = "dagger-run11068-planner"
DESCRIPTION = "DAgger run 11068 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11068-planner</title><style>
...
<div class="header"><h1>dagger-run11068-planner</h1><div class="subtitle">DAgger run 11068 policy planning and online correction · port 53832</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53832</div>

...
PORT = 54012
SERVICE = "dagger-run11113-planner"
DESCRIPTION = "DAgger run 11113 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11113-planner</title><style>
...
<div class="header"><h1>dagger-run11113-planner</h1><div class="subtitle">DAgger run 11113 policy planning and online correction · port 54012</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54012</div>

...
PORT = 52232
SERVICE = "dagger-run10668-planner"
DESCRIPTION = "DAgger run 10668 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10668-planner</title><style>
...
<div class="header"><h1>dagger-run10668-planner</h1><div class="subtitle">DAgger run 10668 policy planning and online correction · port 52232</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52232</div>

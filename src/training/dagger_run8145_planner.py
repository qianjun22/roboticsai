...
PORT = 42140
SERVICE = "dagger_run8145_planner"
DESCRIPTION = "DAgger run 8145 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8145_planner</title><style>
...
<div class="header"><h1>dagger_run8145_planner</h1><div class="subtitle">DAgger run 8145 online learning planner port 42140</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42140</div>

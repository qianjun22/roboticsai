"""
OCI Robot Cloud — DAgger Run 417 Planner
FastAPI service — port 11222
GROOT scene graph DAgger with object-centric structured scene representations
"""
...
PORT = 11222
SERVICE = "dagger_run417_planner"
DESCRIPTION = "GROOT scene graph DAgger using object-centric structured scene representations with graph neural networks for generalizable manipulation planning"
...
var d=[76,79,81,83,85,87,88,90,92];
var max=Math.max(...d);

...
PORT = 53268
SERVICE = "dagger-run10927-planner"
DESCRIPTION = "DAgger run 10927 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10927-planner</title><style>
...
<div class="header"><h1>dagger-run10927-planner</h1><div class="subtitle">DAgger run 10927 policy planning and online correction · port 53268</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53268</div>

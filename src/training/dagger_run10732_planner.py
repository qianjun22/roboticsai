...
PORT = 52488
SERVICE = "dagger-run10732-planner"
DESCRIPTION = "DAgger run 10732 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10732-planner</title><style>
...
<div class="header"><h1>dagger-run10732-planner</h1><div class="subtitle">DAgger run 10732 policy planning and online correction · port 52488</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52488</div>

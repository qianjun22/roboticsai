...
PORT = 11582
SERVICE = "dagger-run507-planner"
DESCRIPTION = "DAgger run 507 training planner with GraspNet-1B billion-parameter grasp proposal network and scene-level grasp ranking"

"""DAgger run 352 planner — tactile sensing DAgger with 192-dim tactile encoder and slip detection for peg-in-hole 91% SR
...
try:
    ...
    _has_fastapi = False
PORT = 10962
SERVICE = "dagger_run352_planner"
DESCRIPTION = "DAgger run 352 planner — tactile sensing DAgger with 192-dim tactile encoder and slip detection for peg-in-hole 91% SR"
if _has_fastapi:

...
PORT = 53100
SERVICE = "dagger-run10885-planner"
DESCRIPTION = "DAgger run 10885 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10885-planner</title><style>
...
<div class="header"><h1>dagger-run10885-planner</h1><div class="subtitle">DAgger run 10885 policy planning and online correction · port 53100</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53100</div>

...
PORT = 53924
SERVICE = "dagger-run11091-planner"
DESCRIPTION = "DAgger run 11091 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run11091-planner</title><style>
...
<div class="header"><h1>dagger-run11091-planner</h1><div class="subtitle">DAgger run 11091 policy planning and online correction · port 53924</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53924</div>

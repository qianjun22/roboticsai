...
PORT = 53036
SERVICE = "dagger-run10869-planner"
DESCRIPTION = "DAgger run 10869 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10869-planner</title><style>
...
<div class="header"><h1>dagger-run10869-planner</h1><div class="subtitle">DAgger run 10869 policy planning and online correction · port 53036</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53036</div>

...
PORT = 51492
SERVICE = "dagger-run10483-planner"
DESCRIPTION = "DAgger run 10483 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10483-planner</title><style>
...
<div class="header"><h1>dagger-run10483-planner</h1><div class="subtitle">DAgger run 10483 policy planning and online correction · port 51492</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51492</div>

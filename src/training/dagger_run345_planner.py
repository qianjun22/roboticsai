"""DAgger run 345 planner — world model DAgger using DREAMER-v3 for synthetic expert demo generation and latent space planning
...
try:
    ...
    _has_fastapi = False
PORT = 10934
SERVICE = "dagger_run345_planner"
DESCRIPTION = "DAgger run 345 planner — world model DAgger using DREAMER-v3 for synthetic expert demo generation and latent space planning"
if _has_fastapi:

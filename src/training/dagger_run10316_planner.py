...
PORT = 50824
SERVICE = "dagger-run10316-planner"
DESCRIPTION = "DAgger run 10316 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10316-planner</title><style>
...
<div class="header"><h1>dagger-run10316-planner</h1><div class="subtitle">DAgger run 10316 policy planning and online correction · port 50824</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50824</div>

...
PORT = 50768
SERVICE = "dagger-run10302-planner"
DESCRIPTION = "DAgger run 10302 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10302-planner</title><style>
...
<div class="header"><h1>dagger-run10302-planner</h1><div class="subtitle">DAgger run 10302 policy planning and online correction · port 50768</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50768</div>

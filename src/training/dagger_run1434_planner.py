...
PORT = 15296
SERVICE = "dagger-run1434-planner"
DESCRIPTION = "DAgger run 1434 training planner and policy distillation service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run1434-planner</title><style>
...
<div class="header"><h1>dagger-run1434-planner</h1><div class="sub">DAgger run 1434 training planner and policy distillation service</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15296 | <b>Status:</b> <span style="color:#4ade80">Live</span>

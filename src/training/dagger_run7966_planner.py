...
PORT = 41424
SERVICE = "dagger_run7966_planner"
DESCRIPTION = "DAgger run 7966 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run7966_planner</title><style>
...
<div class="header"><h1>dagger_run7966_planner</h1><div class="subtitle">DAgger run 7966 online learning planner port 41424</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41424</div>

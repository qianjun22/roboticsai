"""DAgger run374 with prototypical network few-shot class conditioning for task generalization
...
try:
    ...
    _has_fastapi = False
PORT = 11050
SERVICE = "dagger_run374_planner"
DESCRIPTION = "DAgger run374 with prototypical network few-shot class conditioning for task generalization"
if _has_fastapi:

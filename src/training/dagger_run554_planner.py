...
PORT = 11770
SERVICE = "dagger-run554-planner"
DESCRIPTION = "DAgger run 554 training planner using RoboAgent semantic augmentation for efficient robot manipulation learning"

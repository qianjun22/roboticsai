...
PORT = 42252
SERVICE = "dagger_run8173_planner"
DESCRIPTION = "DAgger run 8173 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8173_planner</title><style>
...
<div class="header"><h1>dagger_run8173_planner</h1><div class="subtitle">DAgger run 8173 online learning planner port 42252</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42252</div>

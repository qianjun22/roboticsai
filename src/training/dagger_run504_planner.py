...
PORT = 11570
SERVICE = "dagger-run504-planner"
DESCRIPTION = "DAgger run 504 training planner with CoT-Robot chain-of-thought reasoning integration for multi-step task planning"

...
PORT = 50268
SERVICE = "dagger-run10177-planner"
DESCRIPTION = "DAgger run 10177 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10177-planner</title><style>
...
<div class="header"><h1>dagger-run10177-planner</h1><div class="subtitle">DAgger run 10177 policy planning and online correction · port 50268</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50268</div>

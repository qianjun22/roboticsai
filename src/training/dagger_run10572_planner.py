...
PORT = 51848
SERVICE = "dagger-run10572-planner"
DESCRIPTION = "DAgger run 10572 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10572-planner</title><style>
...
<div class="header"><h1>dagger-run10572-planner</h1><div class="subtitle">DAgger run 10572 policy planning and online correction · port 51848</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51848</div>

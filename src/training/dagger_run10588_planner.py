...
PORT = 51912
SERVICE = "dagger-run10588-planner"
DESCRIPTION = "DAgger run 10588 policy planning and online correction"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger-run10588-planner</title><style>
...
<div class="header"><h1>dagger-run10588-planner</h1><div class="subtitle">DAgger run 10588 policy planning and online correction · port 51912</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51912</div>

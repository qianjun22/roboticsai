...
PORT = 41872
SERVICE = "dagger_run8078_planner"
DESCRIPTION = "DAgger run 8078 online learning planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>dagger_run8078_planner</title><style>
...
<div class="header"><h1>dagger_run8078_planner</h1><div class="subtitle">DAgger run 8078 online learning planner port 41872</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41872</div>

...
PORT = 12942
SERVICE = "dagger_run847_planner"
DESCRIPTION = "DAgger run 847 training planner — manages intervention thresholds and policy correction cycles for online robot learning"

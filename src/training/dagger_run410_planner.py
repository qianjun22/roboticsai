"""DAgger run410 planner using C-BET clustering behavioral transformer for discrete latent action representation in robot policy learning
...
try:
    ...
    _has_fastapi = False
PORT = 11194
SERVICE = "dagger_run410_planner"
DESCRIPTION = "DAgger run410 planner using C-BET clustering behavioral transformer for discrete latent action representation in robot policy learning"
if _has_fastapi:

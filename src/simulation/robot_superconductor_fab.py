...
PORT = 18870
SERVICE = "robot_superconductor_fab"
DESCRIPTION = "Robotic superconductor fabrication system for precision high-temperature superconductor material synthesis"

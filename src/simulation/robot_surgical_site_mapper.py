...
PORT = 50202
SERVICE = "robot-surgical-site-mapper"
DESCRIPTION = "Robotics simulation for surgical site mapper"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-surgical-site-mapper</title><style>
...
<div class="header"><h1>robot-surgical-site-mapper</h1><div class="subtitle">Robotics simulation for surgical site mapper · port 50202</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50202</div>

...
PORT = 13772
SERVICE = "robot_desert_solar_panel_cleaner"
DESCRIPTION = "Robotic desert solar panel cleaning service — autonomous dust removal and panel efficiency optimization for arid environment solar farms"

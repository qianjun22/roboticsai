...
PORT = 16810
SERVICE = "robot_mitochondria_health_monitor"
DESCRIPTION = "Robotic mitochondria health monitor assessing membrane potential, ROS levels and biogenesis markers in live cells"

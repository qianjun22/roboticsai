...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-centroidal-momentum-optimizer</title><style>
...
<div class="header"><h1>robot-centroidal-momentum-optimizer</h1><div class="subtitle">Robotics simulation for centroidal momentum optimizer · port 52034</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52034</div>

...
PORT = 51578
SERVICE = "robot-human-robot-collaboration"
DESCRIPTION = "Robotics simulation for human robot collaboration"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-human-robot-collaboration</title><style>
...
<div class="header"><h1>robot-human-robot-collaboration</h1><div class="subtitle">Robotics simulation for human robot collaboration · port 51578</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51578</div>

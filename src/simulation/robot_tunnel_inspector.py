...
PORT = 38458
SERVICE = "robot_tunnel_inspector"
DESCRIPTION = "Underground tunnel inspection robot with LiDAR mapping"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_tunnel_inspector</title><style>
...
<div class="header"><h1>robot_tunnel_inspector</h1><div class="subtitle">Underground tunnel inspection robot with LiDAR mapping · port 38458</div></div>
<div class="content">

...
PORT = 13776
SERVICE = "robot_stratospheric_balloon_deployer"
DESCRIPTION = "Robotic stratospheric balloon deployment service — autonomous high-altitude payload release and telemetry management for scientific missions"

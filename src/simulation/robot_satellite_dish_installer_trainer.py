...
PORT = 12256
SERVICE = "robot-satellite-dish-installer-trainer"
DESCRIPTION = "Training environment for robotic satellite dish installation — structural mounting, signal alignment, cable routing, and weather-sealing procedures on rooftops"

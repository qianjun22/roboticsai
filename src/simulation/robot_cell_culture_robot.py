...
PORT = 52902
SERVICE = "robot-cell-culture-robot"
DESCRIPTION = "Robotics simulation for cell culture robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cell-culture-robot</title><style>
...
<div class="header"><h1>robot-cell-culture-robot</h1><div class="subtitle">Robotics simulation for cell culture robot · port 52902</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52902</div>

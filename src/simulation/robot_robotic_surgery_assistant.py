...
PORT = 13796
SERVICE = "robot_robotic_surgery_assistant"
DESCRIPTION = "Robotic surgery assistant service — AI-guided surgical planning, intraoperative telemetry, and precision instrument coordination"

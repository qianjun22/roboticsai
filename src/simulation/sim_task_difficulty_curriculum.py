...
PORT = 11384
SERVICE = "sim_task_difficulty_curriculum"
DESCRIPTION = "Automatically adjusts task difficulty in simulation based on policy success rate for curriculum learning"

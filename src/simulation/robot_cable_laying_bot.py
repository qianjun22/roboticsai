...
PORT = 50342
SERVICE = "robot-cable-laying-bot"
DESCRIPTION = "Robotics simulation for cable laying bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cable-laying-bot</title><style>
...
<div class="header"><h1>robot-cable-laying-bot</h1><div class="subtitle">Robotics simulation for cable laying bot · port 50342</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50342</div>

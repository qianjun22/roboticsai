...
PORT = 12228
SERVICE = "sim-autonomous-smart-city-robot-env"
DESCRIPTION = "Simulation environment for autonomous smart city service robots — public space cleaning, infrastructure monitoring, citizen assistance, and emergency response coordination"

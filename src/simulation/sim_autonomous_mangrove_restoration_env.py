...
PORT = 12708
SERVICE = "sim-autonomous-mangrove-restoration-env"
DESCRIPTION = "Simulation environment for autonomous mangrove planting and coastal restoration with amphibious robots"

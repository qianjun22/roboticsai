...
PORT = 13340
SERVICE = "robot_seabed_cable_layer"
DESCRIPTION = "Robot training for seabed fiber optic cable laying with trench navigation, burial depth control, and splice point positioning"

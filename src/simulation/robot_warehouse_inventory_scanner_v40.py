...
PORT = 40750
SERVICE = "robot_warehouse_inventory_scanner"
DESCRIPTION = "Simulation service for warehouse inventory scanner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_warehouse_inventory_scanner</title><style>
...
<div class="header"><h1>robot_warehouse_inventory_scanner</h1><div class="subtitle">Simulation service for warehouse inventory scanner port 40750</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40750</div>

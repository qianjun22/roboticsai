...
PORT = 13320
SERVICE = "robot_satellite_solar_array_deployer"
DESCRIPTION = "Robot training for satellite solar array deployment with panel unfolding sequencing and hinge torque management in microgravity"

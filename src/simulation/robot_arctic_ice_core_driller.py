...
PORT = 13708
SERVICE = "robot_arctic_ice_core_driller"
DESCRIPTION = "Arctic ice core driller robot simulation — autonomous drilling and extraction of ice cores for climate research in polar environments"

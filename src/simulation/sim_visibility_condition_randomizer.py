"""Sim visibility condition randomizer — randomizes fog density, smoke, dust occlusion and partial view conditions for visual robustness
...
try:
    ...
    _has_fastapi = False
PORT = 10912
SERVICE = "sim_visibility_condition_randomizer"
DESCRIPTION = "Sim visibility condition randomizer — randomizes fog density, smoke, dust occlusion and partial view conditions for visual robustness"
if _has_fastapi:

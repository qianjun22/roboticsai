...
PORT = 50986
SERVICE = "robot-protein-crystallization-agent"
DESCRIPTION = "Robotics simulation for protein crystallization agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-protein-crystallization-agent</title><style>
...
<div class="header"><h1>robot-protein-crystallization-agent</h1><div class="subtitle">Robotics simulation for protein crystallization agent · port 50986</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50986</div>

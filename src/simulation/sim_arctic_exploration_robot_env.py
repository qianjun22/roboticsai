...
PORT = 11940
SERVICE = "sim_arctic_exploration_robot_env"
DESCRIPTION = "Arctic exploration robot simulation environment for ice shelf navigation, climate sensor deployment, and extreme cold endurance operations"

...
PORT = 11924
SERVICE = "sim_autonomous_port_crane_env"
DESCRIPTION = "Autonomous port crane simulation environment for container stacking, ship loading coordination, and weather-adaptive lift operations"

...
PORT = 12936
SERVICE = "robot_tire_assembly_balancer"
DESCRIPTION = "Robotic tire assembly and dynamic balancing — bead seating, inflation sequence, balance weight placement, and runout measurement for automotive production"

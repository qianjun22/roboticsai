...
PORT = 52606
SERVICE = "robot-rope-physics-engine"
DESCRIPTION = "Robotics simulation for rope physics engine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-rope-physics-engine</title><style>
...
<div class="header"><h1>robot-rope-physics-engine</h1><div class="subtitle">Robotics simulation for rope physics engine · port 52606</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52606</div>

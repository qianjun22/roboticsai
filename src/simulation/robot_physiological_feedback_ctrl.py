...
PORT = 52562
SERVICE = "robot-physiological-feedback-ctrl"
DESCRIPTION = "Robotics simulation for physiological feedback ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-physiological-feedback-ctrl</title><style>
...
<div class="header"><h1>robot-physiological-feedback-ctrl</h1><div class="subtitle">Robotics simulation for physiological feedback ctrl · port 52562</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52562</div>

...
PORT = 53290
SERVICE = "robot-in-orbit-refueler"
DESCRIPTION = "Robotics simulation for in orbit refueler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-in-orbit-refueler</title><style>
...
<div class="header"><h1>robot-in-orbit-refueler</h1><div class="subtitle">Robotics simulation for in orbit refueler · port 53290</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53290</div>

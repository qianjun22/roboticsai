...
PORT = 53946
SERVICE = "robot-dynamic-reaching-controller"
DESCRIPTION = "Robotics simulation for dynamic reaching controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-dynamic-reaching-controller</title><style>
...
<div class="header"><h1>robot-dynamic-reaching-controller</h1><div class="subtitle">Robotics simulation for dynamic reaching controller · port 53946</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53946</div>

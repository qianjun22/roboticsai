...
PORT = 52362
SERVICE = "robot-multi-agent-manipulation"
DESCRIPTION = "Robotics simulation for multi agent manipulation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multi-agent-manipulation</title><style>
...
<div class="header"><h1>robot-multi-agent-manipulation</h1><div class="subtitle">Robotics simulation for multi agent manipulation · port 52362</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52362</div>

...
PORT = 12944
SERVICE = "robot_greenhouse_climate_controller"
DESCRIPTION = "Robotic climate control system for greenhouse automation — temperature, humidity, CO2, and irrigation management with ML optimization"

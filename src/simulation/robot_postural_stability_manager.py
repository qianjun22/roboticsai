...
PORT = 50110
SERVICE = "robot-postural-stability-manager"
DESCRIPTION = "Robotics simulation for postural stability manager"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-postural-stability-manager</title><style>
...
<div class="header"><h1>robot-postural-stability-manager</h1><div class="subtitle">Robotics simulation for postural stability manager · port 50110</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50110</div>

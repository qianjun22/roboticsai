...
PORT = 12848
SERVICE = "robot_wildfire_suppression_drone"
DESCRIPTION = "Autonomous wildfire suppression drone swarm — fire front tracking, retardant drop coordination, and safe airspace deconfliction"

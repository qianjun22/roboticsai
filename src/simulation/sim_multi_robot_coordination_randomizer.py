"""Sim multi-robot coordination randomizer — randomizes team composition, task allocation, communication delays, and topology for multi-robot scenario diversity
...
try:
    ...
    _has_fastapi = False
PORT = 10936
SERVICE = "sim_multi_robot_coordination_randomizer"
DESCRIPTION = "Sim multi-robot coordination randomizer — randomizes team composition, task allocation, communication delays, and topology for multi-robot scenario diversity"
if _has_fastapi:

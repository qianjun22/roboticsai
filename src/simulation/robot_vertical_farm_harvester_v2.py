...
PORT = 13724
SERVICE = "robot_vertical_farm_harvester_v2"
DESCRIPTION = "Vertical farm harvester robot simulation v2 — precision multi-tier crop harvesting with vision-based ripeness detection in indoor vertical farms"

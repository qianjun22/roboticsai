...
PORT = 50554
SERVICE = "robot-snake-robot-navigator"
DESCRIPTION = "Robotics simulation for snake robot navigator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-snake-robot-navigator</title><style>
...
<div class="header"><h1>robot-snake-robot-navigator</h1><div class="subtitle">Robotics simulation for snake robot navigator · port 50554</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50554</div>

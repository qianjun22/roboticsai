...
PORT = 50734
SERVICE = "robot-mud-traversal-robot"
DESCRIPTION = "Robotics simulation for mud traversal robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mud-traversal-robot</title><style>
...
<div class="header"><h1>robot-mud-traversal-robot</h1><div class="subtitle">Robotics simulation for mud traversal robot · port 50734</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50734</div>

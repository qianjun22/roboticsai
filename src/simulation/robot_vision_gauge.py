...
PORT = 15294
SERVICE = "robot-vision-gauge"
DESCRIPTION = "Simulation service for vision gauge robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vision-gauge</title><style>
...
<div class="header"><h1>robot-vision-gauge</h1><div class="sub">Simulation service for vision gauge robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15294 | <b>Status:</b> <span style="color:#4ade80">Live</span>

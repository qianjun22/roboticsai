...
PORT = 11568
SERVICE = "sim-physical-reasoning-env"
DESCRIPTION = "Physical reasoning simulation environment testing intuitive physics understanding for tool-use and fluid dynamics tasks"

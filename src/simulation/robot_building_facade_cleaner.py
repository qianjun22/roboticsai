...
PORT = 50810
SERVICE = "robot-building-facade-cleaner"
DESCRIPTION = "Robotics simulation for building facade cleaner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-building-facade-cleaner</title><style>
...
<div class="header"><h1>robot-building-facade-cleaner</h1><div class="subtitle">Robotics simulation for building facade cleaner · port 50810</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50810</div>

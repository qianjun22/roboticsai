"""Automated scorer measuring kinematic, dynamic, and contact physics fidelity between Isaac Sim and real robots
...
try:
    ...
    _has_fastapi = False
PORT = 10856
SERVICE = "sim_physics_fidelity_scorer"
DESCRIPTION = "Automated scorer measuring kinematic, dynamic, and contact physics fidelity between Isaac Sim and real robots"
if _has_fastapi:

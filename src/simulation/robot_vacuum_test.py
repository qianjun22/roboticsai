...
PORT = 15274
SERVICE = "robot-vacuum-test"
DESCRIPTION = "Simulation service for vacuum test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vacuum-test</title><style>
...
<div class="header"><h1>robot-vacuum-test</h1><div class="sub">Simulation service for vacuum test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15274 | <b>Status:</b> <span style="color:#4ade80">Live</span>

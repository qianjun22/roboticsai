...
PORT = 15278
SERVICE = "robot-helium-sniff"
DESCRIPTION = "Simulation service for helium sniff robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-helium-sniff</title><style>
...
<div class="header"><h1>robot-helium-sniff</h1><div class="sub">Simulation service for helium sniff robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15278 | <b>Status:</b> <span style="color:#4ade80">Live</span>

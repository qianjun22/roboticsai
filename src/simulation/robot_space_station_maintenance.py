...
PORT = 53286
SERVICE = "robot-space-station-maintenance"
DESCRIPTION = "Robotics simulation for space station maintenance"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-space-station-maintenance</title><style>
...
<div class="header"><h1>robot-space-station-maintenance</h1><div class="subtitle">Robotics simulation for space station maintenance · port 53286</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53286</div>

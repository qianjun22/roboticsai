...
PORT = 50210
SERVICE = "robot-haptic-feedback-surgeon"
DESCRIPTION = "Robotics simulation for haptic feedback surgeon"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-haptic-feedback-surgeon</title><style>
...
<div class="header"><h1>robot-haptic-feedback-surgeon</h1><div class="subtitle">Robotics simulation for haptic feedback surgeon · port 50210</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50210</div>

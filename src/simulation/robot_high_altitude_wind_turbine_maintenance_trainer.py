...
PORT = 12576
SERVICE = "robot_high_altitude_wind_turbine_maintenance_trainer"
DESCRIPTION = "Robot high-altitude wind turbine maintenance trainer with blade inspection, rope access control, and weather-window optimization"

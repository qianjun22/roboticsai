...
PORT = 12292
SERVICE = "sim_underwater_pipeline_inspection_env"
DESCRIPTION = "Simulation environment for underwater pipeline inspection robot navigation and defect detection"

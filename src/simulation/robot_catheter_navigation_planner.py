...
PORT = 52138
SERVICE = "robot-catheter-navigation-planner"
DESCRIPTION = "Robotics simulation for catheter navigation planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-catheter-navigation-planner</title><style>
...
<div class="header"><h1>robot-catheter-navigation-planner</h1><div class="subtitle">Robotics simulation for catheter navigation planner · port 52138</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52138</div>

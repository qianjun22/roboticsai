...
PORT = 13176
SERVICE = "robot_fiber_optic_cable_splicer"
DESCRIPTION = "Robot training for fiber optic cable splicing with precision cleave alignment and fusion weld quality verification"

...
PORT = 15222
SERVICE = "robot-conformal-coat"
DESCRIPTION = "Simulation service for conformal coat robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-conformal-coat</title><style>
...
<div class="header"><h1>robot-conformal-coat</h1><div class="sub">Simulation service for conformal coat robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15222 | <b>Status:</b> <span style="color:#4ade80">Live</span>

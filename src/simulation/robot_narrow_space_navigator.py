...
PORT = 50766
SERVICE = "robot-narrow-space-navigator"
DESCRIPTION = "Robotics simulation for narrow space navigator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-narrow-space-navigator</title><style>
...
<div class="header"><h1>robot-narrow-space-navigator</h1><div class="subtitle">Robotics simulation for narrow space navigator · port 50766</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50766</div>

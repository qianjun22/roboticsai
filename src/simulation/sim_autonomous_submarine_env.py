...
PORT = 11948
SERVICE = "sim_autonomous_submarine_env"
DESCRIPTION = "Autonomous submarine simulation environment for deep ocean navigation, sonar-based mapping, and underwater infrastructure inspection"

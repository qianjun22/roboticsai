...
PORT = 12260
SERVICE = "sim-autonomous-coral-reef-monitor-env"
DESCRIPTION = "Simulation environment for autonomous coral reef monitoring robots — bleaching detection, biodiversity assessment, water chemistry sampling, and restoration planting"

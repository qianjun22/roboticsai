...
PORT = 12676
SERVICE = "sim-autonomous-groundwater-monitoring-env"
DESCRIPTION = "Simulation environment for autonomous groundwater quality monitoring using soil-penetrating sensor robots"

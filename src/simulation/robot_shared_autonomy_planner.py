...
PORT = 52534
SERVICE = "robot-shared-autonomy-planner"
DESCRIPTION = "Robotics simulation for shared autonomy planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-shared-autonomy-planner</title><style>
...
<div class="header"><h1>robot-shared-autonomy-planner</h1><div class="subtitle">Robotics simulation for shared autonomy planner · port 52534</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52534</div>

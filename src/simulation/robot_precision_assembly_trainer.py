...
PORT = 11604
SERVICE = "robot-precision-assembly-trainer"
DESCRIPTION = "Precision assembly training with sub-millimeter tolerance policies for electronic component insertion and PCB handling"

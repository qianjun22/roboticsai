...
PORT = 14986
SERVICE = "robot_automated_permafrost_thaw_monitor"
DESCRIPTION = "Automated robotic sensor network for monitoring permafrost thaw depth and soil temperature profiles"

...
PORT = 13000
SERVICE = "robot_tunnel_boring_monitor"
DESCRIPTION = "Robotic tunnel boring monitor — alignment tracking, soil condition sensing, cutter head wear monitoring, and progress rate optimization"

...
PORT = 12192
SERVICE = "robot-explosive-ordnance-disposal-trainer"
DESCRIPTION = "Training environment for robotic explosive ordnance disposal — remote sensing, controlled detonation procedures, and bomb squad coordination protocols"

...
PORT = 53394
SERVICE = "robot-tendon-driven-hand-ctrl"
DESCRIPTION = "Robotics simulation for tendon driven hand ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tendon-driven-hand-ctrl</title><style>
...
<div class="header"><h1>robot-tendon-driven-hand-ctrl</h1><div class="subtitle">Robotics simulation for tendon driven hand ctrl · port 53394</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53394</div>

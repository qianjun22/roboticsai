...
PORT = 15062
SERVICE = "robot-surface-finish"
DESCRIPTION = "Simulation service for surface finish robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-surface-finish</title><style>
...
<div class="header"><h1>robot-surface-finish</h1><div class="sub">Simulation service for surface finish robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15062 | <b>Status:</b> <span style="color:#4ade80">Live</span>

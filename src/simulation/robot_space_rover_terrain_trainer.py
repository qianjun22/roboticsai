...
PORT = 11976
SERVICE = "robot_space_rover_terrain_trainer"
DESCRIPTION = "Space rover terrain trainer for regolith navigation, sample collection under communication delay, and autonomous science target prioritization"

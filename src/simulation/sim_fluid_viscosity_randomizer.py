"""Simulation fluid viscosity and surface tension domain randomizer for training robot policies to handle liquid and viscous material manipulation
...
try:
    ...
    _has_fastapi = False
PORT = 11160
SERVICE = "sim_fluid_viscosity_randomizer"
DESCRIPTION = "Simulation fluid viscosity and surface tension domain randomizer for training robot policies to handle liquid and viscous material manipulation"
if _has_fastapi:

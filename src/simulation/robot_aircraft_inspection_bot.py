...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aircraft-inspection-bot</title><style>
...
<div class="header"><h1>robot-aircraft-inspection-bot</h1><div class="subtitle">Robotics simulation for aircraft inspection bot · port 50802</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50802</div>

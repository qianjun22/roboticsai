...
PORT = 51486
SERVICE = "robot-electroadhesive-gripper-ctrl"
DESCRIPTION = "Robotics simulation for electroadhesive gripper ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-electroadhesive-gripper-ctrl</title><style>
...
<div class="header"><h1>robot-electroadhesive-gripper-ctrl</h1><div class="subtitle">Robotics simulation for electroadhesive gripper ctrl · port 51486</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51486</div>

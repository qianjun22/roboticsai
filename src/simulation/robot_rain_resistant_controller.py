...
PORT = 50738
SERVICE = "robot-rain-resistant-controller"
DESCRIPTION = "Robotics simulation for rain resistant controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-rain-resistant-controller</title><style>
...
<div class="header"><h1>robot-rain-resistant-controller</h1><div class="subtitle">Robotics simulation for rain resistant controller · port 50738</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50738</div>

...
PORT = 53150
SERVICE = "robot-tunnel-mapping-robot"
DESCRIPTION = "Robotics simulation for tunnel mapping robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tunnel-mapping-robot</title><style>
...
<div class="header"><h1>robot-tunnel-mapping-robot</h1><div class="subtitle">Robotics simulation for tunnel mapping robot · port 53150</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53150</div>

...
PORT = 12500
SERVICE = "sim_autonomous_oil_spill_cleanup_env"
DESCRIPTION = "Autonomous oil spill cleanup robot simulation with skimmer deployment, containment boom placement, and marine environmental impact modeling"

...
PORT = 15006
SERVICE = "robot-pipe-weld"
DESCRIPTION = "Simulation service for pipe weld robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pipe-weld</title><style>
...
<div class="header"><h1>robot-pipe-weld</h1><div class="sub">Simulation service for pipe weld robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15006 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50890
SERVICE = "robot-semiconductor-handler"
DESCRIPTION = "Robotics simulation for semiconductor handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-semiconductor-handler</title><style>
...
<div class="header"><h1>robot-semiconductor-handler</h1><div class="subtitle">Robotics simulation for semiconductor handler · port 50890</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50890</div>

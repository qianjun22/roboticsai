...
PORT = 53526
SERVICE = "robot-sim-to-real-transfer-agent"
DESCRIPTION = "Robotics simulation for sim to real transfer agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-sim-to-real-transfer-agent</title><style>
...
<div class="header"><h1>robot-sim-to-real-transfer-agent</h1><div class="subtitle">Robotics simulation for sim to real transfer agent · port 53526</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53526</div>

...
PORT = 13324
SERVICE = "robot_blast_furnace_tap_hole_driller"
DESCRIPTION = "Robot training for blast furnace tap hole drilling with heat-resistant actuation and molten iron flow control"

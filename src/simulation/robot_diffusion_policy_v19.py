...
PORT = 46842
SERVICE = "robot_diffusion_policy_v19"
DESCRIPTION = "Diffusion policy model for robot action generation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_diffusion_policy_v19</title><style>
...
<div class="header"><h1>robot_diffusion_policy_v19</h1><div class="subtitle">Diffusion policy model for robot action generation · port 46842</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46842</div>

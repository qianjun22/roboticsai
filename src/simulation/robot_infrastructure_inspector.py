...
PORT = 50258
SERVICE = "robot-infrastructure-inspector"
DESCRIPTION = "Robotics simulation for infrastructure inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-infrastructure-inspector</title><style>
...
<div class="header"><h1>robot-infrastructure-inspector</h1><div class="subtitle">Robotics simulation for infrastructure inspector · port 50258</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50258</div>

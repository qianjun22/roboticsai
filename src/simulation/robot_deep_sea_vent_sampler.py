...
PORT = 13348
SERVICE = "robot_deep_sea_vent_sampler"
DESCRIPTION = "Robot training for hydrothermal vent sampling with high-pressure fluid collection and mineral deposit mapping"

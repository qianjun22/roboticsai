...
<div class="header"><h1>robot_parts_bin_picker</h1><div class="subtitle">Simulation service for parts bin picker port 38822</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38822</div>

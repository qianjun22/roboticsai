...
PORT = 12484
SERVICE = "sim_autonomous_forest_firefighting_drone_env"
DESCRIPTION = "Autonomous forest firefighting drone simulation with thermal imaging, retardant drop optimization, and smoke navigation modeling"

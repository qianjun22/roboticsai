...
PORT = 50654
SERVICE = "robot-physics-engine-wrapper"
DESCRIPTION = "Robotics simulation for physics engine wrapper"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-physics-engine-wrapper</title><style>
...
<div class="header"><h1>robot-physics-engine-wrapper</h1><div class="subtitle">Robotics simulation for physics engine wrapper · port 50654</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50654</div>

...
PORT = 13624
SERVICE = "robot_autonomous_mining_driller"
DESCRIPTION = "Autonomous mining drill robot — executes precision core drilling patterns in underground mines, adapts to rock composition in real time, and transmits geological data for ore body modeling"

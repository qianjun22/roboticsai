...
PORT = 51226
SERVICE = "robot-bridge-inspection-agent"
DESCRIPTION = "Robotics simulation for bridge inspection agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-bridge-inspection-agent</title><style>
...
<div class="header"><h1>robot-bridge-inspection-agent</h1><div class="subtitle">Robotics simulation for bridge inspection agent · port 51226</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51226</div>

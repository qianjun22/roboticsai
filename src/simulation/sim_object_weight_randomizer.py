"""Sim object weight randomizer — 50g to 5kg mass range with CoM displacement, asymmetric loads, and hidden mass for grasp robustness training
...
try:
    ...
    _has_fastapi = False
PORT = 10984
SERVICE = "sim_object_weight_randomizer"
DESCRIPTION = "Sim object weight randomizer — 50g to 5kg mass range with CoM displacement, asymmetric loads, and hidden mass for grasp robustness training"
if _has_fastapi:

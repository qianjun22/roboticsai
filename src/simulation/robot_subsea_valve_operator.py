...
PORT = 52246
SERVICE = "robot-subsea-valve-operator"
DESCRIPTION = "Robotics simulation for subsea valve operator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-subsea-valve-operator</title><style>
...
<div class="header"><h1>robot-subsea-valve-operator</h1><div class="subtitle">Robotics simulation for subsea valve operator · port 52246</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52246</div>

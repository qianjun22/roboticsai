...
PORT = 50570
SERVICE = "robot-tensegrity-robot-ctrl"
DESCRIPTION = "Robotics simulation for tensegrity robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tensegrity-robot-ctrl</title><style>
...
<div class="header"><h1>robot-tensegrity-robot-ctrl</h1><div class="subtitle">Robotics simulation for tensegrity robot ctrl · port 50570</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50570</div>

...
PORT = 52590
SERVICE = "robot-force-torque-sim-engine"
DESCRIPTION = "Robotics simulation for force torque sim engine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-force-torque-sim-engine</title><style>
...
<div class="header"><h1>robot-force-torque-sim-engine</h1><div class="subtitle">Robotics simulation for force torque sim engine · port 52590</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52590</div>

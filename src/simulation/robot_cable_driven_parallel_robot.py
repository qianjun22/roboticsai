...
PORT = 51522
SERVICE = "robot-cable-driven-parallel-robot"
DESCRIPTION = "Robotics simulation for cable driven parallel robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cable-driven-parallel-robot</title><style>
...
<div class="header"><h1>robot-cable-driven-parallel-robot</h1><div class="subtitle">Robotics simulation for cable driven parallel robot · port 51522</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51522</div>

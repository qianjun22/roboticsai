...
PORT = 12904
SERVICE = "robot_satellite_dish_aligner"
DESCRIPTION = "Robotic satellite dish alignment system — azimuth/elevation sweep, signal strength optimization, and multi-band pointing accuracy for ground stations"

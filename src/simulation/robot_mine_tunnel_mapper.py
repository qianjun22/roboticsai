...
PORT = 13780
SERVICE = "robot_mine_tunnel_mapper"
DESCRIPTION = "Robotic mine tunnel mapping service — autonomous 3D SLAM and structural assessment for underground mining environments"

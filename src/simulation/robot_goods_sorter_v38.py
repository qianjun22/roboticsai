...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_goods_sorter</title><style>
...
<div class="header"><h1>robot_goods_sorter</h1><div class="subtitle">Simulation service for goods sorter port 39198</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39198</div>

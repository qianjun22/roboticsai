...
PORT = 11972
SERVICE = "sim_disaster_relief_drone_swarm_env"
DESCRIPTION = "Disaster relief drone swarm simulation environment for coordinated search patterns, supply drop coordination, and survivor location mapping"

...
PORT = 12952
SERVICE = "robot_smart_grid_inspector"
DESCRIPTION = "Robotic smart grid inspection system — autonomous power line monitoring, fault detection, and predictive maintenance for electrical infrastructure"

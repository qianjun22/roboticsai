...
PORT = 51030
SERVICE = "robot-flexible-cable-router"
DESCRIPTION = "Robotics simulation for flexible cable router"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-flexible-cable-router</title><style>
...
<div class="header"><h1>robot-flexible-cable-router</h1><div class="subtitle">Robotics simulation for flexible cable router · port 51030</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51030</div>

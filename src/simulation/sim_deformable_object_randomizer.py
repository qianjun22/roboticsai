"""
OCI Robot Cloud — Sim Deformable Object Randomizer
FastAPI service — port 11280
Cloth, rope, and soft-body deformation randomization for dexterous manipulation
"""
...
DESCRIPTION = "Deformable object simulation randomization varying cloth stiffness, rope tension, and soft-body material properties to train policies for textile, cable, and flexible object manipulation"
...
var d=[1e4,5e3,1e3,5e2,1e2,5e2,1e3,5e3,1e4];
var max=Math.max(...d);

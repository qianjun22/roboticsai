...
PORT = 53270
SERVICE = "robot-asteroid-mining-agent"
DESCRIPTION = "Robotics simulation for asteroid mining agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-asteroid-mining-agent</title><style>
...
<div class="header"><h1>robot-asteroid-mining-agent</h1><div class="subtitle">Robotics simulation for asteroid mining agent · port 53270</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53270</div>

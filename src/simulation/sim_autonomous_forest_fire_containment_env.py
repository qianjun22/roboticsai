...
PORT = 12612
SERVICE = "sim-autonomous-forest-fire-containment-env"
DESCRIPTION = "Simulation environment for multi-robot coordination in autonomous forest fire containment and suppression"

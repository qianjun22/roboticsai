...
PORT = 13168
SERVICE = "robot_ice_cream_dispensing_arm"
DESCRIPTION = "Robot training for ice cream dispensing with flavor sequencing, portion control, and cone presentation"

...
PORT = 50134
SERVICE = "robot-grasp-quality-optimizer"
DESCRIPTION = "Robotics simulation for grasp quality optimizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-grasp-quality-optimizer</title><style>
...
<div class="header"><h1>robot-grasp-quality-optimizer</h1><div class="subtitle">Robotics simulation for grasp quality optimizer · port 50134</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50134</div>

...
PORT = 15382
SERVICE = "robot-condenser-perf"
DESCRIPTION = "Simulation service for condenser perf robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-condenser-perf</title><style>
...
<div class="header"><h1>robot-condenser-perf</h1><div class="sub">Simulation service for condenser perf robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15382 | <b>Status:</b> <span style="color:#4ade80">Live</span>

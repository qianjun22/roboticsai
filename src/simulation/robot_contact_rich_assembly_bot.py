...
PORT = 51014
SERVICE = "robot-contact-rich-assembly-bot"
DESCRIPTION = "Robotics simulation for contact rich assembly bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-contact-rich-assembly-bot</title><style>
...
<div class="header"><h1>robot-contact-rich-assembly-bot</h1><div class="subtitle">Robotics simulation for contact rich assembly bot · port 51014</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51014</div>

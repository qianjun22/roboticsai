...
PORT = 50154
SERVICE = "robot-radiation-belt-v8"
DESCRIPTION = "Van Allen radiation belt-aware robot simulation for hardened spacecraft systems with SEU and TID dose tracking"

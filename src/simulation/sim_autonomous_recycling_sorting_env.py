...
PORT = 12356
SERVICE = "sim_autonomous_recycling_sorting_env"
DESCRIPTION = "Simulation environment for autonomous recycling sorting robot material classification and bin management"

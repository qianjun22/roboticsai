...
PORT = 12252
SERVICE = "sim-autonomous-airport-baggage-handling-env"
DESCRIPTION = "Simulation environment for autonomous airport baggage handling robots — conveyor routing, baggage identification, carousel loading, and lost baggage recovery"

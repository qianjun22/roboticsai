...
PORT = 50578
SERVICE = "robot-delta-robot-controller"
DESCRIPTION = "Robotics simulation for delta robot controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-delta-robot-controller</title><style>
...
<div class="header"><h1>robot-delta-robot-controller</h1><div class="subtitle">Robotics simulation for delta robot controller · port 50578</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50578</div>

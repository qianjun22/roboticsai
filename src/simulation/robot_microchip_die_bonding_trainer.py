...
PORT = 12528
SERVICE = "robot_microchip_die_bonding_trainer"
DESCRIPTION = "Robot microchip die bonding trainer with sub-micron placement precision, epoxy dispense optimization, and wire bond quality simulation"

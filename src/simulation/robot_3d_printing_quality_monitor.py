...
PORT = 13152
SERVICE = "robot_3d_printing_quality_monitor"
DESCRIPTION = "Robot training for 3D printing quality monitoring with layer adhesion and dimensional accuracy control"

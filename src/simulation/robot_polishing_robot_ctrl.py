...
PORT = 50874
SERVICE = "robot-polishing-robot-ctrl"
DESCRIPTION = "Robotics simulation for polishing robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-polishing-robot-ctrl</title><style>
...
<div class="header"><h1>robot-polishing-robot-ctrl</h1><div class="subtitle">Robotics simulation for polishing robot ctrl · port 50874</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50874</div>

...
PORT = 52410
SERVICE = "robot-valve-turning-controller"
DESCRIPTION = "Robotics simulation for valve turning controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-valve-turning-controller</title><style>
...
<div class="header"><h1>robot-valve-turning-controller</h1><div class="subtitle">Robotics simulation for valve turning controller · port 52410</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52410</div>

"""Sim collision physics randomizer — contact geometry, material friction pairs, impact response, and environmental collision diversity for safety robustness
...
try:
    ...
    _has_fastapi = False
PORT = 10960
SERVICE = "sim_collision_physics_randomizer"
DESCRIPTION = "Sim collision physics randomizer — contact geometry, material friction pairs, impact response, and environmental collision diversity for safety robustness"
if _has_fastapi:

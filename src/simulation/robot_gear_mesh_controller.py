...
PORT = 50478
SERVICE = "robot-gear-mesh-controller"
DESCRIPTION = "Robotics simulation for gear mesh controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gear-mesh-controller</title><style>
...
<div class="header"><h1>robot-gear-mesh-controller</h1><div class="subtitle">Robotics simulation for gear mesh controller · port 50478</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50478</div>

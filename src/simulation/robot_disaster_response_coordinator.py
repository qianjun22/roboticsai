...
PORT = 12828
SERVICE = "robot_disaster_response_coordinator"
DESCRIPTION = "Multi-robot disaster response coordination — search pattern optimization, survivor detection triage, and safe zone mapping in collapsed structures"

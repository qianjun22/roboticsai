...
PORT = 13768
SERVICE = "robot_tsunami_buoy_swarm_coordinator"
DESCRIPTION = "Robotic tsunami buoy swarm coordination service — autonomous ocean buoy deployment and early-warning network management"

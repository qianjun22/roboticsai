...
PORT = 51650
SERVICE = "robot-cloth-simulation-ctrl"
DESCRIPTION = "Robotics simulation for cloth simulation ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cloth-simulation-ctrl</title><style>
...
<div class="header"><h1>robot-cloth-simulation-ctrl</h1><div class="subtitle">Robotics simulation for cloth simulation ctrl · port 51650</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51650</div>

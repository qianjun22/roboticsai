...
PORT = 11700
SERVICE = "robot-lab-automation-trainer"
DESCRIPTION = "Laboratory automation robot trainer for precision pipetting, sample handling, and experiment execution policies"

...
PORT = 11552
SERVICE = "robot-long-horizon-task-env"
DESCRIPTION = "Long-horizon task execution environment with sub-goal decomposition and replanning for complex manipulation"

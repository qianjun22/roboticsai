...
PORT = 52170
SERVICE = "robot-crop-harvesting-agent"
DESCRIPTION = "Robotics simulation for crop harvesting agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-crop-harvesting-agent</title><style>
...
<div class="header"><h1>robot-crop-harvesting-agent</h1><div class="subtitle">Robotics simulation for crop harvesting agent · port 52170</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52170</div>

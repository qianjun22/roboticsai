...
PORT = 50790
SERVICE = "robot-solar-panel-cleaner"
DESCRIPTION = "Robotics simulation for solar panel cleaner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-solar-panel-cleaner</title><style>
...
<div class="header"><h1>robot-solar-panel-cleaner</h1><div class="subtitle">Robotics simulation for solar panel cleaner · port 50790</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50790</div>

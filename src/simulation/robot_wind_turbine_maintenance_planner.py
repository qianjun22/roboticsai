...
PORT = 12756
SERVICE = "robot_wind_turbine_maintenance_planner"
DESCRIPTION = "Robotic wind turbine inspection and maintenance planning — blade damage detection, climb path optimization, and repair sequencing"

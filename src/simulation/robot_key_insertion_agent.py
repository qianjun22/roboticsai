...
<div class="header"><h1>robot-key-insertion-agent</h1><div class="subtitle">Robotics simulation for key insertion agent · port 51454</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51454</div>

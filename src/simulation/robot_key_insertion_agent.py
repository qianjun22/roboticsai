...
PORT = 50494
SERVICE = "robot-key-insertion-agent"
DESCRIPTION = "Robotics simulation for key insertion agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-key-insertion-agent</title><style>
...
<div class="header"><h1>robot-key-insertion-agent</h1><div class="subtitle">Robotics simulation for key insertion agent · port 50494</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50494</div>

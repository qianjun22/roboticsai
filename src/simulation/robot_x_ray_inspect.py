...
PORT = 15282
SERVICE = "robot-x-ray-inspect"
DESCRIPTION = "Simulation service for x ray inspect robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-x-ray-inspect</title><style>
...
<div class="header"><h1>robot-x-ray-inspect</h1><div class="sub">Simulation service for x ray inspect robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15282 | <b>Status:</b> <span style="color:#4ade80">Live</span>

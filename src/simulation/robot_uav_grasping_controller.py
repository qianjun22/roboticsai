...
PORT = 51234
SERVICE = "robot-uav-grasping-controller"
DESCRIPTION = "Robotics simulation for uav grasping controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-uav-grasping-controller</title><style>
...
<div class="header"><h1>robot-uav-grasping-controller</h1><div class="subtitle">Robotics simulation for uav grasping controller · port 51234</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51234</div>

...
PORT = 53326
SERVICE = "robot-collaborative-assembly-swarm"
DESCRIPTION = "Robotics simulation for collaborative assembly swarm"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-collaborative-assembly-swarm</title><style>
...
<div class="header"><h1>robot-collaborative-assembly-swarm</h1><div class="subtitle">Robotics simulation for collaborative assembly swarm · port 53326</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53326</div>

...
PORT = 11616
SERVICE = "sim-humanoid-locomotion-env"
DESCRIPTION = "Humanoid robot locomotion simulation with full-body control, balance recovery, and stair/ramp traversal tasks"

...
PORT = 15114
SERVICE = "robot-stamp-press"
DESCRIPTION = "Simulation service for stamp press robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-stamp-press</title><style>
...
<div class="header"><h1>robot-stamp-press</h1><div class="sub">Simulation service for stamp press robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15114 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12888
SERVICE = "robot_hazmat_container_handler"
DESCRIPTION = "Robotic hazmat container handling — chemical classification, containment integrity checks, safe transfer protocols, and emergency spill response"

...
PORT = 52242
SERVICE = "robot-underwater-manipulation-ctrl"
DESCRIPTION = "Robotics simulation for underwater manipulation ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-underwater-manipulation-ctrl</title><style>
...
<div class="header"><h1>robot-underwater-manipulation-ctrl</h1><div class="subtitle">Robotics simulation for underwater manipulation ctrl · port 52242</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52242</div>

...
PORT = 13068
SERVICE = "robot_hot_metal_casting"
DESCRIPTION = "Robotic hot metal casting controller — ladle positioning, pour rate control, mold fill optimization, and solidification monitoring"

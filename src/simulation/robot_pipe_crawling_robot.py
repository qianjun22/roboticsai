...
PORT = 50778
SERVICE = "robot-pipe-crawling-robot"
DESCRIPTION = "Robotics simulation for pipe crawling robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pipe-crawling-robot</title><style>
...
<div class="header"><h1>robot-pipe-crawling-robot</h1><div class="subtitle">Robotics simulation for pipe crawling robot · port 50778</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50778</div>

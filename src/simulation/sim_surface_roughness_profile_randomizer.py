"""Simulation surface roughness and texture profile domain randomizer for robot manipulation policy training on diverse contact surfaces
...
try:
    ...
    _has_fastapi = False
PORT = 11184
SERVICE = "sim_surface_roughness_profile_randomizer"
DESCRIPTION = "Simulation surface roughness and texture profile domain randomizer for robot manipulation policy training on diverse contact surfaces"
if _has_fastapi:

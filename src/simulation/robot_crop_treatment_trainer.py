...
PORT = 11796
SERVICE = "robot-crop-treatment-trainer"
DESCRIPTION = "Precision crop treatment robot trainer for variable-rate application, field mapping, and yield optimization"

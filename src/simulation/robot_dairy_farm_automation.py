...
PORT = 13004
SERVICE = "robot_dairy_farm_automation"
DESCRIPTION = "Robotic dairy farm automation system — herd management, automated feeding, health monitoring, and milk quality tracking"

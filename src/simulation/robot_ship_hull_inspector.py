...
PORT = 50806
SERVICE = "robot-ship-hull-inspector"
DESCRIPTION = "Robotics simulation for ship hull inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-ship-hull-inspector</title><style>
...
<div class="header"><h1>robot-ship-hull-inspector</h1><div class="subtitle">Robotics simulation for ship hull inspector · port 50806</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50806</div>

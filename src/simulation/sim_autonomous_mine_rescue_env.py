...
PORT = 12524
SERVICE = "sim_autonomous_mine_rescue_env"
DESCRIPTION = "Autonomous mine rescue robot simulation with gas detection, survivor localization, debris navigation, and safe evacuation path planning"

...
PORT = 13644
SERVICE = "robot_lightning_protection_drone"
DESCRIPTION = "Autonomous lightning protection drone — deploys above critical infrastructure during storm events to create ionized air channels that safely redirect lightning strikes away from substations, data centers, and communication towers"

...
PORT = 15306
SERVICE = "robot-profile-check"
DESCRIPTION = "Simulation service for profile check robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-profile-check</title><style>
...
<div class="header"><h1>robot-profile-check</h1><div class="sub">Simulation service for profile check robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15306 | <b>Status:</b> <span style="color:#4ade80">Live</span>

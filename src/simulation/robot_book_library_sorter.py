...
PORT = 13020
SERVICE = "robot_book_library_sorter"
DESCRIPTION = "Robotic library book sorter — spine reading via OCR, Dewey decimal routing, shelf gap detection, and inventory reconciliation"

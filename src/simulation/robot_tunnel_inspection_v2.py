...
PORT = 13520
SERVICE = "robot_tunnel_inspection_v2"
DESCRIPTION = "Tunnel inspection robot simulation v2 — autonomous structural defect detection in underground tunnels using LiDAR and thermal imaging"

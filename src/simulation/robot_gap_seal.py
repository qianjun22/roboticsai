...
PORT = 15066
SERVICE = "robot-gap-seal"
DESCRIPTION = "Simulation service for gap seal robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gap-seal</title><style>
...
<div class="header"><h1>robot-gap-seal</h1><div class="sub">Simulation service for gap seal robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15066 | <b>Status:</b> <span style="color:#4ade80">Live</span>

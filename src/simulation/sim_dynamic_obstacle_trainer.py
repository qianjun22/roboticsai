...
PORT = 11600
SERVICE = "sim-dynamic-obstacle-trainer"
DESCRIPTION = "Dynamic obstacle avoidance trainer with moving humans, conveyor belts, and unpredictable object trajectories"

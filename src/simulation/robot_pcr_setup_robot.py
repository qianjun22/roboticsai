...
PORT = 50970
SERVICE = "robot-pcr-setup-robot"
DESCRIPTION = "Robotics simulation for pcr setup robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pcr-setup-robot</title><style>
...
<div class="header"><h1>robot-pcr-setup-robot</h1><div class="subtitle">Robotics simulation for pcr setup robot · port 50970</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50970</div>

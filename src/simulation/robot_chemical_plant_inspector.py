...
PORT = 12988
SERVICE = "robot_chemical_plant_inspector"
DESCRIPTION = "Robotic chemical plant inspection system — hazardous environment navigation, leak detection, corrosion mapping, and compliance reporting"

...
PORT = 50634
SERVICE = "robot-emg-signal-decoder"
DESCRIPTION = "Robotics simulation for emg signal decoder"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-emg-signal-decoder</title><style>
...
<div class="header"><h1>robot-emg-signal-decoder</h1><div class="subtitle">Robotics simulation for emg signal decoder · port 50634</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50634</div>

...
PORT = 50762
SERVICE = "robot-cave-exploration-robot"
DESCRIPTION = "Robotics simulation for cave exploration robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cave-exploration-robot</title><style>
...
<div class="header"><h1>robot-cave-exploration-robot</h1><div class="subtitle">Robotics simulation for cave exploration robot · port 50762</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50762</div>

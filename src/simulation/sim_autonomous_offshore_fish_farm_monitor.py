...
PORT = 12668
SERVICE = "sim-autonomous-offshore-fish-farm-monitor"
DESCRIPTION = "Simulation environment for autonomous monitoring of offshore aquaculture fish farms using underwater drones"

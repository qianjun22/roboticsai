...
PORT = 50946
SERVICE = "robot-hotel-service-robot"
DESCRIPTION = "Robotics simulation for hotel service robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-hotel-service-robot</title><style>
...
<div class="header"><h1>robot-hotel-service-robot</h1><div class="subtitle">Robotics simulation for hotel service robot · port 50946</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50946</div>

...
PORT = 13752
SERVICE = "robot_industrial_furnace_inspector"
DESCRIPTION = "Industrial furnace inspector robot simulation — high-temperature refractory inspection, thermal imaging analysis, and predictive maintenance scheduling"

...
<div class="header"><h1>robot_semiconductor_wafer_handler</h1><div class="subtitle">Simulation service for semiconductor wafer handler port 40958</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40958</div>

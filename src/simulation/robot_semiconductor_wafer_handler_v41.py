...
DESCRIPTION = "Simulation service for semiconductor wafer handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_semiconductor_wafer_handler</title><style>
...
<div class="header"><h1>robot_semiconductor_wafer_handler</h1><div class="subtitle">Simulation service for semiconductor wafer handler port 41318</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41318</div>

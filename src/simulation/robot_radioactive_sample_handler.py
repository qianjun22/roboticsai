...
PORT = 13332
SERVICE = "robot_radioactive_sample_handler"
DESCRIPTION = "Robot training for radioactive sample handling with dose rate monitoring and shielded container manipulation"

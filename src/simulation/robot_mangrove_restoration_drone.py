...
PORT = 13788
SERVICE = "robot_mangrove_restoration_drone"
DESCRIPTION = "Robotic mangrove restoration drone service — autonomous seedling deployment and coastal ecosystem rehabilitation monitoring"

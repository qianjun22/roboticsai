...
PORT = 13036
SERVICE = "robot_concrete_facade_inspector"
DESCRIPTION = "Robotic concrete facade inspection system — crack mapping, spalling detection, rebar exposure analysis, and repair priority ranking for buildings"

...
PORT = 50770
SERVICE = "robot-high-shelf-reacher"
DESCRIPTION = "Robotics simulation for high shelf reacher"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-high-shelf-reacher</title><style>
...
<div class="header"><h1>robot-high-shelf-reacher</h1><div class="subtitle">Robotics simulation for high shelf reacher · port 50770</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50770</div>

...
PORT = 30598
SERVICE = "robot_default_mode_network_v5"
DESCRIPTION = "Default mode network simulation microservice for robotics idle state processing and self-referential tasks"

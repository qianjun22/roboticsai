...
PORT = 12928
SERVICE = "robot_shipyard_block_assembly"
DESCRIPTION = "Robotic shipyard hull block assembly — large-panel alignment, multi-robot coordination for heavy lifting, weld seam preparation, and dimensional verification"

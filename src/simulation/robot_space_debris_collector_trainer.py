...
PORT = 12208
SERVICE = "robot-space-debris-collector-trainer"
DESCRIPTION = "Training environment for robotic space debris collection — orbital mechanics integration, grappling arm control, debris stabilization, and deorbit burn coordination"

...
PORT = 15146
SERVICE = "robot-arc-weld"
DESCRIPTION = "Simulation service for arc weld robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-arc-weld</title><style>
...
<div class="header"><h1>robot-arc-weld</h1><div class="sub">Simulation service for arc weld robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15146 | <b>Status:</b> <span style="color:#4ade80">Live</span>

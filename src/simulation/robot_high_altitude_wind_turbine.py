...
PORT = 12996
SERVICE = "robot_high_altitude_wind_turbine"
DESCRIPTION = "High-altitude wind turbine maintenance robot — blade inspection, de-icing operations, and structural health monitoring at extreme heights"

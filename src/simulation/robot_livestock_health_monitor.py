...
DESCRIPTION = "Robotic livestock health monitoring — gait analysis, body condition scoring, estrus detection, and early disease flag alerts for cattle and swine operations"

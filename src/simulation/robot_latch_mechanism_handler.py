...
<div class="header"><h1>robot-latch-mechanism-handler</h1><div class="subtitle">Robotics simulation for latch mechanism handler · port 51470</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51470</div>

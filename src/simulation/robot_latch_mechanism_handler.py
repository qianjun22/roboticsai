...
PORT = 53390
SERVICE = "robot-latch-mechanism-handler"
DESCRIPTION = "Robotics simulation for latch mechanism handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-latch-mechanism-handler</title><style>
...
<div class="header"><h1>robot-latch-mechanism-handler</h1><div class="subtitle">Robotics simulation for latch mechanism handler · port 53390</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53390</div>

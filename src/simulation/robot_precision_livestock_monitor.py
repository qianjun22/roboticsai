...
PORT = 13356
SERVICE = "robot_precision_livestock_monitor"
DESCRIPTION = "Robot training for precision livestock monitoring with individual animal tracking, health scoring, and feeding behavior analysis"

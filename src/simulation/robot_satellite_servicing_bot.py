...
PORT = 51334
SERVICE = "robot-satellite-servicing-bot"
DESCRIPTION = "Robotics simulation for satellite servicing bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-satellite-servicing-bot</title><style>
...
<div class="header"><h1>robot-satellite-servicing-bot</h1><div class="subtitle">Robotics simulation for satellite servicing bot · port 51334</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51334</div>

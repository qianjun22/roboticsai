...
PORT = 11628
SERVICE = "robot-industrial-inspection-trainer"
DESCRIPTION = "Industrial inspection robot trainer for visual defect detection, weld quality assessment, and pipeline integrity checks"

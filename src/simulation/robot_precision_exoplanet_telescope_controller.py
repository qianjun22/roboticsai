...
PORT = 14582
SERVICE = "robot_precision_exoplanet_telescope_controller"
DESCRIPTION = "Precision robotic controller for exoplanet detection telescope alignment and tracking"

"""Environment gravity randomization for robot policy robustness across varying gravitational conditions and mobile platforms
...
try:
    ...
    _has_fastapi = False
PORT = 10880
SERVICE = "sim_gravity_randomizer"
DESCRIPTION = "Environment gravity randomization for robot policy robustness across varying gravitational conditions and mobile platforms"
if _has_fastapi:

...
PORT = 12452
SERVICE = "sim_autonomous_airport_runway_inspection_env"
DESCRIPTION = "Autonomous airport runway inspection robot simulation with FOD detection, surface crack analysis, and real-time reporting"

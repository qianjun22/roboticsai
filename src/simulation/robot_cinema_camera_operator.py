...
PORT = 12856
SERVICE = "robot_cinema_camera_operator"
DESCRIPTION = "Autonomous cinema camera robot — subject tracking, dolly move choreography, focus pulling, and multi-camera coordination for live events"

...
PORT = 15358
SERVICE = "robot-shaft-balance"
DESCRIPTION = "Simulation service for shaft balance robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-shaft-balance</title><style>
...
<div class="header"><h1>robot-shaft-balance</h1><div class="sub">Simulation service for shaft balance robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15358 | <b>Status:</b> <span style="color:#4ade80">Live</span>

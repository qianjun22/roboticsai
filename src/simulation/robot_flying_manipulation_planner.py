...
PORT = 50286
SERVICE = "robot-flying-manipulation-planner"
DESCRIPTION = "Robotics simulation for flying manipulation planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-flying-manipulation-planner</title><style>
...
<div class="header"><h1>robot-flying-manipulation-planner</h1><div class="subtitle">Robotics simulation for flying manipulation planner · port 50286</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50286</div>

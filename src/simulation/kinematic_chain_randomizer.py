"""Kinematic chain parameter randomization including link lengths, joint axis errors, and DH offsets
...
try:
    ...
    _has_fastapi = False
PORT = 11112
SERVICE = "sim_kinematic_chain_randomizer"
DESCRIPTION = "Kinematic chain parameter randomization including link lengths, joint axis errors, and DH offsets"
if _has_fastapi:

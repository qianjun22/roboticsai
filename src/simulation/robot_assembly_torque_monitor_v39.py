...
PORT = 39778
SERVICE = "robot_assembly_torque_monitor"
DESCRIPTION = "Simulation service for assembly torque monitor"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_assembly_torque_monitor</title><style>
...
<div class="header"><h1>robot_assembly_torque_monitor</h1><div class="subtitle">Simulation service for assembly torque monitor port 39778</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39778</div>

"""Robot payload mass and inertia randomization for robust grasping under load uncertainty
...
try:
    ...
    _has_fastapi = False
PORT = 11088
SERVICE = "sim_robot_payload_randomizer"
DESCRIPTION = "Robot payload mass and inertia randomization for robust grasping under load uncertainty"
if _has_fastapi:

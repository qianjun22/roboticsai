...
PORT = 11652
SERVICE = "robot-surgical-assistant-trainer"
DESCRIPTION = "Surgical assistant robot trainer for tissue manipulation, instrument passing, and camera positioning with safety-critical constraints"

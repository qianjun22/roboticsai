...
<div class="header"><h1>robot_slip_detection_service</h1><div class="subtitle">Simulation service for slip detection service port 41750</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41750</div>

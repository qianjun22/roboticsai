...
PORT = 13076
SERVICE = "robot_plastic_bottle_blower"
DESCRIPTION = "Robotic plastic bottle blow molding system — preform temperature control, mold clamping optimization, and wall thickness uniformity monitoring"

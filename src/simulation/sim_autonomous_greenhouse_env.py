...
PORT = 12268
SERVICE = "sim-autonomous-greenhouse-env"
DESCRIPTION = "Simulation environment for autonomous greenhouse management robots — climate control, crop monitoring, irrigation scheduling, and automated harvesting coordination"

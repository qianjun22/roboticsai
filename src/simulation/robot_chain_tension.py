...
PORT = 15346
SERVICE = "robot-chain-tension"
DESCRIPTION = "Simulation service for chain tension robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-chain-tension</title><style>
...
<div class="header"><h1>robot-chain-tension</h1><div class="sub">Simulation service for chain tension robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15346 | <b>Status:</b> <span style="color:#4ade80">Live</span>

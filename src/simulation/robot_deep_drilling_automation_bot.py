...
PORT = 13854
SERVICE = "robot_deep_drilling_automation_bot"
DESCRIPTION = "Autonomous robot for deep drilling automation, borehole monitoring, and subsurface extraction operations"

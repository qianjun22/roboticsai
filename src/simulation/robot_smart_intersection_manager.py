...
PORT = 13560
SERVICE = "robot_smart_intersection_manager"
DESCRIPTION = "Autonomous robot smart intersection manager — real-time traffic flow optimization, pedestrian safety enforcement, incident detection, and adaptive signal control for urban intersections"

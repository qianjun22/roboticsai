...
PORT = 12556
SERVICE = "sim_autonomous_space_debris_removal_env"
DESCRIPTION = "Autonomous space debris removal robot simulation with orbital mechanics, capture mechanism control, and de-orbit trajectory planning"

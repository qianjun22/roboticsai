...
PORT = 12404
SERVICE = "sim_autonomous_parking_lot_management_env"
DESCRIPTION = "Simulation environment for autonomous parking lot management robot space allocation and valet operations"

...
PORT = 39210
SERVICE = "robot_vibration_analyzer"
DESCRIPTION = "Simulation service for vibration analyzer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_vibration_analyzer</title><style>
...
<div class="header"><h1>robot_vibration_analyzer</h1><div class="subtitle">Simulation service for vibration analyzer port 39210</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39210</div>

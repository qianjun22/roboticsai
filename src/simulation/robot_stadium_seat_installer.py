...
PORT = 12912
SERVICE = "robot_stadium_seat_installer"
DESCRIPTION = "Robotic stadium seating installation — row alignment, fastener torque verification, armrest assembly, and ADA clearance compliance checking"

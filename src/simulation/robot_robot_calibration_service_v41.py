...
PORT = 41138
SERVICE = "robot_robot_calibration_service"
DESCRIPTION = "Simulation service for robot calibration service"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_robot_calibration_service</title><style>
...
<div class="header"><h1>robot_robot_calibration_service</h1><div class="subtitle">Simulation service for robot calibration service port 41138</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41138</div>

...
PORT = 52586
SERVICE = "robot-tactile-sensor-sim"
DESCRIPTION = "Robotics simulation for tactile sensor sim"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tactile-sensor-sim</title><style>
...
<div class="header"><h1>robot-tactile-sensor-sim</h1><div class="subtitle">Robotics simulation for tactile sensor sim · port 52586</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52586</div>

...
PORT = 39954
SERVICE = "robot_grasp_planner"
DESCRIPTION = "Simulation service for grasp planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_grasp_planner</title><style>
...
<div class="header"><h1>robot_grasp_planner</h1><div class="subtitle">Simulation service for grasp planner port 39954</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39954</div>

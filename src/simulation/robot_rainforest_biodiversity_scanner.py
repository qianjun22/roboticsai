...
PORT = 13850
SERVICE = "robot_rainforest_biodiversity_scanner"
DESCRIPTION = "Autonomous robot for rainforest biodiversity scanning, species identification, and ecological mapping"

...
PORT = 12428
SERVICE = "sim_autonomous_deep_sea_mining_env"
DESCRIPTION = "Autonomous deep-sea mining robot simulation environment with pressure, sonar, and mineral extraction modeling"

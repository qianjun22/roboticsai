...
PORT = 42294
SERVICE = "robot_paint_spray_controller"
DESCRIPTION = "Simulation service for paint spray controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_paint_spray_controller</title><style>
...
<div class="header"><h1>robot_paint_spray_controller</h1><div class="subtitle">Simulation service for paint spray controller port 42294</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42294</div>

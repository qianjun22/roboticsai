...
PORT = 12128
SERVICE = "robot-quarry-operations-trainer"
DESCRIPTION = "Training environment for robots operating in quarry settings — drilling, blasting coordination, and rock material transport"

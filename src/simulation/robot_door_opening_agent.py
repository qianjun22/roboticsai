...
PORT = 51442
SERVICE = "robot-door-opening-agent"
DESCRIPTION = "Robotics simulation for door opening agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-door-opening-agent</title><style>
...
<div class="header"><h1>robot-door-opening-agent</h1><div class="subtitle">Robotics simulation for door opening agent · port 51442</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51442</div>

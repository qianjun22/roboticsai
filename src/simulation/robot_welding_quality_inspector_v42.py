...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_welding_quality_inspector</title><style>
...
<div class="header"><h1>robot_welding_quality_inspector</h1><div class="subtitle">Simulation service for welding quality inspector port 41810</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41810</div>

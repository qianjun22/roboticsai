...
PORT = 11620
SERVICE = "robot-door-opening-policy-trainer"
DESCRIPTION = "Door opening policy trainer supporting push, pull, lever, and knob door types with generalized contact planning"

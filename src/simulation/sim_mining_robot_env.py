...
PORT = 11660
SERVICE = "sim-mining-robot-env"
DESCRIPTION = "Mining robot simulation with underground navigation, ore detection, drilling tasks, and autonomous haul truck coordination"

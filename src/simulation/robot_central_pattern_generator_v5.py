...
PORT = 30498
SERVICE = "robot_central_pattern_generator_v5"
DESCRIPTION = "Central pattern generator simulation microservice for rhythmic locomotion and gait synthesis robotics"

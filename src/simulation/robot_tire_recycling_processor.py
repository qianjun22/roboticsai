...
PORT = 13008
SERVICE = "robot_tire_recycling_processor"
DESCRIPTION = "Robotic tire recycling processor — shredding sequence optimization, material separation, and throughput maximization for sustainable recycling"

...
PORT = 13684
SERVICE = "robot_high_rise_facade_cleaner"
DESCRIPTION = "High-rise facade cleaning robot simulation — automated vertical surface traversal and cleaning for skyscrapers"

...
PORT = 13700
SERVICE = "robot_tidal_turbine_biofouling_cleaner"
DESCRIPTION = "Tidal turbine biofouling cleaner robot simulation — autonomous underwater removal of marine growth from tidal energy turbine blades"

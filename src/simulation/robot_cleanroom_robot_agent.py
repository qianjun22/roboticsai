...
PORT = 50894
SERVICE = "robot-cleanroom-robot-agent"
DESCRIPTION = "Robotics simulation for cleanroom robot agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cleanroom-robot-agent</title><style>
...
<div class="header"><h1>robot-cleanroom-robot-agent</h1><div class="subtitle">Robotics simulation for cleanroom robot agent · port 50894</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50894</div>

...
PORT = 11796
SERVICE = "robot-precision-spray-trainer"
DESCRIPTION = "Precision spray robot trainer for variable-rate pesticide application, drift minimization, and coverage optimization"

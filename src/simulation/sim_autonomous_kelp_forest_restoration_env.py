...
PORT = 12652
SERVICE = "sim-autonomous-kelp-forest-restoration-env"
DESCRIPTION = "Simulation environment for autonomous kelp forest restoration using underwater planting robots"

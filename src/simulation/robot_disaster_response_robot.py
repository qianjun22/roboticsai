...
PORT = 52162
SERVICE = "robot-disaster-response-robot"
DESCRIPTION = "Robotics simulation for disaster response robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-disaster-response-robot</title><style>
...
<div class="header"><h1>robot-disaster-response-robot</h1><div class="subtitle">Robotics simulation for disaster response robot · port 52162</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52162</div>

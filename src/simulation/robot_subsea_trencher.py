...
PORT = 12816
SERVICE = "robot_subsea_trencher"
DESCRIPTION = "Autonomous subsea cable trenching robot — seabed soil classification, trench depth control, and cable burial verification for offshore installations"

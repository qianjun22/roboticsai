...
PORT = 11712
SERVICE = "sim-ocean-cleanup-robot-env"
DESCRIPTION = "Ocean cleanup robot simulation environment for debris collection, marine navigation, and pollution monitoring"

...
PORT = 53006
SERVICE = "robot-multi-contact-loco-planner"
DESCRIPTION = "Robotics simulation for multi contact loco planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multi-contact-loco-planner</title><style>
...
<div class="header"><h1>robot-multi-contact-loco-planner</h1><div class="subtitle">Robotics simulation for multi contact loco planner · port 53006</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53006</div>

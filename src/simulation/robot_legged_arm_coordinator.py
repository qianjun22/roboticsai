...
PORT = 51054
SERVICE = "robot-legged-arm-coordinator"
DESCRIPTION = "Robotics simulation for legged arm coordinator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-legged-arm-coordinator</title><style>
...
<div class="header"><h1>robot-legged-arm-coordinator</h1><div class="subtitle">Robotics simulation for legged arm coordinator · port 51054</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51054</div>

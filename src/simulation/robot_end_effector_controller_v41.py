...
PORT = 41382
SERVICE = "robot_end_effector_controller"
DESCRIPTION = "Simulation service for end effector controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_end_effector_controller</title><style>
...
<div class="header"><h1>robot_end_effector_controller</h1><div class="subtitle">Simulation service for end effector controller port 41382</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41382</div>

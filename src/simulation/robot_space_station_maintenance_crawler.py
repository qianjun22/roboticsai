...
PORT = 13096
SERVICE = "robot_space_station_maintenance_crawler"
DESCRIPTION = "Robot training for space station external maintenance crawling, inspection, and repair operations"

...
PORT = 13352
SERVICE = "robot_autonomous_road_repair"
DESCRIPTION = "Robot training for autonomous road surface repair with pothole detection, asphalt milling, and paving sequence coordination"

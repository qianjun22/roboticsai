...
PORT = 11824
SERVICE = "robot_autonomous_lawncare_trainer"
DESCRIPTION = "Autonomous lawncare robot trainer for terrain mapping, mowing pattern optimization, and obstacle avoidance"

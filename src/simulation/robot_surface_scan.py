...
PORT = 15302
SERVICE = "robot-surface-scan"
DESCRIPTION = "Simulation service for surface scan robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-surface-scan</title><style>
...
<div class="header"><h1>robot-surface-scan</h1><div class="sub">Simulation service for surface scan robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15302 | <b>Status:</b> <span style="color:#4ade80">Live</span>

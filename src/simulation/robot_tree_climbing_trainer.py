...
PORT = 11740
SERVICE = "robot-tree-climbing-trainer"
DESCRIPTION = "Tree climbing robot trainer for branch navigation, canopy inspection, and aerial work platform positioning"

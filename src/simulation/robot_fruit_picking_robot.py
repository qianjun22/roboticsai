...
PORT = 50814
SERVICE = "robot-fruit-picking-robot"
DESCRIPTION = "Robotics simulation for fruit picking robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fruit-picking-robot</title><style>
...
<div class="header"><h1>robot-fruit-picking-robot</h1><div class="subtitle">Robotics simulation for fruit picking robot · port 50814</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50814</div>

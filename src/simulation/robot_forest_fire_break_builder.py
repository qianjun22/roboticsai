...
PORT = 12892
SERVICE = "robot_forest_fire_break_builder"
DESCRIPTION = "Robotic forest firebreak construction — terrain mapping, tree felling sequence planning, debris clearing, and soil compaction for fire containment lines"

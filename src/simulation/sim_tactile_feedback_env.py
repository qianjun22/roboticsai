...
PORT = 11592
SERVICE = "sim-tactile-feedback-env"
DESCRIPTION = "Tactile feedback simulation environment with fingertip pressure arrays and slip detection for dexterous manipulation"

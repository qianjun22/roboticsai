...
PORT = 12188
SERVICE = "sim-autonomous-mine-mapper-env"
DESCRIPTION = "Simulation environment for autonomous underground mine mapping robots — LiDAR-based 3D mapping, gas detection, structural stability assessment, and navigation"

...
PORT = 52526
SERVICE = "robot-haptic-glove-controller"
DESCRIPTION = "Robotics simulation for haptic glove controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-haptic-glove-controller</title><style>
...
<div class="header"><h1>robot-haptic-glove-controller</h1><div class="subtitle">Robotics simulation for haptic glove controller · port 52526</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52526</div>

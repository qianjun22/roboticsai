...
PORT = 11608
SERVICE = "sim-cloth-manipulation-trainer"
DESCRIPTION = "Cloth manipulation simulation trainer with FEM-based deformable body physics for folding, draping, and textile assembly"

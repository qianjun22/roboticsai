...
PORT = 12536
SERVICE = "robot_precision_injection_molding_trainer"
DESCRIPTION = "Robot precision injection molding trainer with mold clamping force optimization, cycle time reduction, and part ejection defect prevention"

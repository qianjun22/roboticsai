"""Simulation payload inertia and mass distribution domain randomizer for robust robot arm policy training under varying load conditions
...
try:
    ...
    _has_fastapi = False
PORT = 11192
SERVICE = "sim_payload_inertia_randomizer"
DESCRIPTION = "Simulation payload inertia and mass distribution domain randomizer for robust robot arm policy training under varying load conditions"
if _has_fastapi:

...
PORT = 51010
SERVICE = "robot-in-hand-manipulation-solver"
DESCRIPTION = "Robotics simulation for in hand manipulation solver"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-in-hand-manipulation-solver</title><style>
...
<div class="header"><h1>robot-in-hand-manipulation-solver</h1><div class="subtitle">Robotics simulation for in hand manipulation solver · port 51010</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51010</div>

...
PORT = 51754
SERVICE = "robot-wind-turbine-inspector"
DESCRIPTION = "Robotics simulation for wind turbine inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-wind-turbine-inspector</title><style>
...
<div class="header"><h1>robot-wind-turbine-inspector</h1><div class="subtitle">Robotics simulation for wind turbine inspector · port 51754</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51754</div>

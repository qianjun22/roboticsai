...
PORT = 15122
SERVICE = "robot-lathe-turn"
DESCRIPTION = "Simulation service for lathe turn robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-lathe-turn</title><style>
...
<div class="header"><h1>robot-lathe-turn</h1><div class="sub">Simulation service for lathe turn robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15122 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12832
SERVICE = "robot_recycling_material_separator"
DESCRIPTION = "Robotic recycling material separation — multi-stream classification, conveyor sorting actuation, and contamination rejection for MRF automation"

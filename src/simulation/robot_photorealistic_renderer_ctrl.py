...
PORT = 50658
SERVICE = "robot-photorealistic-renderer-ctrl"
DESCRIPTION = "Robotics simulation for photorealistic renderer ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-photorealistic-renderer-ctrl</title><style>
...
<div class="header"><h1>robot-photorealistic-renderer-ctrl</h1><div class="subtitle">Robotics simulation for photorealistic renderer ctrl · port 50658</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50658</div>

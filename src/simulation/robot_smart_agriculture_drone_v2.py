...
PORT = 13572
SERVICE = "robot_smart_agriculture_drone_v2"
DESCRIPTION = "Autonomous robot smart agriculture drone v2 — precision crop monitoring, soil health analysis, targeted pesticide application, yield prediction, and harvest planning for modern farms"

...
PORT = 12984
SERVICE = "robot_explosive_ordnance_disposal"
DESCRIPTION = "Robotic EOD system controller — threat assessment, safe manipulation planning, standoff distance calculation, and disposal sequencing"

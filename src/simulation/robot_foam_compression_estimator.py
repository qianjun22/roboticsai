...
PORT = 51038
SERVICE = "robot-foam-compression-estimator"
DESCRIPTION = "Robotics simulation for foam compression estimator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-foam-compression-estimator</title><style>
...
<div class="header"><h1>robot-foam-compression-estimator</h1><div class="subtitle">Robotics simulation for foam compression estimator · port 51038</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51038</div>

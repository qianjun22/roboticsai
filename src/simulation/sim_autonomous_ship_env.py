...
PORT = 11800
SERVICE = "sim-autonomous-ship-env"
DESCRIPTION = "Autonomous ship simulation environment for port navigation, obstacle avoidance, and cargo handling operations"

...
PORT = 12580
SERVICE = "sim_autonomous_glacier_research_env"
DESCRIPTION = "Autonomous glacier research robot simulation with ice core drilling, crevasse navigation, and climate data collection in extreme cold environments"

...
PORT = 13064
SERVICE = "robot_plant_nursery_automation"
DESCRIPTION = "Robotic plant nursery automation system — seedling transplanting, watering schedule optimization, pest detection, and harvest readiness assessment"

...
PORT = 14998
SERVICE = "robot-door-open"
DESCRIPTION = "Simulation service for door open robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-door-open</title><style>
...
<div class="header"><h1>robot-door-open</h1><div class="sub">Simulation service for door open robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14998 | <b>Status:</b> <span style="color:#4ade80">Live</span>

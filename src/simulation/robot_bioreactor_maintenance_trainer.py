...
PORT = 11804
SERVICE = "robot-bioreactor-maintenance-trainer"
DESCRIPTION = "Bioreactor maintenance robot trainer for sterile environment operation, sample extraction, and sensor calibration"

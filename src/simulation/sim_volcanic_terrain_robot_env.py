...
PORT = 11932
SERVICE = "sim_volcanic_terrain_robot_env"
DESCRIPTION = "Volcanic terrain robot simulation environment for lava flow monitoring, gas emission sensing, and geological sample collection in extreme heat"

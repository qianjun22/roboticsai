...
PORT = 53542
SERVICE = "robot-haptic-simulation-agent"
DESCRIPTION = "Robotics simulation for haptic simulation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-haptic-simulation-agent</title><style>
...
<div class="header"><h1>robot-haptic-simulation-agent</h1><div class="subtitle">Robotics simulation for haptic simulation agent · port 53542</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53542</div>

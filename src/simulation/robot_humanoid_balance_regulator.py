...
PORT = 51050
SERVICE = "robot-humanoid-balance-regulator"
DESCRIPTION = "Robotics simulation for humanoid balance regulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-humanoid-balance-regulator</title><style>
...
<div class="header"><h1>robot-humanoid-balance-regulator</h1><div class="subtitle">Robotics simulation for humanoid balance regulator · port 51050</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51050</div>

...
PORT = 15014
SERVICE = "robot_automated_battery_cell_stacker"
DESCRIPTION = "Automated robotic battery cell stacking system for high-precision lithium-ion battery assembly"

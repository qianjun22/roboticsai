...
PORT = 13316
SERVICE = "robot_landfill_waste_sorter"
DESCRIPTION = "Robot training for landfill waste sorting with material classification and recyclable stream separation"

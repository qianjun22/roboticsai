...
PORT = 12800
SERVICE = "robot_stadium_turf_maintenance"
DESCRIPTION = "Robotic stadium turf maintenance system — mowing pattern optimization, irrigation scheduling, and wear zone recovery for sports venues"

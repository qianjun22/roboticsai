...
PORT = 15254
SERVICE = "robot-hipot-test"
DESCRIPTION = "Simulation service for hipot test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-hipot-test</title><style>
...
<div class="header"><h1>robot-hipot-test</h1><div class="sub">Simulation service for hipot test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15254 | <b>Status:</b> <span style="color:#4ade80">Live</span>

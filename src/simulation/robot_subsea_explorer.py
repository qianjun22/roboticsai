...
PORT = 38462
SERVICE = "robot_subsea_explorer"
DESCRIPTION = "Subsea exploration simulation for deep ocean robotic missions"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_subsea_explorer</title><style>
...
<div class="header"><h1>robot_subsea_explorer</h1><div class="subtitle">Subsea exploration simulation for deep ocean robotic missions · port 38462</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38462</div>

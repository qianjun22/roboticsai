...
PORT = 50922
SERVICE = "robot-last-mile-delivery-bot"
DESCRIPTION = "Robotics simulation for last mile delivery bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-last-mile-delivery-bot</title><style>
...
<div class="header"><h1>robot-last-mile-delivery-bot</h1><div class="subtitle">Robotics simulation for last mile delivery bot · port 50922</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50922</div>

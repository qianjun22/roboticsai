...
PORT = 15246
SERVICE = "robot-salt-spray"
DESCRIPTION = "Simulation service for salt spray robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-salt-spray</title><style>
...
<div class="header"><h1>robot-salt-spray</h1><div class="sub">Simulation service for salt spray robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15246 | <b>Status:</b> <span style="color:#4ade80">Live</span>

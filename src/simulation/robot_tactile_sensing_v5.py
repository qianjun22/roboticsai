...
PORT = 30666
SERVICE = "robot_tactile_sensing_v5"
DESCRIPTION = "Tactile sensing simulation microservice for robotics skin-like pressure detection and texture discrimination"

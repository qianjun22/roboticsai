...
DESCRIPTION = "Simulation service for multi arm coordinator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_multi_arm_coordinator</title><style>
...
<div class="header"><h1>robot_multi_arm_coordinator</h1><div class="subtitle">Simulation service for multi arm coordinator port 39742</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39742</div>

...
PORT = 13084
SERVICE = "robot_fish_farm_feeder"
DESCRIPTION = "Robotic fish farm feeding system — biomass estimation, feed distribution optimization, water quality monitoring, and harvest timing prediction"

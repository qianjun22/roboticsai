...
PORT = 14994
SERVICE = "robot-bin-pack"
DESCRIPTION = "Simulation service for bin pack robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-bin-pack</title><style>
...
<div class="header"><h1>robot-bin-pack</h1><div class="sub">Simulation service for bin pack robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14994 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 13216
SERVICE = "robot_thermal_power_plant_inspector"
DESCRIPTION = "Robot training for thermal power plant inspection with turbine scanning and boiler tube assessment"

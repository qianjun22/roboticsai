...
PORT = 52250
SERVICE = "robot-marine-specimen-collector"
DESCRIPTION = "Robotics simulation for marine specimen collector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-marine-specimen-collector</title><style>
...
<div class="header"><h1>robot-marine-specimen-collector</h1><div class="subtitle">Robotics simulation for marine specimen collector · port 52250</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52250</div>

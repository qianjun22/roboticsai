...
PORT = 12976
SERVICE = "robot_satellite_assembly_arm"
DESCRIPTION = "Robotic satellite assembly arm controller — precision component mating, torque-controlled fastening, and zero-gravity manipulation planning"

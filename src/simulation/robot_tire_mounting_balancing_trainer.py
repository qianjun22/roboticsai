...
PORT = 12504
SERVICE = "robot_tire_mounting_balancing_trainer"
DESCRIPTION = "Robot tire mounting and balancing trainer with torque sequencing, wheel alignment verification, and TPMS sensor installation simulation"

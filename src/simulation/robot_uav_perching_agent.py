...
PORT = 52218
SERVICE = "robot-uav-perching-agent"
DESCRIPTION = "Robotics simulation for uav perching agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-uav-perching-agent</title><style>
...
<div class="header"><h1>robot-uav-perching-agent</h1><div class="subtitle">Robotics simulation for uav perching agent · port 52218</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52218</div>

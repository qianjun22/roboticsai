...
PORT = 11656
SERVICE = "sim-retail-robot-env"
DESCRIPTION = "Retail robot simulation environment with shelf scanning, restocking, customer assistance, and checkout automation tasks"

...
PORT = 12604
SERVICE = "sim-autonomous-tidal-energy-maintenance-env"
DESCRIPTION = "Simulation environment for autonomous maintenance of tidal energy turbines and underwater infrastructure"

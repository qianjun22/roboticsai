...
PORT = 13564
SERVICE = "robot_building_energy_optimizer"
DESCRIPTION = "Autonomous robot building energy optimizer — HVAC control, lighting automation, occupancy-based energy management, and carbon footprint reduction for commercial buildings"

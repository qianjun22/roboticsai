...
PORT = 53430
SERVICE = "robot-continuum-robot-planner"
DESCRIPTION = "Robotics simulation for continuum robot planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-continuum-robot-planner</title><style>
...
<div class="header"><h1>robot-continuum-robot-planner</h1><div class="subtitle">Robotics simulation for continuum robot planner · port 53430</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53430</div>

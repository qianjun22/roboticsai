"""Depth sensor noise and missing data randomization for robust visual policy training
...
try:
    ...
    _has_fastapi = False
PORT = 11072
SERVICE = "sim_depth_sensor_noise_randomizer"
DESCRIPTION = "Depth sensor noise and missing data randomization for robust visual policy training"
if _has_fastapi:

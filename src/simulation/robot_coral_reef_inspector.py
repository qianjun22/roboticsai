...
PORT = 50346
SERVICE = "robot-coral-reef-inspector"
DESCRIPTION = "Robotics simulation for coral reef inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-coral-reef-inspector</title><style>
...
<div class="header"><h1>robot-coral-reef-inspector</h1><div class="subtitle">Robotics simulation for coral reef inspector · port 50346</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50346</div>

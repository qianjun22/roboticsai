...
PORT = 12940
SERVICE = "robot_automated_inspection_drone"
DESCRIPTION = "Autonomous drone inspection planner for industrial facilities — flight path optimization, defect detection, and report generation"

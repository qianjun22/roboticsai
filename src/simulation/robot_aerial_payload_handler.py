...
<div class="header"><h1>robot-aerial-payload-handler</h1><div class="subtitle">Robotics simulation for aerial payload handler · port 52198</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52198</div>

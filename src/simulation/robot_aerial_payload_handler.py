...
PORT = 51238
SERVICE = "robot-aerial-payload-handler"
DESCRIPTION = "Robotics simulation for aerial payload handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aerial-payload-handler</title><style>
...
<div class="header"><h1>robot-aerial-payload-handler</h1><div class="subtitle">Robotics simulation for aerial payload handler · port 51238</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51238</div>

...
PORT = 12564
SERVICE = "sim_autonomous_hurricane_infrastructure_assessment_env"
DESCRIPTION = "Autonomous hurricane infrastructure assessment drone simulation with damage classification, flood mapping, and repair priority ranking"

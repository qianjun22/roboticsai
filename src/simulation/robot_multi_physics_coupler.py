...
PORT = 51654
SERVICE = "robot-multi-physics-coupler"
DESCRIPTION = "Robotics simulation for multi physics coupler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multi-physics-coupler</title><style>
...
<div class="header"><h1>robot-multi-physics-coupler</h1><div class="subtitle">Robotics simulation for multi physics coupler · port 51654</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51654</div>

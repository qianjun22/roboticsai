...
PORT = 11576
SERVICE = "sim-legged-robot-terrain-env"
DESCRIPTION = "Legged robot terrain traversal simulation with procedural terrain generation, slope variation, and step/gap obstacles"

...
PORT = 12876
SERVICE = "robot_smart_grid_cable_connector"
DESCRIPTION = "Robotic smart grid cable connection system — high-voltage connector alignment, torque verification, and live grid safe-work coordination"

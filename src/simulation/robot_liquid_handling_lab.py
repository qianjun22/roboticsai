...
PORT = 12960
SERVICE = "robot_liquid_handling_lab"
DESCRIPTION = "Robotic liquid handling system for laboratory automation — pipetting accuracy, sample tracking, contamination prevention, and protocol execution"

...
PORT = 12216
SERVICE = "robot-pharmaceutical-packaging-trainer"
DESCRIPTION = "Training environment for robotic pharmaceutical packaging — blister pack assembly, serialization, tamper-evident sealing, and GMP compliance verification"

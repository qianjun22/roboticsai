"""Policy Simulation Sandbox — FastAPI port 9000"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Policy Simulation Sandbox</title>
...
<body><h1>Policy Simulation Sandbox</h1>
<div class="card"><h2>Sandbox Episodes</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="Policy Simulation Sandbox")

...
PORT = 13548
SERVICE = "robot_power_line_inspector_v2"
DESCRIPTION = "Autonomous robot power line inspection v2 — AI-driven fault detection, thermal imaging, and predictive maintenance for electrical grid infrastructure"

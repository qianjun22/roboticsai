...
PORT = 53490
SERVICE = "robot-teleoperation-proxy-agent"
DESCRIPTION = "Robotics simulation for teleoperation proxy agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-teleoperation-proxy-agent</title><style>
...
<div class="header"><h1>robot-teleoperation-proxy-agent</h1><div class="subtitle">Robotics simulation for teleoperation proxy agent · port 53490</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53490</div>

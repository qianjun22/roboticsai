...
PORT = 13862
SERVICE = "robot_precision_aquaculture_monitor"
DESCRIPTION = "Autonomous underwater robot for precision aquaculture monitoring, fish health tracking, and water quality management"

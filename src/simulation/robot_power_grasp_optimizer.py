...
PORT = 50170
SERVICE = "robot-power-grasp-optimizer"
DESCRIPTION = "Robotics simulation for power grasp optimizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-power-grasp-optimizer</title><style>
...
<div class="header"><h1>robot-power-grasp-optimizer</h1><div class="subtitle">Robotics simulation for power grasp optimizer · port 50170</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50170</div>

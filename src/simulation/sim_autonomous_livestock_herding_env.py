...
PORT = 12164
SERVICE = "sim-autonomous-livestock-herding-env"
DESCRIPTION = "Simulation environment for autonomous livestock herding robots — animal behavior modeling, low-stress mustering, gate operation, and paddock management"

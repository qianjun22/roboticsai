...
PORT = 12516
SERVICE = "sim_autonomous_arctic_research_station_env"
DESCRIPTION = "Autonomous arctic research station robot simulation with extreme cold handling, equipment maintenance under polar conditions, and supply management"

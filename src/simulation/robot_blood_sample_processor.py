...
PORT = 13032
SERVICE = "robot_blood_sample_processor"
DESCRIPTION = "Robotic blood sample processor — tube handling, centrifuge loading, aliquoting, barcode tracking, and lab automation integration"

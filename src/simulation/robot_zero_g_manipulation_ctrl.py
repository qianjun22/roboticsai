...
PORT = 53274
SERVICE = "robot-zero-g-manipulation-ctrl"
DESCRIPTION = "Robotics simulation for zero g manipulation ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-zero-g-manipulation-ctrl</title><style>
...
<div class="header"><h1>robot-zero-g-manipulation-ctrl</h1><div class="subtitle">Robotics simulation for zero g manipulation ctrl · port 53274</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53274</div>

...
PORT = 50222
SERVICE = "robot-robotic-biopsy-agent"
DESCRIPTION = "Robotics simulation for robotic biopsy agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-robotic-biopsy-agent</title><style>
...
<div class="header"><h1>robot-robotic-biopsy-agent</h1><div class="subtitle">Robotics simulation for robotic biopsy agent · port 50222</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50222</div>

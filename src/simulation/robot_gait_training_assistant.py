...
PORT = 50598
SERVICE = "robot-gait-training-assistant"
DESCRIPTION = "Robotics simulation for gait training assistant"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gait-training-assistant</title><style>
...
<div class="header"><h1>robot-gait-training-assistant</h1><div class="subtitle">Robotics simulation for gait training assistant · port 50598</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50598</div>

...
PORT = 12204
SERVICE = "sim-autonomous-polar-research-env"
DESCRIPTION = "Simulation environment for autonomous polar research robots — ice core sampling, weather station maintenance, crevasse detection, and long-range traverse planning"

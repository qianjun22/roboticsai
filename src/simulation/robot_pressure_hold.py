...
PORT = 15270
SERVICE = "robot-pressure-hold"
DESCRIPTION = "Simulation service for pressure hold robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pressure-hold</title><style>
...
<div class="header"><h1>robot-pressure-hold</h1><div class="sub">Simulation service for pressure hold robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15270 | <b>Status:</b> <span style="color:#4ade80">Live</span>

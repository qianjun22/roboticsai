...
PORT = 53454
SERVICE = "robot-parallel-kinematic-machine"
DESCRIPTION = "Robotics simulation for parallel kinematic machine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-parallel-kinematic-machine</title><style>
...
<div class="header"><h1>robot-parallel-kinematic-machine</h1><div class="subtitle">Robotics simulation for parallel kinematic machine · port 53454</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53454</div>

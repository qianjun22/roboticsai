...
PORT = 15338
SERVICE = "robot-bearing-life"
DESCRIPTION = "Simulation service for bearing life robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-bearing-life</title><style>
...
<div class="header"><h1>robot-bearing-life</h1><div class="sub">Simulation service for bearing life robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15338 | <b>Status:</b> <span style="color:#4ade80">Live</span>

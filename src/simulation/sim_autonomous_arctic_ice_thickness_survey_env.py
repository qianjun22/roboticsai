...
PORT = 12732
SERVICE = "sim-autonomous-arctic-ice-thickness-survey-env"
DESCRIPTION = "Simulation environment for autonomous arctic sea ice thickness survey using under-ice AUV robots"

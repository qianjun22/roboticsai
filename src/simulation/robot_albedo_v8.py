...
PORT = 40866
SERVICE = "robot-albedo-v8"
DESCRIPTION = "Surface albedo-adaptive robot simulation for terrain classification and reflectance-aware navigation in varied environments"

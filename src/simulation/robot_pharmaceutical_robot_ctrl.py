...
PORT = 50898
SERVICE = "robot-pharmaceutical-robot-ctrl"
DESCRIPTION = "Robotics simulation for pharmaceutical robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pharmaceutical-robot-ctrl</title><style>
...
<div class="header"><h1>robot-pharmaceutical-robot-ctrl</h1><div class="subtitle">Robotics simulation for pharmaceutical robot ctrl · port 50898</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50898</div>

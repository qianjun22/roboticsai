...
PORT = 12232
SERVICE = "robot-ship-hull-cleaning-trainer"
DESCRIPTION = "Training environment for robotic ship hull cleaning — underwater adhesion, barnacle removal, hull coating inspection, and corrosion mapping while minimizing dry-dock time"

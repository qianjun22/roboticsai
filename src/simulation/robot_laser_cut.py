...
PORT = 15150
SERVICE = "robot-laser-cut"
DESCRIPTION = "Simulation service for laser cut robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-laser-cut</title><style>
...
<div class="header"><h1>robot-laser-cut</h1><div class="sub">Simulation service for laser cut robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15150 | <b>Status:</b> <span style="color:#4ade80">Live</span>

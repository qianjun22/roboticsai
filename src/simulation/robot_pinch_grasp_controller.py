...
PORT = 50174
SERVICE = "robot-pinch-grasp-controller"
DESCRIPTION = "Robotics simulation for pinch grasp controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pinch-grasp-controller</title><style>
...
<div class="header"><h1>robot-pinch-grasp-controller</h1><div class="subtitle">Robotics simulation for pinch grasp controller · port 50174</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50174</div>

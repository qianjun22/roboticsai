...
PORT = 12836
SERVICE = "robot_dairy_milking_station"
DESCRIPTION = "Autonomous dairy milking robot — teat detection, attachment sequencing, milk flow monitoring, and udder health anomaly detection"

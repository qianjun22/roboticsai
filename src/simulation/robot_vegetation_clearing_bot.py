...
PORT = 53110
SERVICE = "robot-vegetation-clearing-bot"
DESCRIPTION = "Robotics simulation for vegetation clearing bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vegetation-clearing-bot</title><style>
...
<div class="header"><h1>robot-vegetation-clearing-bot</h1><div class="subtitle">Robotics simulation for vegetation clearing bot · port 53110</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53110</div>

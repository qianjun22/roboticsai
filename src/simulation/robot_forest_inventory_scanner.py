...
PORT = 13368
SERVICE = "robot_forest_inventory_scanner"
DESCRIPTION = "Robot training for forest inventory scanning with tree species classification, diameter measurement, and biomass estimation"

...
PORT = 51314
SERVICE = "robot-underwater-mapping-agent"
DESCRIPTION = "Robotics simulation for underwater mapping agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-underwater-mapping-agent</title><style>
...
<div class="header"><h1>robot-underwater-mapping-agent</h1><div class="subtitle">Robotics simulation for underwater mapping agent · port 51314</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51314</div>

"""Joint friction and viscous damping randomization for realistic actuator dynamics simulation
...
DESCRIPTION = "Joint friction and viscous damping randomization for realistic actuator dynamics simulation"
if _has_fastapi:

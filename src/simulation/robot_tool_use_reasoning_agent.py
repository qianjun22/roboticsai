...
PORT = 51006
SERVICE = "robot-tool-use-reasoning-agent"
DESCRIPTION = "Robotics simulation for tool use reasoning agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tool-use-reasoning-agent</title><style>
...
<div class="header"><h1>robot-tool-use-reasoning-agent</h1><div class="subtitle">Robotics simulation for tool use reasoning agent · port 51006</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51006</div>

"""Sim Scenario Diversity Scorer — measures and maximizes eval suite diversity with gap analysis.
...
PORT = 10676
SERVICE = "sim_scenario_diversity_scorer"
DESCRIPTION = "Measures and maximizes eval suite diversity with coverage gap analysis"

...
PORT = 52050
SERVICE = "robot-dexterous-hand-controller"
DESCRIPTION = "Robotics simulation for dexterous hand controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-dexterous-hand-controller</title><style>
...
<div class="header"><h1>robot-dexterous-hand-controller</h1><div class="subtitle">Robotics simulation for dexterous hand controller · port 52050</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52050</div>

...
PORT = 53174
SERVICE = "robot-aerial-contact-controller"
DESCRIPTION = "Robotics simulation for aerial contact controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aerial-contact-controller</title><style>
...
<div class="header"><h1>robot-aerial-contact-controller</h1><div class="subtitle">Robotics simulation for aerial contact controller · port 53174</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53174</div>

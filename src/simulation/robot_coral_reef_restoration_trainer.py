...
PORT = 11732
SERVICE = "robot-coral-reef-restoration-trainer"
DESCRIPTION = "Coral reef restoration robot trainer for fragment placement, health monitoring, and underwater terrain mapping"

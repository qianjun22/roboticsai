...
PORT = 50842
SERVICE = "robot-forestry-robot-ctrl"
DESCRIPTION = "Robotics simulation for forestry robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-forestry-robot-ctrl</title><style>
...
<div class="header"><h1>robot-forestry-robot-ctrl</h1><div class="subtitle">Robotics simulation for forestry robot ctrl · port 50842</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50842</div>

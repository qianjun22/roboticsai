...
PORT = 51298
SERVICE = "robot-underwater-welding-agent"
DESCRIPTION = "Robotics simulation for underwater welding agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-underwater-welding-agent</title><style>
...
<div class="header"><h1>robot-underwater-welding-agent</h1><div class="subtitle">Robotics simulation for underwater welding agent · port 51298</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51298</div>

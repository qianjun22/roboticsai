...
PORT = 13728
SERVICE = "robot_wildfire_perimeter_mapping_drone"
DESCRIPTION = "Wildfire perimeter mapping drone simulation — real-time autonomous aerial fire boundary detection and dynamic containment line prediction"

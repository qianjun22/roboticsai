...
PORT = 11880
SERVICE = "sim_autonomous_delivery_drone_env"
DESCRIPTION = "Autonomous delivery drone simulation environment for urban airspace navigation, payload management, and precision landing at delivery points"

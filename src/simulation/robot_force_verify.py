...
PORT = 15326
SERVICE = "robot-force-verify"
DESCRIPTION = "Simulation service for force verify robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-force-verify</title><style>
...
<div class="header"><h1>robot-force-verify</h1><div class="sub">Simulation service for force verify robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15326 | <b>Status:</b> <span style="color:#4ade80">Live</span>

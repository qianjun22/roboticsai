...
<div class="header"><h1>robot_end_effector_controller</h1><div class="subtitle">Simulation service for end effector controller port 40662</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40662</div>

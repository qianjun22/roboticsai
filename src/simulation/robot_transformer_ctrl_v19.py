...
PORT = 46838
SERVICE = "robot_transformer_ctrl_v19"
DESCRIPTION = "Transformer-based controller for sequential robot decision making"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_transformer_ctrl_v19</title><style>
...
<div class="header"><h1>robot_transformer_ctrl_v19</h1><div class="subtitle">Transformer-based controller for sequential robot decision making · port 46838</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46838</div>

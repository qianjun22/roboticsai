...
PORT = 13660
SERVICE = "robot_smart_greenhouse_climate_controller"
DESCRIPTION = "Robotic smart greenhouse climate controller — automated temperature, humidity, and ventilation management for precision agriculture"

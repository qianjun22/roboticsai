...
PORT = 13544
SERVICE = "robot_oil_pipeline_inspector_v2"
DESCRIPTION = "Oil pipeline inspection robot v2 — autonomous pipeline crawling with leak detection, corrosion analysis, and blockage identification for energy infrastructure maintenance"

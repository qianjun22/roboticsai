...
PORT = 52066
SERVICE = "robot-multi-modal-grasp-planner"
DESCRIPTION = "Robotics simulation for multi modal grasp planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multi-modal-grasp-planner</title><style>
...
<div class="header"><h1>robot-multi-modal-grasp-planner</h1><div class="subtitle">Robotics simulation for multi modal grasp planner · port 52066</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52066</div>

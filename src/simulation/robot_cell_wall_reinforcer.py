...
PORT = 16806
SERVICE = "robot_cell_wall_reinforcer"
DESCRIPTION = "Robotic cell wall reinforcer for plant cell engineering with targeted cellulose synthase complex manipulation"

...
DESCRIPTION = "Dam structural inspection robot simulation — autonomous crack detection, concrete analysis, and safety assessment for hydroelectric dam infrastructure"

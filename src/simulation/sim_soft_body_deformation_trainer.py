...
PORT = 11480
SERVICE = "sim_soft_body_deformation_trainer"
DESCRIPTION = "Trains policies on soft-body deformation tasks using FEM-based simulation for fabric and food handling"

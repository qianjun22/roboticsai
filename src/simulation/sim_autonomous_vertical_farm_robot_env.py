...
PORT = 12364
SERVICE = "sim_autonomous_vertical_farm_robot_env"
DESCRIPTION = "Simulation environment for autonomous vertical farm robot crop harvesting and nutrient management"

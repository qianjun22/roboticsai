...
PORT = 13024
SERVICE = "robot_waterway_debris_remover"
DESCRIPTION = "Robotic waterway debris removal system — surface scanning, debris classification, collection arm control, and disposal routing for clean waterways"

...
PORT = 40858
SERVICE = "robot-eccentricity-v8"
DESCRIPTION = "Orbital eccentricity-modeled robot simulation for variable solar flux environments and eccentric orbit proximity ops"

...
PORT = 50950
SERVICE = "robot-hospital-delivery-agent"
DESCRIPTION = "Robotics simulation for hospital delivery agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-hospital-delivery-agent</title><style>
...
<div class="header"><h1>robot-hospital-delivery-agent</h1><div class="subtitle">Robotics simulation for hospital delivery agent · port 50950</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50950</div>

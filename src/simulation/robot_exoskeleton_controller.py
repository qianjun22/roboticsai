...
PORT = 51546
SERVICE = "robot-exoskeleton-controller"
DESCRIPTION = "Robotics simulation for exoskeleton controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-exoskeleton-controller</title><style>
...
<div class="header"><h1>robot-exoskeleton-controller</h1><div class="subtitle">Robotics simulation for exoskeleton controller · port 51546</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51546</div>

...
PORT = 15242
SERVICE = "robot-humidity-test"
DESCRIPTION = "Simulation service for humidity test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-humidity-test</title><style>
...
<div class="header"><h1>robot-humidity-test</h1><div class="sub">Simulation service for humidity test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15242 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50914
SERVICE = "robot-pallet-stacking-agent"
DESCRIPTION = "Robotics simulation for pallet stacking agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pallet-stacking-agent</title><style>
...
<div class="header"><h1>robot-pallet-stacking-agent</h1><div class="subtitle">Robotics simulation for pallet stacking agent · port 50914</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50914</div>

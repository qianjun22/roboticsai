...
PORT = 50774
SERVICE = "robot-confined-space-inspector"
DESCRIPTION = "Robotics simulation for confined space inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-confined-space-inspector</title><style>
...
<div class="header"><h1>robot-confined-space-inspector</h1><div class="subtitle">Robotics simulation for confined space inspector · port 50774</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50774</div>

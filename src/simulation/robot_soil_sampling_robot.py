...
PORT = 52174
SERVICE = "robot-soil-sampling-robot"
DESCRIPTION = "Robotics simulation for soil sampling robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-soil-sampling-robot</title><style>
...
<div class="header"><h1>robot-soil-sampling-robot</h1><div class="subtitle">Robotics simulation for soil sampling robot · port 52174</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52174</div>

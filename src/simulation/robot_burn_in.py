...
PORT = 15250
SERVICE = "robot-burn-in"
DESCRIPTION = "Simulation service for burn in robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-burn-in</title><style>
...
<div class="header"><h1>robot-burn-in</h1><div class="sub">Simulation service for burn in robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15250 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50846
SERVICE = "robot-mining-extraction-agent"
DESCRIPTION = "Robotics simulation for mining extraction agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mining-extraction-agent</title><style>
...
<div class="header"><h1>robot-mining-extraction-agent</h1><div class="subtitle">Robotics simulation for mining extraction agent · port 50846</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50846</div>

...
PORT = 13292
SERVICE = "robot_electric_vehicle_battery_swapper"
DESCRIPTION = "Robot training for electric vehicle battery swapping with pack alignment, locking mechanism, and charge state verification"

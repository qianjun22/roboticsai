...
PORT = 12788
SERVICE = "robot_museum_artifact_handler"
DESCRIPTION = "Precision robotic museum artifact handling — fragile object grasping, climate-controlled transport, and provenance-safe movement logging"

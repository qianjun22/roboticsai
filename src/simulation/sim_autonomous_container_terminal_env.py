...
PORT = 12156
SERVICE = "sim-autonomous-container-terminal-env"
DESCRIPTION = "Simulation environment for autonomous container terminal operations — crane coordination, AGV routing, vessel scheduling, and yard optimization"

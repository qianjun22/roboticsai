...
PORT = 12896
SERVICE = "robot_greenhouse_pollinator"
DESCRIPTION = "Robotic greenhouse pollination system — flower detection, vibration frequency matching, pollen transfer efficiency tracking, and crop yield correlation"

...
PORT = 15266
SERVICE = "robot-flow-check"
DESCRIPTION = "Simulation service for flow check robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-flow-check</title><style>
...
<div class="header"><h1>robot-flow-check</h1><div class="sub">Simulation service for flow check robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15266 | <b>Status:</b> <span style="color:#4ade80">Live</span>

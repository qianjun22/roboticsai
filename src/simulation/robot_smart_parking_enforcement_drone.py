...
PORT = 13886
SERVICE = "robot_smart_parking_enforcement_drone"
DESCRIPTION = "Autonomous drone robot for smart parking enforcement, violation detection, and urban mobility management"

...
PORT = 13048
SERVICE = "robot_poultry_processing_line"
DESCRIPTION = "Robotic poultry processing line controller — carcass orientation, cut sequencing, yield optimization, and hygiene compliance monitoring"

...
PORT = 15142
SERVICE = "robot-spot-weld"
DESCRIPTION = "Simulation service for spot weld robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-spot-weld</title><style>
...
<div class="header"><h1>robot-spot-weld</h1><div class="sub">Simulation service for spot weld robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15142 | <b>Status:</b> <span style="color:#4ade80">Live</span>

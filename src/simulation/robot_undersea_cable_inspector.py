...
PORT = 13640
SERVICE = "robot_undersea_cable_inspector"
DESCRIPTION = "Autonomous undersea cable inspection robot — navigates deep-ocean routes to visually inspect fiber optic and power cable integrity, detecting breaks, abrasion damage, and marine fouling for repair prioritization"

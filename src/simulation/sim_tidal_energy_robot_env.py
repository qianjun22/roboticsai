...
PORT = 11760
SERVICE = "sim-tidal-energy-robot-env"
DESCRIPTION = "Tidal energy plant robot simulation for turbine inspection, marine growth removal, and underwater maintenance"

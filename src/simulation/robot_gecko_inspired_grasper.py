...
PORT = 50530
SERVICE = "robot-gecko-inspired-grasper"
DESCRIPTION = "Robotics simulation for gecko inspired grasper"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gecko-inspired-grasper</title><style>
...
<div class="header"><h1>robot-gecko-inspired-grasper</h1><div class="subtitle">Robotics simulation for gecko inspired grasper · port 50530</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50530</div>

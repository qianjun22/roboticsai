...
PORT = 50786
SERVICE = "robot-cable-inspection-bot"
DESCRIPTION = "Robotics simulation for cable inspection bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cable-inspection-bot</title><style>
...
<div class="header"><h1>robot-cable-inspection-bot</h1><div class="subtitle">Robotics simulation for cable inspection bot · port 50786</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50786</div>

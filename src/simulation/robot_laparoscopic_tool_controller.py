...
PORT = 53062
SERVICE = "robot-laparoscopic-tool-controller"
DESCRIPTION = "Robotics simulation for laparoscopic tool controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-laparoscopic-tool-controller</title><style>
...
<div class="header"><h1>robot-laparoscopic-tool-controller</h1><div class="subtitle">Robotics simulation for laparoscopic tool controller · port 53062</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53062</div>

...
PORT = 13012
SERVICE = "robot_aircraft_fueling_system"
DESCRIPTION = "Robotic aircraft fueling system — precise nozzle docking, fuel quantity management, safety interlock verification, and turnaround time optimization"

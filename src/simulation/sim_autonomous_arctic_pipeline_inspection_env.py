...
PORT = 12628
SERVICE = "sim-autonomous-arctic-pipeline-inspection-env"
DESCRIPTION = "Simulation environment for autonomous inspection of arctic oil and gas pipelines in extreme cold conditions"

...
PORT = 16726
SERVICE = "robot_ammonia_cracker_v2"
DESCRIPTION = "Robotic ammonia cracker for hydrogen production via catalytic decomposition with automated safety controls"

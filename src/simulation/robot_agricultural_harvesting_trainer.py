...
PORT = 11636
SERVICE = "robot-agricultural-harvesting-trainer"
DESCRIPTION = "Agricultural harvesting robot trainer with crop detection, selective picking policies, and yield optimization strategies"

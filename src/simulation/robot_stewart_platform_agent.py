...
PORT = 50582
SERVICE = "robot-stewart-platform-agent"
DESCRIPTION = "Robotics simulation for stewart platform agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-stewart-platform-agent</title><style>
...
<div class="header"><h1>robot-stewart-platform-agent</h1><div class="subtitle">Robotics simulation for stewart platform agent · port 50582</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50582</div>

...
PORT = 13312
SERVICE = "robot_coral_transplant_arm"
DESCRIPTION = "Robot training for coral reef restoration with fragment handling, substrate placement, and transplant survival monitoring"

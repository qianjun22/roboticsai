...
PORT = 12172
SERVICE = "sim-autonomous-avalanche-rescue-env"
DESCRIPTION = "Simulation environment for autonomous avalanche rescue robots — victim localization, snow excavation coordination, thermal imaging, and survivor extraction"

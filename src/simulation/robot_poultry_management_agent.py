...
PORT = 50834
SERVICE = "robot-poultry-management-agent"
DESCRIPTION = "Robotics simulation for poultry management agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-poultry-management-agent</title><style>
...
<div class="header"><h1>robot-poultry-management-agent</h1><div class="subtitle">Robotics simulation for poultry management agent · port 50834</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50834</div>

...
PORT = 13124
SERVICE = "robot_surgical_suturing_assistant"
DESCRIPTION = "Robot training for surgical suturing assistance with needle path planning and tissue tension control"

...
PORT = 12388
SERVICE = "sim_autonomous_cruise_ship_maintenance_env"
DESCRIPTION = "Simulation environment for autonomous cruise ship maintenance robot hull inspection and deck servicing"

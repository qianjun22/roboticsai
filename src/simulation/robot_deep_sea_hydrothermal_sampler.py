...
PORT = 12916
SERVICE = "robot_deep_sea_hydrothermal_sampler"
DESCRIPTION = "Deep-sea robotic hydrothermal vent sampler — extreme pressure tolerance, fluid collection sequencing, and biological specimen preservation protocols"

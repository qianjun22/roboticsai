...
PORT = 53002
SERVICE = "robot-whole-body-compliance-ctrl"
DESCRIPTION = "Robotics simulation for whole body compliance ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-whole-body-compliance-ctrl</title><style>
...
<div class="header"><h1>robot-whole-body-compliance-ctrl</h1><div class="subtitle">Robotics simulation for whole body compliance ctrl · port 53002</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53002</div>

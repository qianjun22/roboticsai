...
PORT = 16802
SERVICE = "robot_dna_origami_assembler_v2"
DESCRIPTION = "Robotic DNA origami assembler for nanoscale structural engineering with atomic force microscopy verification"

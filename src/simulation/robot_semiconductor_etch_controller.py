...
PORT = 12968
SERVICE = "robot_semiconductor_etch_controller"
DESCRIPTION = "Robotic semiconductor etch process controller — plasma etch parameter tuning, uniformity monitoring, and endpoint detection for wafer fabrication"

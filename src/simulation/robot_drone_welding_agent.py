...
PORT = 51266
SERVICE = "robot-drone-welding-agent"
DESCRIPTION = "Robotics simulation for drone welding agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-drone-welding-agent</title><style>
...
<div class="header"><h1>robot-drone-welding-agent</h1><div class="subtitle">Robotics simulation for drone welding agent · port 51266</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51266</div>

...
PORT = 12496
SERVICE = "robot_aerospace_composite_layup_trainer"
DESCRIPTION = "Robot aerospace composite layup trainer with carbon fiber placement precision, autoclave cycle optimization, and defect detection simulation"

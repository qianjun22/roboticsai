...
PORT = 51022
SERVICE = "robot-liquid-pouring-controller"
DESCRIPTION = "Robotics simulation for liquid pouring controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-liquid-pouring-controller</title><style>
...
<div class="header"><h1>robot-liquid-pouring-controller</h1><div class="subtitle">Robotics simulation for liquid pouring controller · port 51022</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51022</div>

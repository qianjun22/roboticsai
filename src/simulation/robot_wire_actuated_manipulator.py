...
PORT = 50566
SERVICE = "robot-wire-actuated-manipulator"
DESCRIPTION = "Robotics simulation for wire actuated manipulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-wire-actuated-manipulator</title><style>
...
<div class="header"><h1>robot-wire-actuated-manipulator</h1><div class="subtitle">Robotics simulation for wire actuated manipulator · port 50566</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50566</div>

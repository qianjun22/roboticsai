...
PORT = 12716
SERVICE = "sim-autonomous-seabed-cable-burial-env"
DESCRIPTION = "Simulation environment for autonomous seabed cable burial robots — subsea power and communications infrastructure"

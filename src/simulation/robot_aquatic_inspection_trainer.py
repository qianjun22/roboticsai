...
PORT = 11848
SERVICE = "robot_aquatic_inspection_trainer"
DESCRIPTION = "Aquatic inspection robot trainer for underwater hull inspection, pipeline monitoring, and marine structure assessment"

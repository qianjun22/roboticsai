...
PORT = 13540
SERVICE = "robot_mine_detection_rover"
DESCRIPTION = "Mine detection rover robot simulation — autonomous landmine and IED detection using ground-penetrating radar and multi-spectral sensing in demining operations"

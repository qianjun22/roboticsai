...
PORT = 15342
SERVICE = "robot-gear-mesh"
DESCRIPTION = "Simulation service for gear mesh robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gear-mesh</title><style>
...
<div class="header"><h1>robot-gear-mesh</h1><div class="sub">Simulation service for gear mesh robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15342 | <b>Status:</b> <span style="color:#4ade80">Live</span>

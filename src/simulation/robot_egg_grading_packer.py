...
PORT = 13016
SERVICE = "robot_egg_grading_packer"
DESCRIPTION = "Robotic egg grading and packing system — weight classification, crack detection, orientation alignment, and carton-filling optimization"

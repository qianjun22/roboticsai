...
PORT = 11876
SERVICE = "robot_pharmaceutical_dispensing_trainer"
DESCRIPTION = "Pharmaceutical dispensing robot trainer for medication verification, dose accuracy control, and sterile environment manipulation"

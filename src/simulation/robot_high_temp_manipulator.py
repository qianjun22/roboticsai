...
PORT = 50722
SERVICE = "robot-high-temp-manipulator"
DESCRIPTION = "Robotics simulation for high temp manipulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-high-temp-manipulator</title><style>
...
<div class="header"><h1>robot-high-temp-manipulator</h1><div class="subtitle">Robotics simulation for high temp manipulator · port 50722</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50722</div>

...
PORT = 13656
SERVICE = "robot_arctic_sea_ice_monitor"
DESCRIPTION = "Autonomous arctic sea ice monitoring robot — deploys across polar regions to measure ice thickness, extent, and salinity, feeding climate models with high-resolution data to improve sea-level rise and shipping route predictions"

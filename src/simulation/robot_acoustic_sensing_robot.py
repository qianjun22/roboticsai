...
PORT = 50706
SERVICE = "robot-acoustic-sensing-robot"
DESCRIPTION = "Robotics simulation for acoustic sensing robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-acoustic-sensing-robot</title><style>
...
<div class="header"><h1>robot-acoustic-sensing-robot</h1><div class="subtitle">Robotics simulation for acoustic sensing robot · port 50706</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50706</div>

...
PORT = 50718
SERVICE = "robot-radiation-tolerant-robot"
DESCRIPTION = "Robotics simulation for radiation tolerant robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-radiation-tolerant-robot</title><style>
...
<div class="header"><h1>robot-radiation-tolerant-robot</h1><div class="subtitle">Robotics simulation for radiation tolerant robot · port 50718</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50718</div>

...
PORT = 12568
SERVICE = "robot_liquid_hydrogen_fueling_trainer"
DESCRIPTION = "Robot liquid hydrogen fueling trainer with cryogenic handling protocols, leak detection, and safe disconnect sequencing for hydrogen aircraft"

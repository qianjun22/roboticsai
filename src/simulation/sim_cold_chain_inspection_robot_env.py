...
PORT = 11900
SERVICE = "sim_cold_chain_inspection_robot_env"
DESCRIPTION = "Cold chain inspection robot simulation environment for temperature monitoring, seal integrity verification, and logistics compliance tracking"

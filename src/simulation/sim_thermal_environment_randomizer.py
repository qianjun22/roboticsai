"""Sim thermal environment randomizer — randomizes ambient temperature, heat gradients, and thermal expansion effects on robot components
...
try:
    ...
    _has_fastapi = False
PORT = 10920
SERVICE = "sim_thermal_environment_randomizer"
DESCRIPTION = "Sim thermal environment randomizer — randomizes ambient temperature, heat gradients, and thermal expansion effects on robot components"
if _has_fastapi:

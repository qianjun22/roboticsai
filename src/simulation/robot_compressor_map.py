...
PORT = 15390
SERVICE = "robot-compressor-map"
DESCRIPTION = "Simulation service for compressor map robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-compressor-map</title><style>
...
<div class="header"><h1>robot-compressor-map</h1><div class="sub">Simulation service for compressor map robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15390 | <b>Status:</b> <span style="color:#4ade80">Live</span>

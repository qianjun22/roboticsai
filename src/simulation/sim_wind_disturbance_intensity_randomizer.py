"""Simulation wind disturbance intensity domain randomizer for robust aerial and mobile robot policy training
...
try:
    ...
    _has_fastapi = False
PORT = 11136
SERVICE = "sim_wind_disturbance_intensity_randomizer"
DESCRIPTION = "Simulation wind disturbance intensity domain randomizer for robust aerial and mobile robot policy training"
if _has_fastapi:

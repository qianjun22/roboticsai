...
PORT = 50042
SERVICE = "robot-bimanual-coordination-engine"
DESCRIPTION = "Robotics simulation for bimanual coordination engine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-bimanual-coordination-engine</title><style>
...
<div class="header"><h1>robot-bimanual-coordination-engine</h1><div class="subtitle">Robotics simulation for bimanual coordination engine · port 50042</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50042</div>

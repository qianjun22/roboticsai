...
PORT = 12200
SERVICE = "robot-cold-storage-picker-trainer"
DESCRIPTION = "Training environment for robotic cold storage order picking — sub-zero operation, frozen product handling, condensation management, and ergonomic task sequencing"

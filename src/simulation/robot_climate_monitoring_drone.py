...
PORT = 13500
SERVICE = "robot_climate_monitoring_drone"
DESCRIPTION = "Autonomous climate monitoring drone simulation — atmospheric data collection, sensor fusion, and environmental telemetry for robotics research"

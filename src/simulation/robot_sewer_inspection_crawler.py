...
PORT = 12992
SERVICE = "robot_sewer_inspection_crawler"
DESCRIPTION = "Robotic sewer inspection crawler — pipe diameter adaptation, blockage detection, structural crack analysis, and maintenance priority scoring"

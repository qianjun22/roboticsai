...
PORT = 12148
SERVICE = "sim-autonomous-street-sweeper-env"
DESCRIPTION = "Simulation environment for autonomous street sweeper robots — debris detection, route optimization, water pressure control, and curb navigation"

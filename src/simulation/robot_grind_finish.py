...
PORT = 15134
SERVICE = "robot-grind-finish"
DESCRIPTION = "Simulation service for grind finish robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-grind-finish</title><style>
...
<div class="header"><h1>robot-grind-finish</h1><div class="sub">Simulation service for grind finish robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15134 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 15378
SERVICE = "robot-heat-exchanger"
DESCRIPTION = "Simulation service for heat exchanger robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-heat-exchanger</title><style>
...
<div class="header"><h1>robot-heat-exchanger</h1><div class="sub">Simulation service for heat exchanger robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15378 | <b>Status:</b> <span style="color:#4ade80">Live</span>

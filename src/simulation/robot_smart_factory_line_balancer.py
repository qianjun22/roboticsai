...
PORT = 13344
SERVICE = "robot_smart_factory_line_balancer"
DESCRIPTION = "Robot training for smart factory line balancing with workstation throughput optimization and bottleneck detection"

"""Simulation magnetic field and electromagnetic interference domain randomizer for robust robot sensor policy training
...
try:
    ...
    _has_fastapi = False
PORT = 11176
SERVICE = "sim_magnetic_field_randomizer"
DESCRIPTION = "Simulation magnetic field and electromagnetic interference domain randomizer for robust robot sensor policy training"
if _has_fastapi:

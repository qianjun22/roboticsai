...
PORT = 12348
SERVICE = "sim_autonomous_cold_chain_delivery_env"
DESCRIPTION = "Simulation environment for autonomous cold chain delivery robot temperature maintenance and route optimization"

...
PORT = 13580
SERVICE = "robot_desert_solar_farm_inspector"
DESCRIPTION = "Autonomous robot simulation for desert solar farm inspection — panel cleaning, fault detection, and thermal anomaly scanning"

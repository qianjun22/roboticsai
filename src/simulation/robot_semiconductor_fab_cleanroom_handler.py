...
PORT = 12720
SERVICE = "robot-semiconductor-fab-cleanroom-handler"
DESCRIPTION = "Training pipeline for robots handling wafer cassettes and process equipment in semiconductor fab cleanroom environments"

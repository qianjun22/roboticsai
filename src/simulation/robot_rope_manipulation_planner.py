...
PORT = 51026
SERVICE = "robot-rope-manipulation-planner"
DESCRIPTION = "Robotics simulation for rope manipulation planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-rope-manipulation-planner</title><style>
...
<div class="header"><h1>robot-rope-manipulation-planner</h1><div class="subtitle">Robotics simulation for rope manipulation planner · port 51026</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51026</div>

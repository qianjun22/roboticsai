...
PORT = 12440
SERVICE = "robot_electric_vehicle_battery_assembly_trainer"
DESCRIPTION = "Robot EV battery assembly trainer with cell stacking, welding precision, and quality control simulation for lithium-ion manufacturing"

...
PORT = 14962
SERVICE = "robot-terrain-adapt"
DESCRIPTION = "Simulation service for terrain adapt robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-terrain-adapt</title><style>
...
<div class="header"><h1>robot-terrain-adapt</h1><div class="sub">Simulation service for terrain adapt robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14962 |&nbsp; <b>Status:</b> <span style="color:#4ade80">Live</span>

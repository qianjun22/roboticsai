...
PORT = 15310
SERVICE = "robot-roundness-meas"
DESCRIPTION = "Simulation service for roundness meas robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-roundness-meas</title><style>
...
<div class="header"><h1>robot-roundness-meas</h1><div class="sub">Simulation service for roundness meas robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15310 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 12548
SERVICE = "sim_autonomous_volcanic_lava_monitoring_env"
DESCRIPTION = "Autonomous volcanic lava monitoring robot simulation with thermal imaging, gas sensor fusion, and eruption prediction data collection"

...
PORT = 50454
SERVICE = "robot-decentralized-grasp-net"
DESCRIPTION = "Robotics simulation for decentralized grasp net"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-decentralized-grasp-net</title><style>
...
<div class="header"><h1>robot-decentralized-grasp-net</h1><div class="subtitle">Robotics simulation for decentralized grasp net · port 50454</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50454</div>

...
PORT = 50822
SERVICE = "robot-greenhouse-tending-agent"
DESCRIPTION = "Robotics simulation for greenhouse tending agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-greenhouse-tending-agent</title><style>
...
<div class="header"><h1>robot-greenhouse-tending-agent</h1><div class="subtitle">Robotics simulation for greenhouse tending agent · port 50822</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50822</div>

...
PORT = 46850
SERVICE = "robot_score_matching_v19"
DESCRIPTION = "Score matching for probabilistic robot policy estimation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_score_matching_v19</title><style>
...
<div class="header"><h1>robot_score_matching_v19</h1><div class="subtitle">Score matching for probabilistic robot policy estimation · port 46850</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46850</div>

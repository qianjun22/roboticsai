...
PORT = 51310
SERVICE = "robot-deep-sea-sampler"
DESCRIPTION = "Robotics simulation for deep sea sampler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-deep-sea-sampler</title><style>
...
<div class="header"><h1>robot-deep-sea-sampler</h1><div class="subtitle">Robotics simulation for deep sea sampler · port 51310</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51310</div>

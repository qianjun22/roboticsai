...
PORT = 11852
SERVICE = "sim_mine_inspection_robot_env"
DESCRIPTION = "Mine inspection robot simulation environment for tunnel mapping, hazard detection, and autonomous navigation in confined spaces"

...
PORT = 11920
SERVICE = "robot_satellite_assembly_trainer"
DESCRIPTION = "Satellite assembly robot trainer for micro-gravity manipulation, precision component alignment, and orbital deployment preparation"

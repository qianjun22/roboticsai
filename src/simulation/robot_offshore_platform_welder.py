...
PORT = 12900
SERVICE = "robot_offshore_platform_welder"
DESCRIPTION = "Robotic offshore platform welding — wave motion compensation, corrosion-resistant bead profile control, and underwater weld inspection integration"

...
PORT = 50966
SERVICE = "robot-centrifuge-loading-agent"
DESCRIPTION = "Robotics simulation for centrifuge loading agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-centrifuge-loading-agent</title><style>
...
<div class="header"><h1>robot-centrifuge-loading-agent</h1><div class="subtitle">Robotics simulation for centrifuge loading agent · port 50966</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50966</div>

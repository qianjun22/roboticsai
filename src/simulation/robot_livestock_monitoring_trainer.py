...
PORT = 11724
SERVICE = "robot-livestock-monitoring-trainer"
DESCRIPTION = "Livestock monitoring robot trainer for animal health assessment, behavioral analysis, and herd management"

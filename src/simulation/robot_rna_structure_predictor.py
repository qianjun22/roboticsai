...
PORT = 16798
SERVICE = "robot_rna_structure_predictor"
DESCRIPTION = "Robotic RNA structure predictor using SHAPE-Seq assays and automated enzymatic probing for folding validation"

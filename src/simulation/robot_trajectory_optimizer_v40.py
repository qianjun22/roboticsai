...
<div class="header"><h1>robot_trajectory_optimizer</h1><div class="subtitle">Simulation service for trajectory optimizer port 40318</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40318</div>

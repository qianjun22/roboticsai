...
PORT = 50870
SERVICE = "robot-grinding-robot-agent"
DESCRIPTION = "Robotics simulation for grinding robot agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-grinding-robot-agent</title><style>
...
<div class="header"><h1>robot-grinding-robot-agent</h1><div class="subtitle">Robotics simulation for grinding robot agent · port 50870</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50870</div>

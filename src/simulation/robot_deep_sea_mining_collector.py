...
PORT = 13240
SERVICE = "robot_deep_sea_mining_collector"
DESCRIPTION = "Robot training for deep sea mineral collector operations with sediment handling and buoyancy control"

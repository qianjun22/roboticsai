...
PORT = 11596
SERVICE = "robot-workspace-collision-mapper"
DESCRIPTION = "Maps robot workspace collision zones using swept volume analysis and dynamic obstacle avoidance planning"

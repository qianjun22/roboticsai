...
PORT = 53194
SERVICE = "robot-quadrotor-grasp-planner"
DESCRIPTION = "Robotics simulation for quadrotor grasp planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-quadrotor-grasp-planner</title><style>
...
<div class="header"><h1>robot-quadrotor-grasp-planner</h1><div class="subtitle">Robotics simulation for quadrotor grasp planner · port 53194</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53194</div>

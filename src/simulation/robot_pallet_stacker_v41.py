...
PORT = 41474
SERVICE = "robot_pallet_stacker"
DESCRIPTION = "Simulation service for pallet stacker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_pallet_stacker</title><style>
...
<div class="header"><h1>robot_pallet_stacker</h1><div class="subtitle">Simulation service for pallet stacker port 41474</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41474</div>

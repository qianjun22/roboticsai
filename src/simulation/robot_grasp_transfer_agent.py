...
PORT = 53038
SERVICE = "robot-grasp-transfer-agent"
DESCRIPTION = "Robotics simulation for grasp transfer agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-grasp-transfer-agent</title><style>
...
<div class="header"><h1>robot-grasp-transfer-agent</h1><div class="subtitle">Robotics simulation for grasp transfer agent · port 53038</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53038</div>

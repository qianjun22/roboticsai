...
PORT = 53170
SERVICE = "robot-multirotor-arm-synergizer"
DESCRIPTION = "Robotics simulation for multirotor arm synergizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multirotor-arm-synergizer</title><style>
...
<div class="header"><h1>robot-multirotor-arm-synergizer</h1><div class="subtitle">Robotics simulation for multirotor arm synergizer · port 53170</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53170</div>

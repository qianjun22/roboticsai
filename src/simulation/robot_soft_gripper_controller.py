...
PORT = 53398
SERVICE = "robot-soft-gripper-controller"
DESCRIPTION = "Robotics simulation for soft gripper controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-soft-gripper-controller</title><style>
...
<div class="header"><h1>robot-soft-gripper-controller</h1><div class="subtitle">Robotics simulation for soft gripper controller · port 53398</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53398</div>

...
PORT = 41206
SERVICE = "robot_conveyor_optimizer"
DESCRIPTION = "Simulation service for conveyor optimizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_conveyor_optimizer</title><style>
...
<div class="header"><h1>robot_conveyor_optimizer</h1><div class="subtitle">Simulation service for conveyor optimizer port 41206</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41206</div>

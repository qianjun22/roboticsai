...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-multi-finger-grasp-planner</title><style>
...
<div class="header"><h1>robot-multi-finger-grasp-planner</h1><div class="subtitle">Robotics simulation for multi finger grasp planner · port 51958</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51958</div>

...
PORT = 14974
SERVICE = "robot_automated_glacier_mass_balance_probe"
DESCRIPTION = "Automated robotic probing system for glacier mass balance measurement and ice core sampling"

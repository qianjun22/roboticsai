...
PORT = 50398
SERVICE = "robot-extravehicular-arm-planner"
DESCRIPTION = "Robotics simulation for extravehicular arm planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-extravehicular-arm-planner</title><style>
...
<div class="header"><h1>robot-extravehicular-arm-planner</h1><div class="subtitle">Robotics simulation for extravehicular arm planner · port 50398</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50398</div>

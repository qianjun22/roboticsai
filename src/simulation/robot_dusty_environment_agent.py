...
PORT = 50730
SERVICE = "robot-dusty-environment-agent"
DESCRIPTION = "Robotics simulation for dusty environment agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-dusty-environment-agent</title><style>
...
<div class="header"><h1>robot-dusty-environment-agent</h1><div class="subtitle">Robotics simulation for dusty environment agent · port 50730</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50730</div>

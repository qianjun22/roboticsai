...
PORT = 12776
SERVICE = "robot_underground_cable_layer"
DESCRIPTION = "Robotic underground cable laying simulation — trench navigation, cable routing, joint placement, and compaction sequence planning"

...
PORT = 15034
SERVICE = "robot_autonomous_precision_irrigation_optimizer"
DESCRIPTION = "Autonomous robotic system for field-scale precision irrigation optimization and water use efficiency"

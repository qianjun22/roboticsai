...
PORT = 12412
SERVICE = "sim_autonomous_greenhouse_pollination_env"
DESCRIPTION = "Simulation environment for autonomous greenhouse pollination robot precision flower targeting and pollen delivery"

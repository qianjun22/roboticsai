...
PORT = 12420
SERVICE = "sim_autonomous_fish_farm_feeder_env"
DESCRIPTION = "Simulation environment for autonomous fish farm feeder robot biomass monitoring and feed optimization"

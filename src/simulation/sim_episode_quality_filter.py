"""Sim Episode Quality Filter — FastAPI port 8992"""
import math, random
...
def build_html():
    ...
    return f"""<!DOCTYPE html><html><head><title>Sim Episode Quality Filter</title>
...
<body><h1>Sim Episode Quality Filter</h1>
<div class="card"><h2>Episode Quality Scores</h2>
<svg width="450" height="180">{bars}</svg>
<p>Current value: {data[-1]} | Peak: {max(data)} | Port: {PORT}</p>
</div></body></html>"""

if USE_FASTAPI:
    app = FastAPI(title="Sim Episode Quality Filter")

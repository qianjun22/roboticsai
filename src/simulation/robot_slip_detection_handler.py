...
PORT = 53990
SERVICE = "robot-slip-detection-handler"
DESCRIPTION = "Robotics simulation for slip detection handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-slip-detection-handler</title><style>
...
<div class="header"><h1>robot-slip-detection-handler</h1><div class="subtitle">Robotics simulation for slip detection handler · port 53990</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53990</div>

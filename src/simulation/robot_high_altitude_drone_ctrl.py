...
PORT = 50754
SERVICE = "robot-high-altitude-drone-ctrl"
DESCRIPTION = "Robotics simulation for high altitude drone ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-high-altitude-drone-ctrl</title><style>
...
<div class="header"><h1>robot-high-altitude-drone-ctrl</h1><div class="subtitle">Robotics simulation for high altitude drone ctrl · port 50754</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50754</div>

...
PORT = 12780
SERVICE = "robot_textile_sorting_classifier"
DESCRIPTION = "Robotic textile sorting and classification — fabric type recognition, defect detection, and automated routing for recycling or repurposing"

...
PORT = 51362
SERVICE = "robot-planetary-drill-operator"
DESCRIPTION = "Robotics simulation for planetary drill operator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-planetary-drill-operator</title><style>
...
<div class="header"><h1>robot-planetary-drill-operator</h1><div class="subtitle">Robotics simulation for planetary drill operator · port 51362</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51362</div>

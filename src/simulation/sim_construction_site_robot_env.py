...
PORT = 11844
SERVICE = "sim_construction_site_robot_env"
DESCRIPTION = "Construction site robot simulation environment for material handling, progress monitoring, and safety compliance tasks"

...
PORT = 11780
SERVICE = "robot-autonomous-train-trainer"
DESCRIPTION = "Autonomous train robot trainer for track inspection, obstacle detection, and precision docking at stations"

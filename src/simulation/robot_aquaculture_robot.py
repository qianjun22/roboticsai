...
PORT = 50838
SERVICE = "robot-aquaculture-robot"
DESCRIPTION = "Robotics simulation for aquaculture robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aquaculture-robot</title><style>
...
<div class="header"><h1>robot-aquaculture-robot</h1><div class="subtitle">Robotics simulation for aquaculture robot · port 50838</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50838</div>

...
PORT = 50930
SERVICE = "robot-warehouse-navigator"
DESCRIPTION = "Robotics simulation for warehouse navigator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-warehouse-navigator</title><style>
...
<div class="header"><h1>robot-warehouse-navigator</h1><div class="subtitle">Robotics simulation for warehouse navigator · port 50930</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50930</div>

...
PORT = 13628
SERVICE = "robot_tsunami_warning_buoy"
DESCRIPTION = "Autonomous tsunami warning buoy robot — continuously monitors ocean pressure anomalies and seismic signatures to detect undersea earthquakes, automatically broadcasting early warning alerts to coastal emergency systems"

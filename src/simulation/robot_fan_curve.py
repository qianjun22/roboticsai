...
PORT = 15362
SERVICE = "robot-fan-curve"
DESCRIPTION = "Simulation service for fan curve robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fan-curve</title><style>
...
<div class="header"><h1>robot-fan-curve</h1><div class="sub">Simulation service for fan curve robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15362 | <b>Status:</b> <span style="color:#4ade80">Live</span>

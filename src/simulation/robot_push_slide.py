...
PORT = 15094
SERVICE = "robot-push-slide"
DESCRIPTION = "Simulation service for push slide robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-push-slide</title><style>
...
<div class="header"><h1>robot-push-slide</h1><div class="sub">Simulation service for push slide robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15094 | <b>Status:</b> <span style="color:#4ade80">Live</span>

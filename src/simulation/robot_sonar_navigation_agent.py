...
PORT = 50366
SERVICE = "robot-sonar-navigation-agent"
DESCRIPTION = "Robotics simulation for sonar navigation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-sonar-navigation-agent</title><style>
...
<div class="header"><h1>robot-sonar-navigation-agent</h1><div class="subtitle">Robotics simulation for sonar navigation agent · port 50366</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50366</div>

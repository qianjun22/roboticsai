...
PORT = 11728
SERVICE = "sim-polar-research-robot-env"
DESCRIPTION = "Polar research robot simulation environment for ice core sampling, blizzard navigation, and scientific instrument deployment"

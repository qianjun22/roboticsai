...
PORT = 50758
SERVICE = "robot-deep-ocean-rov-agent"
DESCRIPTION = "Robotics simulation for deep ocean rov agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-deep-ocean-rov-agent</title><style>
...
<div class="header"><h1>robot-deep-ocean-rov-agent</h1><div class="subtitle">Robotics simulation for deep ocean rov agent · port 50758</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50758</div>

...
PORT = 50166
SERVICE = "robot-functional-grasp-selector"
DESCRIPTION = "Robotics simulation for functional grasp selector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-functional-grasp-selector</title><style>
...
<div class="header"><h1>robot-functional-grasp-selector</h1><div class="subtitle">Robotics simulation for functional grasp selector · port 50166</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50166</div>

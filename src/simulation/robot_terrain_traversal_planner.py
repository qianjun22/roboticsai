...
PORT = 53106
SERVICE = "robot-terrain-traversal-planner"
DESCRIPTION = "Robotics simulation for terrain traversal planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-terrain-traversal-planner</title><style>
...
<div class="header"><h1>robot-terrain-traversal-planner</h1><div class="subtitle">Robotics simulation for terrain traversal planner · port 53106</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53106</div>

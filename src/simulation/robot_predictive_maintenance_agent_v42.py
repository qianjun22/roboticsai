...
PORT = 42094
SERVICE = "robot_predictive_maintenance_agent"
DESCRIPTION = "Simulation service for predictive maintenance agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_predictive_maintenance_agent</title><style>
...
<div class="header"><h1>robot_predictive_maintenance_agent</h1><div class="subtitle">Simulation service for predictive maintenance agent port 42094</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42094</div>

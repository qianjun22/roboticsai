...
PORT = 11788
SERVICE = "robot-glasshouse-cultivation-trainer"
DESCRIPTION = "Glasshouse cultivation robot trainer for climate control, pest detection, and precision crop management"

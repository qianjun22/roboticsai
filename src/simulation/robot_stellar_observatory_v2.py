...
PORT = 18850
SERVICE = "robot_stellar_observatory_v2"
DESCRIPTION = "Second-generation robotic stellar observatory for autonomous deep-space observation and data collection"

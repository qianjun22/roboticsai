...
PORT = 51034
SERVICE = "robot-granular-material-scooper"
DESCRIPTION = "Robotics simulation for granular material scooper"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-granular-material-scooper</title><style>
...
<div class="header"><h1>robot-granular-material-scooper</h1><div class="subtitle">Robotics simulation for granular material scooper · port 51034</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51034</div>

...
PORT = 12220
SERVICE = "sim-autonomous-highway-maintenance-env"
DESCRIPTION = "Simulation environment for autonomous highway maintenance robots — pothole detection, crack sealing, line repainting, and traffic management coordination"

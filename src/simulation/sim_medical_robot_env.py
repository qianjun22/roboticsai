...
PORT = 11632
SERVICE = "sim-medical-robot-env"
DESCRIPTION = "Medical robot simulation environment for surgical assistance, IV insertion, and patient transfer with safety-critical constraints"

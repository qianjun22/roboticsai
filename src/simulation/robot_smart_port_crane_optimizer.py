...
PORT = 13720
SERVICE = "robot_smart_port_crane_optimizer"
DESCRIPTION = "Smart port crane optimizer robot simulation — AI-driven container crane scheduling and load balancing for port throughput maximization"

...
PORT = 13328
SERVICE = "robot_vineyard_canopy_manager"
DESCRIPTION = "Robot training for vineyard canopy management with shoot positioning, leaf removal, and disease inspection between vine rows"

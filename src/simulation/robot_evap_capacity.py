...
PORT = 15386
SERVICE = "robot-evap-capacity"
DESCRIPTION = "Simulation service for evap capacity robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-evap-capacity</title><style>
...
<div class="header"><h1>robot-evap-capacity</h1><div class="sub">Simulation service for evap capacity robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15386 | <b>Status:</b> <span style="color:#4ade80">Live</span>

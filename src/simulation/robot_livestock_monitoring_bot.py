...
PORT = 50826
SERVICE = "robot-livestock-monitoring-bot"
DESCRIPTION = "Robotics simulation for livestock monitoring bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-livestock-monitoring-bot</title><style>
...
<div class="header"><h1>robot-livestock-monitoring-bot</h1><div class="subtitle">Robotics simulation for livestock monitoring bot · port 50826</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50826</div>

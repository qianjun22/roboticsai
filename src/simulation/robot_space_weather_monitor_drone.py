...
PORT = 13736
SERVICE = "robot_space_weather_monitor_drone"
DESCRIPTION = "Space weather monitor drone simulation — high-altitude autonomous drone for solar wind, radiation belt, and geomagnetic storm monitoring"

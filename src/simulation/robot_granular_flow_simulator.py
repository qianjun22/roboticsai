...
PORT = 50682
SERVICE = "robot-granular-flow-simulator"
DESCRIPTION = "Robotics simulation for granular flow simulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-granular-flow-simulator</title><style>
...
<div class="header"><h1>robot-granular-flow-simulator</h1><div class="subtitle">Robotics simulation for granular flow simulator · port 50682</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50682</div>

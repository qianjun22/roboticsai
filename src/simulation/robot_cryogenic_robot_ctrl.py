...
PORT = 50726
SERVICE = "robot-cryogenic-robot-ctrl"
DESCRIPTION = "Robotics simulation for cryogenic robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cryogenic-robot-ctrl</title><style>
...
<div class="header"><h1>robot-cryogenic-robot-ctrl</h1><div class="subtitle">Robotics simulation for cryogenic robot ctrl · port 50726</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50726</div>

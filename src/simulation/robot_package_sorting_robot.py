...
PORT = 50910
SERVICE = "robot-package-sorting-robot"
DESCRIPTION = "Robotics simulation for package sorting robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-package-sorting-robot</title><style>
...
<div class="header"><h1>robot-package-sorting-robot</h1><div class="subtitle">Robotics simulation for package sorting robot · port 50910</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50910</div>

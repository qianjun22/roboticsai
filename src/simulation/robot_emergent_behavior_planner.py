...
PORT = 51418
SERVICE = "robot-emergent-behavior-planner"
DESCRIPTION = "Robotics simulation for emergent behavior planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-emergent-behavior-planner</title><style>
...
<div class="header"><h1>robot-emergent-behavior-planner</h1><div class="subtitle">Robotics simulation for emergent behavior planner · port 51418</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51418</div>

"""Simulation collision geometry randomizer for robust robot policy training across diverse environments
...
try:
    ...
    _has_fastapi = False
PORT = 10832
SERVICE = "sim_collision_randomizer"
DESCRIPTION = "Simulation collision geometry randomizer for robust robot policy training across diverse environments"
if _has_fastapi:

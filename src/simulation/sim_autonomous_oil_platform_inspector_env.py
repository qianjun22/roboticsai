...
PORT = 12396
SERVICE = "sim_autonomous_oil_platform_inspector_env"
DESCRIPTION = "Simulation environment for autonomous oil platform inspection robot flare stack monitoring and leak detection"

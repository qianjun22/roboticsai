...
PORT = 13712
SERVICE = "robot_volcanic_lava_flow_monitor"
DESCRIPTION = "Volcanic lava flow monitor robot simulation — heat-shielded autonomous robot tracking lava flow boundaries and eruption progression"

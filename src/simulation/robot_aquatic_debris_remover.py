...
PORT = 50362
SERVICE = "robot-aquatic-debris-remover"
DESCRIPTION = "Robotics simulation for aquatic debris remover"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aquatic-debris-remover</title><style>
...
<div class="header"><h1>robot-aquatic-debris-remover</h1><div class="subtitle">Robotics simulation for aquatic debris remover · port 50362</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50362</div>

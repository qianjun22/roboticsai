...
PORT = 11580
SERVICE = "robot-contact-rich-policy-trainer"
DESCRIPTION = "Trains contact-rich manipulation policies with force/torque feedback using hybrid position-force control and compliance learning"

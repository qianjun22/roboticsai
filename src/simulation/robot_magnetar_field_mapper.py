...
PORT = 16774
SERVICE = "robot_magnetar_field_mapper"
DESCRIPTION = "Robotic magnetar field mapper processing X-ray polarimetry data for neutron star magnetic field reconstruction"

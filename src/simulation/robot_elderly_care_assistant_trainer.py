...
PORT = 11856
SERVICE = "robot_elderly_care_assistant_trainer"
DESCRIPTION = "Elderly care assistant robot trainer for mobility assistance, medication reminders, fall detection, and daily activity support"

...
PORT = 13092
SERVICE = "sim_underground_mine_rescue_env"
DESCRIPTION = "Underground mine rescue simulation environment for autonomous robot navigation in collapsed tunnels"

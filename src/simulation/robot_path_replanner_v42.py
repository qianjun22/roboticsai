...
<div class="header"><h1>robot_path_replanner</h1><div class="subtitle">Simulation service for path replanner port 42126</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42126</div>

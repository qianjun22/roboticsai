...
PORT = 15018
SERVICE = "robot-glass-pick"
DESCRIPTION = "Simulation service for glass pick robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-glass-pick</title><style>
...
<div class="header"><h1>robot-glass-pick</h1><div class="sub">Simulation service for glass pick robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15018 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50710
SERVICE = "robot-olfactory-robot-agent"
DESCRIPTION = "Robotics simulation for olfactory robot agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-olfactory-robot-agent</title><style>
...
<div class="header"><h1>robot-olfactory-robot-agent</h1><div class="subtitle">Robotics simulation for olfactory robot agent · port 50710</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50710</div>

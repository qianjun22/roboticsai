...
PORT = 14230
SERVICE = "robot_automated_wind_turbine_maintainer"
DESCRIPTION = "Automated wind turbine maintenance robot simulation for blade inspection and repair at height"

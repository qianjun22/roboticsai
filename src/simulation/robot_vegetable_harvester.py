...
PORT = 50818
SERVICE = "robot-vegetable-harvester"
DESCRIPTION = "Robotics simulation for vegetable harvester"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vegetable-harvester</title><style>
...
<div class="header"><h1>robot-vegetable-harvester</h1><div class="subtitle">Robotics simulation for vegetable harvester · port 50818</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50818</div>

...
PORT = 12804
SERVICE = "robot_oil_pipeline_inspector"
DESCRIPTION = "Robotic oil pipeline inspection crawler — corrosion mapping, weld integrity scanning, and leak detection for subsea and buried pipelines"

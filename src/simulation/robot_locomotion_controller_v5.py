...
PORT = 30650
SERVICE = "robot_locomotion_controller_v5"
DESCRIPTION = "Locomotion controller simulation microservice for robotics bipedal and wheeled movement coordination"

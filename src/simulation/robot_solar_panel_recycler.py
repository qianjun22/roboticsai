...
PORT = 13252
SERVICE = "robot_solar_panel_recycler"
DESCRIPTION = "Robot training for solar panel disassembly and material recovery with safe handling of photovoltaic components"

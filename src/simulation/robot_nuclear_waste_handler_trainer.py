...
PORT = 11764
SERVICE = "robot-nuclear-waste-handler-trainer"
DESCRIPTION = "Nuclear waste handling robot trainer for remote manipulation, containment protocols, and radiation-safe operation"

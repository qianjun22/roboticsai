...
PORT = 12948
SERVICE = "robot_precision_welding_arm"
DESCRIPTION = "Precision robotic welding arm controller — seam tracking, weld quality monitoring, and adaptive parameter tuning for industrial joining"

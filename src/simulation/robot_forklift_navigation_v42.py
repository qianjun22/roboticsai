...
PORT = 41826
SERVICE = "robot_forklift_navigation"
DESCRIPTION = "Simulation service for forklift navigation"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_forklift_navigation</title><style>
...
<div class="header"><h1>robot_forklift_navigation</h1><div class="subtitle">Simulation service for forklift navigation port 41826</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41826</div>

...
PORT = 11748
SERVICE = "robot-satellite-servicing-trainer"
DESCRIPTION = "Satellite servicing robot trainer for on-orbit docking, component replacement, and propellant transfer"

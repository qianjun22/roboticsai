...
PORT = 50878
SERVICE = "robot-riveting-robot-agent"
DESCRIPTION = "Robotics simulation for riveting robot agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-riveting-robot-agent</title><style>
...
<div class="header"><h1>robot-riveting-robot-agent</h1><div class="subtitle">Robotics simulation for riveting robot agent · port 50878</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50878</div>

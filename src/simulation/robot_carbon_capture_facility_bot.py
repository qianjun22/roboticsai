...
PORT = 13866
SERVICE = "robot_carbon_capture_facility_bot"
DESCRIPTION = "Autonomous robot for carbon capture facility monitoring, DAC system maintenance, and CO2 storage management"

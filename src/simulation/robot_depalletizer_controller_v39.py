...
PORT = 39866
SERVICE = "robot_depalletizer_controller"
DESCRIPTION = "Simulation service for depalletizer controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_depalletizer_controller</title><style>
...
<div class="header"><h1>robot_depalletizer_controller</h1><div class="subtitle">Simulation service for depalletizer controller port 39866</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39866</div>

...
PORT = 41246
SERVICE = "robot_thermal_leak_detector"
DESCRIPTION = "Simulation service for thermal leak detector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_thermal_leak_detector</title><style>
...
<div class="header"><h1>robot_thermal_leak_detector</h1><div class="subtitle">Simulation service for thermal leak detector port 41246</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41246</div>

...
PORT = 15298
SERVICE = "robot-laser-scan"
DESCRIPTION = "Simulation service for laser scan robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-laser-scan</title><style>
...
<div class="header"><h1>robot-laser-scan</h1><div class="sub">Simulation service for laser scan robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15298 | <b>Status:</b> <span style="color:#4ade80">Live</span>

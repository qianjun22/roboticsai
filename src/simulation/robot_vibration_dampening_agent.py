...
PORT = 50702
SERVICE = "robot-vibration-dampening-agent"
DESCRIPTION = "Robotics simulation for vibration dampening agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vibration-dampening-agent</title><style>
...
<div class="header"><h1>robot-vibration-dampening-agent</h1><div class="subtitle">Robotics simulation for vibration dampening agent · port 50702</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50702</div>

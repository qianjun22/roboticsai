...
PORT = 50470
SERVICE = "robot-peg-in-hole-inserter"
DESCRIPTION = "Robotics simulation for peg in hole inserter"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-peg-in-hole-inserter</title><style>
...
<div class="header"><h1>robot-peg-in-hole-inserter</h1><div class="subtitle">Robotics simulation for peg in hole inserter · port 50470</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50470</div>

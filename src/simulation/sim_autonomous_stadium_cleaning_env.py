...
PORT = 12436
SERVICE = "sim_autonomous_stadium_cleaning_env"
DESCRIPTION = "Autonomous stadium cleaning robot simulation environment with crowd avoidance, zone planning, and cleaning efficiency metrics"

...
PORT = 41178
SERVICE = "robot_emergency_stop_system"
DESCRIPTION = "Simulation service for emergency stop system"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_emergency_stop_system</title><style>
...
<div class="header"><h1>robot_emergency_stop_system</h1><div class="subtitle">Simulation service for emergency stop system port 41178</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41178</div>

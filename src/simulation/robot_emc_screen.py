...
PORT = 15258
SERVICE = "robot-emc-screen"
DESCRIPTION = "Simulation service for emc screen robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-emc-screen</title><style>
...
<div class="header"><h1>robot-emc-screen</h1><div class="sub">Simulation service for emc screen robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15258 | <b>Status:</b> <span style="color:#4ade80">Live</span>

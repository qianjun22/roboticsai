...
PORT = 12244
SERVICE = "sim-autonomous-underground-utility-mapper-env"
DESCRIPTION = "Simulation environment for autonomous underground utility mapping robots — GPR scanning, pipe material identification, depth estimation, and GIS data integration"

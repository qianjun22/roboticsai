...
PORT = 16766
SERVICE = "robot_galactic_center_imager"
DESCRIPTION = "Robotic galactic center imager coordinating multi-wavelength observatories and black hole event horizon imaging"

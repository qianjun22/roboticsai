...
PORT = 51518
SERVICE = "robot-vine-robot-controller"
DESCRIPTION = "Robotics simulation for vine robot controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vine-robot-controller</title><style>
...
<div class="header"><h1>robot-vine-robot-controller</h1><div class="subtitle">Robotics simulation for vine robot controller · port 51518</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51518</div>

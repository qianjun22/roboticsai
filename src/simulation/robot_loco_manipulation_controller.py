...
PORT = 50086
SERVICE = "robot-loco-manipulation-controller"
DESCRIPTION = "Robotics simulation for loco manipulation controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-loco-manipulation-controller</title><style>
...
<div class="header"><h1>robot-loco-manipulation-controller</h1><div class="subtitle">Robotics simulation for loco manipulation controller · port 50086</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50086</div>

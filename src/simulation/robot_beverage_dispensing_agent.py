...
PORT = 50906
SERVICE = "robot-beverage-dispensing-agent"
DESCRIPTION = "Robotics simulation for beverage dispensing agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-beverage-dispensing-agent</title><style>
...
<div class="header"><h1>robot-beverage-dispensing-agent</h1><div class="subtitle">Robotics simulation for beverage dispensing agent · port 50906</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50906</div>

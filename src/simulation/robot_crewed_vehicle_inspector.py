...
PORT = 53294
SERVICE = "robot-crewed-vehicle-inspector"
DESCRIPTION = "Robotics simulation for crewed vehicle inspector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-crewed-vehicle-inspector</title><style>
...
<div class="header"><h1>robot-crewed-vehicle-inspector</h1><div class="subtitle">Robotics simulation for crewed vehicle inspector · port 53294</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53294</div>

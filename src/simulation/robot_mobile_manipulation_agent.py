...
PORT = 51058
SERVICE = "robot-mobile-manipulation-agent"
DESCRIPTION = "Robotics simulation for mobile manipulation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mobile-manipulation-agent</title><style>
...
<div class="header"><h1>robot-mobile-manipulation-agent</h1><div class="subtitle">Robotics simulation for mobile manipulation agent · port 51058</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51058</div>

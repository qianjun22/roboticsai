"""Object surface texture and material property randomization for grasp robustness training
...
try:
    ...
    _has_fastapi = False
PORT = 11080
SERVICE = "sim_object_surface_randomizer"
DESCRIPTION = "Object surface texture and material property randomization for grasp robustness training"
if _has_fastapi:

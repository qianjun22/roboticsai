...
PORT = 53126
SERVICE = "robot-search-rescue-navigator"
DESCRIPTION = "Robotics simulation for search rescue navigator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-search-rescue-navigator</title><style>
...
<div class="header"><h1>robot-search-rescue-navigator</h1><div class="subtitle">Robotics simulation for search rescue navigator · port 53126</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53126</div>

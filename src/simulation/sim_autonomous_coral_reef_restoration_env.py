...
PORT = 12468
SERVICE = "sim_autonomous_coral_reef_restoration_env"
DESCRIPTION = "Autonomous coral reef restoration robot simulation with underwater navigation, fragment transplantation, and reef health monitoring"

...
PORT = 11564
SERVICE = "robot-mobile-manipulation-env"
DESCRIPTION = "Mobile manipulation simulation environment combining locomotion and arm control for fetch-and-place tasks"

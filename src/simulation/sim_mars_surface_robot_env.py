...
PORT = 11768
SERVICE = "sim-mars-surface-robot-env"
DESCRIPTION = "Mars surface robot simulation environment for dust storm navigation, sample collection, and habitat construction"

...
PORT = 12456
SERVICE = "robot_semiconductor_wafer_handling_trainer"
DESCRIPTION = "Robot semiconductor wafer handling trainer with ultra-clean room protocols, electrostatic discharge prevention, and yield optimization"

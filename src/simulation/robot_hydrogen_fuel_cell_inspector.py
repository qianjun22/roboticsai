...
PORT = 13260
SERVICE = "robot_hydrogen_fuel_cell_inspector"
DESCRIPTION = "Robot training for hydrogen fuel cell inspection with leak detection and membrane integrity assessment"

...
PORT = 11668
SERVICE = "sim-disaster-response-robot-env"
DESCRIPTION = "Disaster response simulation with rubble navigation, victim detection, structural assessment, and coordinated rescue operations"

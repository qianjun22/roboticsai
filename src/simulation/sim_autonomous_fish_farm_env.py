...
PORT = 12180
SERVICE = "sim-autonomous-fish-farm-env"
DESCRIPTION = "Simulation environment for autonomous aquaculture management — feeding optimization, water quality monitoring, net cleaning, and fish health assessment"

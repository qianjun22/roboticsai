...
PORT = 13688
SERVICE = "robot_mine_rescue_crawler"
DESCRIPTION = "Mine rescue crawler robot simulation — autonomous navigation through collapsed mine tunnels for survivor detection and extraction"

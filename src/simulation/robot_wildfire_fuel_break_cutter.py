...
PORT = 13882
SERVICE = "robot_wildfire_fuel_break_cutter"
DESCRIPTION = "Autonomous robot for wildfire fuel break creation, vegetation clearing, and fire perimeter management"

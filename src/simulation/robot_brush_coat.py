...
PORT = 15110
SERVICE = "robot-brush-coat"
DESCRIPTION = "Simulation service for brush coat robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-brush-coat</title><style>
...
<div class="header"><h1>robot-brush-coat</h1><div class="sub">Simulation service for brush coat robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15110 | <b>Status:</b> <span style="color:#4ade80">Live</span>

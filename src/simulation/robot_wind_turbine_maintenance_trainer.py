...
PORT = 12184
SERVICE = "robot-wind-turbine-maintenance-trainer"
DESCRIPTION = "Training environment for robotic wind turbine maintenance — blade inspection, gearbox servicing, nacelle access, and safety lockout procedures at height"

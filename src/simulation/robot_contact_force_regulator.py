...
PORT = 50466
SERVICE = "robot-contact-force-regulator"
DESCRIPTION = "Robotics simulation for contact force regulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-contact-force-regulator</title><style>
...
<div class="header"><h1>robot-contact-force-regulator</h1><div class="subtitle">Robotics simulation for contact force regulator · port 50466</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50466</div>

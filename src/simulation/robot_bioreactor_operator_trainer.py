...
PORT = 12112
SERVICE = "robot-bioreactor-operator-trainer"
DESCRIPTION = "Robot training environment for bioreactor operation and bioprocess monitoring in pharmaceutical manufacturing"

...
PORT = 13120
SERVICE = "robot_grain_elevator_manager"
DESCRIPTION = "Robot training for grain elevator operations including auger control, bin management, and moisture monitoring"

...
PORT = 12764
SERVICE = "robot_hospital_logistics_navigator"
DESCRIPTION = "Autonomous hospital logistics robot navigation — medication delivery routing, sterile zone compliance, and patient flow avoidance"

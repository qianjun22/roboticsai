...
PORT = 12056
SERVICE = "robot-precision-agriculture-trainer"
DESCRIPTION = "Robot training environment for precision agriculture including soil sampling, planting, and crop monitoring"

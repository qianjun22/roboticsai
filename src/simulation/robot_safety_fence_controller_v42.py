...
PORT = 41894
SERVICE = "robot_safety_fence_controller"
DESCRIPTION = "Simulation service for safety fence controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_safety_fence_controller</title><style>
...
<div class="header"><h1>robot_safety_fence_controller</h1><div class="subtitle">Simulation service for safety fence controller port 41894</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41894</div>

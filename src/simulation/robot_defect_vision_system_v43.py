...
PORT = 42442
SERVICE = "robot_defect_vision_system"
DESCRIPTION = "Simulation service for defect vision system"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_defect_vision_system</title><style>
...
<div class="header"><h1>robot_defect_vision_system</h1><div class="subtitle">Simulation service for defect vision system port 42442</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 42442</div>

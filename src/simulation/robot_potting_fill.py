...
PORT = 15226
SERVICE = "robot-potting-fill"
DESCRIPTION = "Simulation service for potting fill robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-potting-fill</title><style>
...
<div class="header"><h1>robot-potting-fill</h1><div class="sub">Simulation service for potting fill robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15226 | <b>Status:</b> <span style="color:#4ade80">Live</span>

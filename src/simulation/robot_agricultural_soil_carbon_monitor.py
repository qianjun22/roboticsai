...
PORT = 13744
SERVICE = "robot_agricultural_soil_carbon_monitor"
DESCRIPTION = "Agricultural soil carbon monitor robot simulation — autonomous field robot for soil sampling, carbon sequestration measurement, and regenerative farming analytics"

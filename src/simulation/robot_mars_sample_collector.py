...
PORT = 50382
SERVICE = "robot-mars-sample-collector"
DESCRIPTION = "Robotics simulation for mars sample collector"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mars-sample-collector</title><style>
...
<div class="header"><h1>robot-mars-sample-collector</h1><div class="subtitle">Robotics simulation for mars sample collector · port 50382</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50382</div>

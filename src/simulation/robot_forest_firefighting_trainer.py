...
PORT = 11960
SERVICE = "robot_forest_firefighting_trainer"
DESCRIPTION = "Forest firefighting robot trainer for fire front detection, hotspot suppression, and terrain navigation in challenging wildland environments"

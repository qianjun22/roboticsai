...
PORT = 13060
SERVICE = "robot_offshore_platform_inspector"
DESCRIPTION = "Robotic offshore platform inspection system — corrosion mapping, flange integrity checking, and riser inspection for oil and gas facilities"

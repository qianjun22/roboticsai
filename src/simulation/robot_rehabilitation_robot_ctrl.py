...
PORT = 51554
SERVICE = "robot-rehabilitation-robot-ctrl"
DESCRIPTION = "Robotics simulation for rehabilitation robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-rehabilitation-robot-ctrl</title><style>
...
<div class="header"><h1>robot-rehabilitation-robot-ctrl</h1><div class="subtitle">Robotics simulation for rehabilitation robot ctrl · port 51554</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51554</div>

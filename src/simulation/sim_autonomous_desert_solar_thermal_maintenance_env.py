...
PORT = 12740
SERVICE = "sim-autonomous-desert-solar-thermal-maintenance-env"
DESCRIPTION = "Simulation environment for autonomous maintenance of desert solar thermal plants — mirror alignment and heat exchanger cleaning"

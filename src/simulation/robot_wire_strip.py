...
PORT = 15050
SERVICE = "robot-wire-strip"
DESCRIPTION = "Simulation service for wire strip robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-wire-strip</title><style>
...
<div class="header"><h1>robot-wire-strip</h1><div class="sub">Simulation service for wire strip robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15050 | <b>Status:</b> <span style="color:#4ade80">Live</span>

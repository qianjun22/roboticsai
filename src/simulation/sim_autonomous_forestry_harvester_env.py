...
PORT = 12316
SERVICE = "sim_autonomous_forestry_harvester_env"
DESCRIPTION = "Simulation environment for autonomous forestry harvesting robot terrain navigation and tree processing"

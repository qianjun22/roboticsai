...
PORT = 51638
SERVICE = "robot-fluid-interaction-agent"
DESCRIPTION = "Robotics simulation for fluid interaction agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fluid-interaction-agent</title><style>
...
<div class="header"><h1>robot-fluid-interaction-agent</h1><div class="subtitle">Robotics simulation for fluid interaction agent · port 51638</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51638</div>

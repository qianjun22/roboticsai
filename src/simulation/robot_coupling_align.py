...
PORT = 15354
SERVICE = "robot-coupling-align"
DESCRIPTION = "Simulation service for coupling align robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-coupling-align</title><style>
...
<div class="header"><h1>robot-coupling-align</h1><div class="sub">Simulation service for coupling align robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15354 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 16778
SERVICE = "robot_quasar_spectroscope"
DESCRIPTION = "Robotic quasar spectroscope for automated redshift measurement and intergalactic medium absorption mapping"

...
PORT = 13696
SERVICE = "robot_subsea_cable_repair_bot"
DESCRIPTION = "Subsea cable repair robot simulation — deep-water autonomous inspection and repair of undersea fiber optic and power cables"

...
PORT = 40870
SERVICE = "robot-radiative-v8"
DESCRIPTION = "Radiative transfer-aware robot simulation for thermal management in extreme environments and infrared-guided navigation"

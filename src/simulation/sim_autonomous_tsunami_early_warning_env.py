...
PORT = 12724
SERVICE = "sim-autonomous-tsunami-early-warning-env"
DESCRIPTION = "Simulation environment for autonomous tsunami early warning buoy networks with self-positioning ocean robots"

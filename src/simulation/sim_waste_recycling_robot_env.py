...
PORT = 11816
SERVICE = "sim-waste-recycling-robot-env"
DESCRIPTION = "Waste recycling robot simulation for material sorting, contamination detection, and conveyor belt navigation"

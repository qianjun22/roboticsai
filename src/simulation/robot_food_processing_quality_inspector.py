...
PORT = 12744
SERVICE = "robot_food_processing_quality_inspector"
DESCRIPTION = "AI-driven quality inspection for robotic food processing lines — detects defects, contamination, and packaging errors"

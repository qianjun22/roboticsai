...
PORT = 53258
SERVICE = "robot-lunar-surface-explorer"
DESCRIPTION = "Robotics simulation for lunar surface explorer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-lunar-surface-explorer</title><style>
...
<div class="header"><h1>robot-lunar-surface-explorer</h1><div class="subtitle">Robotics simulation for lunar surface explorer · port 53258</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53258</div>

...
PORT = 11584
SERVICE = "sim-force-feedback-trainer"
DESCRIPTION = "Force feedback simulation trainer with haptic rendering, contact force profiles, and compliance-aware policy training"

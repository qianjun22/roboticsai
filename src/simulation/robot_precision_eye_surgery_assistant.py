...
PORT = 14274
SERVICE = "robot_precision_eye_surgery_assistant"
DESCRIPTION = "Precision eye surgery assistant robot simulation for ophthalmic microsurgical procedure support"

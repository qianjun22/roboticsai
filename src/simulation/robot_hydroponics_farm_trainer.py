...
PORT = 12168
SERVICE = "robot-hydroponics-farm-trainer"
DESCRIPTION = "Training environment for robotic hydroponics farm management — nutrient dosing, pH balancing, harvest timing, and plant health monitoring"

...
PORT = 12660
SERVICE = "sim-autonomous-methane-leak-detection-env"
DESCRIPTION = "Simulation environment for autonomous methane leak detection at oil and gas facilities using drone swarms"

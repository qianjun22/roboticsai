...
PORT = 13072
SERVICE = "robot_paper_pulp_processor"
DESCRIPTION = "Robotic paper pulp processing system — fiber consistency control, chemical dosing, sheet formation optimization, and quality grading"

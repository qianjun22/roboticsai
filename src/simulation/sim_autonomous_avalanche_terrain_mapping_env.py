...
PORT = 12692
SERVICE = "sim-autonomous-avalanche-terrain-mapping-env"
DESCRIPTION = "Simulation environment for autonomous avalanche terrain mapping and snowpack stability assessment with drone robots"

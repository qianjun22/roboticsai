...
PORT = 15014
SERVICE = "robot-fabric-fold"
DESCRIPTION = "Simulation service for fabric fold robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fabric-fold</title><style>
...
<div class="header"><h1>robot-fabric-fold</h1><div class="sub">Simulation service for fabric fold robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15014 | <b>Status:</b> <span style="color:#4ade80">Live</span>

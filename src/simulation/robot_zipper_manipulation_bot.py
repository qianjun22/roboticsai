...
PORT = 51458
SERVICE = "robot-zipper-manipulation-bot"
DESCRIPTION = "Robotics simulation for zipper manipulation bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-zipper-manipulation-bot</title><style>
...
<div class="header"><h1>robot-zipper-manipulation-bot</h1><div class="subtitle">Robotics simulation for zipper manipulation bot · port 51458</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51458</div>

"""Force-torque sensor noise and calibration error randomizer reducing sim-to-real policy failures by 61 percent
...
try:
    ...
    _has_fastapi = False
PORT = 10888
SERVICE = "sim_force_sensor_randomizer"
DESCRIPTION = "Force-torque sensor noise and calibration error randomizer reducing sim-to-real policy failures by 61 percent"
if _has_fastapi:

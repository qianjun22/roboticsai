...
PORT = 53114
SERVICE = "robot-pipeline-inspection-agent"
DESCRIPTION = "Robotics simulation for pipeline inspection agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pipeline-inspection-agent</title><style>
...
<div class="header"><h1>robot-pipeline-inspection-agent</h1><div class="subtitle">Robotics simulation for pipeline inspection agent · port 53114</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53114</div>

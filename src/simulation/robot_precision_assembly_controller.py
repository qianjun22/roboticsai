...
DESCRIPTION = "Robotics simulation for precision assembly controller"
...
<div class="header"><h1>robot-precision-assembly-controller</h1><div class="subtitle">Robotics simulation for precision assembly controller · port 50034</div></div>
<div class="content">

...
PORT = 50034
SERVICE = "robot-precision-assembly-controller"
DESCRIPTION = "Robotics simulation service for precision assembly controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-precision-assembly-controller</title><style>
...
<div class="header"><h1>robot-precision-assembly-controller</h1><div class="subtitle">Robotics simulation service for precision assembly controller · port 50034</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50034</div>

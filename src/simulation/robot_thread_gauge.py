...
PORT = 15318
SERVICE = "robot-thread-gauge"
DESCRIPTION = "Simulation service for thread gauge robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-thread-gauge</title><style>
...
<div class="header"><h1>robot-thread-gauge</h1><div class="sub">Simulation service for thread gauge robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15318 | <b>Status:</b> <span style="color:#4ade80">Live</span>

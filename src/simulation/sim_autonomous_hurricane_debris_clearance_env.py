...
PORT = 12700
SERVICE = "sim-autonomous-hurricane-debris-clearance-env"
DESCRIPTION = "Simulation environment for autonomous hurricane debris clearance robots coordinating with emergency response teams"

...
PORT = 11964
SERVICE = "sim_livestock_monitoring_robot_env"
DESCRIPTION = "Livestock monitoring robot simulation environment for animal health tracking, feeding automation, and herd behavior analysis in agricultural settings"

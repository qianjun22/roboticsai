...
PORT = 12920
SERVICE = "robot_data_center_rack_installer"
DESCRIPTION = "Robotic data center rack installation — server rail mounting, cable management routing, power strip alignment, and rack unit inventory tracking"

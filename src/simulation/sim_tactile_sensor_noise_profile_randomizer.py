"""Simulation tactile sensor noise profile domain randomizer for contact-rich robot manipulation training
...
try:
    ...
    _has_fastapi = False
PORT = 11144
SERVICE = "sim_tactile_sensor_noise_profile_randomizer"
DESCRIPTION = "Simulation tactile sensor noise profile domain randomizer for contact-rich robot manipulation training"
if _has_fastapi:

...
PORT = 15218
SERVICE = "robot-wave-solder"
DESCRIPTION = "Simulation service for wave solder robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-wave-solder</title><style>
...
<div class="header"><h1>robot-wave-solder</h1><div class="sub">Simulation service for wave solder robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15218 | <b>Status:</b> <span style="color:#4ade80">Live</span>

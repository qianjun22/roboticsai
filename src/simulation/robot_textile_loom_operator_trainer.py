...
PORT = 12144
SERVICE = "robot-textile-loom-operator-trainer"
DESCRIPTION = "Training environment for robotic textile loom operation — thread tensioning, pattern programming, defect detection, and web handling"

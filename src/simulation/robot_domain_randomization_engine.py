...
PORT = 51610
SERVICE = "robot-domain-randomization-engine"
DESCRIPTION = "Robotics simulation for domain randomization engine"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-domain-randomization-engine</title><style>
...
<div class="header"><h1>robot-domain-randomization-engine</h1><div class="subtitle">Robotics simulation for domain randomization engine · port 51610</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51610</div>

...
<div class="header"><h1>robot-domain-randomization-engine</h1><div class="subtitle">Robotics simulation for domain randomization engine · port 53530</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53530</div>

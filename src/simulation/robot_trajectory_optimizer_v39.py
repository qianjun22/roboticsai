...
PORT = 39478
SERVICE = "robot_trajectory_optimizer"
DESCRIPTION = "Simulation service for trajectory optimizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_trajectory_optimizer</title><style>
...
<div class="header"><h1>robot_trajectory_optimizer</h1><div class="subtitle">Simulation service for trajectory optimizer port 39478</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39478</div>

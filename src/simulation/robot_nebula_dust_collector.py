...
PORT = 16762
SERVICE = "robot_nebula_dust_collector"
DESCRIPTION = "Robotic nebula dust collector analyzing interstellar grain composition and pre-solar presolar particle capture"

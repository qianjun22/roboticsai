...
PORT = 13532
SERVICE = "robot_arctic_research_drone"
DESCRIPTION = "Arctic research drone robot simulation — autonomous polar exploration for ice core sampling, climate data collection, and wildlife monitoring in extreme cold environments"

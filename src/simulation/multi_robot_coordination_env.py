...
PORT = 11548
SERVICE = "multi-robot-coordination-env"
DESCRIPTION = "Simulation environment for multi-robot coordination tasks with collision avoidance and task allocation"

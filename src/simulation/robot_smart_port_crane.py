...
PORT = 13592
SERVICE = "robot_smart_port_crane"
DESCRIPTION = "Autonomous robot simulation for smart port crane operations — container stacking, load balancing, collision avoidance, and berth scheduling optimization"

...
PORT = 13740
SERVICE = "robot_ocean_plastic_cleanup_drone"
DESCRIPTION = "Ocean plastic cleanup drone simulation — autonomous surface robot for marine debris detection and collection"

...
PORT = 15058
SERVICE = "robot-panel-align"
DESCRIPTION = "Simulation service for panel align robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-panel-align</title><style>
...
<div class="header"><h1>robot-panel-align</h1><div class="sub">Simulation service for panel align robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15058 | <b>Status:</b> <span style="color:#4ade80">Live</span>

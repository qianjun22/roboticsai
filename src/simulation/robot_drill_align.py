...
PORT = 15130
SERVICE = "robot-drill-align"
DESCRIPTION = "Simulation service for drill align robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-drill-align</title><style>
...
<div class="header"><h1>robot-drill-align</h1><div class="sub">Simulation service for drill align robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15130 | <b>Status:</b> <span style="color:#4ade80">Live</span>

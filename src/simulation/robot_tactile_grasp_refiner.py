...
PORT = 50138
SERVICE = "robot-tactile-grasp-refiner"
DESCRIPTION = "Robotics simulation for tactile grasp refiner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tactile-grasp-refiner</title><style>
...
<div class="header"><h1>robot-tactile-grasp-refiner</h1><div class="subtitle">Robotics simulation for tactile grasp refiner · port 50138</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50138</div>

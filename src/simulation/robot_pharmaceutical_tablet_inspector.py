...
PORT = 13156
SERVICE = "robot_pharmaceutical_tablet_inspector"
DESCRIPTION = "Robot training for pharmaceutical tablet inspection with vision-based defect detection and weight verification"

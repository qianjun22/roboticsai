...
PORT = 13080
SERVICE = "robot_hazmat_handling_suit"
DESCRIPTION = "Robotic hazmat handling system — chemical spill containment, decontamination sequencing, and safe material disposal for emergency response"

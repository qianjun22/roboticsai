...
PORT = 53870
SERVICE = "robot-mass-spec-loader-bot"
DESCRIPTION = "Robotics simulation for mass spec loader bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mass-spec-loader-bot</title><style>
...
<div class="header"><h1>robot-mass-spec-loader-bot</h1><div class="subtitle">Robotics simulation for mass spec loader bot · port 53870</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53870</div>

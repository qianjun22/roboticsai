...
PORT = 13600
SERVICE = "robot_hyperloop_maintenance_bot"
DESCRIPTION = "Autonomous robot simulation for hyperloop maintenance — tube pressure inspection, maglev rail alignment, pod diagnostics, and emergency breach response"

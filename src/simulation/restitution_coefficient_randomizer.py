"""Domain randomization of restitution (bounciness) coefficients for sim diversity
...
try:
    ...
    _has_fastapi = False
PORT = 11048
SERVICE = "sim_restitution_coefficient_randomizer"
DESCRIPTION = "Domain randomization of restitution (bounciness) coefficients for sim diversity"
if _has_fastapi:

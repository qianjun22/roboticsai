...
PORT = 50926
SERVICE = "robot-autonomous-forklift-ctrl"
DESCRIPTION = "Robotics simulation for autonomous forklift ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-autonomous-forklift-ctrl</title><style>
...
<div class="header"><h1>robot-autonomous-forklift-ctrl</h1><div class="subtitle">Robotics simulation for autonomous forklift ctrl · port 50926</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50926</div>

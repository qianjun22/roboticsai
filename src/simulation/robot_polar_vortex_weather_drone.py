...
PORT = 13756
SERVICE = "robot_polar_vortex_weather_drone"
DESCRIPTION = "Polar vortex weather drone simulation — autonomous UAV for arctic atmospheric sampling, polar vortex tracking, and extreme cold-weather data collection"

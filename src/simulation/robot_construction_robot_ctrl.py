...
PORT = 50850
SERVICE = "robot-construction-robot-ctrl"
DESCRIPTION = "Robotics simulation for construction robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-construction-robot-ctrl</title><style>
...
<div class="header"><h1>robot-construction-robot-ctrl</h1><div class="subtitle">Robotics simulation for construction robot ctrl · port 50850</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50850</div>

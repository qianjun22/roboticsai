...
PORT = 11708
SERVICE = "robot-pharmaceutical-trainer"
DESCRIPTION = "Pharmaceutical manufacturing robot trainer for sterile handling, tablet sorting, and blister pack assembly"

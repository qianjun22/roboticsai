...
PORT = 12212
SERVICE = "sim-autonomous-vertical-farm-env"
DESCRIPTION = "Simulation environment for autonomous vertical farm robots — LED spectrum control, nutrient circulation, multi-tier harvesting, and pest detection"

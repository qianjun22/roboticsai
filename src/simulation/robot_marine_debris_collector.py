...
PORT = 12964
SERVICE = "robot_marine_debris_collector"
DESCRIPTION = "Autonomous marine debris collection robot — underwater navigation, debris classification, collection sequencing, and ocean health reporting"

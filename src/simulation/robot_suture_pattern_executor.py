...
<div class="header"><h1>robot-suture-pattern-executor</h1><div class="subtitle">Robotics simulation for suture pattern executor · port 52114</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52114</div>

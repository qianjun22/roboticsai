...
PORT = 53074
SERVICE = "robot-suture-pattern-executor"
DESCRIPTION = "Robotics simulation for suture pattern executor"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-suture-pattern-executor</title><style>
...
<div class="header"><h1>robot-suture-pattern-executor</h1><div class="subtitle">Robotics simulation for suture pattern executor · port 53074</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53074</div>

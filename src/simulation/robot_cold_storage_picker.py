...
PORT = 12772
SERVICE = "robot_cold_storage_picker"
DESCRIPTION = "Robotic cold storage order picking — temperature zone compliance, frosted surface grasping, and energy-efficient navigation for sub-zero environments"

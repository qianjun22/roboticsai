...
PORT = 13472
SERVICE = "robot_tire_vulcanization_controller"
DESCRIPTION = "Industrial tire vulcanization process robot with temperature-pressure control and cure monitoring"

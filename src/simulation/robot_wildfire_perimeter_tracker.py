...
PORT = 13608
SERVICE = "robot_wildfire_perimeter_tracker"
DESCRIPTION = "Autonomous robot system for wildfire perimeter tracking — deploys aerial and ground units to map fire boundaries in real time, feeding incident command centers with live spread predictions"

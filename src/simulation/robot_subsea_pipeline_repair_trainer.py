...
PORT = 12488
SERVICE = "robot_subsea_pipeline_repair_trainer"
DESCRIPTION = "Robot subsea pipeline repair trainer with underwater welding, leak detection, and remotely operated vehicle control simulation"

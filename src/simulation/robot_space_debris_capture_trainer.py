...
PORT = 12728
SERVICE = "robot-space-debris-capture-trainer"
DESCRIPTION = "Training pipeline for space robots performing orbital debris capture and deorbit using net and harpoon mechanisms"

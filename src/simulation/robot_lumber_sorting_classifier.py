...
PORT = 13164
SERVICE = "robot_lumber_sorting_classifier"
DESCRIPTION = "Robot training for lumber grading and sorting with vision-based knot detection and species classification"

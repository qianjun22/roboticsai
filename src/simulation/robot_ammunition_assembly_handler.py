...
PORT = 13172
SERVICE = "robot_ammunition_assembly_handler"
DESCRIPTION = "Robot training for ammunition assembly handling with safe sequencing and quality inspection protocols"

...
PORT = 12600
SERVICE = "robot-pharmaceutical-capsule-filling-trainer"
DESCRIPTION = "Training pipeline for pharmaceutical capsule filling robots with precision dosing and contamination prevention"

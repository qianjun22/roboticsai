...
PORT = 12760
SERVICE = "robot_bridge_inspection_crawler"
DESCRIPTION = "Autonomous robotic bridge inspection crawler — structural crack detection, cable tension monitoring, and corrosion mapping"

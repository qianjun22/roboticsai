...
PORT = 12596
SERVICE = "sim-autonomous-levee-inspection-env"
DESCRIPTION = "Simulation environment for autonomous levee and flood barrier inspection with aerial and ground robots"

...
PORT = 50310
SERVICE = "robot-aerial-inspection-arm"
DESCRIPTION = "Robotics simulation for aerial inspection arm"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-aerial-inspection-arm</title><style>
...
<div class="header"><h1>robot-aerial-inspection-arm</h1><div class="subtitle">Robotics simulation for aerial inspection arm · port 50310</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50310</div>

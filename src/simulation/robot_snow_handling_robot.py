...
PORT = 50746
SERVICE = "robot-snow-handling-robot"
DESCRIPTION = "Robotics simulation for snow handling robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-snow-handling-robot</title><style>
...
<div class="header"><h1>robot-snow-handling-robot</h1><div class="subtitle">Robotics simulation for snow handling robot · port 50746</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50746</div>

...
PORT = 53058
SERVICE = "robot-surgical-needle-driver"
DESCRIPTION = "Robotics simulation for surgical needle driver"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-surgical-needle-driver</title><style>
...
<div class="header"><h1>robot-surgical-needle-driver</h1><div class="subtitle">Robotics simulation for surgical needle driver · port 53058</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53058</div>

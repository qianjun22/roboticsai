...
PORT = 12532
SERVICE = "sim_autonomous_urban_flood_response_env"
DESCRIPTION = "Autonomous urban flood response robot simulation with water level sensing, pump deployment coordination, and rescue path planning"

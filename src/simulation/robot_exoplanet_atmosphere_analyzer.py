...
PORT = 16754
SERVICE = "robot_exoplanet_atmosphere_analyzer"
DESCRIPTION = "Robotic exoplanet atmosphere analyzer processing spectroscopic transit data to detect biosignature gases"

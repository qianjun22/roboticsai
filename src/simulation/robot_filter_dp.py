...
PORT = 15374
SERVICE = "robot-filter-dp"
DESCRIPTION = "Simulation service for filter dp robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-filter-dp</title><style>
...
<div class="header"><h1>robot-filter-dp</h1><div class="sub">Simulation service for filter dp robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15374 | <b>Status:</b> <span style="color:#4ade80">Live</span>

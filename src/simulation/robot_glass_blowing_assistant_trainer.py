...
PORT = 12152
SERVICE = "robot-glass-blowing-assistant-trainer"
DESCRIPTION = "Training environment for robotic glass blowing assistance — temperature control, molten glass shaping, mold positioning, and annealing coordination"

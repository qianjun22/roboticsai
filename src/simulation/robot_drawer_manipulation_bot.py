...
PORT = 50486
SERVICE = "robot-drawer-manipulation-bot"
DESCRIPTION = "Robotics simulation for drawer manipulation bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-drawer-manipulation-bot</title><style>
...
<div class="header"><h1>robot-drawer-manipulation-bot</h1><div class="subtitle">Robotics simulation for drawer manipulation bot · port 50486</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50486</div>

"""Sim Domain Adaptation V2 — advanced domain adaptation from simulation to real world.
...
PORT = 10624
SERVICE = "sim_domain_adaptation_v2"
DESCRIPTION = "Advanced domain adaptation from simulation to real world"

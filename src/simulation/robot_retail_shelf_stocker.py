...
PORT = 50934
SERVICE = "robot-retail-shelf-stocker"
DESCRIPTION = "Robotics simulation for retail shelf stocker"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-retail-shelf-stocker</title><style>
...
<div class="header"><h1>robot-retail-shelf-stocker</h1><div class="subtitle">Robotics simulation for retail shelf stocker · port 50934</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50934</div>

...
PORT = 13288
SERVICE = "robot_pharmaceutical_vial_filler"
DESCRIPTION = "Robot training for pharmaceutical vial filling with sterile environment compliance and fill volume precision control"

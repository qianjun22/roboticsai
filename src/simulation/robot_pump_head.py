...
PORT = 15366
SERVICE = "robot-pump-head"
DESCRIPTION = "Simulation service for pump head robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pump-head</title><style>
...
<div class="header"><h1>robot-pump-head</h1><div class="sub">Simulation service for pump head robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15366 | <b>Status:</b> <span style="color:#4ade80">Live</span>

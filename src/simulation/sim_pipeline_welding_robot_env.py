...
PORT = 11956
SERVICE = "sim_pipeline_welding_robot_env"
DESCRIPTION = "Pipeline welding robot simulation environment for joint preparation, weld quality monitoring, and post-weld inspection in industrial settings"

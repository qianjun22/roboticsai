...
PORT = 39274
SERVICE = "robot_pcb_inspection_robot"
DESCRIPTION = "Simulation service for pcb inspection robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_pcb_inspection_robot</title><style>
...
<div class="header"><h1>robot_pcb_inspection_robot</h1><div class="subtitle">Simulation service for pcb inspection robot port 39274</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39274</div>

...
PORT = 50418
SERVICE = "robot-swarm-formation-controller"
DESCRIPTION = "Robotics simulation for swarm formation controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-swarm-formation-controller</title><style>
...
<div class="header"><h1>robot-swarm-formation-controller</h1><div class="subtitle">Robotics simulation for swarm formation controller · port 50418</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50418</div>

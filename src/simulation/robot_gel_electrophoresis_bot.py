...
PORT = 50974
SERVICE = "robot-gel-electrophoresis-bot"
DESCRIPTION = "Robotics simulation for gel electrophoresis bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gel-electrophoresis-bot</title><style>
...
<div class="header"><h1>robot-gel-electrophoresis-bot</h1><div class="subtitle">Robotics simulation for gel electrophoresis bot · port 50974</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50974</div>

...
PORT = 11776
SERVICE = "sim-hydroponic-farm-robot-env"
DESCRIPTION = "Hydroponic farm robot simulation for nutrient management, plant health monitoring, and automated harvesting"

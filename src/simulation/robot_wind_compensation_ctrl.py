...
PORT = 50750
SERVICE = "robot-wind-compensation-ctrl"
DESCRIPTION = "Robotics simulation for wind compensation ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-wind-compensation-ctrl</title><style>
...
<div class="header"><h1>robot-wind-compensation-ctrl</h1><div class="subtitle">Robotics simulation for wind compensation ctrl · port 50750</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50750</div>

...
PORT = 11528
SERVICE = "sim_human_robot_collaboration_env"
DESCRIPTION = "Simulates human-robot collaboration scenarios with safety zones, handoff behaviors, and intent prediction"

...
PORT = 50938
SERVICE = "robot-checkout-automation-agent"
DESCRIPTION = "Robotics simulation for checkout automation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-checkout-automation-agent</title><style>
...
<div class="header"><h1>robot-checkout-automation-agent</h1><div class="subtitle">Robotics simulation for checkout automation agent · port 50938</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50938</div>

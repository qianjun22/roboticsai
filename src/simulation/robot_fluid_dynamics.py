...
PORT = 14966
SERVICE = "robot-fluid-dynamics"
DESCRIPTION = "Simulation service for fluid dynamics robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fluid-dynamics</title><style>
...
<div class="header"><h1>robot-fluid-dynamics</h1><div class="sub">Simulation service for fluid dynamics robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 14966 |&nbsp; <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 50902
SERVICE = "robot-food-handling-robot"
DESCRIPTION = "Robotics simulation for food handling robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-food-handling-robot</title><style>
...
<div class="header"><h1>robot-food-handling-robot</h1><div class="subtitle">Robotics simulation for food handling robot · port 50902</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50902</div>

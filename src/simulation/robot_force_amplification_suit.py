...
PORT = 51562
SERVICE = "robot-force-amplification-suit"
DESCRIPTION = "Robotics simulation for force amplification suit"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-force-amplification-suit</title><style>
...
<div class="header"><h1>robot-force-amplification-suit</h1><div class="subtitle">Robotics simulation for force amplification suit · port 51562</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51562</div>

...
PORT = 51166
SERVICE = "robot-instrument-collision-avoider"
DESCRIPTION = "Robotics simulation for instrument collision avoider"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-instrument-collision-avoider</title><style>
...
<div class="header"><h1>robot-instrument-collision-avoider</h1><div class="subtitle">Robotics simulation for instrument collision avoider · port 51166</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51166</div>

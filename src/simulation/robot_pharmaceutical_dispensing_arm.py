...
PORT = 12820
SERVICE = "robot_pharmaceutical_dispensing_arm"
DESCRIPTION = "Robotic pharmaceutical dispensing arm — dose verification, sterile handling protocols, expiry tracking, and patient safety cross-checks"

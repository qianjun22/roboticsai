...
PORT = 15118
SERVICE = "robot-cutter-guide"
DESCRIPTION = "Simulation service for cutter guide robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-cutter-guide</title><style>
...
<div class="header"><h1>robot-cutter-guide</h1><div class="sub">Simulation service for cutter guide robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15118 | <b>Status:</b> <span style="color:#4ade80">Live</span>

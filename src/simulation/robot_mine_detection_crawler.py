...
PORT = 53118
SERVICE = "robot-mine-detection-crawler"
DESCRIPTION = "Robotics simulation for mine detection crawler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-mine-detection-crawler</title><style>
...
<div class="header"><h1>robot-mine-detection-crawler</h1><div class="subtitle">Robotics simulation for mine detection crawler · port 53118</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53118</div>

...
PORT = 13692
SERVICE = "robot_hazmat_spill_containment_drone"
DESCRIPTION = "Hazmat spill containment drone simulation — autonomous aerial deployment of containment barriers for chemical and biological spills"

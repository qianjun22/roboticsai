...
PORT = 15022
SERVICE = "robot-pallet-stack"
DESCRIPTION = "Simulation service for pallet stack robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pallet-stack</title><style>
...
<div class="header"><h1>robot-pallet-stack</h1><div class="sub">Simulation service for pallet stack robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15022 | <b>Status:</b> <span style="color:#4ade80">Live</span>

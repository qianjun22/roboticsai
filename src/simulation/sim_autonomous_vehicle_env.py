...
PORT = 11676
SERVICE = "sim-autonomous-vehicle-env"
DESCRIPTION = "Autonomous vehicle simulation environment with LiDAR, camera fusion, pedestrian/cyclist interaction, and urban driving scenarios"

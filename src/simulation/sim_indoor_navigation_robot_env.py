...
PORT = 11828
SERVICE = "sim_indoor_navigation_robot_env"
DESCRIPTION = "Indoor navigation robot simulation environment for semantic mapping, waypoint planning, and dynamic obstacle handling"

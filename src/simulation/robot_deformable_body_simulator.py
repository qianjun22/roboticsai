...
PORT = 53554
SERVICE = "robot-deformable-body-simulator"
DESCRIPTION = "Robotics simulation for deformable body simulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-deformable-body-simulator</title><style>
...
<div class="header"><h1>robot-deformable-body-simulator</h1><div class="subtitle">Robotics simulation for deformable body simulator · port 53554</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53554</div>

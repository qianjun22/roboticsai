...
PORT = 15230
SERVICE = "robot-vibration-test"
DESCRIPTION = "Simulation service for vibration test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-vibration-test</title><style>
...
<div class="header"><h1>robot-vibration-test</h1><div class="sub">Simulation service for vibration test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15230 | <b>Status:</b> <span style="color:#4ade80">Live</span>

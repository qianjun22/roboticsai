...
PORT = 50522
SERVICE = "robot-pneumatic-actuator-mgr"
DESCRIPTION = "Robotics simulation for pneumatic actuator mgr"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pneumatic-actuator-mgr</title><style>
...
<div class="header"><h1>robot-pneumatic-actuator-mgr</h1><div class="subtitle">Robotics simulation for pneumatic actuator mgr · port 50522</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50522</div>

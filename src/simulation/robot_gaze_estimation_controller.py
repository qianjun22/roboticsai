...
PORT = 53510
SERVICE = "robot-gaze-estimation-controller"
DESCRIPTION = "Robotics simulation for gaze estimation controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-gaze-estimation-controller</title><style>
...
<div class="header"><h1>robot-gaze-estimation-controller</h1><div class="subtitle">Robotics simulation for gaze estimation controller · port 53510</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53510</div>

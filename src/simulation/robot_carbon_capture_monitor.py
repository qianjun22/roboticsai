...
PORT = 12956
SERVICE = "robot_carbon_capture_monitor"
DESCRIPTION = "Robotic carbon capture monitoring system — autonomous sensor deployment, CO2 absorption measurement, and efficiency optimization for DAC facilities"

...
PORT = 12340
SERVICE = "sim_autonomous_retail_inventory_robot_env"
DESCRIPTION = "Simulation environment for autonomous retail inventory robot shelf scanning and stock management"

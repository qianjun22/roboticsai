...
PORT = 15054
SERVICE = "robot-connector-mate"
DESCRIPTION = "Simulation service for connector mate robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-connector-mate</title><style>
...
<div class="header"><h1>robot-connector-mate</h1><div class="sub">Simulation service for connector mate robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15054 | <b>Status:</b> <span style="color:#4ade80">Live</span>

...
PORT = 11716
SERVICE = "robot-vineyard-harvesting-trainer"
DESCRIPTION = "Vineyard harvesting robot trainer for grape cluster detection, selective picking, and terrain navigation"

...
PORT = 11560
SERVICE = "sim-contact-rich-assembly-env"
DESCRIPTION = "Contact-rich assembly simulation environment with force/torque sensing and compliance control for precision tasks"

...
PORT = 50714
SERVICE = "robot-chemical-detection-bot"
DESCRIPTION = "Robotics simulation for chemical detection bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-chemical-detection-bot</title><style>
...
<div class="header"><h1>robot-chemical-detection-bot</h1><div class="subtitle">Robotics simulation for chemical detection bot · port 50714</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50714</div>

...
PORT = 13040
SERVICE = "robot_paint_spray_coater"
DESCRIPTION = "Robotic paint spray coating system — surface prep validation, coat thickness control, overspray minimization, and cure schedule optimization"

...
PORT = 12136
SERVICE = "robot-printing-press-operator-trainer"
DESCRIPTION = "Training environment for robotic printing press operation — ink management, plate alignment, substrate feeding, and quality inspection"

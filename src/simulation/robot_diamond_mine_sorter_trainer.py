...
PORT = 12248
SERVICE = "robot-diamond-mine-sorter-trainer"
DESCRIPTION = "Training environment for robotic diamond mine ore sorting — X-ray fluorescence analysis, high-value fragment detection, conveyor control, and tailings management"

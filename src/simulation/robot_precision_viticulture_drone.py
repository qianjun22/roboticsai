...
PORT = 13808
SERVICE = "robot_precision_viticulture_drone"
DESCRIPTION = "Robotic precision viticulture drone service — autonomous vineyard monitoring, disease detection, and harvest yield prediction for wine production"

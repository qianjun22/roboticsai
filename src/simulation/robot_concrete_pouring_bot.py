...
PORT = 50858
SERVICE = "robot-concrete-pouring-bot"
DESCRIPTION = "Robotics simulation for concrete pouring bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-concrete-pouring-bot</title><style>
...
<div class="header"><h1>robot-concrete-pouring-bot</h1><div class="subtitle">Robotics simulation for concrete pouring bot · port 50858</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50858</div>

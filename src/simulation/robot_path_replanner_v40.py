...
PORT = 40206
SERVICE = "robot_path_replanner"
DESCRIPTION = "Simulation service for path replanner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_path_replanner</title><style>
...
<div class="header"><h1>robot_path_replanner</h1><div class="subtitle">Simulation service for path replanner port 40206</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40206</div>

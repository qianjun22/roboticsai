...
PORT = 12840
SERVICE = "robot_package_last_mile_delivery"
DESCRIPTION = "Autonomous last-mile package delivery robot — sidewalk navigation, doorbell interaction, secure drop protocols, and failed delivery rerouting"

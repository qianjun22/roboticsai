"""Photorealistic lighting environment randomizer with 400 HDR maps, dynamic shadows, and material response variation
...
DESCRIPTION = "Photorealistic lighting environment randomizer with 400 HDR maps, dynamic shadows, and material response variation"
if _has_fastapi:

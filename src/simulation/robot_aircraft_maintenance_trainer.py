...
PORT = 12064
SERVICE = "robot-aircraft-maintenance-trainer"
DESCRIPTION = "Robot training environment for aircraft maintenance including engine inspection and fuselage repair"

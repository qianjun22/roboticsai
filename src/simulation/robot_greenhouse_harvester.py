...
PORT = 38454
SERVICE = "robot_greenhouse_harvester"
DESCRIPTION = "Greenhouse harvesting simulation with plant detection and picking"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_greenhouse_harvester</title><style>
...
<div class="header"><h1>robot_greenhouse_harvester</h1><div class="subtitle">Greenhouse harvesting simulation with plant detection and picking · port 38454</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 38454</div>

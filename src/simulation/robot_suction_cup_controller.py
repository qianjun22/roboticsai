...
PORT = 50538
SERVICE = "robot-suction-cup-controller"
DESCRIPTION = "Robotics simulation for suction cup controller"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-suction-cup-controller</title><style>
...
<div class="header"><h1>robot-suction-cup-controller</h1><div class="subtitle">Robotics simulation for suction cup controller · port 50538</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50538</div>

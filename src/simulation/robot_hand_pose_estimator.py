...
PORT = 54002
SERVICE = "robot-hand-pose-estimator"
DESCRIPTION = "Robotics simulation for hand pose estimator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-hand-pose-estimator</title><style>
...
<div class="header"><h1>robot-hand-pose-estimator</h1><div class="subtitle">Robotics simulation for hand pose estimator · port 54002</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 54002</div>

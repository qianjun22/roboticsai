...
PORT = 14226
SERVICE = "robot_precision_optical_fiber_splicer"
DESCRIPTION = "Precision optical fiber splicing robot simulation for high-accuracy photonic interconnect assembly"

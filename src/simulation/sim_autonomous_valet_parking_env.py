...
PORT = 11836
SERVICE = "sim_autonomous_valet_parking_env"
DESCRIPTION = "Autonomous valet parking simulation environment for precision maneuvering, space detection, and multi-vehicle coordination"

...
PORT = 51434
SERVICE = "robot-snap-fit-assembler"
DESCRIPTION = "Robotics simulation for snap fit assembler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-snap-fit-assembler</title><style>
...
<div class="header"><h1>robot-snap-fit-assembler</h1><div class="subtitle">Robotics simulation for snap fit assembler · port 51434</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51434</div>

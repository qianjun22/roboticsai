...
PORT = 13056
SERVICE = "robot_circuit_board_rework"
DESCRIPTION = "Robotic circuit board rework station — component desoldering, pad cleaning, replacement placement, and reflow profile optimization"

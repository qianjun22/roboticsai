...
PORT = 11868
SERVICE = "robot_power_grid_inspector_trainer"
DESCRIPTION = "Power grid inspection robot trainer for transmission line monitoring, insulator defect detection, and substation equipment assessment"

...
PORT = 11808
SERVICE = "sim-cold-storage-logistics-robot-env"
DESCRIPTION = "Cold storage logistics robot simulation for temperature-sensitive cargo handling and freezer navigation"

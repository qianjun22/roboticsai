...
PORT = 11892
SERVICE = "sim_hospital_logistics_robot_env"
DESCRIPTION = "Hospital logistics robot simulation environment for medication delivery, lab specimen transport, and sterile supply chain management"

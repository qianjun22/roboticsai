...
PORT = 13180
SERVICE = "robot_glacier_monitoring_drone"
DESCRIPTION = "Robot training for glacier monitoring drone with ice thickness measurement and calving event detection"

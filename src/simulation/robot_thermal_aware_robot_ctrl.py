...
PORT = 50698
SERVICE = "robot-thermal-aware-robot-ctrl"
DESCRIPTION = "Robotics simulation for thermal aware robot ctrl"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-thermal-aware-robot-ctrl</title><style>
...
<div class="header"><h1>robot-thermal-aware-robot-ctrl</h1><div class="subtitle">Robotics simulation for thermal aware robot ctrl · port 50698</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50698</div>

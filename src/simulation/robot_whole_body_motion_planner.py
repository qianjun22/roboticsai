...
PORT = 51042
SERVICE = "robot-whole-body-motion-planner"
DESCRIPTION = "Robotics simulation for whole body motion planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-whole-body-motion-planner</title><style>
...
<div class="header"><h1>robot-whole-body-motion-planner</h1><div class="subtitle">Robotics simulation for whole body motion planner · port 51042</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51042</div>

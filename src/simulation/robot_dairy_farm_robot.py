...
PORT = 50830
SERVICE = "robot-dairy-farm-robot"
DESCRIPTION = "Robotics simulation for dairy farm robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-dairy-farm-robot</title><style>
...
<div class="header"><h1>robot-dairy-farm-robot</h1><div class="subtitle">Robotics simulation for dairy farm robot · port 50830</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50830</div>

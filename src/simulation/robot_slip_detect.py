...
PORT = 15086
SERVICE = "robot-slip-detect"
DESCRIPTION = "Simulation service for slip detect robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-slip-detect</title><style>
...
<div class="header"><h1>robot-slip-detect</h1><div class="sub">Simulation service for slip detect robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15086 | <b>Status:</b> <span style="color:#4ade80">Live</span>

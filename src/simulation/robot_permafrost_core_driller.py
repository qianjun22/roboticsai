...
PORT = 13184
SERVICE = "robot_permafrost_core_driller"
DESCRIPTION = "Robot training for permafrost core drilling with temperature-adaptive bit control and sample preservation"

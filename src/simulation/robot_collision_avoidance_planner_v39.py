...
PORT = 39362
SERVICE = "robot_collision_avoidance_planner"
DESCRIPTION = "Simulation service for collision avoidance planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_collision_avoidance_planner</title><style>
...
<div class="header"><h1>robot_collision_avoidance_planner</h1><div class="subtitle">Simulation service for collision avoidance planner port 39362</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 39362</div>

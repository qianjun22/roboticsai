...
PORT = 53422
SERVICE = "robot-jamming-gripper-planner"
DESCRIPTION = "Robotics simulation for jamming gripper planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-jamming-gripper-planner</title><style>
...
<div class="header"><h1>robot-jamming-gripper-planner</h1><div class="subtitle">Robotics simulation for jamming gripper planner · port 53422</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53422</div>

...
PORT = 51262
SERVICE = "robot-tethered-aerial-manipulator"
DESCRIPTION = "Robotics simulation for tethered aerial manipulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tethered-aerial-manipulator</title><style>
...
<div class="header"><h1>robot-tethered-aerial-manipulator</h1><div class="subtitle">Robotics simulation for tethered aerial manipulator · port 51262</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51262</div>

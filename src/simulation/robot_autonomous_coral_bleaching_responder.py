...
PORT = 14966
SERVICE = "robot_autonomous_coral_bleaching_responder"
DESCRIPTION = "Autonomous underwater robotic system for coral reef monitoring and bleaching intervention"

...
PORT = 12636
SERVICE = "sim-autonomous-estuary-conservation-env"
DESCRIPTION = "Simulation environment for autonomous estuary and wetland conservation with water quality sensing robots"

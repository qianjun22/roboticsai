...
PORT = 11624
SERVICE = "sim-underwater-robot-env"
DESCRIPTION = "Underwater robot simulation environment with hydrodynamic forces, buoyancy, and subsea inspection task scenarios"

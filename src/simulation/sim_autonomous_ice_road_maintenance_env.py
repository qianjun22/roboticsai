...
PORT = 12508
SERVICE = "sim_autonomous_ice_road_maintenance_env"
DESCRIPTION = "Autonomous ice road maintenance robot simulation with surface condition sensing, de-icing material distribution, and load capacity monitoring"

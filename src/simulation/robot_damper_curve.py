...
PORT = 15334
SERVICE = "robot-damper-curve"
DESCRIPTION = "Simulation service for damper curve robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-damper-curve</title><style>
...
<div class="header"><h1>robot-damper-curve</h1><div class="sub">Simulation service for damper curve robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15334 | <b>Status:</b> <span style="color:#4ade80">Live</span>

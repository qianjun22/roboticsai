...
PORT = 50954
SERVICE = "robot-pharmacy-dispensing-bot"
DESCRIPTION = "Robotics simulation for pharmacy dispensing bot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-pharmacy-dispensing-bot</title><style>
...
<div class="header"><h1>robot-pharmacy-dispensing-bot</h1><div class="subtitle">Robotics simulation for pharmacy dispensing bot · port 50954</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50954</div>

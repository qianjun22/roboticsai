...
PORT = 12560
SERVICE = "robot_optical_fiber_splicing_trainer"
DESCRIPTION = "Robot optical fiber splicing trainer with sub-micron alignment, fusion splice loss measurement, and cable management simulation"

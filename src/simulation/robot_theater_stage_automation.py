...
PORT = 12880
SERVICE = "robot_theater_stage_automation"
DESCRIPTION = "Robotic theater stage automation — set piece movement choreography, lighting rig positioning, and safe human performer co-presence management"

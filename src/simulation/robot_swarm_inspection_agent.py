...
PORT = 51422
SERVICE = "robot-swarm-inspection-agent"
DESCRIPTION = "Robotics simulation for swarm inspection agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-swarm-inspection-agent</title><style>
...
<div class="header"><h1>robot-swarm-inspection-agent</h1><div class="subtitle">Robotics simulation for swarm inspection agent · port 51422</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51422</div>

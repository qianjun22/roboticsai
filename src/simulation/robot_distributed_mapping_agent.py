...
<div class="header"><h1>robot-distributed-mapping-agent</h1><div class="subtitle">Robotics simulation for distributed mapping agent · port 51394</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51394</div>

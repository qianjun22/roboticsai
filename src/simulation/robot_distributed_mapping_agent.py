...
PORT = 50434
SERVICE = "robot-distributed-mapping-agent"
DESCRIPTION = "Robotics simulation for distributed mapping agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-distributed-mapping-agent</title><style>
...
<div class="header"><h1>robot-distributed-mapping-agent</h1><div class="subtitle">Robotics simulation for distributed mapping agent · port 50434</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50434</div>

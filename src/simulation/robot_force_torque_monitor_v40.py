...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_force_torque_monitor</title><style>
...
<div class="header"><h1>robot_force_torque_monitor</h1><div class="subtitle">Simulation service for force torque monitor port 40546</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 40546</div>

...
PORT = 11744
SERVICE = "sim-sewage-treatment-robot-env"
DESCRIPTION = "Sewage treatment plant robot simulation for pipe maintenance, sensor calibration, and chemical dosing tasks"

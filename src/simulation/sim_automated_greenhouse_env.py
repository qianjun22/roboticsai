...
PORT = 11820
SERVICE = "sim_automated_greenhouse_env"
DESCRIPTION = "Automated greenhouse environment simulator for climate control, irrigation scheduling, and crop growth optimization"

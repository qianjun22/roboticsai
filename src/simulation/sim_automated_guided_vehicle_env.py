...
PORT = 12124
SERVICE = "sim-automated-guided-vehicle-env"
DESCRIPTION = "Simulation environment for automated guided vehicle (AGV) path planning and fleet coordination training"

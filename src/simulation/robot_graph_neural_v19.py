...
PORT = 46834
SERVICE = "robot_graph_neural_v19"
DESCRIPTION = "Graph neural network for robot simulation and policy learning"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_graph_neural_v19</title><style>
...
<div class="header"><h1>robot_graph_neural_v19</h1><div class="subtitle">Graph neural network for robot simulation and policy learning · port 46834</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 46834</div>

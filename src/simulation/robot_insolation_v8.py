...
PORT = 40862
SERVICE = "robot-insolation-v8"
DESCRIPTION = "Solar insolation-adaptive robot simulation for energy-aware scheduling and photovoltaic-powered field operations"

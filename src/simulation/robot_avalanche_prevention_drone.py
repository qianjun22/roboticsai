...
PORT = 13604
SERVICE = "robot_avalanche_prevention_drone"
DESCRIPTION = "Autonomous drone system for avalanche prevention — monitors snowpack instability, deploys controlled charges, and coordinates evacuation alerts in mountain terrain"

...
PORT = 14306
SERVICE = "robot_precision_cardiac_stent_placer"
DESCRIPTION = "Precision cardiac stent placement robot simulation for minimally invasive coronary intervention"

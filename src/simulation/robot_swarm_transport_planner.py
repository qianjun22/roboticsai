...
PORT = 50426
SERVICE = "robot-swarm-transport-planner"
DESCRIPTION = "Robotics simulation for swarm transport planner"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-swarm-transport-planner</title><style>
...
<div class="header"><h1>robot-swarm-transport-planner</h1><div class="subtitle">Robotics simulation for swarm transport planner · port 50426</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50426</div>

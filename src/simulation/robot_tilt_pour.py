...
PORT = 15102
SERVICE = "robot-tilt-pour"
DESCRIPTION = "Simulation service for tilt pour robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-tilt-pour</title><style>
...
<div class="header"><h1>robot-tilt-pour</h1><div class="sub">Simulation service for tilt pour robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15102 | <b>Status:</b> <span style="color:#4ade80">Live</span>

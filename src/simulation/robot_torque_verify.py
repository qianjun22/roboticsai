...
PORT = 15322
SERVICE = "robot-torque-verify"
DESCRIPTION = "Simulation service for torque verify robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-torque-verify</title><style>
...
<div class="header"><h1>robot-torque-verify</h1><div class="sub">Simulation service for torque verify robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15322 | <b>Status:</b> <span style="color:#4ade80">Live</span>

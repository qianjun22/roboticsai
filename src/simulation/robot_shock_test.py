...
PORT = 15234
SERVICE = "robot-shock-test"
DESCRIPTION = "Simulation service for shock test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-shock-test</title><style>
...
<div class="header"><h1>robot-shock-test</h1><div class="sub">Simulation service for shock test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15234 | <b>Status:</b> <span style="color:#4ade80">Live</span>

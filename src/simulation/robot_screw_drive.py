...
PORT = 15042
SERVICE = "robot-screw-drive"
DESCRIPTION = "Simulation service for screw drive robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-screw-drive</title><style>
...
<div class="header"><h1>robot-screw-drive</h1><div class="sub">Simulation service for screw drive robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15042 | <b>Status:</b> <span style="color:#4ade80">Live</span>

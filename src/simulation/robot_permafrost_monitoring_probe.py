...
PORT = 13636
SERVICE = "robot_permafrost_monitoring_probe"
DESCRIPTION = "Autonomous permafrost monitoring probe robot — drills into arctic and subarctic soil to measure temperature gradients, methane emissions, and soil stability, providing early warning data for climate researchers and infrastructure planners"

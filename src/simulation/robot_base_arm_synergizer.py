...
PORT = 52982
SERVICE = "robot-base-arm-synergizer"
DESCRIPTION = "Robotics simulation for base arm synergizer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-base-arm-synergizer</title><style>
...
<div class="header"><h1>robot-base-arm-synergizer</h1><div class="subtitle">Robotics simulation for base arm synergizer · port 52982</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52982</div>

...
PORT = 11588
SERVICE = "robot-bimanual-coordination-trainer"
DESCRIPTION = "Trains bimanual robot coordination policies for two-arm manipulation tasks with synchronized motion planning"

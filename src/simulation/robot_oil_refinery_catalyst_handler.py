...
PORT = 12704
SERVICE = "robot-oil-refinery-catalyst-handler"
DESCRIPTION = "Training pipeline for robots performing catalyst loading and unloading in oil refinery reactor vessels"

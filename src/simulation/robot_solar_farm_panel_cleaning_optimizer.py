...
PORT = 12632
SERVICE = "robot-solar-farm-panel-cleaning-optimizer"
DESCRIPTION = "Optimizes robotic cleaning schedules for utility-scale solar farms to maximize energy yield"

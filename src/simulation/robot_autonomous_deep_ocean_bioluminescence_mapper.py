...
PORT = 14978
SERVICE = "robot_autonomous_deep_ocean_bioluminescence_mapper"
DESCRIPTION = "Autonomous deep-sea robotic system for mapping bioluminescent organism distributions"

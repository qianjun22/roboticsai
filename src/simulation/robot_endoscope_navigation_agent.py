...
PORT = 52110
SERVICE = "robot-endoscope-navigation-agent"
DESCRIPTION = "Robotics simulation for endoscope navigation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-endoscope-navigation-agent</title><style>
...
<div class="header"><h1>robot-endoscope-navigation-agent</h1><div class="subtitle">Robotics simulation for endoscope navigation agent · port 52110</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52110</div>

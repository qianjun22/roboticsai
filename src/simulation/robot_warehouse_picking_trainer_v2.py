...
PORT = 11644
SERVICE = "robot-warehouse-picking-trainer-v2"
DESCRIPTION = "Enhanced warehouse picking trainer v2 with multi-SKU recognition, dynamic bin locations, and order batching optimization"

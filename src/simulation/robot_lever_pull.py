...
PORT = 15034
SERVICE = "robot-lever-pull"
DESCRIPTION = "Simulation service for lever pull robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-lever-pull</title><style>
...
<div class="header"><h1>robot-lever-pull</h1><div class="sub">Simulation service for lever pull robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15034 | <b>Status:</b> <span style="color:#4ade80">Live</span>

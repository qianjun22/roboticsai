...
PORT = 12680
SERVICE = "robot-mine-tunnel-mapping-trainer"
DESCRIPTION = "Training pipeline for robots performing 3D mapping and hazard detection in underground mine tunnels"

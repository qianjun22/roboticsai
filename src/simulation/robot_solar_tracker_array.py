...
PORT = 13044
SERVICE = "robot_solar_tracker_array"
DESCRIPTION = "Robotic solar tracker array controller — single-axis and dual-axis tracking optimization, panel cleaning scheduling, and output monitoring"

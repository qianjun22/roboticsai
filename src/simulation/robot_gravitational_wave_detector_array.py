...
PORT = 15642
SERVICE = "robot_gravitational_wave_detector_array"
DESCRIPTION = "Autonomous robotic array for maintaining precision alignment of gravitational wave interferometers"

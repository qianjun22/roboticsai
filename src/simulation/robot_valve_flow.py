...
PORT = 15370
SERVICE = "robot-valve-flow"
DESCRIPTION = "Simulation service for valve flow robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-valve-flow</title><style>
...
<div class="header"><h1>robot-valve-flow</h1><div class="sub">Simulation service for valve flow robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15370 | <b>Status:</b> <span style="color:#4ade80">Live</span>

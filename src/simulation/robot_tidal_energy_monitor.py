...
PORT = 13588
SERVICE = "robot_tidal_energy_monitor"
DESCRIPTION = "Autonomous robot simulation for tidal energy monitoring — underwater turbine inspection, sediment analysis, and power generation telemetry"

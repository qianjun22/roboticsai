...
PORT = 11664
SERVICE = "robot-fire-fighting-trainer"
DESCRIPTION = "Firefighting robot trainer with thermal imaging, hose deployment, door breach, and smoke-navigation policy learning"

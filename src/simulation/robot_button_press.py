...
PORT = 15030
SERVICE = "robot-button-press"
DESCRIPTION = "Simulation service for button press robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-button-press</title><style>
...
<div class="header"><h1>robot-button-press</h1><div class="sub">Simulation service for button press robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15030 | <b>Status:</b> <span style="color:#4ade80">Live</span>

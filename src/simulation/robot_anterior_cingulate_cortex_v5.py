...
PORT = 31574
SERVICE = "robot_anterior_cingulate_cortex_v5"
DESCRIPTION = "Anterior cingulate cortex simulation service for robotics conflict detection and error monitoring"

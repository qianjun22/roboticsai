...
PORT = 53842
SERVICE = "robot-sample-handling-robot"
DESCRIPTION = "Robotics simulation for sample handling robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-sample-handling-robot</title><style>
...
<div class="header"><h1>robot-sample-handling-robot</h1><div class="subtitle">Robotics simulation for sample handling robot · port 53842</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53842</div>

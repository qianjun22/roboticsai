...
PORT = 11792
SERVICE = "sim-smart-factory-robot-env"
DESCRIPTION = "Smart factory robot simulation environment for autonomous production line management and quality control"

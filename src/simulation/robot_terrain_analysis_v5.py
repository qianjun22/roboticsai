...
PORT = 30718
SERVICE = "robot_terrain_analysis_v5"
DESCRIPTION = "Terrain analysis simulation microservice for robotics surface classification and traversability assessment"

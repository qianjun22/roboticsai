...
PORT = 12824
SERVICE = "robot_mining_ore_sorter"
DESCRIPTION = "Robotic ore sorting system for mining — hyperspectral grade classification, conveyor control, and real-time yield optimization"

...
PORT = 15090
SERVICE = "robot-grasp-plan"
DESCRIPTION = "Simulation service for grasp plan robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-grasp-plan</title><style>
...
<div class="header"><h1>robot-grasp-plan</h1><div class="sub">Simulation service for grasp plan robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15090 | <b>Status:</b> <span style="color:#4ade80">Live</span>

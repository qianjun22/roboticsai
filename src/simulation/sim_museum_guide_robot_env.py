...
PORT = 11720
SERVICE = "sim-museum-guide-robot-env"
DESCRIPTION = "Museum guide robot simulation environment for visitor interaction, exhibit navigation, and Q&A task policies"

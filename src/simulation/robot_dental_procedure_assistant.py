...
PORT = 12932
SERVICE = "robot_dental_procedure_assistant"
DESCRIPTION = "Robotic dental procedure assistant — tool handoff sequencing, suction placement optimization, patient motion compensation, and procedure timing analytics"

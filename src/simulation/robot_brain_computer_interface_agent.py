...
PORT = 50638
SERVICE = "robot-brain-computer-interface-agent"
DESCRIPTION = "Robotics simulation for brain computer interface agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-brain-computer-interface-agent</title><style>
...
<div class="header"><h1>robot-brain-computer-interface-agent</h1><div class="subtitle">Robotics simulation for brain computer interface agent · port 50638</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50638</div>

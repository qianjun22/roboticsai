...
<div class="header"><h1>robot-brain-computer-interface-agent</h1><div class="subtitle">Robotics simulation for brain computer interface agent · port 53518</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53518</div>

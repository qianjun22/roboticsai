...
PORT = 11752
SERVICE = "sim-lunar-surface-robot-env"
DESCRIPTION = "Lunar surface robot simulation environment for regolith excavation, base construction, and low-gravity navigation"

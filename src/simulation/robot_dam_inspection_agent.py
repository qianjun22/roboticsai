...
PORT = 50798
SERVICE = "robot-dam-inspection-agent"
DESCRIPTION = "Robotics simulation for dam inspection agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-dam-inspection-agent</title><style>
...
<div class="header"><h1>robot-dam-inspection-agent</h1><div class="subtitle">Robotics simulation for dam inspection agent · port 50798</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50798</div>

...
PORT = 52074
SERVICE = "robot-compliant-finger-regulator"
DESCRIPTION = "Robotics simulation for compliant finger regulator"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-compliant-finger-regulator</title><style>
...
<div class="header"><h1>robot-compliant-finger-regulator</h1><div class="subtitle">Robotics simulation for compliant finger regulator · port 52074</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52074</div>

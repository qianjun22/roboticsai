...
PORT = 53214
SERVICE = "robot-rov-tool-changer"
DESCRIPTION = "Robotics simulation for rov tool changer"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-rov-tool-changer</title><style>
...
<div class="header"><h1>robot-rov-tool-changer</h1><div class="subtitle">Robotics simulation for rov tool changer · port 53214</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53214</div>

...
PORT = 13748
SERVICE = "robot_space_station_maintenance_bot"
DESCRIPTION = "Space station maintenance bot simulation — zero-gravity robotic arm for EVA task assistance, hull inspection, and orbital infrastructure repair"

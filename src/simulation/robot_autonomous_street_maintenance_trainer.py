...
PORT = 11832
SERVICE = "robot_autonomous_street_maintenance_trainer"
DESCRIPTION = "Autonomous street maintenance robot trainer for pothole detection, crack sealing, and infrastructure inspection tasks"

...
PORT = 11648
SERVICE = "sim-space-robot-env"
DESCRIPTION = "Space robot simulation environment with zero-gravity dynamics, satellite servicing tasks, and microgravity manipulation"

...
PORT = 11672
SERVICE = "robot-elderly-care-trainer"
DESCRIPTION = "Elderly care robot trainer for fall detection, medication reminders, mobility assistance, and social engagement tasks"

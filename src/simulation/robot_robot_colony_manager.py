...
PORT = 52370
SERVICE = "robot-robot-colony-manager"
DESCRIPTION = "Robotics simulation for robot colony manager"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-robot-colony-manager</title><style>
...
<div class="header"><h1>robot-robot-colony-manager</h1><div class="subtitle">Robotics simulation for robot colony manager · port 52370</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 52370</div>

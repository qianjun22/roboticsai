...
PORT = 13616
SERVICE = "robot_space_debris_tracker"
DESCRIPTION = "Autonomous space debris tracking robot — uses radar and optical sensors to catalog orbital debris, predict collision risks with active satellites, and recommend avoidance maneuvers"

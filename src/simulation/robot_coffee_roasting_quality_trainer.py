...
PORT = 12432
SERVICE = "robot_coffee_roasting_quality_trainer"
DESCRIPTION = "Robot coffee roasting quality trainer with temperature profiling, bean color analysis, and roast curve optimization"

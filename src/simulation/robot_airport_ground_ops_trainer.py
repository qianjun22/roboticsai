...
PORT = 11896
SERVICE = "robot_airport_ground_ops_trainer"
DESCRIPTION = "Airport ground operations robot trainer for baggage handling, aircraft pushback assistance, and runway FOD detection"

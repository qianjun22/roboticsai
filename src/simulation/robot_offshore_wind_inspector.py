...
PORT = 13620
SERVICE = "robot_offshore_wind_inspector"
DESCRIPTION = "Autonomous offshore wind turbine inspection robot — navigates marine environments to perform blade, tower, and foundation inspections using ultrasonic and visual sensors, reducing human exposure to hazardous offshore conditions"

...
PORT = 50958
SERVICE = "robot-lab-automation-agent"
DESCRIPTION = "Robotics simulation for lab automation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-lab-automation-agent</title><style>
...
<div class="header"><h1>robot-lab-automation-agent</h1><div class="subtitle">Robotics simulation for lab automation agent · port 50958</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50958</div>

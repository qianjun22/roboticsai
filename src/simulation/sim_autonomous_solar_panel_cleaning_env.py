...
PORT = 12492
SERVICE = "sim_autonomous_solar_panel_cleaning_env"
DESCRIPTION = "Autonomous solar panel cleaning robot simulation with dust accumulation modeling, cleaning path optimization, and power generation impact tracking"

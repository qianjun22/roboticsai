...
PORT = 51018
SERVICE = "robot-deformable-cloth-handler"
DESCRIPTION = "Robotics simulation for deformable cloth handler"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-deformable-cloth-handler</title><style>
...
<div class="header"><h1>robot-deformable-cloth-handler</h1><div class="subtitle">Robotics simulation for deformable cloth handler · port 51018</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 51018</div>

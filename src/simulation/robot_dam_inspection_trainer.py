...
PORT = 11912
SERVICE = "robot_dam_inspection_trainer"
DESCRIPTION = "Dam inspection robot trainer for crack detection, seepage monitoring, and structural health assessment in hydroelectric infrastructure"

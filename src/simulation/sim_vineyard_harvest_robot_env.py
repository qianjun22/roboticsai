...
PORT = 11908
SERVICE = "sim_vineyard_harvest_robot_env"
DESCRIPTION = "Vineyard harvest robot simulation environment for grape cluster detection, selective picking, and terrain navigation on uneven slopes"

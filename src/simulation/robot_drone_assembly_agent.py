...
PORT = 50282
SERVICE = "robot-drone-assembly-agent"
DESCRIPTION = "Robotics simulation for drone assembly agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-drone-assembly-agent</title><style>
...
<div class="header"><h1>robot-drone-assembly-agent</h1><div class="subtitle">Robotics simulation for drone assembly agent · port 50282</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50282</div>

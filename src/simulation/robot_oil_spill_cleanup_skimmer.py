...
PORT = 13360
SERVICE = "robot_oil_spill_cleanup_skimmer"
DESCRIPTION = "Robot training for oil spill cleanup with surface skimmer navigation, oil-water separation, and containment boom deployment"

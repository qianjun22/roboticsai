...
PORT = 53798
SERVICE = "robot-order-picking-robot"
DESCRIPTION = "Robotics simulation for order picking robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-order-picking-robot</title><style>
...
<div class="header"><h1>robot-order-picking-robot</h1><div class="subtitle">Robotics simulation for order picking robot · port 53798</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53798</div>

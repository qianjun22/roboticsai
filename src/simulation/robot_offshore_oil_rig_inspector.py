...
PORT = 13304
SERVICE = "robot_offshore_oil_rig_inspector"
DESCRIPTION = "Robot training for offshore oil rig inspection with corrosion detection, flare stack monitoring, and subsea riser assessment"

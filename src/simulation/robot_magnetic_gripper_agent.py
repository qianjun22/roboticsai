...
PORT = 53414
SERVICE = "robot-magnetic-gripper-agent"
DESCRIPTION = "Robotics simulation for magnetic gripper agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-magnetic-gripper-agent</title><style>
...
<div class="header"><h1>robot-magnetic-gripper-agent</h1><div class="subtitle">Robotics simulation for magnetic gripper agent · port 53414</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 53414</div>

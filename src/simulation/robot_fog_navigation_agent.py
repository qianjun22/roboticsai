...
PORT = 50742
SERVICE = "robot-fog-navigation-agent"
DESCRIPTION = "Robotics simulation for fog navigation agent"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-fog-navigation-agent</title><style>
...
<div class="header"><h1>robot-fog-navigation-agent</h1><div class="subtitle">Robotics simulation for fog navigation agent · port 50742</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 50742</div>

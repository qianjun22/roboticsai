...
PORT = 12176
SERVICE = "robot-semiconductor-wafer-handler-trainer"
DESCRIPTION = "Training environment for robotic semiconductor wafer handling — cleanroom protocol adherence, vacuum chuck operations, and contamination-free transport"

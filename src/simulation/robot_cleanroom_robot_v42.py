...
PORT = 41802
SERVICE = "robot_cleanroom_robot"
DESCRIPTION = "Simulation service for cleanroom robot"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot_cleanroom_robot</title><style>
...
<div class="header"><h1>robot_cleanroom_robot</h1><div class="subtitle">Simulation service for cleanroom robot port 41802</div></div>
<div class="content">
<div class="metric"><strong>Status:</strong> operational</div>
<div class="metric"><strong>Port:</strong> 41802</div>

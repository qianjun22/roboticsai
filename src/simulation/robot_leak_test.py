...
PORT = 15262
SERVICE = "robot-leak-test"
DESCRIPTION = "Simulation service for leak test robotics tasks"
...
def dashboard():
    ...
    return f"""<!DOCTYPE html><html><head><title>robot-leak-test</title><style>
...
<div class="header"><h1>robot-leak-test</h1><div class="sub">Simulation service for leak test robotics tasks</div></div>
<div class="content">
<div class="metric"><b>Port:</b> 15262 | <b>Status:</b> <span style="color:#4ade80">Live</span>

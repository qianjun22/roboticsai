"""
AI World Sept 14-16 2026 logistics v2 — platinum booth, 3-person team, live robot demo.
...
PORT = 10315
SERVICE = "ai_world_logistics_planner_v2"
DESCRIPTION = "AI World Sept 14-16 2026 logistics v2 — platinum booth 2024, 3-person team, live robot demo"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/events/ai_world/logistics_v2")
    def ai_world_logistics_v2():
        return {
            "booth": "2024_20x20_platinum",
            "team": ["Jun_demo_lead", "ml_engineer_robot_op", "oci_pm_meetings"],
            "equipment": ["franka_arm", "oci_a100_laptop", "backup_laptop"],
            "completion_pct": 42
        }

    @app.post("/events/ai_world/logistics_v2/update")
    def ai_world_logistics_v2_update():
        return {
            "item": "booth_contract",
            "status": "completed",
            "updated_plan": "booth_signed",
            "completion_pct": 55
        }

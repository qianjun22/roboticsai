"""Growth accounting platform for robotics AI decomposing ARR changes into new business, expansion, contraction, and churn components
...
try:
    ...
    _has_fastapi = False
PORT = 11193
SERVICE = "growth_accounting_platform"
DESCRIPTION = "Growth accounting platform for robotics AI decomposing ARR changes into new business, expansion, contraction, and churn components"
if _has_fastapi:

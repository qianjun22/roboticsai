"""Partner certification program for OCI Robot Cloud with technical training tracks, assessments, and badge issuance for SI partners
...
try:
    ...
    _has_fastapi = False
PORT = 11157
SERVICE = "partner_certification_program"
DESCRIPTION = "Partner certification program for OCI Robot Cloud with technical training tracks, assessments, and badge issuance for SI partners"
if _has_fastapi:

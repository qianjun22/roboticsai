"""
OCI Robot Cloud — Revenue Operations V2
FastAPI service — port 11303
RevOps v2: unified funnel analytics, territory design, and quota management
"""
...
DESCRIPTION = "Revenue operations v2 unifying funnel analytics, sales territory design, quota management, and compensation modeling for scalable GTM execution as headcount grows"
...
var d=[12,18,26,35,46,58,71,86,102];
var max=Math.max(...d);

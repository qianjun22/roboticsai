"""
Enterprise trial manager: milestone-gated 4-week trial to paid conversion.
...
PORT = 10275
SERVICE = "enterprise_trial_manager"
DESCRIPTION = "Manage enterprise trial to paid conversion — 4-week milestone-gated trial structure"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/trials/manager")
    def trials_manager():
        return {
            "trial_id": "T001-Machina",
            "week": 4,
            "milestones": {
                "onboarding": True,
                "first_eval": True,
    ...
    @app.post("/trials/manager/trigger_conversion")
    def trigger_conversion():
        return {
            "trial_id": "T001",
            "pricing_sent": True,
            "close_date_estimate": "2026-04-15",
            "arr_estimate": 187500
        }

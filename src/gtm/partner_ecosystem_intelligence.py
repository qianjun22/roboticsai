"""Competitive and ecosystem intelligence platform tracking partner health signals and automated market move monitoring
...
try:
    ...
    _has_fastapi = False
PORT = 10899
SERVICE = "partner_ecosystem_intelligence"
DESCRIPTION = "Competitive and ecosystem intelligence platform tracking partner health signals and automated market move monitoring"
if _has_fastapi:

"""Pricing intelligence platform for robotics AI tracking competitor pricing, win/loss by price point, and optimal discount thresholds
...
DESCRIPTION = "Pricing intelligence platform for robotics AI tracking competitor pricing, win/loss by price point, and optimal discount thresholds"
if _has_fastapi:

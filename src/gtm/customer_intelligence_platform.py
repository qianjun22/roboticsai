"""Customer intelligence platform aggregating usage, support, and expansion signals for robotics accounts
...
try:
    ...
    _has_fastapi = False
PORT = 10839
SERVICE = "customer_intelligence_platform"
DESCRIPTION = "Customer intelligence platform aggregating usage, support, and expansion signals for robotics accounts"
if _has_fastapi:

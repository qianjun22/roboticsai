"""ML-based sales forecast model v2 — pipeline health, seasonality, ARR trajectory with confidence intervals
...
PORT = 10355
SERVICE = "sales_forecast_model_v2"
DESCRIPTION = "ML-based sales forecast model v2 — pipeline health, seasonality, ARR trajectory with confidence intervals"

"""Enterprise pricing negotiation playbook — price floors, concession matrix, approval authority, close tactics
...
PORT = 10409
SERVICE = "pricing_negotiation_playbook"
DESCRIPTION = "Enterprise pricing negotiation playbook — price floors, concession matrix, approval authority, close tactics"

"""Sales performance analytics v2 with rep-level coaching insights, ML forecast model, and quota pacing alerts
...
try:
    ...
    _has_fastapi = False
PORT = 10865
SERVICE = "sales_performance_analytics_v2"
DESCRIPTION = "Sales performance analytics v2 with rep-level coaching insights, ML forecast model, and quota pacing alerts"
if _has_fastapi:

"""GTC 2027 talk proposal v2 — 5%→97% SR story, 10K attendees, NVIDIA partner track
...
try:
    ...
    FastAPI = None
PORT = 10341
SERVICE = "gtc_2027_talk_proposal_v2"
DESCRIPTION = "GTC 2027 talk proposal v2 — 5%→97% SR story, 10K attendees, NVIDIA partner track"
if FastAPI:
    ...
    @app.get("/events/gtc_2027/proposal_v2")
    def proposal_v2():
        return {"title": "From 5% to 97%: How OCI A100 + DAgger Built a Production Robot in 12 Months", "track": "robotics_ai", "abstract_words": 350, "data_points": ["200_dagger_runs", "97pct_sr", "0.43_per_run", "5_customers"]}
    @app.post("/events/gtc_2027/proposal_v2/submit")
    def submit():
        return {"proposal_id": f"gtc27_{int(time.time())}", "submitted": True, "track": "nvidia_partner_robotics", "session_type": "30min_talk", "review_date": "2026-11-01"}

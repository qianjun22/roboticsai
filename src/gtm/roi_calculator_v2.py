"""Enterprise robot ROI calculator v2 — labor savings, error reduction, throughput gains, payback period
...
DESCRIPTION = "Enterprise robot ROI calculator v2 — labor savings, error reduction, throughput gains, payback period"

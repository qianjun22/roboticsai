"""
OCI Robot Cloud — Revenue Forecast V2
FastAPI service — port 11223
ML-powered ARR forecasting with pipeline signals and cohort analysis
"""
...
PORT = 11223
SERVICE = "revenue_forecast_v2"
DESCRIPTION = "ML-powered revenue forecast v2 combining pipeline stage probabilities, cohort expansion rates, and churn signals for accurate ARR projection toward Series A"
...
var d=[120,180,280,420,580,760,900,1050,1200];
var max=Math.max(...d);

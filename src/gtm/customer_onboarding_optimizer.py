"""Optimize time-to-value for new customers — day0 to production playbook, blocker detection, milestone tracking
...
PORT = 10357
SERVICE = "customer_onboarding_optimizer"
DESCRIPTION = "Optimize time-to-value for new customers — day0 to production playbook, blocker detection, milestone tracking"

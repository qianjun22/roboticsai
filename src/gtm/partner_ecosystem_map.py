"""Partner ecosystem map visualizing NVIDIA, OCI, and robotics ISV relationships and co-sell opportunities
...
try:
    ...
    _has_fastapi = False
PORT = 10841
SERVICE = "partner_ecosystem_map"
DESCRIPTION = "Partner ecosystem map visualizing NVIDIA, OCI, and robotics ISV relationships and co-sell opportunities"
if _has_fastapi:

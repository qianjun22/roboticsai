"""
Map and analyze customer journey — touchpoints, time-to-value, friction detection
...
DESCRIPTION = "Map and analyze customer journey — touchpoints, time-to-value, friction detection"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    def journey_analytics():
        return {
            ...
            "days_in_stage": 12,
            "total_journey_days": 45,
            "next_action": "referral_ask"
        }

    @app.get("/customers/journey/analytics/aggregate")
    def journey_analytics_aggregate():
        return {
            "avg_days_aware_to_trial": 18,
            "avg_days_trial_to_value": 9,
            "biggest_friction": "trial_to_onboard",
            "cohort_improving": True
        }

"""Customer win-back engine targeting churned accounts with personalized re-engagement campaigns
...
try:
    ...
    _has_fastapi = False
PORT = 11087
SERVICE = "customer_win_back_engine"
DESCRIPTION = "Customer win-back engine targeting churned accounts with personalized re-engagement campaigns"
if _has_fastapi:

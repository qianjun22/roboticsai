"""
OCI Robot Cloud — Competitive Win Rate Tracker
FastAPI service — port 11291
Track win/loss rates by competitor, deal size, vertical, and rep for strategic insights
"""
...
DESCRIPTION = "Competitive win rate tracker analyzing win/loss patterns by competitor, deal size, industry vertical, and sales rep to identify strategic improvement opportunities"
...
var d=[41,44,47,51,54,57,61,64,68];
var max=Math.max(...d);

...
PORT = 10517
SERVICE = "field_sales_playbook"
DESCRIPTION = "Field sales playbook: discovery → demo → POC → close with talk tracks"
...
if FastAPI:
    ...
    def dashboard():
        win_rate = round(random.uniform(0.64, 0.74), 3); bar = int(win_rate * 220)
...
<p>Port: {PORT} | Playbook Win Rate: {win_rate}</p>
<svg width='260' height='40'><rect width='220' height='30' fill='#1e293b' rx='4'/>
<rect width='{bar}' height='30' fill='#38bdf8' rx='4'/>
<text x='10' y='20' font-size='12'>Field Sales Win Rate: {win_rate}</text></svg>
</body></html>"""

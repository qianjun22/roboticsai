"""Partner performance scorecard with pipeline contribution, win rate, and enablement metrics
...
try:
    ...
    _has_fastapi = False
PORT = 11089
SERVICE = "partner_performance_scorecard"
DESCRIPTION = "Partner performance scorecard with pipeline contribution, win rate, and enablement metrics"
if _has_fastapi:

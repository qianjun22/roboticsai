"""Customer advocacy program — platinum/gold/silver tiers, reference calls, case studies, conference speaker pipeline
...
DESCRIPTION = "Customer advocacy program — platinum/gold/silver tiers, reference calls, case studies, conference speaker pipeline"

"""Pilot conversion tracker v2 with ML conversion probability scoring and automated intervention triggers
...
try:
    ...
    _has_fastapi = False
PORT = 10861
SERVICE = "pilot_conversion_tracker_v2"
DESCRIPTION = "Pilot conversion tracker v2 with ML conversion probability scoring and automated intervention triggers"
if _has_fastapi:

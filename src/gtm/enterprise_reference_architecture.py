"""OCI Robot Cloud enterprise reference architecture — VCN topology, Jetson edge, OCI Vault, sizing guide by fleet size
...
PORT = 10445
SERVICE = "enterprise_reference_architecture"
DESCRIPTION = "OCI Robot Cloud enterprise reference architecture — VCN topology, Jetson edge, OCI Vault, sizing guide by fleet size"

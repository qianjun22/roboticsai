"""Partner go-to-market kit with co-branded assets, demo scripts, and technical enablement materials
...
try:
    ...
    _has_fastapi = False
PORT = 11103
SERVICE = "partner_go_to_market_kit"
DESCRIPTION = "Partner go-to-market kit with co-branded assets, demo scripts, and technical enablement materials"
if _has_fastapi:

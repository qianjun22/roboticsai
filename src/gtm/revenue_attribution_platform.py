"""
OCI Robot Cloud — Revenue Attribution Platform
FastAPI service — port 11237
Multi-touch attribution modeling across all GTM channels and touchpoints
"""
...
PORT = 11237
SERVICE = "revenue_attribution_platform"
DESCRIPTION = "Multi-touch revenue attribution platform modeling contribution of each GTM channel, campaign, and touchpoint to closed revenue for optimal spend allocation"

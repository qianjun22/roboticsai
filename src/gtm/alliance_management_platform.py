"""Strategic alliance management platform for NVIDIA, OCI, and ISV partnerships with health scoring and initiative tracking
...
try:
    ...
    _has_fastapi = False
PORT = 10879
SERVICE = "alliance_management_platform"
DESCRIPTION = "Strategic alliance management platform for NVIDIA, OCI, and ISV partnerships with health scoring and initiative tracking"
if _has_fastapi:

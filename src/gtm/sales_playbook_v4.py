"""Sales playbook v4 consolidating NVIDIA co-sell, design partner, and PLG motion plays
...
try:
    ...
    _has_fastapi = False
PORT = 11101
SERVICE = "sales_playbook_v4"
DESCRIPTION = "Sales playbook v4 consolidating NVIDIA co-sell, design partner, and PLG motion plays"
if _has_fastapi:

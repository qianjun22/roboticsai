"""Series A fundraising readiness checker — 15 criteria scoring, gap analysis, estimated ready date tracker
...
PORT = 10387
SERVICE = "series_a_readiness_checker"
DESCRIPTION = "Series A fundraising readiness checker — 15 criteria scoring, gap analysis, estimated ready date tracker"

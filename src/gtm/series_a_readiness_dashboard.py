"""Series A fundraising readiness dashboard scoring technical, commercial, and team milestones for $5M raise
...
try:
    ...
    _has_fastapi = False
PORT = 11131
SERVICE = "series_a_readiness_dashboard"
DESCRIPTION = "Series A fundraising readiness dashboard scoring technical, commercial, and team milestones for $5M raise"
if _has_fastapi:

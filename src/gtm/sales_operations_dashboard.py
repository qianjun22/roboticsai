"""Unified sales operations dashboard for pipeline tracking and performance metrics
...
try:
    ...
    _has_fastapi = False
PORT = 10829
SERVICE = "sales_operations_dashboard"
DESCRIPTION = "Unified sales operations dashboard for pipeline tracking and performance metrics"
if _has_fastapi:

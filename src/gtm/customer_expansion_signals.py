"""Customer expansion signal detector — usage tier breach, new robot, exec engagement signals with 48hr outreach trigger
...
PORT = 10447
SERVICE = "customer_expansion_signals"
DESCRIPTION = "Customer expansion signal detector — usage tier breach, new robot, exec engagement signals with 48hr outreach trigger"

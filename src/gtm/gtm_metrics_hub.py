...
PORT = 10495
SERVICE = "gtm_metrics_hub"
DESCRIPTION = "GTM metrics hub: unified marketing + sales + CS + product command center"
...
if FastAPI:
    ...
    def dashboard():
        nrr = round(random.uniform(115, 122), 1); bar = int((nrr/130) * 220)

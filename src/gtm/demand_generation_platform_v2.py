"""Demand generation platform v2 with intent data integration and automated nurture sequences for robotics pipeline
...
try:
    ...
    _has_fastapi = False
PORT = 10859
SERVICE = "demand_generation_platform_v2"
DESCRIPTION = "Demand generation platform v2 with intent data integration and automated nurture sequences for robotics pipeline"
if _has_fastapi:

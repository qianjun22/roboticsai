...
PORT = 10469
SERVICE = "revenue_ops_playbook"
DESCRIPTION = "Revenue operations playbook: sales + marketing + CS alignment and forecasting"
...
if FastAPI:
    ...
    def dashboard():
        win_rate = round(random.uniform(0.62, 0.74), 3); bar = int(win_rate * 220)

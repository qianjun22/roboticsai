"""Real-time sales pipeline dashboard v2 — 8 deals, stage health scores, velocity tracking, weighted forecast
...
PORT = 10441
SERVICE = "sales_pipeline_dashboard_v2"
DESCRIPTION = "Real-time sales pipeline dashboard v2 — 8 deals, stage health scores, velocity tracking, weighted forecast"

"""Real-time sales velocity dashboard measuring pipeline throughput at $42k/week with cycle time and velocity lever analysis
...
DESCRIPTION = "Real-time sales velocity dashboard measuring pipeline throughput at $42k/week with cycle time and velocity lever analysis"
if _has_fastapi:

"""
Series B readiness tracking — post-Series A milestone monitoring toward $3M ARR
...
PORT = 10279
SERVICE = "series_b_readiness_tracker_v2"
DESCRIPTION = "Series B readiness tracking — post-Series A milestone monitoring toward $3M ARR"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/finance/series_b_v2/readiness")
    def series_b_readiness():
        return {
            "metric": "arr",
            "current_k": 250,
            "target_k": 3000,
    ...
    @app.get("/finance/series_b_v2/dashboard")
    def series_b_dashboard():
        return {
            "overall_readiness_pct": 8,
            "critical_path": "arr_growth",
            "investor_readiness": "early",
            "target_close": "Q1 2028"
        }

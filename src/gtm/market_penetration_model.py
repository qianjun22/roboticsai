...
PORT = 10465
SERVICE = "market_penetration_model"
DESCRIPTION = "Market penetration model: TAM/SAM/SOM forecasting and segment analysis"
...
if FastAPI:
    ...
    def dashboard():
        pct = round(random.uniform(0.4, 0.7), 2); bar = int(pct * 220)

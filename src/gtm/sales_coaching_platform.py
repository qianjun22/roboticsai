"""AI-powered sales coaching platform with call analysis, rep scoring, and skill gap detection
...
DESCRIPTION = "AI-powered sales coaching platform with call analysis, rep scoring, and skill gap detection"
if _has_fastapi:

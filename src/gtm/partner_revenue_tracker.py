"""Partner revenue tracker for OCI Robot Cloud measuring influenced ARR, co-sell pipeline, and partner-sourced deals
...
try:
    ...
    _has_fastapi = False
PORT = 11187
SERVICE = "partner_revenue_tracker"
DESCRIPTION = "Partner revenue tracker for OCI Robot Cloud measuring influenced ARR, co-sell pipeline, and partner-sourced deals"
if _has_fastapi:

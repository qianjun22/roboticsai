"""Partnership deal desk for co-sell structuring, margin allocation, and approval workflows
...
try:
    ...
    _has_fastapi = False
PORT = 11075
SERVICE = "partnership_deal_desk"
DESCRIPTION = "Partnership deal desk for co-sell structuring, margin allocation, and approval workflows"
if _has_fastapi:

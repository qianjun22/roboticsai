"""Developer portal analytics tracking docs traffic, SDK downloads, and API key activation funnels
...
try:
    ...
    _has_fastapi = False
PORT = 11113
SERVICE = "developer_portal_analytics"
DESCRIPTION = "Developer portal analytics tracking docs traffic, SDK downloads, and API key activation funnels"
if _has_fastapi:

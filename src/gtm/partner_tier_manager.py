...
PORT = 10553
SERVICE = "partner_tier_manager"
DESCRIPTION = "Partner tier manager: Silver/Gold/Platinum tiers with progression tracking"
...
if FastAPI:
    ...
    def dashboard():
        gold_pct = round(random.uniform(0.35, 0.55), 3); bar = int(gold_pct * 220)

"""
Systematic outbound prospecting — 847 ICP companies, 41% open rate, 5 meetings/month
...
PORT = 10311
SERVICE = "outbound_prospecting_engine"
DESCRIPTION = "Systematic outbound prospecting — 847 ICP companies, 41% open rate, 5 meetings/month"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/sales/outbound/prospects")
    def outbound_prospects():
        return {"total_icp": 847, "enriched": 312, "in_sequence": 47, "responses": 37, "meetings_booked": 5, "open_rate": 0.41, "reply_rate": 0.12}

    @app.post("/sales/outbound/sequence")
    def outbound_sequence():
        return {"sequence_id": f"seq_{int(time.time())}", "prospect_id": "robotics_startup_002", "first_touch_scheduled": "2026-04-02", "personalization_signals": ["series_b_funding", "franka_job_post"]}

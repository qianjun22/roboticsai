"""Product usage analytics dashboard — API calls, fine-tune runs, DAU, feature adoption, activation funnel
...
DESCRIPTION = "Product usage analytics dashboard — API calls, fine-tune runs, DAU, feature adoption, activation funnel"

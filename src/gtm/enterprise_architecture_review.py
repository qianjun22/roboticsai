"""Enterprise deployment architecture review — 7-item OCI checklist, production approval gate, zero incidents from reviewed deployments
...
PORT = 10453
SERVICE = "enterprise_architecture_review"
DESCRIPTION = "Enterprise deployment architecture review — 7-item OCI checklist, production approval gate, zero incidents from reviewed deployments"

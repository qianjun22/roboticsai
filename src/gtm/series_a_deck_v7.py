"""
Series A deck v7 — Q2 traction $430K ARR, AI World plan, NVIDIA progress, $5M ask
...
PORT = 10297
SERVICE = "series_a_deck_v7"
DESCRIPTION = "Series A deck v7 — Q2 traction $430K ARR, AI World plan, NVIDIA progress, $5M ask"
...
<div class="metric"><h2>Service Info</h2><p>Port: {PORT} | Status: operational</p></div>
    ...
    @app.get("/gtm/series_a/deck_v7")
    def deck_v7():
        return {
            "version": "v7",
            "sections": ["problem", "insight", "product", "traction", "market", "team", "ask"],
            "arr_k": 430,
            "ask_m": 5,
            "pre_money_m": 22,
    ...
    @app.get("/gtm/series_a/deck_v7/diff")
    def deck_v7_diff():
        return {
            "changed_slides": ["traction", "market", "nvidia_progress"],
            "new_data_points": ["430k_arr", "ai_world_booth", "nvidia_intro_pending"],
            "narrative_updates": 3
        }

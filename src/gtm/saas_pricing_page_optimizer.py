"""SaaS pricing page A/B optimizer — anchoring effects, tier clarity, conversion rate improvement from 3.2 to 5 percent
...
PORT = 10429
SERVICE = "saas_pricing_page_optimizer"
DESCRIPTION = "SaaS pricing page A/B optimizer — anchoring effects, tier clarity, conversion rate improvement from 3.2 to 5 percent"

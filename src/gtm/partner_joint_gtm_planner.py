"""Joint go-to-market planning tool for coordinating NVIDIA and OCI robotics partner initiatives
...
try:
    ...
    _has_fastapi = False
PORT = 10833
SERVICE = "partner_joint_gtm_planner"
DESCRIPTION = "Joint go-to-market planning tool for coordinating NVIDIA and OCI robotics partner initiatives"
if _has_fastapi:

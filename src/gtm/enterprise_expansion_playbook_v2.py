"""QBR-driven enterprise expansion playbook v2 — trigger detection, upsell motion, close rate tracking
...
PORT = 10415
SERVICE = "enterprise_expansion_playbook_v2"
DESCRIPTION = "QBR-driven enterprise expansion playbook v2 — trigger detection, upsell motion, close rate tracking"
